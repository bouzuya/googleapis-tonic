            ...
            pub mod airflow {
                ...
                pub mod service {
                    ...
                    pub mod v1 {
                        #[cfg(any(feature = "google-cloud-orchestration-airflow-service-v1",))]
                        include!(
                            "bytes_btree_map/google.cloud.orchestration.airflow.service.v1.rs"
                        );
                    }
                    ...
                    pub mod v1beta1 {
                        #[cfg(any(feature = "google-cloud-orchestration-airflow-service-v1beta1",))]
                        include!(
                            "bytes_btree_map/google.cloud.orchestration.airflow.service.v1beta1.rs"
                        );
                    }
                }
            }
        ...
        pub mod beyondcorp {
            ...
            pub mod clientconnectorservices {
                ...
                pub mod v1 {
                    #[cfg(any(feature = "google-cloud-beyondcorp-clientconnectorservices-v1",))]
                    include!(
                        "bytes_btree_map/google.cloud.beyondcorp.clientconnectorservices.v1.rs"
                    );
                }
            }
            ...
            pub mod consumer {
                ...
                pub mod procurement {
                    ...
                    pub mod v1 {
                        #[cfg(any(feature = "google-cloud-commerce-consumer-procurement-v1",))]
                        include!(
                            "bytes_btree_map/google.cloud.commerce.consumer.procurement.v1.rs"
                        );
                    }
                }
            }
            ...
            pub mod management {
                ...
                pub mod logs {
                    ...
                    pub mod v1 {
                        #[cfg(any(feature = "google-cloud-saasaccelerator-management-logs-v1",))]
                        include!(
                            "bytes_btree_map/google.cloud.saasaccelerator.management.logs.v1.rs"
                        );
                    }
                }
            }
            ...
            pub mod v2 {
                ...
                pub mod interactionmodel {
                    ...
                    pub mod prompt {
                        #[cfg(any(feature = "google-actions-sdk-v2-interactionmodel-prompt",))]
                        include!(
                            "bytes_btree_map/google.actions.sdk.v2.interactionmodel.prompt.rs"
                        );
                    }
                    ...
                    pub mod r#type {
                        #[cfg(any(feature = "google-actions-sdk-v2-interactionmodel-type",))]
                        include!(
                            "bytes_btree_map/google.actions.sdk.v2.interactionmodel.r#type.rs"
                        );
                    }
                }
            }
