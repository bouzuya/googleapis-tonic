...
pub struct ReportConfig {
    ...
    pub group_preferenceset_assignments:
        ::prost::alloc::vec::Vec<report_config::GroupPreferenceSetAssignment>,
}
...
pub struct MachineArchitectureDetails {
    ...
    #[prost(
        enumeration = "machine_architecture_details::CpuHyperThreading",
        tag = "8"
    )]
...
pub mod report_summary {
    ...
    pub struct GroupPreferenceSetFinding {
        ...
        #[prost(message, optional, tag = "6")]
        pub monthly_cost_os_license:
            ::core::option::Option<super::super::super::super::r#type::Money>,
        #[prost(message, optional, tag = "7")]
        pub monthly_cost_network_egress:
            ::core::option::Option<super::super::super::super::r#type::Money>,
        #[prost(message, optional, tag = "8")]
...
pub mod migration_center_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::BatchUpdateAssetsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::ReportAssetFramesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::AggregateAssetsValuesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::ListImportDataFilesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::ListErrorFramesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::ListPreferenceSetsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::ListReportConfigsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::ListReportsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
