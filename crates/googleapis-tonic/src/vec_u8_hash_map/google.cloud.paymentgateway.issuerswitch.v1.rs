...
pub mod issuer_switch_rules_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::ListRuleMetadataResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
...
pub mod issuer_switch_participants_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::IssuerParticipant>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        ) -> std::result::Result<tonic::Response<super::IssuerParticipants>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
    ...
    impl ReasonCode {
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "DEFERRED_ARBITRATION_RAISE_DEFERRED_CHARGEBACK_PRE_ARBITRATION_REJECTED" => {
                    Some(Self::DeferredArbitrationRaiseDeferredChargebackPreArbitrationRejected)
                }
    ...
    impl ReasonCode {
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                "REASON_CODE_UNSPECIFIED" => Some(Self::Unspecified),
                "CHARGEBACK_BENEFICIARY_CANNOT_CREDIT_OR_PRE_ARBITRATION_DUPLICATE_PROCESS" => {
                    Some(Self::ChargebackBeneficiaryCannotCreditOrPreArbitrationDuplicateProcess)
                }
                "PRE_ARBITRATION_DECLINED_BENEFICIARY_CREDITED_ONLINE" => {
