...
#[prost(message, optional, tag = "4")]
pub settled_amount: ::core::option::Option<super::super::super::super::super::r#type::Money>,
}
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
TransactionType::MandateNotification => "TRANSACTION_TYPE_MANDATE_NOTIFICATION",
...
TransactionType::ActivationInternational => "TRANSACTION_TYPE_ACTIVATION_INTERNATIONAL",
TransactionType::ActivationUpiServices => "TRANSACTION_TYPE_ACTIVATION_UPI_SERVICES",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"TRANSACTION_TYPE_ACTIVATION_INTERNATIONAL" => Some(Self::ActivationInternational),
"TRANSACTION_TYPE_ACTIVATION_UPI_SERVICES" => Some(Self::ActivationUpiServices),
_ => None,
}
}
}
...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> IssuerSwitchRulesClient<InterceptedService<T, F>>
where
...
pub async fn list_rules(&mut self, request: impl tonic::IntoRequest<super::ListRulesRequest>) -> std::result::Result<tonic::Response<super::ListRulesResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.paymentgateway.issuerswitch.v1.IssuerSwitchRules/ListRules");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.paymentgateway.issuerswitch.v1.IssuerSwitchRules", "ListRules"));
self.inner.unary(req, path, codec).await
}
/// List all rule metadata for a given rule identifier.
pub async fn list_rule_metadata(&mut self, request: impl tonic::IntoRequest<super::ListRuleMetadataRequest>) -> std::result::Result<tonic::Response<super::ListRuleMetadataResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.paymentgateway.issuerswitch.v1.IssuerSwitchRules/ListRuleMetadata");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.paymentgateway.issuerswitch.v1.IssuerSwitchRules", "ListRuleMetadata"));
self.inner.unary(req, path, codec).await
}
/// List all metadata values for a rule metadata identifier.
pub async fn list_rule_metadata_values(&mut self, request: impl tonic::IntoRequest<super::ListRuleMetadataValuesRequest>) -> std::result::Result<tonic::Response<super::ListRuleMetadataValuesResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.paymentgateway.issuerswitch.v1.IssuerSwitchRules", "ListRuleMetadataValues"));
self.inner.unary(req, path, codec).await
}
/// Create (add) multiple values to the list of values under the specified rule
/// metadata resource.
pub async fn batch_create_rule_metadata_values(&mut self, request: impl tonic::IntoRequest<super::BatchCreateRuleMetadataValuesRequest>) -> std::result::Result<tonic::Response<super::BatchCreateRuleMetadataValuesResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.paymentgateway.issuerswitch.v1.IssuerSwitchRules", "BatchCreateRuleMetadataValues"));
self.inner.unary(req, path, codec).await
}
/// Delete (remove) multiple values from the list of values under the specified
/// rules metadata resource.
pub async fn batch_delete_rule_metadata_values(&mut self, request: impl tonic::IntoRequest<super::BatchDeleteRuleMetadataValuesRequest>) -> std::result::Result<tonic::Response<()>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.paymentgateway.issuerswitch.v1.IssuerSwitchRules", "BatchDeleteRuleMetadataValues"));
self.inner.unary(req, path, codec).await
}
}
}
...
/// account number.
pub async fn fetch_participant(&mut self, request: impl tonic::IntoRequest<super::FetchParticipantRequest>) -> std::result::Result<tonic::Response<super::IssuerParticipant>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.paymentgateway.issuerswitch.v1.IssuerSwitchParticipants", "FetchParticipant"));
self.inner.unary(req, path, codec).await
}
...
pub async fn update_issuer_participant(&mut self, request: impl tonic::IntoRequest<super::UpdateIssuerParticipantRequest>) -> std::result::Result<tonic::Response<super::IssuerParticipant>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.paymentgateway.issuerswitch.v1.IssuerSwitchParticipants", "UpdateIssuerParticipant"));
self.inner.unary(req, path, codec).await
}
...
///     : The state cannot be changed to `ACTIVE`. This API will return an
///     error.
pub async fn activate_participant(&mut self, request: impl tonic::IntoRequest<super::ParticipantStateChangeRequest>) -> std::result::Result<tonic::Response<super::IssuerParticipants>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.paymentgateway.issuerswitch.v1.IssuerSwitchParticipants", "ActivateParticipant"));
self.inner.unary(req, path, codec).await
}
...
///     : The state cannot be changed to `INACTIVE`. This API will return an
///     error.
pub async fn deactivate_participant(&mut self, request: impl tonic::IntoRequest<super::ParticipantStateChangeRequest>) -> std::result::Result<tonic::Response<super::IssuerParticipants>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.paymentgateway.issuerswitch.v1.IssuerSwitchParticipants", "DeactivateParticipant"));
self.inner.unary(req, path, codec).await
}
...
///     to the UPI payments orchestrator. The user will be forced to
///     re-register with their changed mobile number.
pub async fn mobile_number_changed(&mut self, request: impl tonic::IntoRequest<super::ParticipantStateChangeRequest>) -> std::result::Result<tonic::Response<super::IssuerParticipants>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.paymentgateway.issuerswitch.v1.IssuerSwitchParticipants", "MobileNumberChanged"));
self.inner.unary(req, path, codec).await
}
}
}
...
"CUSTOMER_ACCOUNT_NOT_CREDITED_BACK" => Some(Self::CustomerAccountNotCreditedBack),
"BENEFICIARY_ACCOUNT_NOT_CREDITED" => Some(Self::BeneficiaryAccountNotCredited),
"GOODS_SERVICES_CREDIT_NOT_PROCESSED" => Some(Self::GoodsServicesCreditNotProcessed),
"MERCHANT_NOT_RECEIVED_CONFIRMATION" => Some(Self::MerchantNotReceivedConfirmation),
...
"TRANSACTION_CREDIT_CONFIRMATION" => Some(Self::TransactionCreditConfirmation),
_ => None,
}
}
}
...
"COMPLAINT_RESOLVED_NOW_OR_MANUALLY" => Some(Self::ComplaintResolvedNowOrManually),
...
"RET_INVALID_BENEFICIARY_DETAILS" => Some(Self::RetInvalidBeneficiaryDetails),
"RET_ANY_OTHER_REASON" => Some(Self::RetAnyOtherReason),
"RET_BENEFICIARY_CANNOT_CREDIT" => Some(Self::RetBeneficiaryCannotCredit),
"RET_MERCHANT_NOT_RECEIVED_CONFIRMATION" => Some(Self::RetMerchantNotReceivedConfirmation),
...
"DEFERRED_PRE_ARBITRATION_RAISE" => Some(Self::DeferredPreArbitrationRaise),
...
match value {
"REASON_CODE_UNSPECIFIED" => Some(Self::Unspecified),
"CHARGEBACK_RAISE_REMITTER_DEBITED_BENEFICIARY_NOT_CREDITED" => Some(Self::ChargebackRaiseRemitterDebitedBeneficiaryNotCredited),
"PRE_ARBITRATION_RAISE_BENEFICIARY_NOT_CREDITED" => Some(Self::PreArbitrationRaiseBeneficiaryNotCredited),
"DEFERRED_CHARGEBACK_RAISE_BENEFICIARY_NOT_CREDITED" => Some(Self::DeferredChargebackRaiseBeneficiaryNotCredited),
"DEFERRED_PRE_ARBITRATION_RAISE_BENEFICIARY_NOT_CREDITED" => Some(Self::DeferredPreArbitrationRaiseBeneficiaryNotCredited),
"DEFERRED_ARBITRATION_RAISE_DEFERRED_CHARGEBACK_PRE_ARBITRATION_REJECTED" => Some(Self::DeferredArbitrationRaiseDeferredChargebackPreArbitrationRejected),
...
"CHARGEBACK_CARD_HOLDER_CHARGED_MORE" => Some(Self::ChargebackCardHolderChargedMore),
"CUSTOMER_CLAIMING_GOODS_SERVICES_NOT_DELIVERED" => Some(Self::CustomerClaimingGoodsServicesNotDelivered),
"PARTIES_DENIED" => Some(Self::PartiesDenied),
"FUNDS_TRANSFERRED_TO_UNINTENDED_BENEFICIARY" => Some(Self::FundsTransferredToUnintendedBeneficiary),
_ => None,
}
}
}
...
"DEFERRED_CHARGEBACK_ACCEPTANCE" => Some(Self::DeferredChargebackAcceptance),
"PRE_ARBITRATION_ACCEPTANCE" => Some(Self::PreArbitrationAcceptance),
"DEFERRED_PRE_ARBITRATION_ACCEPTANCE" => Some(Self::DeferredPreArbitrationAcceptance),
"PRE_ARBITRATION_DECLINED" => Some(Self::PreArbitrationDeclined),
"DEFERRED_PRE_ARBITRATION_DECLINED" => Some(Self::DeferredPreArbitrationDeclined),
...
"FRAUD_CHARGEBACK_REPRESENTMENT" => Some(Self::FraudChargebackRepresentment),
"FRAUD_CHARGEBACK_ACCEPT" => Some(Self::FraudChargebackAccept),
"WRONG_CREDIT_REPRESENTMENT" => Some(Self::WrongCreditRepresentment),
"WRONG_CREDIT_CHARGEBACK_ACCEPTANCE" => Some(Self::WrongCreditChargebackAcceptance),
...
match value {
"REASON_CODE_UNSPECIFIED" => Some(Self::Unspecified),
"CHARGEBACK_BENEFICIARY_CANNOT_CREDIT_OR_PRE_ARBITRATION_DUPLICATE_PROCESS" => Some(Self::ChargebackBeneficiaryCannotCreditOrPreArbitrationDuplicateProcess),
"PRE_ARBITRATION_DECLINED_BENEFICIARY_CREDITED_ONLINE" => Some(Self::PreArbitrationDeclinedBeneficiaryCreditedOnline),
"PRE_ARBITRATION_DECLINED_BENEFICIARY_CREDITED_MANUALLY" => Some(Self::PreArbitrationDeclinedBeneficiaryCreditedManually),
"DEFERRED_CHARGEBACK_ACCEPTANCE_ACCOUNT_NOT_CREDITED_TCC_RAISED" => Some(Self::DeferredChargebackAcceptanceAccountNotCreditedTccRaised),
"DEFERRED_RE_PRESENTMENT_RAISE_ACCOUNT_CREDITED_TCC_RAISED" => Some(Self::DeferredRePresentmentRaiseAccountCreditedTccRaised),
"DEFERRED_PRE_ARBITRATION_ACCEPTANCE_ACCOUNT_NOT_CREDITED" => Some(Self::DeferredPreArbitrationAcceptanceAccountNotCredited),
"DEFERRED_PRE_ARBITRATION_DECLINED_ACCOUNT_CREDITED" => Some(Self::DeferredPreArbitrationDeclinedAccountCredited),
"FRAUD_CHARGEBACK_ACCEPT_AMOUNT_RECOVERED_FROM_FRAUDULENT_ACCOUNT" => Some(Self::FraudChargebackAcceptAmountRecoveredFromFraudulentAccount),
"FRAUD_CHARGEBACK_REPRESENTMENT_LIEN_MARKED_INSUFFICIENT_BALANCE" => Some(Self::FraudChargebackRepresentmentLienMarkedInsufficientBalance),
"FRAUD_CHARGEBACK_REPRESENTMENT_FIR_NOT_PROVIDED" => Some(Self::FraudChargebackRepresentmentFirNotProvided),
"FRAUD_CHARGEBACK_REPRESENTMENT_REASON_OTHERS" => Some(Self::FraudChargebackRepresentmentReasonOthers),
"RE_PRESENTMENT_RAISE_BENEFICIARY_CREDITED_ONLINE" => Some(Self::RePresentmentRaiseBeneficiaryCreditedOnline),
"RE_PRESENTMENT_RAISE_BENEFICIARY_CREDITED_MANUALLY" => Some(Self::RePresentmentRaiseBeneficiaryCreditedManually),
"CREDIT_ADJUSTMENT_GOODS_SERVICES_CREDIT_NOT_PROCESSED" => Some(Self::CreditAdjustmentGoodsServicesCreditNotProcessed),
"CREDIT_ADJUSTMENT_GOODS_SERVICES_DEFECTIVE" => Some(Self::CreditAdjustmentGoodsServicesDefective),
"CREDIT_ADJUSTMENT_PAID_BY_ALTERNATE_MEANS" => Some(Self::CreditAdjustmentPaidByAlternateMeans),
"CREDIT_ADJUSTMENT_GOODS_SERVICES_NOT_RECEIVED" => Some(Self::CreditAdjustmentGoodsServicesNotReceived),
"CREDIT_ADJUSTMENT_MERCHANT_NOT_RECEIVED_CONFIRMATION" => Some(Self::CreditAdjustmentMerchantNotReceivedConfirmation),
"CREDIT_ADJUSTMENT_DUPLICATE_TRANSACTION" => Some(Self::CreditAdjustmentDuplicateTransaction),
"CREDIT_ADJUSTMENT_REASON_OTHERS" => Some(Self::CreditAdjustmentReasonOthers),
"CREDIT_ADJUSTMENT_NON_MATCHING_ACCOUNT_NUMBER" => Some(Self::CreditAdjustmentNonMatchingAccountNumber),
"CREDIT_ADJUSTMENT_CARD_HOLDER_CHARGED_MORE" => Some(Self::CreditAdjustmentCardHolderChargedMore),
"CREDIT_ADJUSTMENT_CREDIT_NOT_PROCESSED" => Some(Self::CreditAdjustmentCreditNotProcessed),
"CREDIT_ADJUSTMENT_BENEFICIARY_CANNOT_CREDIT" => Some(Self::CreditAdjustmentBeneficiaryCannotCredit),
"CHARGEBACK_ACCEPTANCE_MERCHANT_CANNOT_PROVIDE_SERVICE" => Some(Self::ChargebackAcceptanceMerchantCannotProvideService),
"RE_PRESENTMENT_RAISE_GOODS_SERVICES_PROVIDED" => Some(Self::RePresentmentRaiseGoodsServicesProvided),
"PRE_ARBITRATION_DECLINED_SERVICES_PROVIDED_LATER" => Some(Self::PreArbitrationDeclinedServicesProvidedLater),
"PRE_ARBITRATION_ACCEPTANCE_SERVICES_NOT_PROVIDED_BY_MERCHANT" => Some(Self::PreArbitrationAcceptanceServicesNotProvidedByMerchant),
"ARBITRATION_ACCEPTANCE_ILLEGIBLE_FULFILMENT" => Some(Self::ArbitrationAcceptanceIllegibleFulfilment),
"ARBITRATION_CONTINUATION_CUSTOMER_STILL_NOT_RECEIVED_SERVICE" => Some(Self::ArbitrationContinuationCustomerStillNotReceivedService),
"ARBITRATION_WITHDRAWN_CUSTOMER_RECEIVED_SERVICE_LATER" => Some(Self::ArbitrationWithdrawnCustomerReceivedServiceLater),
"ARBITRATION_VERDICT_PANEL_VERDICT" => Some(Self::ArbitrationVerdictPanelVerdict),
...
"WRONG_CREDIT_CHARGEBACK_ACCEPTANCE_AMOUNT_RECOVERED" => Some(Self::WrongCreditChargebackAcceptanceAmountRecovered),
"WRONG_CREDIT_REPRESENTMENT_LIEN_MARKED_INSUFFICIENT_BALANCE" => Some(Self::WrongCreditRepresentmentLienMarkedInsufficientBalance),
"WRONG_CREDIT_REPRESENTMENT_CUSTOMER_INACCESSIBLE" => Some(Self::WrongCreditRepresentmentCustomerInaccessible),
"WRONG_CREDIT_REPRESENTMENT_REASON_OTHERS" => Some(Self::WrongCreditRepresentmentReasonOthers),
_ => None,
}
}
}
...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> IssuerSwitchResolutionsClient<InterceptedService<T, F>>
where
F: tonic::service::Interceptor,
T::ResponseBody: Default,
T: tonic::codegen::Service<http::Request<tonic::body::BoxBody>, Response = http::Response<<T as tonic::client::GrpcService<tonic::body::BoxBody>>::ResponseBody>>,
...
pub async fn create_complaint(&mut self, request: impl tonic::IntoRequest<super::CreateComplaintRequest>) -> std::result::Result<tonic::Response<super::super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.paymentgateway.issuerswitch.v1.IssuerSwitchResolutions", "CreateComplaint"));
self.inner.unary(req, path, codec).await
}
...
/// - `response`:
/// [Complaint][google.cloud.paymentgateway.issuerswitch.v1.Complaint]
pub async fn resolve_complaint(&mut self, request: impl tonic::IntoRequest<super::ResolveComplaintRequest>) -> std::result::Result<tonic::Response<super::super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.paymentgateway.issuerswitch.v1.IssuerSwitchResolutions", "ResolveComplaint"));
self.inner.unary(req, path, codec).await
}
...
pub async fn create_dispute(&mut self, request: impl tonic::IntoRequest<super::CreateDisputeRequest>) -> std::result::Result<tonic::Response<super::super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.paymentgateway.issuerswitch.v1.IssuerSwitchResolutions", "CreateDispute"));
self.inner.unary(req, path, codec).await
}
...
/// - `response`:
/// [Dispute][google.cloud.paymentgateway.issuerswitch.v1.Dispute]
pub async fn resolve_dispute(&mut self, request: impl tonic::IntoRequest<super::ResolveDisputeRequest>) -> std::result::Result<tonic::Response<super::super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.paymentgateway.issuerswitch.v1.IssuerSwitchResolutions", "ResolveDispute"));
self.inner.unary(req, path, codec).await
}
}
}
...
pub async fn list_metadata_transactions(&mut self, request: impl tonic::IntoRequest<super::ListMetadataTransactionsRequest>) -> std::result::Result<tonic::Response<super::ListMetadataTransactionsResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.paymentgateway.issuerswitch.v1.IssuerSwitchTransactions", "ListMetadataTransactions"));
self.inner.unary(req, path, codec).await
}
/// List financial transactions that satisfy specified filter criteria.
pub async fn list_financial_transactions(&mut self, request: impl tonic::IntoRequest<super::ListFinancialTransactionsRequest>) -> std::result::Result<tonic::Response<super::ListFinancialTransactionsResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.paymentgateway.issuerswitch.v1.IssuerSwitchTransactions", "ListFinancialTransactions"));
self.inner.unary(req, path, codec).await
}
/// List mandate transactions that satisfy specified filter criteria.
pub async fn list_mandate_transactions(&mut self, request: impl tonic::IntoRequest<super::ListMandateTransactionsRequest>) -> std::result::Result<tonic::Response<super::ListMandateTransactionsResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.paymentgateway.issuerswitch.v1.IssuerSwitchTransactions", "ListMandateTransactions"));
self.inner.unary(req, path, codec).await
}
/// List complaint transactions that satisfy specified filter criteria.
pub async fn list_complaint_transactions(&mut self, request: impl tonic::IntoRequest<super::ListComplaintTransactionsRequest>) -> std::result::Result<tonic::Response<super::ListComplaintTransactionsResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.paymentgateway.issuerswitch.v1.IssuerSwitchTransactions", "ListComplaintTransactions"));
self.inner.unary(req, path, codec).await
}
...
pub async fn export_financial_transactions(&mut self, request: impl tonic::IntoRequest<super::ExportFinancialTransactionsRequest>) -> std::result::Result<tonic::Response<super::super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.paymentgateway.issuerswitch.v1.IssuerSwitchTransactions", "ExportFinancialTransactions"));
self.inner.unary(req, path, codec).await
}
...
///     switch maps the ErrorCode to an appropriate error code that complies
///     with the UPI specification.
pub async fn export_metadata_transactions(&mut self, request: impl tonic::IntoRequest<super::ExportMetadataTransactionsRequest>) -> std::result::Result<tonic::Response<super::super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.paymentgateway.issuerswitch.v1.IssuerSwitchTransactions", "ExportMetadataTransactions"));
self.inner.unary(req, path, codec).await
}
...
pub async fn export_mandate_transactions(&mut self, request: impl tonic::IntoRequest<super::ExportMandateTransactionsRequest>) -> std::result::Result<tonic::Response<super::super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.paymentgateway.issuerswitch.v1.IssuerSwitchTransactions", "ExportMandateTransactions"));
self.inner.unary(req, path, codec).await
}
...
pub async fn export_complaint_transactions(&mut self, request: impl tonic::IntoRequest<super::ExportComplaintTransactionsRequest>) -> std::result::Result<tonic::Response<super::super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.paymentgateway.issuerswitch.v1.IssuerSwitchTransactions", "ExportComplaintTransactions"));
self.inner.unary(req, path, codec).await
}
}
}
...
#[prost(enumeration = "super::super::super::super::logging::r#type::LogSeverity", tag = "2")]
pub severity: i32,
#[prost(enumeration = "ApiType", tag = "3")]
pub api_type: i32,
