...
pub memberships: ::std::collections::HashMap<::prost::alloc::string::String, allow_binding_explanation::AnnotatedAllowMembership>,
...
pub denied_permissions: ::std::collections::HashMap<::prost::alloc::string::String, deny_rule_explanation::AnnotatedPermissionMatching>,
#[prost(message, optional, tag = "4")]
pub combined_exception_permission: ::core::option::Option<deny_rule_explanation::AnnotatedPermissionMatching>,
#[prost(map = "string, message", tag = "5")]
pub exception_permissions: ::std::collections::HashMap<::prost::alloc::string::String, deny_rule_explanation::AnnotatedPermissionMatching>,
#[prost(message, optional, tag = "6")]
pub combined_denied_principal: ::core::option::Option<deny_rule_explanation::AnnotatedDenyPrincipalMatching>,
#[prost(map = "string, message", tag = "7")]
pub denied_principals: ::std::collections::HashMap<::prost::alloc::string::String, deny_rule_explanation::AnnotatedDenyPrincipalMatching>,
#[prost(message, optional, tag = "8")]
pub combined_exception_principal: ::core::option::Option<deny_rule_explanation::AnnotatedDenyPrincipalMatching>,
#[prost(map = "string, message", tag = "9")]
pub exception_principals: ::std::collections::HashMap<::prost::alloc::string::String, deny_rule_explanation::AnnotatedDenyPrincipalMatching>,
