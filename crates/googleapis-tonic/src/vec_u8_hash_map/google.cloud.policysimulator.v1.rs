...
pub policy_overlay: ::std::collections::HashMap<::prost::alloc::string::String, super::super::super::iam::v1::Policy>,
...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> SimulatorClient<InterceptedService<T, F>>
where
...
pub async fn get_replay(&mut self, request: impl tonic::IntoRequest<super::GetReplayRequest>) -> std::result::Result<tonic::Response<super::Replay>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.policysimulator.v1.Simulator/GetReplay");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.policysimulator.v1.Simulator", "GetReplay"));
...
pub async fn create_replay(&mut self, request: impl tonic::IntoRequest<super::CreateReplayRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.policysimulator.v1.Simulator/CreateReplay");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.policysimulator.v1.Simulator", "CreateReplay"));
self.inner.unary(req, path, codec).await
}
/// Lists the results of running a
/// [Replay][google.cloud.policysimulator.v1.Replay].
pub async fn list_replay_results(&mut self, request: impl tonic::IntoRequest<super::ListReplayResultsRequest>) -> std::result::Result<tonic::Response<super::ListReplayResultsResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.policysimulator.v1.Simulator/ListReplayResults");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.policysimulator.v1.Simulator", "ListReplayResults"));
self.inner.unary(req, path, codec).await
}
}
}
