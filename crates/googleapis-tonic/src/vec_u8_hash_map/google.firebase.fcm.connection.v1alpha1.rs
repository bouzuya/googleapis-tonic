...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> ConnectionApiClient<InterceptedService<T, F>>
where
...
pub async fn connect(&mut self, request: impl tonic::IntoStreamingRequest<Message = super::UpstreamRequest>) -> std::result::Result<tonic::Response<tonic::codec::Streaming<super::DownstreamResponse>>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.firebase.fcm.connection.v1alpha1.ConnectionApi/Connect");
let mut req = request.into_streaming_request();
req.extensions_mut().insert(GrpcMethod::new("google.firebase.fcm.connection.v1alpha1.ConnectionApi", "Connect"));
