...
pub cloud_export_additional_properties: ::prost::alloc::vec::Vec<CloudExportAdditionalProperties>,
...
#[prost(string, tag = "1")]
pub name: ::prost::alloc::string::String,
#[prost(enumeration = "super::super::super::r#type::channel::ChannelEnum", tag = "2")]
pub channel: i32,
#[prost(string, tag = "3")]
...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> ProductsServiceClient<InterceptedService<T, F>>
where
...
let path = http::uri::PathAndQuery::from_static("/google.shopping.merchant.products.v1beta.ProductsService/GetProduct");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.shopping.merchant.products.v1beta.ProductsService", "GetProduct"));
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.shopping.merchant.products.v1beta.ProductsService/ListProducts");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.shopping.merchant.products.v1beta.ProductsService", "ListProducts"));
self.inner.unary(req, path, codec).await
}
}
}
...
#[prost(enumeration = "super::super::super::r#type::channel::ChannelEnum", tag = "3")]
pub channel: i32,
#[prost(string, tag = "4")]
pub offer_id: ::prost::alloc::string::String,
#[prost(string, tag = "5")]
...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> ProductInputsServiceClient<InterceptedService<T, F>>
where
F: tonic::service::Interceptor,
T::ResponseBody: Default,
T: tonic::codegen::Service<http::Request<tonic::body::BoxBody>, Response = http::Response<<T as tonic::client::GrpcService<tonic::body::BoxBody>>::ResponseBody>>,
...
pub async fn insert_product_input(&mut self, request: impl tonic::IntoRequest<super::InsertProductInputRequest>) -> std::result::Result<tonic::Response<super::ProductInput>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.shopping.merchant.products.v1beta.ProductInputsService/InsertProductInput");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.shopping.merchant.products.v1beta.ProductInputsService", "InsertProductInput"));
self.inner.unary(req, path, codec).await
}
...
/// After inserting, updating, or deleting a product input, it may take several
/// minutes before the processed product can be retrieved.
pub async fn delete_product_input(&mut self, request: impl tonic::IntoRequest<super::DeleteProductInputRequest>) -> std::result::Result<tonic::Response<()>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.shopping.merchant.products.v1beta.ProductInputsService/DeleteProductInput");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.shopping.merchant.products.v1beta.ProductInputsService", "DeleteProductInput"));
self.inner.unary(req, path, codec).await
}
}
}
