...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> UiDetectionServiceClient<InterceptedService<T, F>>
where
...
/// Runs the detection.
pub async fn execute_detection(&mut self, request: impl tonic::IntoRequest<super::UiDetectionRequest>) -> std::result::Result<tonic::Response<super::UiDetectionResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.chromeos.uidetection.v1.UiDetectionService/ExecuteDetection");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.chromeos.uidetection.v1.UiDetectionService", "ExecuteDetection"));
