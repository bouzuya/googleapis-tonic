...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> IdentityAwareProxyAdminV1Beta1Client<InterceptedService<T, F>>
where
...
let path = http::uri::PathAndQuery::from_static("/google.cloud.iap.v1beta1.IdentityAwareProxyAdminV1Beta1/SetIamPolicy");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.iap.v1beta1.IdentityAwareProxyAdminV1Beta1", "SetIamPolicy"));
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.iap.v1beta1.IdentityAwareProxyAdminV1Beta1/GetIamPolicy");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.iap.v1beta1.IdentityAwareProxyAdminV1Beta1", "GetIamPolicy"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.iap.v1beta1.IdentityAwareProxyAdminV1Beta1/TestIamPermissions");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.iap.v1beta1.IdentityAwareProxyAdminV1Beta1", "TestIamPermissions"));
self.inner.unary(req, path, codec).await
}
}
}
