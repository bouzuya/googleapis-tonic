...
pub struct TerraformBlueprint {
    ...
    pub input_values:
        ::std::collections::HashMap<::prost::alloc::string::String, TerraformVariable>,
...
pub struct DeploymentOperationMetadata {
    #[prost(
        enumeration = "deployment_operation_metadata::DeploymentStep",
        tag = "1"
    )]
    pub step: i32,
    #[prost(message, optional, tag = "2")]
...
pub mod config_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get_revision(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/google.cloud.config.v1.Config/GetRevision");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "google.cloud.config.v1.Config",
                "GetRevision",
        ...
        pub async fn get_resource(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/google.cloud.config.v1.Config/GetResource");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "google.cloud.config.v1.Config",
                "GetResource",
        ...
        pub async fn get_preview(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/google.cloud.config.v1.Config/GetPreview");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "google.cloud.config.v1.Config",
                "GetPreview",
        ...
        ) -> std::result::Result<tonic::Response<super::ListPreviewsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/google.cloud.config.v1.Config/ListPreviews");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "google.cloud.config.v1.Config",
                "ListPreviews",
        ...
        ) -> std::result::Result<tonic::Response<super::ExportPreviewResultResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::ListTerraformVersionsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::TerraformVersion>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
