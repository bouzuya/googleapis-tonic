...
AdGroupAdEngineStatus::AdGroupAdInappropriateForCampaign => "AD_GROUP_AD_INAPPROPRIATE_FOR_CAMPAIGN",
AdGroupAdEngineStatus::AdGroupAdMobileUrlUnderReview => "AD_GROUP_AD_MOBILE_URL_UNDER_REVIEW",
...
"AD_GROUP_AD_INAPPROPRIATE_FOR_CAMPAIGN" => Some(Self::AdGroupAdInappropriateForCampaign),
...
AdGroupCriterionEngineStatus::AdGroupCriterionEligible => "AD_GROUP_CRITERION_ELIGIBLE",
AdGroupCriterionEngineStatus::AdGroupCriterionInappropriateForCampaign => "AD_GROUP_CRITERION_INAPPROPRIATE_FOR_CAMPAIGN",
AdGroupCriterionEngineStatus::AdGroupCriterionInvalidMobileSearch => "AD_GROUP_CRITERION_INVALID_MOBILE_SEARCH",
AdGroupCriterionEngineStatus::AdGroupCriterionInvalidPcSearch => "AD_GROUP_CRITERION_INVALID_PC_SEARCH",
AdGroupCriterionEngineStatus::AdGroupCriterionInvalidSearch => "AD_GROUP_CRITERION_INVALID_SEARCH",
AdGroupCriterionEngineStatus::AdGroupCriterionLowSearchVolume => "AD_GROUP_CRITERION_LOW_SEARCH_VOLUME",
AdGroupCriterionEngineStatus::AdGroupCriterionMobileUrlUnderReview => "AD_GROUP_CRITERION_MOBILE_URL_UNDER_REVIEW",
AdGroupCriterionEngineStatus::AdGroupCriterionPartiallyInvalid => "AD_GROUP_CRITERION_PARTIALLY_INVALID",
AdGroupCriterionEngineStatus::AdGroupCriterionToBeActivated => "AD_GROUP_CRITERION_TO_BE_ACTIVATED",
AdGroupCriterionEngineStatus::AdGroupCriterionUnderReview => "AD_GROUP_CRITERION_UNDER_REVIEW",
AdGroupCriterionEngineStatus::AdGroupCriterionNotReviewed => "AD_GROUP_CRITERION_NOT_REVIEWED",
AdGroupCriterionEngineStatus::AdGroupCriterionOnHold => "AD_GROUP_CRITERION_ON_HOLD",
AdGroupCriterionEngineStatus::AdGroupCriterionPendingReview => "AD_GROUP_CRITERION_PENDING_REVIEW",
AdGroupCriterionEngineStatus::AdGroupCriterionPaused => "AD_GROUP_CRITERION_PAUSED",
AdGroupCriterionEngineStatus::AdGroupCriterionRemoved => "AD_GROUP_CRITERION_REMOVED",
AdGroupCriterionEngineStatus::AdGroupCriterionApproved => "AD_GROUP_CRITERION_APPROVED",
AdGroupCriterionEngineStatus::AdGroupCriterionDisapproved => "AD_GROUP_CRITERION_DISAPPROVED",
AdGroupCriterionEngineStatus::AdGroupCriterionServing => "AD_GROUP_CRITERION_SERVING",
AdGroupCriterionEngineStatus::AdGroupCriterionAccountPaused => "AD_GROUP_CRITERION_ACCOUNT_PAUSED",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"AD_GROUP_CRITERION_INAPPROPRIATE_FOR_CAMPAIGN" => Some(Self::AdGroupCriterionInappropriateForCampaign),
"AD_GROUP_CRITERION_INVALID_MOBILE_SEARCH" => Some(Self::AdGroupCriterionInvalidMobileSearch),
"AD_GROUP_CRITERION_INVALID_PC_SEARCH" => Some(Self::AdGroupCriterionInvalidPcSearch),
"AD_GROUP_CRITERION_INVALID_SEARCH" => Some(Self::AdGroupCriterionInvalidSearch),
"AD_GROUP_CRITERION_LOW_SEARCH_VOLUME" => Some(Self::AdGroupCriterionLowSearchVolume),
"AD_GROUP_CRITERION_MOBILE_URL_UNDER_REVIEW" => Some(Self::AdGroupCriterionMobileUrlUnderReview),
"AD_GROUP_CRITERION_PARTIALLY_INVALID" => Some(Self::AdGroupCriterionPartiallyInvalid),
...
ConversionCustomVariableCardinality::ExceedsSegmentationLimitButNotStatsLimit => "EXCEEDS_SEGMENTATION_LIMIT_BUT_NOT_STATS_LIMIT",
ConversionCustomVariableCardinality::ApproachesStatsLimit => "APPROACHES_STATS_LIMIT",
...
"EXCEEDS_SEGMENTATION_LIMIT_BUT_NOT_STATS_LIMIT" => Some(Self::ExceedsSegmentationLimitButNotStatsLimit),
