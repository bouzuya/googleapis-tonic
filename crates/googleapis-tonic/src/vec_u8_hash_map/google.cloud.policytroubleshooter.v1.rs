...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> IamCheckerClient<InterceptedService<T, F>>
where
...
let path = http::uri::PathAndQuery::from_static("/google.cloud.policytroubleshooter.v1.IamChecker/TroubleshootIamPolicy");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.policytroubleshooter.v1.IamChecker", "TroubleshootIamPolicy"));
