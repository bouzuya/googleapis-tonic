...
pub mod project_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::GetServiceAccountResponse>, tonic::Status>
        {
...
pub struct JoinRestrictionPolicy {
    #[prost(
        enumeration = "join_restriction_policy::JoinCondition",
        optional,
        tag = "1"
    )]
...
pub mod routine_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::ListRoutinesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
...
pub mod row_access_policy_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::ListRowAccessPoliciesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
...
pub struct ExternalDataConfiguration {
    ...
    #[prost(
        enumeration = "external_data_configuration::MetadataCacheMode",
        tag = "24"
    )]
...
pub struct QueryParameterValue {
    ...
    pub struct_values:
        ::std::collections::HashMap<::prost::alloc::string::String, QueryParameterValue>,
...
pub struct JobConfigurationQuery {
    ...
    pub external_table_definitions:
        ::std::collections::HashMap<::prost::alloc::string::String, ExternalDataConfiguration>,
    #[prost(message, repeated, tag = "4")]
...
pub struct JobConfigurationLoad {
    ...
    pub create_session: ::core::option::Option<bool>,
    #[prost(
        enumeration = "job_configuration_load::ColumnNameCharacterMap",
        tag = "50"
    )]
...
pub struct JobConfigurationExtract {
    ...
    pub model_extract_options:
        ::core::option::Option<job_configuration_extract::ModelExtractOptions>,
...
pub struct BiEngineStatistics {
    ...
    #[prost(
        enumeration = "bi_engine_statistics::BiEngineAccelerationMode",
        tag = "3"
    )]
...
pub struct PerformanceInsights {
    ...
    pub stage_performance_standalone_insights:
        ::prost::alloc::vec::Vec<StagePerformanceStandaloneInsight>,
    #[prost(message, repeated, tag = "3")]
...
pub mod job_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::JobCancelResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        pub async fn get_job(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/google.cloud.bigquery.v2.JobService/GetJob");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "google.cloud.bigquery.v2.JobService",
                "GetJob",
        ...
        ) -> std::result::Result<tonic::Response<super::GetQueryResultsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        pub async fn query(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/google.cloud.bigquery.v2.JobService/Query");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "google.cloud.bigquery.v2.JobService",
                "Query",
