...
pub match_target_labels: ::std::collections::HashMap<::prost::alloc::string::String, ::prost::alloc::string::String>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Strategy {
...
pub deploy_parameters: ::std::collections::HashMap<::prost::alloc::string::String, ::prost::alloc::string::String>,
...
pub phase_artifacts: ::std::collections::HashMap<::prost::alloc::string::String, target_artifact::PhaseArtifact>,
