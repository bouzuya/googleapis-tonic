...
ContentLabelType::BrandSuitabilityContentForFamilies => "BRAND_SUITABILITY_CONTENT_FOR_FAMILIES",
ContentLabelType::BrandSuitabilityGamesFighting => "BRAND_SUITABILITY_GAMES_FIGHTING",
ContentLabelType::BrandSuitabilityGamesMature => "BRAND_SUITABILITY_GAMES_MATURE",
ContentLabelType::BrandSuitabilityHealthSensitive => "BRAND_SUITABILITY_HEALTH_SENSITIVE",
ContentLabelType::BrandSuitabilityHealthSourceUndetermined => "BRAND_SUITABILITY_HEALTH_SOURCE_UNDETERMINED",
ContentLabelType::BrandSuitabilityNewsRecent => "BRAND_SUITABILITY_NEWS_RECENT",
ContentLabelType::BrandSuitabilityNewsSensitive => "BRAND_SUITABILITY_NEWS_SENSITIVE",
ContentLabelType::BrandSuitabilityNewsSourceNotFeatured => "BRAND_SUITABILITY_NEWS_SOURCE_NOT_FEATURED",
ContentLabelType::BrandSuitabilityPolitics => "BRAND_SUITABILITY_POLITICS",
ContentLabelType::BrandSuitabilityReligion => "BRAND_SUITABILITY_RELIGION",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"BRAND_SUITABILITY_CONTENT_FOR_FAMILIES" => Some(Self::BrandSuitabilityContentForFamilies),
"BRAND_SUITABILITY_GAMES_FIGHTING" => Some(Self::BrandSuitabilityGamesFighting),
"BRAND_SUITABILITY_GAMES_MATURE" => Some(Self::BrandSuitabilityGamesMature),
"BRAND_SUITABILITY_HEALTH_SENSITIVE" => Some(Self::BrandSuitabilityHealthSensitive),
"BRAND_SUITABILITY_HEALTH_SOURCE_UNDETERMINED" => Some(Self::BrandSuitabilityHealthSourceUndetermined),
"BRAND_SUITABILITY_NEWS_RECENT" => Some(Self::BrandSuitabilityNewsRecent),
"BRAND_SUITABILITY_NEWS_SENSITIVE" => Some(Self::BrandSuitabilityNewsSensitive),
"BRAND_SUITABILITY_NEWS_SOURCE_NOT_FEATURED" => Some(Self::BrandSuitabilityNewsSourceNotFeatured),
...
UserListCustomerTypeCategory::HighValueCustomers => "HIGH_VALUE_CUSTOMERS",
UserListCustomerTypeCategory::DisengagedCustomers => "DISENGAGED_CUSTOMERS",
...
"DEMAND_GEN_VIDEO_RESPONSIVE_AD" => Some(Self::DemandGenVideoResponsiveAd),
...
AdGroupCriterionPrimaryStatusReason::CampaignPending => "CAMPAIGN_PENDING",
AdGroupCriterionPrimaryStatusReason::CampaignCriterionNegative => "CAMPAIGN_CRITERION_NEGATIVE",
AdGroupCriterionPrimaryStatusReason::CampaignPaused => "CAMPAIGN_PAUSED",
AdGroupCriterionPrimaryStatusReason::CampaignRemoved => "CAMPAIGN_REMOVED",
...
AdGroupCriterionPrimaryStatusReason::AdGroupCriterionDisapproved => "AD_GROUP_CRITERION_DISAPPROVED",
AdGroupCriterionPrimaryStatusReason::AdGroupCriterionRarelyServed => "AD_GROUP_CRITERION_RARELY_SERVED",
AdGroupCriterionPrimaryStatusReason::AdGroupCriterionLowQuality => "AD_GROUP_CRITERION_LOW_QUALITY",
AdGroupCriterionPrimaryStatusReason::AdGroupCriterionUnderReview => "AD_GROUP_CRITERION_UNDER_REVIEW",
AdGroupCriterionPrimaryStatusReason::AdGroupCriterionPendingReview => "AD_GROUP_CRITERION_PENDING_REVIEW",
AdGroupCriterionPrimaryStatusReason::AdGroupCriterionBelowFirstPageBid => "AD_GROUP_CRITERION_BELOW_FIRST_PAGE_BID",
AdGroupCriterionPrimaryStatusReason::AdGroupCriterionNegative => "AD_GROUP_CRITERION_NEGATIVE",
AdGroupCriterionPrimaryStatusReason::AdGroupCriterionRestricted => "AD_GROUP_CRITERION_RESTRICTED",
AdGroupCriterionPrimaryStatusReason::AdGroupCriterionPaused => "AD_GROUP_CRITERION_PAUSED",
AdGroupCriterionPrimaryStatusReason::AdGroupCriterionPausedDueToLowActivity => "AD_GROUP_CRITERION_PAUSED_DUE_TO_LOW_ACTIVITY",
AdGroupCriterionPrimaryStatusReason::AdGroupCriterionRemoved => "AD_GROUP_CRITERION_REMOVED",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"AD_GROUP_CRITERION_RARELY_SERVED" => Some(Self::AdGroupCriterionRarelyServed),
"AD_GROUP_CRITERION_LOW_QUALITY" => Some(Self::AdGroupCriterionLowQuality),
...
"AD_GROUP_CRITERION_BELOW_FIRST_PAGE_BID" => Some(Self::AdGroupCriterionBelowFirstPageBid),
...
"AD_GROUP_CRITERION_PAUSED_DUE_TO_LOW_ACTIVITY" => Some(Self::AdGroupCriterionPausedDueToLowActivity),
