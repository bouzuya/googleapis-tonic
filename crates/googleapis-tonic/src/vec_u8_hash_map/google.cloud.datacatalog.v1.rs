...
#[prost(map = "string, message", tag = "3")]
pub common_usage_within_time_range: ::std::collections::HashMap<::prost::alloc::string::String, CommonUsageStats>,
...
pub state: i32,
#[prost(map = "string, message", tag = "2")]
pub errors: ::std::collections::HashMap<::prost::alloc::string::String, super::super::super::rpc::Status>,
}
