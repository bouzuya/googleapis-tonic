...
#[prost(message, optional, tag = "3")]
pub static_duration: ::core::option::Option<super::super::super::super::r#type::LocalizedText>,
#[prost(message, optional, tag = "4")]
...
#[prost(message, optional, tag = "2")]
pub localized_values: ::core::option::Option<route_leg_step_transit_details::TransitDetailsLocalizedValues>,
#[prost(string, tag = "3")]
...
#[prost(enumeration = "compute_routes_request::ExtraComputation", repeated, packed = "false", tag = "15")]
...
ExtraComputation::HtmlFormattedNavigationInstructions => "HTML_FORMATTED_NAVIGATION_INSTRUCTIONS",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"HTML_FORMATTED_NAVIGATION_INSTRUCTIONS" => Some(Self::HtmlFormattedNavigationInstructions),
_ => None,
}
}
}
...
pub units: i32,
#[prost(enumeration = "compute_route_matrix_request::ExtraComputation", repeated, packed = "false", tag = "8")]
pub extra_computations: ::prost::alloc::vec::Vec<i32>,
...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> RoutesClient<InterceptedService<T, F>>
where
...
let path = http::uri::PathAndQuery::from_static("/google.maps.routing.v2.Routes/ComputeRoutes");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.maps.routing.v2.Routes", "ComputeRoutes"));
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.maps.routing.v2.Routes/ComputeRouteMatrix");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.maps.routing.v2.Routes", "ComputeRouteMatrix"));
