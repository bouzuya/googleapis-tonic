...
pub struct QuotaIncreaseEligibility {
    ...
    #[prost(
        enumeration = "quota_increase_eligibility::IneligibilityReason",
        tag = "2"
    )]
...
pub mod cloud_quotas_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::ListQuotaInfosResponse>, tonic::Status>
        {
        ...
        ) -> std::result::Result<tonic::Response<super::ListQuotaPreferencesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
