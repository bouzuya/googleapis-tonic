...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> RouteOptimizationClient<InterceptedService<T, F>>
where
...
let path = http::uri::PathAndQuery::from_static("/google.maps.routeoptimization.v1.RouteOptimization/OptimizeTours");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.maps.routeoptimization.v1.RouteOptimization", "OptimizeTours"));
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.maps.routeoptimization.v1.RouteOptimization/BatchOptimizeTours");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.maps.routeoptimization.v1.RouteOptimization", "BatchOptimizeTours"));
self.inner.unary(req, path, codec).await
}
}
}
