...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> AutokeyAdminClient<InterceptedService<T, F>>
where
...
pub async fn update_autokey_config(&mut self, request: impl tonic::IntoRequest<super::UpdateAutokeyConfigRequest>) -> std::result::Result<tonic::Response<super::AutokeyConfig>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.AutokeyAdmin/UpdateAutokeyConfig");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.AutokeyAdmin", "UpdateAutokeyConfig"));
self.inner.unary(req, path, codec).await
}
/// Returns the [AutokeyConfig][google.cloud.kms.v1.AutokeyConfig] for a
/// folder.
pub async fn get_autokey_config(&mut self, request: impl tonic::IntoRequest<super::GetAutokeyConfigRequest>) -> std::result::Result<tonic::Response<super::AutokeyConfig>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.AutokeyAdmin/GetAutokeyConfig");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.AutokeyAdmin", "GetAutokeyConfig"));
self.inner.unary(req, path, codec).await
}
/// Returns the effective Cloud KMS Autokey configuration for a given project.
pub async fn show_effective_autokey_config(&mut self, request: impl tonic::IntoRequest<super::ShowEffectiveAutokeyConfigRequest>) -> std::result::Result<tonic::Response<super::ShowEffectiveAutokeyConfigResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.AutokeyAdmin/ShowEffectiveAutokeyConfig");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.AutokeyAdmin", "ShowEffectiveAutokeyConfig"));
self.inner.unary(req, path, codec).await
}
}
}
...
AccessReason::ModifiedGoogleInitiatedSystemOperation => "MODIFIED_GOOGLE_INITIATED_SYSTEM_OPERATION",
AccessReason::GoogleResponseToProductionAlert => "GOOGLE_RESPONSE_TO_PRODUCTION_ALERT",
AccessReason::CustomerAuthorizedWorkflowServicing => "CUSTOMER_AUTHORIZED_WORKFLOW_SERVICING",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub async fn list_ekm_connections(&mut self, request: impl tonic::IntoRequest<super::ListEkmConnectionsRequest>) -> std::result::Result<tonic::Response<super::ListEkmConnectionsResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.EkmService/ListEkmConnections");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.EkmService", "ListEkmConnections"));
self.inner.unary(req, path, codec).await
}
/// Returns metadata for a given
/// [EkmConnection][google.cloud.kms.v1.EkmConnection].
pub async fn get_ekm_connection(&mut self, request: impl tonic::IntoRequest<super::GetEkmConnectionRequest>) -> std::result::Result<tonic::Response<super::EkmConnection>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.EkmService/GetEkmConnection");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.EkmService", "GetEkmConnection"));
self.inner.unary(req, path, codec).await
}
/// Creates a new [EkmConnection][google.cloud.kms.v1.EkmConnection] in a given
/// Project and Location.
pub async fn create_ekm_connection(&mut self, request: impl tonic::IntoRequest<super::CreateEkmConnectionRequest>) -> std::result::Result<tonic::Response<super::EkmConnection>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.EkmService/CreateEkmConnection");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.EkmService", "CreateEkmConnection"));
self.inner.unary(req, path, codec).await
}
/// Updates an [EkmConnection][google.cloud.kms.v1.EkmConnection]'s metadata.
pub async fn update_ekm_connection(&mut self, request: impl tonic::IntoRequest<super::UpdateEkmConnectionRequest>) -> std::result::Result<tonic::Response<super::EkmConnection>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.EkmService/UpdateEkmConnection");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.EkmService", "UpdateEkmConnection"));
self.inner.unary(req, path, codec).await
}
/// Returns the [EkmConfig][google.cloud.kms.v1.EkmConfig] singleton resource
/// for a given project and location.
pub async fn get_ekm_config(&mut self, request: impl tonic::IntoRequest<super::GetEkmConfigRequest>) -> std::result::Result<tonic::Response<super::EkmConfig>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.EkmService/GetEkmConfig");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.EkmService", "GetEkmConfig"));
self.inner.unary(req, path, codec).await
}
/// Updates the [EkmConfig][google.cloud.kms.v1.EkmConfig] singleton resource
/// for a given project and location.
pub async fn update_ekm_config(&mut self, request: impl tonic::IntoRequest<super::UpdateEkmConfigRequest>) -> std::result::Result<tonic::Response<super::EkmConfig>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.EkmService/UpdateEkmConfig");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.EkmService", "UpdateEkmConfig"));
self.inner.unary(req, path, codec).await
}
...
pub async fn verify_connectivity(&mut self, request: impl tonic::IntoRequest<super::VerifyConnectivityRequest>) -> std::result::Result<tonic::Response<super::VerifyConnectivityResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.EkmService/VerifyConnectivity");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.EkmService", "VerifyConnectivity"));
self.inner.unary(req, path, codec).await
}
}
}
...
pub async fn list_key_rings(&mut self, request: impl tonic::IntoRequest<super::ListKeyRingsRequest>) -> std::result::Result<tonic::Response<super::ListKeyRingsResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.KeyManagementService/ListKeyRings");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.KeyManagementService", "ListKeyRings"));
self.inner.unary(req, path, codec).await
}
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.KeyManagementService", "ListCryptoKeys"));
self.inner.unary(req, path, codec).await
}
/// Lists [CryptoKeyVersions][google.cloud.kms.v1.CryptoKeyVersion].
pub async fn list_crypto_key_versions(&mut self, request: impl tonic::IntoRequest<super::ListCryptoKeyVersionsRequest>) -> std::result::Result<tonic::Response<super::ListCryptoKeyVersionsResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.KeyManagementService/ListCryptoKeyVersions");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.KeyManagementService", "ListCryptoKeyVersions"));
self.inner.unary(req, path, codec).await
}
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.KeyManagementService", "ListImportJobs"));
self.inner.unary(req, path, codec).await
}
/// Returns metadata for a given [KeyRing][google.cloud.kms.v1.KeyRing].
pub async fn get_key_ring(&mut self, request: impl tonic::IntoRequest<super::GetKeyRingRequest>) -> std::result::Result<tonic::Response<super::KeyRing>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.KeyManagementService/GetKeyRing");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.KeyManagementService", "GetKeyRing"));
self.inner.unary(req, path, codec).await
}
/// Returns metadata for a given [CryptoKey][google.cloud.kms.v1.CryptoKey], as
/// well as its [primary][google.cloud.kms.v1.CryptoKey.primary]
/// [CryptoKeyVersion][google.cloud.kms.v1.CryptoKeyVersion].
pub async fn get_crypto_key(&mut self, request: impl tonic::IntoRequest<super::GetCryptoKeyRequest>) -> std::result::Result<tonic::Response<super::CryptoKey>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.KeyManagementService/GetCryptoKey");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.KeyManagementService", "GetCryptoKey"));
self.inner.unary(req, path, codec).await
}
/// Returns metadata for a given
/// [CryptoKeyVersion][google.cloud.kms.v1.CryptoKeyVersion].
pub async fn get_crypto_key_version(&mut self, request: impl tonic::IntoRequest<super::GetCryptoKeyVersionRequest>) -> std::result::Result<tonic::Response<super::CryptoKeyVersion>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.KeyManagementService/GetCryptoKeyVersion");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.KeyManagementService", "GetCryptoKeyVersion"));
self.inner.unary(req, path, codec).await
}
...
pub async fn get_public_key(&mut self, request: impl tonic::IntoRequest<super::GetPublicKeyRequest>) -> std::result::Result<tonic::Response<super::PublicKey>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.KeyManagementService/GetPublicKey");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.KeyManagementService", "GetPublicKey"));
self.inner.unary(req, path, codec).await
}
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.KeyManagementService", "GetImportJob"));
self.inner.unary(req, path, codec).await
}
/// Create a new [KeyRing][google.cloud.kms.v1.KeyRing] in a given Project and
/// Location.
pub async fn create_key_ring(&mut self, request: impl tonic::IntoRequest<super::CreateKeyRingRequest>) -> std::result::Result<tonic::Response<super::KeyRing>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.KeyManagementService/CreateKeyRing");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.KeyManagementService", "CreateKeyRing"));
self.inner.unary(req, path, codec).await
}
...
/// are required.
pub async fn create_crypto_key(&mut self, request: impl tonic::IntoRequest<super::CreateCryptoKeyRequest>) -> std::result::Result<tonic::Response<super::CryptoKey>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.KeyManagementService/CreateCryptoKey");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.KeyManagementService", "CreateCryptoKey"));
self.inner.unary(req, path, codec).await
}
...
pub async fn create_crypto_key_version(&mut self, request: impl tonic::IntoRequest<super::CreateCryptoKeyVersionRequest>) -> std::result::Result<tonic::Response<super::CryptoKeyVersion>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.KeyManagementService/CreateCryptoKeyVersion");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.KeyManagementService", "CreateCryptoKeyVersion"));
self.inner.unary(req, path, codec).await
}
...
pub async fn import_crypto_key_version(&mut self, request: impl tonic::IntoRequest<super::ImportCryptoKeyVersionRequest>) -> std::result::Result<tonic::Response<super::CryptoKeyVersion>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.KeyManagementService/ImportCryptoKeyVersion");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.KeyManagementService", "ImportCryptoKeyVersion"));
self.inner.unary(req, path, codec).await
}
...
/// required.
pub async fn create_import_job(&mut self, request: impl tonic::IntoRequest<super::CreateImportJobRequest>) -> std::result::Result<tonic::Response<super::ImportJob>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.KeyManagementService/CreateImportJob");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.KeyManagementService", "CreateImportJob"));
self.inner.unary(req, path, codec).await
}
/// Update a [CryptoKey][google.cloud.kms.v1.CryptoKey].
pub async fn update_crypto_key(&mut self, request: impl tonic::IntoRequest<super::UpdateCryptoKeyRequest>) -> std::result::Result<tonic::Response<super::CryptoKey>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.KeyManagementService/UpdateCryptoKey");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.KeyManagementService", "UpdateCryptoKey"));
self.inner.unary(req, path, codec).await
}
...
pub async fn update_crypto_key_version(&mut self, request: impl tonic::IntoRequest<super::UpdateCryptoKeyVersionRequest>) -> std::result::Result<tonic::Response<super::CryptoKeyVersion>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.KeyManagementService/UpdateCryptoKeyVersion");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.KeyManagementService", "UpdateCryptoKeyVersion"));
self.inner.unary(req, path, codec).await
}
...
pub async fn update_crypto_key_primary_version(&mut self, request: impl tonic::IntoRequest<super::UpdateCryptoKeyPrimaryVersionRequest>) -> std::result::Result<tonic::Response<super::CryptoKey>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.KeyManagementService/UpdateCryptoKeyPrimaryVersion");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.KeyManagementService", "UpdateCryptoKeyPrimaryVersion"));
self.inner.unary(req, path, codec).await
}
...
pub async fn destroy_crypto_key_version(&mut self, request: impl tonic::IntoRequest<super::DestroyCryptoKeyVersionRequest>) -> std::result::Result<tonic::Response<super::CryptoKeyVersion>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.KeyManagementService/DestroyCryptoKeyVersion");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.KeyManagementService", "DestroyCryptoKeyVersion"));
self.inner.unary(req, path, codec).await
}
...
/// and [destroy_time][google.cloud.kms.v1.CryptoKeyVersion.destroy_time] will
/// be cleared.
pub async fn restore_crypto_key_version(&mut self, request: impl tonic::IntoRequest<super::RestoreCryptoKeyVersionRequest>) -> std::result::Result<tonic::Response<super::CryptoKeyVersion>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.KeyManagementService/RestoreCryptoKeyVersion");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.KeyManagementService", "RestoreCryptoKeyVersion"));
self.inner.unary(req, path, codec).await
}
...
/// [CryptoKey.purpose][google.cloud.kms.v1.CryptoKey.purpose] must be
/// [ENCRYPT_DECRYPT][google.cloud.kms.v1.CryptoKey.CryptoKeyPurpose.ENCRYPT_DECRYPT].
pub async fn encrypt(&mut self, request: impl tonic::IntoRequest<super::EncryptRequest>) -> std::result::Result<tonic::Response<super::EncryptResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.KeyManagementService/Encrypt");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.KeyManagementService", "Encrypt"));
self.inner.unary(req, path, codec).await
}
...
/// [CryptoKey.purpose][google.cloud.kms.v1.CryptoKey.purpose] must be
/// [ENCRYPT_DECRYPT][google.cloud.kms.v1.CryptoKey.CryptoKeyPurpose.ENCRYPT_DECRYPT].
pub async fn decrypt(&mut self, request: impl tonic::IntoRequest<super::DecryptRequest>) -> std::result::Result<tonic::Response<super::DecryptResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.KeyManagementService/Decrypt");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.KeyManagementService", "Decrypt"));
self.inner.unary(req, path, codec).await
}
...
pub async fn raw_encrypt(&mut self, request: impl tonic::IntoRequest<super::RawEncryptRequest>) -> std::result::Result<tonic::Response<super::RawEncryptResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.KeyManagementService/RawEncrypt");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.KeyManagementService", "RawEncrypt"));
self.inner.unary(req, path, codec).await
}
...
/// must be
/// [RAW_ENCRYPT_DECRYPT][google.cloud.kms.v1.CryptoKey.CryptoKeyPurpose.RAW_ENCRYPT_DECRYPT].
pub async fn raw_decrypt(&mut self, request: impl tonic::IntoRequest<super::RawDecryptRequest>) -> std::result::Result<tonic::Response<super::RawDecryptResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.KeyManagementService/RawDecrypt");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.KeyManagementService", "RawDecrypt"));
self.inner.unary(req, path, codec).await
}
...
pub async fn asymmetric_sign(&mut self, request: impl tonic::IntoRequest<super::AsymmetricSignRequest>) -> std::result::Result<tonic::Response<super::AsymmetricSignResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.KeyManagementService/AsymmetricSign");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.KeyManagementService", "AsymmetricSign"));
self.inner.unary(req, path, codec).await
}
...
/// with [CryptoKey.purpose][google.cloud.kms.v1.CryptoKey.purpose]
/// ASYMMETRIC_DECRYPT.
pub async fn asymmetric_decrypt(&mut self, request: impl tonic::IntoRequest<super::AsymmetricDecryptRequest>) -> std::result::Result<tonic::Response<super::AsymmetricDecryptResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.KeyManagementService/AsymmetricDecrypt");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.KeyManagementService", "AsymmetricDecrypt"));
self.inner.unary(req, path, codec).await
}
/// Signs data using a [CryptoKeyVersion][google.cloud.kms.v1.CryptoKeyVersion]
/// with [CryptoKey.purpose][google.cloud.kms.v1.CryptoKey.purpose] MAC,
/// producing a tag that can be verified by another source with the same key.
pub async fn mac_sign(&mut self, request: impl tonic::IntoRequest<super::MacSignRequest>) -> std::result::Result<tonic::Response<super::MacSignResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.KeyManagementService/MacSign");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.KeyManagementService", "MacSign"));
self.inner.unary(req, path, codec).await
}
...
pub async fn mac_verify(&mut self, request: impl tonic::IntoRequest<super::MacVerifyRequest>) -> std::result::Result<tonic::Response<super::MacVerifyResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.KeyManagementService/MacVerify");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.KeyManagementService", "MacVerify"));
self.inner.unary(req, path, codec).await
}
/// Generate random bytes using the Cloud KMS randomness source in the provided
/// location.
pub async fn generate_random_bytes(&mut self, request: impl tonic::IntoRequest<super::GenerateRandomBytesRequest>) -> std::result::Result<tonic::Response<super::GenerateRandomBytesResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.KeyManagementService/GenerateRandomBytes");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.KeyManagementService", "GenerateRandomBytes"));
self.inner.unary(req, path, codec).await
}
}
}
...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> AutokeyClient<InterceptedService<T, F>>
where
F: tonic::service::Interceptor,
T::ResponseBody: Default,
T: tonic::codegen::Service<http::Request<tonic::body::BoxBody>, Response = http::Response<<T as tonic::client::GrpcService<tonic::body::BoxBody>>::ResponseBody>>,
...
/// [CryptoKey][google.cloud.kms.v1.CryptoKey].
pub async fn create_key_handle(&mut self, request: impl tonic::IntoRequest<super::CreateKeyHandleRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.Autokey/CreateKeyHandle");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.Autokey", "CreateKeyHandle"));
self.inner.unary(req, path, codec).await
}
/// Returns the [KeyHandle][google.cloud.kms.v1.KeyHandle].
pub async fn get_key_handle(&mut self, request: impl tonic::IntoRequest<super::GetKeyHandleRequest>) -> std::result::Result<tonic::Response<super::KeyHandle>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.Autokey/GetKeyHandle");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.Autokey", "GetKeyHandle"));
self.inner.unary(req, path, codec).await
}
/// Lists [KeyHandles][google.cloud.kms.v1.KeyHandle].
pub async fn list_key_handles(&mut self, request: impl tonic::IntoRequest<super::ListKeyHandlesRequest>) -> std::result::Result<tonic::Response<super::ListKeyHandlesResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.kms.v1.Autokey/ListKeyHandles");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.kms.v1.Autokey", "ListKeyHandles"));
self.inner.unary(req, path, codec).await
}
}
}
