...
pub struct LoggingConfig {
    ...
    pub service_log_generation_rules:
        ::prost::alloc::vec::Vec<logging_config::ServiceLogGenerationRule>,
}
...
pub struct AttributesConfig {
    ...
    pub catalog_attributes:
        ::std::collections::HashMap<::prost::alloc::string::String, CatalogAttribute>,
...
pub mod branch_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::ListBranchesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
...
pub struct MerchantCenterAccountLink {
    ...
    #[prost(message, repeated, tag = "6")]
    pub feed_filters:
        ::prost::alloc::vec::Vec<merchant_center_account_link::MerchantCenterFeedFilter>,
...
pub mod merchant_center_account_link_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn list_merchant_center_account_links(
            &mut self,
            request: impl tonic::IntoRequest<super::ListMerchantCenterAccountLinksRequest>,
        ) -> std::result::Result<
        ...
        pub async fn create_merchant_center_account_link(
            &mut self,
            request: impl tonic::IntoRequest<super::CreateMerchantCenterAccountLinkRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::super::longrunning::Operation>,
            tonic::Status,
        > {
        ...
        pub async fn delete_merchant_center_account_link(
            &mut self,
            request: impl tonic::IntoRequest<super::DeleteMerchantCenterAccountLinkRequest>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
...
pub mod project_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::ListEnrolledSolutionsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
