...
#[prost(message, repeated, tag = "1")]
pub facet_position_adjustments: ::prost::alloc::vec::Vec<force_return_facet_action::FacetPositionAdjustment>,
}
...
pub fn as_str_name(&self) -> &'static str {
match self {
RecommendationsFilteringOption::Unspecified => "RECOMMENDATIONS_FILTERING_OPTION_UNSPECIFIED",
RecommendationsFilteringOption::RecommendationsFilteringDisabled => "RECOMMENDATIONS_FILTERING_DISABLED",
RecommendationsFilteringOption::RecommendationsFilteringEnabled => "RECOMMENDATIONS_FILTERING_ENABLED",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
#[prost(message, optional, tag = "2")]
pub default_log_generation_rule: ::core::option::Option<logging_config::LogGenerationRule>,
#[prost(message, repeated, tag = "4")]
pub service_log_generation_rules: ::prost::alloc::vec::Vec<logging_config::ServiceLogGenerationRule>,
}
...
pub notification_pubsub_topic: ::prost::alloc::string::String,
#[prost(message, optional, tag = "7")]
pub transformed_user_events_metadata: ::core::option::Option<TransformedUserEventsMetadata>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
...
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.UserEventService/WriteUserEvent");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.UserEventService", "WriteUserEvent"));
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.UserEventService/CollectUserEvent");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.UserEventService", "CollectUserEvent"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.UserEventService/PurgeUserEvents");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.UserEventService", "PurgeUserEvents"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.UserEventService/ImportUserEvents");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.UserEventService", "ImportUserEvents"));
self.inner.unary(req, path, codec).await
}
...
pub async fn rejoin_user_events(&mut self, request: impl tonic::IntoRequest<super::RejoinUserEventsRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.UserEventService/RejoinUserEvents");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.UserEventService", "RejoinUserEvents"));
self.inner.unary(req, path, codec).await
}
}
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.SearchService/Search");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.SearchService", "Search"));
self.inner.unary(req, path, codec).await
}
}
}
...
#[prost(map = "string, message", tag = "4")]
pub attribute_results: ::std::collections::HashMap<::prost::alloc::string::String, complete_query_response::AttributeResult>,
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.CompletionService/CompleteQuery");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.CompletionService", "CompleteQuery"));
self.inner.unary(req, path, codec).await
}
...
/// This feature is only available for users who have Retail Search enabled.
/// Enable Retail Search on Cloud Console before using this feature.
pub async fn import_completion_data(&mut self, request: impl tonic::IntoRequest<super::ImportCompletionDataRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.CompletionService/ImportCompletionData");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.CompletionService", "ImportCompletionData"));
self.inner.unary(req, path, codec).await
}
}
}
...
pub name: ::prost::alloc::string::String,
#[prost(map = "string, message", tag = "2")]
pub catalog_attributes: ::std::collections::HashMap<::prost::alloc::string::String, CatalogAttribute>,
...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> BranchServiceClient<InterceptedService<T, F>>
where
F: tonic::service::Interceptor,
T::ResponseBody: Default,
T: tonic::codegen::Service<http::Request<tonic::body::BoxBody>, Response = http::Response<<T as tonic::client::GrpcService<tonic::body::BoxBody>>::ResponseBody>>,
...
pub async fn list_branches(&mut self, request: impl tonic::IntoRequest<super::ListBranchesRequest>) -> std::result::Result<tonic::Response<super::ListBranchesResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.BranchService/ListBranches");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.BranchService", "ListBranches"));
self.inner.unary(req, path, codec).await
}
/// Retrieves a [Branch][google.cloud.retail.v2alpha.Branch].
pub async fn get_branch(&mut self, request: impl tonic::IntoRequest<super::GetBranchRequest>) -> std::result::Result<tonic::Response<super::Branch>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.BranchService/GetBranch");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.BranchService", "GetBranch"));
self.inner.unary(req, path, codec).await
}
}
}
...
pub language_code: ::prost::alloc::string::String,
#[prost(message, repeated, tag = "6")]
pub feed_filters: ::prost::alloc::vec::Vec<merchant_center_account_link::MerchantCenterFeedFilter>,
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.PredictionService/Predict");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.PredictionService", "Predict"));
self.inner.unary(req, path, codec).await
}
}
}
...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> ProductServiceClient<InterceptedService<T, F>>
where
F: tonic::service::Interceptor,
T::ResponseBody: Default,
T: tonic::codegen::Service<http::Request<tonic::body::BoxBody>, Response = http::Response<<T as tonic::client::GrpcService<tonic::body::BoxBody>>::ResponseBody>>,
...
pub async fn create_product(&mut self, request: impl tonic::IntoRequest<super::CreateProductRequest>) -> std::result::Result<tonic::Response<super::Product>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ProductService/CreateProduct");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ProductService", "CreateProduct"));
self.inner.unary(req, path, codec).await
}
/// Gets a [Product][google.cloud.retail.v2alpha.Product].
pub async fn get_product(&mut self, request: impl tonic::IntoRequest<super::GetProductRequest>) -> std::result::Result<tonic::Response<super::Product>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ProductService/GetProduct");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ProductService", "GetProduct"));
self.inner.unary(req, path, codec).await
}
/// Gets a list of [Product][google.cloud.retail.v2alpha.Product]s.
pub async fn list_products(&mut self, request: impl tonic::IntoRequest<super::ListProductsRequest>) -> std::result::Result<tonic::Response<super::ListProductsResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ProductService/ListProducts");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ProductService", "ListProducts"));
self.inner.unary(req, path, codec).await
}
/// Updates a [Product][google.cloud.retail.v2alpha.Product].
pub async fn update_product(&mut self, request: impl tonic::IntoRequest<super::UpdateProductRequest>) -> std::result::Result<tonic::Response<super::Product>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ProductService/UpdateProduct");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ProductService", "UpdateProduct"));
self.inner.unary(req, path, codec).await
}
/// Deletes a [Product][google.cloud.retail.v2alpha.Product].
pub async fn delete_product(&mut self, request: impl tonic::IntoRequest<super::DeleteProductRequest>) -> std::result::Result<tonic::Response<()>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ProductService/DeleteProduct");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ProductService", "DeleteProduct"));
self.inner.unary(req, path, codec).await
}
...
/// to false.
pub async fn purge_products(&mut self, request: impl tonic::IntoRequest<super::PurgeProductsRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ProductService/PurgeProducts");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ProductService", "PurgeProducts"));
self.inner.unary(req, path, codec).await
}
...
pub async fn import_products(&mut self, request: impl tonic::IntoRequest<super::ImportProductsRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ProductService/ImportProducts");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ProductService", "ImportProducts"));
self.inner.unary(req, path, codec).await
}
...
/// they are obsolete.
pub async fn set_inventory(&mut self, request: impl tonic::IntoRequest<super::SetInventoryRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ProductService/SetInventory");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ProductService", "SetInventory"));
self.inner.unary(req, path, codec).await
}
...
pub async fn add_fulfillment_places(&mut self, request: impl tonic::IntoRequest<super::AddFulfillmentPlacesRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ProductService/AddFulfillmentPlaces");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ProductService", "AddFulfillmentPlaces"));
self.inner.unary(req, path, codec).await
}
/// We recommend that you use the
...
/// updates will not be marked as [done][google.longrunning.Operation.done]
/// until being obsolete.
pub async fn remove_fulfillment_places(&mut self, request: impl tonic::IntoRequest<super::RemoveFulfillmentPlacesRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ProductService/RemoveFulfillmentPlaces");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ProductService", "RemoveFulfillmentPlaces"));
self.inner.unary(req, path, codec).await
}
...
/// updates will not be marked as [done][google.longrunning.Operation.done]
/// until being obsolete.
pub async fn add_local_inventories(&mut self, request: impl tonic::IntoRequest<super::AddLocalInventoriesRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ProductService/AddLocalInventories");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ProductService", "AddLocalInventories"));
self.inner.unary(req, path, codec).await
}
...
/// updates will not be marked as [done][google.longrunning.Operation.done]
/// until being obsolete.
pub async fn remove_local_inventories(&mut self, request: impl tonic::IntoRequest<super::RemoveLocalInventoriesRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ProductService/RemoveLocalInventories");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ProductService", "RemoveLocalInventories"));
self.inner.unary(req, path, codec).await
}
}
}
...
pub async fn create_serving_config(&mut self, request: impl tonic::IntoRequest<super::CreateServingConfigRequest>) -> std::result::Result<tonic::Response<super::ServingConfig>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ServingConfigService/CreateServingConfig");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ServingConfigService", "CreateServingConfig"));
self.inner.unary(req, path, codec).await
}
/// Deletes a ServingConfig.
///
/// Returns a NotFound error if the ServingConfig does not exist.
pub async fn delete_serving_config(&mut self, request: impl tonic::IntoRequest<super::DeleteServingConfigRequest>) -> std::result::Result<tonic::Response<()>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ServingConfigService/DeleteServingConfig");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ServingConfigService", "DeleteServingConfig"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ServingConfigService/UpdateServingConfig");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ServingConfigService", "UpdateServingConfig"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ServingConfigService/GetServingConfig");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ServingConfigService", "GetServingConfig"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ServingConfigService/ListServingConfigs");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ServingConfigService", "ListServingConfigs"));
self.inner.unary(req, path, codec).await
}
...
pub async fn add_control(&mut self, request: impl tonic::IntoRequest<super::AddControlRequest>) -> std::result::Result<tonic::Response<super::ServingConfig>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ServingConfigService/AddControl");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ServingConfigService", "AddControl"));
self.inner.unary(req, path, codec).await
}
...
/// ServingConfig.
pub async fn remove_control(&mut self, request: impl tonic::IntoRequest<super::RemoveControlRequest>) -> std::result::Result<tonic::Response<super::ServingConfig>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ServingConfigService/RemoveControl");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ServingConfigService", "RemoveControl"));
self.inner.unary(req, path, codec).await
}
}
}
...
#[prost(string, repeated, tag = "1")]
pub deleted_catalog_attributes: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
#[prost(string, repeated, tag = "2")]
pub reset_catalog_attributes: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
/// with the project.
pub async fn list_catalogs(&mut self, request: impl tonic::IntoRequest<super::ListCatalogsRequest>) -> std::result::Result<tonic::Response<super::ListCatalogsResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.CatalogService/ListCatalogs");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.CatalogService", "ListCatalogs"));
self.inner.unary(req, path, codec).await
}
/// Updates the [Catalog][google.cloud.retail.v2alpha.Catalog]s.
pub async fn update_catalog(&mut self, request: impl tonic::IntoRequest<super::UpdateCatalogRequest>) -> std::result::Result<tonic::Response<super::Catalog>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.CatalogService/UpdateCatalog");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.CatalogService", "UpdateCatalog"));
self.inner.unary(req, path, codec).await
}
...
///   {newBranch}.
pub async fn set_default_branch(&mut self, request: impl tonic::IntoRequest<super::SetDefaultBranchRequest>) -> std::result::Result<tonic::Response<()>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.CatalogService/SetDefaultBranch");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.CatalogService", "SetDefaultBranch"));
self.inner.unary(req, path, codec).await
}
/// Get which branch is currently default branch set by
/// [CatalogService.SetDefaultBranch][google.cloud.retail.v2alpha.CatalogService.SetDefaultBranch]
/// method under a specified parent catalog.
pub async fn get_default_branch(&mut self, request: impl tonic::IntoRequest<super::GetDefaultBranchRequest>) -> std::result::Result<tonic::Response<super::GetDefaultBranchResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.CatalogService/GetDefaultBranch");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.CatalogService", "GetDefaultBranch"));
self.inner.unary(req, path, codec).await
}
/// Gets a [CompletionConfig][google.cloud.retail.v2alpha.CompletionConfig].
pub async fn get_completion_config(&mut self, request: impl tonic::IntoRequest<super::GetCompletionConfigRequest>) -> std::result::Result<tonic::Response<super::CompletionConfig>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.CatalogService/GetCompletionConfig");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.CatalogService", "GetCompletionConfig"));
self.inner.unary(req, path, codec).await
}
/// Updates the
/// [CompletionConfig][google.cloud.retail.v2alpha.CompletionConfig]s.
pub async fn update_completion_config(&mut self, request: impl tonic::IntoRequest<super::UpdateCompletionConfigRequest>) -> std::result::Result<tonic::Response<super::CompletionConfig>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.CatalogService/UpdateCompletionConfig");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.CatalogService", "UpdateCompletionConfig"));
self.inner.unary(req, path, codec).await
}
/// Gets an [AttributesConfig][google.cloud.retail.v2alpha.AttributesConfig].
pub async fn get_attributes_config(&mut self, request: impl tonic::IntoRequest<super::GetAttributesConfigRequest>) -> std::result::Result<tonic::Response<super::AttributesConfig>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.CatalogService/GetAttributesConfig");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.CatalogService", "GetAttributesConfig"));
self.inner.unary(req, path, codec).await
}
/// Updates the
...
pub async fn update_attributes_config(&mut self, request: impl tonic::IntoRequest<super::UpdateAttributesConfigRequest>) -> std::result::Result<tonic::Response<super::AttributesConfig>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.CatalogService/UpdateAttributesConfig");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.CatalogService", "UpdateAttributesConfig"));
self.inner.unary(req, path, codec).await
}
/// Adds the specified
...
pub async fn add_catalog_attribute(&mut self, request: impl tonic::IntoRequest<super::AddCatalogAttributeRequest>) -> std::result::Result<tonic::Response<super::AttributesConfig>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.CatalogService/AddCatalogAttribute");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.CatalogService", "AddCatalogAttribute"));
self.inner.unary(req, path, codec).await
}
...
pub async fn remove_catalog_attribute(&mut self, request: impl tonic::IntoRequest<super::RemoveCatalogAttributeRequest>) -> std::result::Result<tonic::Response<super::AttributesConfig>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.CatalogService/RemoveCatalogAttribute");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.CatalogService", "RemoveCatalogAttribute"));
self.inner.unary(req, path, codec).await
}
/// Removes all specified
/// [CatalogAttribute][google.cloud.retail.v2alpha.CatalogAttribute]s from the
/// [AttributesConfig][google.cloud.retail.v2alpha.AttributesConfig].
pub async fn batch_remove_catalog_attributes(&mut self, request: impl tonic::IntoRequest<super::BatchRemoveCatalogAttributesRequest>) -> std::result::Result<tonic::Response<super::BatchRemoveCatalogAttributesResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.CatalogService/BatchRemoveCatalogAttributes");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.CatalogService", "BatchRemoveCatalogAttributes"));
self.inner.unary(req, path, codec).await
}
...
pub async fn replace_catalog_attribute(&mut self, request: impl tonic::IntoRequest<super::ReplaceCatalogAttributeRequest>) -> std::result::Result<tonic::Response<super::AttributesConfig>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.CatalogService/ReplaceCatalogAttribute");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.CatalogService", "ReplaceCatalogAttribute"));
self.inner.unary(req, path, codec).await
}
}
}
...
#[prost(message, repeated, tag = "1")]
pub merchant_center_account_links: ::prost::alloc::vec::Vec<MerchantCenterAccountLink>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> MerchantCenterAccountLinkServiceClient<InterceptedService<T, F>>
where
F: tonic::service::Interceptor,
T::ResponseBody: Default,
T: tonic::codegen::Service<http::Request<tonic::body::BoxBody>, Response = http::Response<<T as tonic::client::GrpcService<tonic::body::BoxBody>>::ResponseBody>>,
<T as tonic::codegen::Service<http::Request<tonic::body::BoxBody>>>::Error: Into<StdError> + Send + Sync,
{
MerchantCenterAccountLinkServiceClient::new(InterceptedService::new(inner, interceptor))
}
/// Compress requests with the given encoding.
///
/// This requires the server to support it otherwise it might respond with an
...
pub async fn list_merchant_center_account_links(&mut self, request: impl tonic::IntoRequest<super::ListMerchantCenterAccountLinksRequest>) -> std::result::Result<tonic::Response<super::ListMerchantCenterAccountLinksResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.MerchantCenterAccountLinkService/ListMerchantCenterAccountLinks");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.MerchantCenterAccountLinkService", "ListMerchantCenterAccountLinks"));
self.inner.unary(req, path, codec).await
}
/// Creates a
/// [MerchantCenterAccountLink][google.cloud.retail.v2alpha.MerchantCenterAccountLink].
pub async fn create_merchant_center_account_link(&mut self, request: impl tonic::IntoRequest<super::CreateMerchantCenterAccountLinkRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.MerchantCenterAccountLinkService/CreateMerchantCenterAccountLink");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.MerchantCenterAccountLinkService", "CreateMerchantCenterAccountLink"));
self.inner.unary(req, path, codec).await
}
/// Deletes a
/// [MerchantCenterAccountLink][google.cloud.retail.v2alpha.MerchantCenterAccountLink].
...
pub async fn delete_merchant_center_account_link(&mut self, request: impl tonic::IntoRequest<super::DeleteMerchantCenterAccountLinkRequest>) -> std::result::Result<tonic::Response<()>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.MerchantCenterAccountLinkService/DeleteMerchantCenterAccountLink");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.MerchantCenterAccountLinkService", "DeleteMerchantCenterAccountLink"));
self.inner.unary(req, path, codec).await
}
}
}
...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> AnalyticsServiceClient<InterceptedService<T, F>>
where
F: tonic::service::Interceptor,
T::ResponseBody: Default,
T: tonic::codegen::Service<http::Request<tonic::body::BoxBody>, Response = http::Response<<T as tonic::client::GrpcService<tonic::body::BoxBody>>::ResponseBody>>,
...
pub async fn export_analytics_metrics(&mut self, request: impl tonic::IntoRequest<super::ExportAnalyticsMetricsRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.AnalyticsService/ExportAnalyticsMetrics");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.AnalyticsService", "ExportAnalyticsMetrics"));
self.inner.unary(req, path, codec).await
}
}
}
...
Restriction::UniqueServingConfigRestriction => "UNIQUE_SERVING_CONFIG_RESTRICTION",
Restriction::UniqueModelRestriction => "UNIQUE_MODEL_RESTRICTION",
Restriction::UniqueModelTypeRestriction => "UNIQUE_MODEL_TYPE_RESTRICTION",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"UNIQUE_SERVING_CONFIG_RESTRICTION" => Some(Self::UniqueServingConfigRestriction),
"UNIQUE_MODEL_RESTRICTION" => Some(Self::UniqueModelRestriction),
"UNIQUE_MODEL_TYPE_RESTRICTION" => Some(Self::UniqueModelTypeRestriction),
_ => None,
}
}
}
...
pub type_dedicated_config: ::core::option::Option<model_features_config::TypeDedicatedConfig>,
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ControlService/CreateControl");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ControlService", "CreateControl"));
self.inner.unary(req, path, codec).await
}
/// Deletes a Control.
///
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ControlService/DeleteControl");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ControlService", "DeleteControl"));
self.inner.unary(req, path, codec).await
}
/// Updates a Control.
///
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ControlService/UpdateControl");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ControlService", "UpdateControl"));
self.inner.unary(req, path, codec).await
}
/// Gets a Control.
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ControlService/GetControl");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ControlService", "GetControl"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ControlService/ListControls");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ControlService", "ListControls"));
self.inner.unary(req, path, codec).await
}
}
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ModelService/CreateModel");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ModelService", "CreateModel"));
self.inner.unary(req, path, codec).await
}
/// Gets a model.
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ModelService/GetModel");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ModelService", "GetModel"));
self.inner.unary(req, path, codec).await
}
/// Pauses the training of an existing model.
pub async fn pause_model(&mut self, request: impl tonic::IntoRequest<super::PauseModelRequest>) -> std::result::Result<tonic::Response<super::Model>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ModelService/PauseModel");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ModelService", "PauseModel"));
self.inner.unary(req, path, codec).await
}
/// Resumes the training of an existing model.
pub async fn resume_model(&mut self, request: impl tonic::IntoRequest<super::ResumeModelRequest>) -> std::result::Result<tonic::Response<super::Model>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ModelService/ResumeModel");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ModelService", "ResumeModel"));
self.inner.unary(req, path, codec).await
}
/// Deletes an existing model.
pub async fn delete_model(&mut self, request: impl tonic::IntoRequest<super::DeleteModelRequest>) -> std::result::Result<tonic::Response<()>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ModelService/DeleteModel");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ModelService", "DeleteModel"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ModelService/ListModels");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ModelService", "ListModels"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ModelService/UpdateModel");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ModelService", "UpdateModel"));
self.inner.unary(req, path, codec).await
}
/// Tunes an existing model.
pub async fn tune_model(&mut self, request: impl tonic::IntoRequest<super::TuneModelRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ModelService/TuneModel");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ModelService", "TuneModel"));
self.inner.unary(req, path, codec).await
}
}
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ProjectService/GetProject");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ProjectService", "GetProject"));
self.inner.unary(req, path, codec).await
}
...
pub async fn accept_terms(&mut self, request: impl tonic::IntoRequest<super::AcceptTermsRequest>) -> std::result::Result<tonic::Response<super::Project>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ProjectService/AcceptTerms");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ProjectService", "AcceptTerms"));
self.inner.unary(req, path, codec).await
}
...
pub async fn enroll_solution(&mut self, request: impl tonic::IntoRequest<super::EnrollSolutionRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ProjectService/EnrollSolution");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ProjectService", "EnrollSolution"));
self.inner.unary(req, path, codec).await
}
/// Lists all the retail API solutions the project has enrolled.
pub async fn list_enrolled_solutions(&mut self, request: impl tonic::IntoRequest<super::ListEnrolledSolutionsRequest>) -> std::result::Result<tonic::Response<super::ListEnrolledSolutionsResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ProjectService/ListEnrolledSolutions");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ProjectService", "ListEnrolledSolutions"));
self.inner.unary(req, path, codec).await
}
/// Gets the [LoggingConfig][google.cloud.retail.v2alpha.LoggingConfig] of the
/// requested project.
pub async fn get_logging_config(&mut self, request: impl tonic::IntoRequest<super::GetLoggingConfigRequest>) -> std::result::Result<tonic::Response<super::LoggingConfig>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ProjectService/GetLoggingConfig");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ProjectService", "GetLoggingConfig"));
self.inner.unary(req, path, codec).await
}
/// Updates the [LoggingConfig][google.cloud.retail.v2alpha.LoggingConfig] of
/// the requested project.
pub async fn update_logging_config(&mut self, request: impl tonic::IntoRequest<super::UpdateLoggingConfigRequest>) -> std::result::Result<tonic::Response<super::LoggingConfig>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ProjectService/UpdateLoggingConfig");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ProjectService", "UpdateLoggingConfig"));
self.inner.unary(req, path, codec).await
}
/// Get the [AlertConfig][google.cloud.retail.v2alpha.AlertConfig] of the
/// requested project.
pub async fn get_alert_config(&mut self, request: impl tonic::IntoRequest<super::GetAlertConfigRequest>) -> std::result::Result<tonic::Response<super::AlertConfig>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ProjectService/GetAlertConfig");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ProjectService", "GetAlertConfig"));
self.inner.unary(req, path, codec).await
}
/// Update the alert config of the requested project.
pub async fn update_alert_config(&mut self, request: impl tonic::IntoRequest<super::UpdateAlertConfigRequest>) -> std::result::Result<tonic::Response<super::AlertConfig>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.retail.v2alpha.ProjectService/UpdateAlertConfig");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.retail.v2alpha.ProjectService", "UpdateAlertConfig"));
self.inner.unary(req, path, codec).await
}
}
}
