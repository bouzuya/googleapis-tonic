...
pub struct Cluster {
    ...
    pub external_load_balancer_ipv4_address_pools:
    ...
    pub external_load_balancer_ipv6_address_pools:
        ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
}
...
pub struct ServerConfig {
    #[prost(map = "string, message", tag = "1")]
    pub channels: ::std::collections::HashMap<::prost::alloc::string::String, ChannelConfig>,
...
pub mod edge_container_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::ListMachinesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::ListVpnConnectionsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
