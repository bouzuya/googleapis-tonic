...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> PhishingProtectionServiceV1Beta1Client<InterceptedService<T, F>>
where
...
pub async fn report_phishing(&mut self, request: impl tonic::IntoRequest<super::ReportPhishingRequest>) -> std::result::Result<tonic::Response<super::ReportPhishingResponse>, tonic::Status> {
...
req.extensions_mut().insert(GrpcMethod::new("google.cloud.phishingprotection.v1beta1.PhishingProtectionServiceV1Beta1", "ReportPhishing"));
