...
pub sale_price_effective_date: ::core::option::Option<super::super::super::super::r#type::Interval>,
...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> LocalInventoryServiceClient<InterceptedService<T, F>>
where
...
pub async fn list_local_inventories(&mut self, request: impl tonic::IntoRequest<super::ListLocalInventoriesRequest>) -> std::result::Result<tonic::Response<super::ListLocalInventoriesResponse>, tonic::Status> {
...
req.extensions_mut().insert(GrpcMethod::new("google.shopping.merchant.inventories.v1beta.LocalInventoryService", "ListLocalInventories"));
...
pub async fn insert_local_inventory(&mut self, request: impl tonic::IntoRequest<super::InsertLocalInventoryRequest>) -> std::result::Result<tonic::Response<super::LocalInventory>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.shopping.merchant.inventories.v1beta.LocalInventoryService", "InsertLocalInventory"));
self.inner.unary(req, path, codec).await
}
...
pub async fn delete_local_inventory(&mut self, request: impl tonic::IntoRequest<super::DeleteLocalInventoryRequest>) -> std::result::Result<tonic::Response<()>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.shopping.merchant.inventories.v1beta.LocalInventoryService", "DeleteLocalInventory"));
self.inner.unary(req, path, codec).await
}
}
}
...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> RegionalInventoryServiceClient<InterceptedService<T, F>>
where
F: tonic::service::Interceptor,
T::ResponseBody: Default,
T: tonic::codegen::Service<http::Request<tonic::body::BoxBody>, Response = http::Response<<T as tonic::client::GrpcService<tonic::body::BoxBody>>::ResponseBody>>,
...
pub async fn list_regional_inventories(&mut self, request: impl tonic::IntoRequest<super::ListRegionalInventoriesRequest>) -> std::result::Result<tonic::Response<super::ListRegionalInventoriesResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.shopping.merchant.inventories.v1beta.RegionalInventoryService", "ListRegionalInventories"));
self.inner.unary(req, path, codec).await
}
...
/// resource to appear in products.
pub async fn insert_regional_inventory(&mut self, request: impl tonic::IntoRequest<super::InsertRegionalInventoryRequest>) -> std::result::Result<tonic::Response<super::RegionalInventory>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.shopping.merchant.inventories.v1beta.RegionalInventoryService", "InsertRegionalInventory"));
self.inner.unary(req, path, codec).await
}
...
/// Once you have received a successful delete response, wait for that
/// period before attempting a delete again.
pub async fn delete_regional_inventory(&mut self, request: impl tonic::IntoRequest<super::DeleteRegionalInventoryRequest>) -> std::result::Result<tonic::Response<()>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.shopping.merchant.inventories.v1beta.RegionalInventoryService", "DeleteRegionalInventory"));
self.inner.unary(req, path, codec).await
}
}
}
