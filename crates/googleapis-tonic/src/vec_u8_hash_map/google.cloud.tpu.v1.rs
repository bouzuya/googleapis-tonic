...
req.extensions_mut().insert(GrpcMethod::new("google.cloud.tpu.v1.Tpu", "ListNodes"));
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.tpu.v1.Tpu", "GetNode"));
self.inner.unary(req, path, codec).await
}
/// Creates a node.
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.tpu.v1.Tpu", "CreateNode"));
self.inner.unary(req, path, codec).await
}
/// Deletes a node.
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.tpu.v1.Tpu", "DeleteNode"));
self.inner.unary(req, path, codec).await
}
/// Reimages a node's OS.
pub async fn reimage_node(&mut self, request: impl tonic::IntoRequest<super::ReimageNodeRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.tpu.v1.Tpu/ReimageNode");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.tpu.v1.Tpu", "ReimageNode"));
self.inner.unary(req, path, codec).await
}
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.tpu.v1.Tpu", "StopNode"));
self.inner.unary(req, path, codec).await
}
/// Starts a node.
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.tpu.v1.Tpu", "StartNode"));
self.inner.unary(req, path, codec).await
}
/// List TensorFlow versions supported by this API.
pub async fn list_tensor_flow_versions(&mut self, request: impl tonic::IntoRequest<super::ListTensorFlowVersionsRequest>) -> std::result::Result<tonic::Response<super::ListTensorFlowVersionsResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.tpu.v1.Tpu/ListTensorFlowVersions");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.tpu.v1.Tpu", "ListTensorFlowVersions"));
self.inner.unary(req, path, codec).await
}
/// Gets TensorFlow Version.
pub async fn get_tensor_flow_version(&mut self, request: impl tonic::IntoRequest<super::GetTensorFlowVersionRequest>) -> std::result::Result<tonic::Response<super::TensorFlowVersion>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.tpu.v1.Tpu/GetTensorFlowVersion");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.tpu.v1.Tpu", "GetTensorFlowVersion"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.tpu.v1.Tpu/ListAcceleratorTypes");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.tpu.v1.Tpu", "ListAcceleratorTypes"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.tpu.v1.Tpu/GetAcceleratorType");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.tpu.v1.Tpu", "GetAcceleratorType"));
self.inner.unary(req, path, codec).await
}
}
}
