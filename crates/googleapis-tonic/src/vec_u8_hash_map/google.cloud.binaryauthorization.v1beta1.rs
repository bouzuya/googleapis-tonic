...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> BinauthzManagementServiceV1Beta1Client<InterceptedService<T, F>>
where
...
req.extensions_mut().insert(GrpcMethod::new("google.cloud.binaryauthorization.v1beta1.BinauthzManagementServiceV1Beta1", "GetPolicy"));
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.binaryauthorization.v1beta1.BinauthzManagementServiceV1Beta1", "UpdatePolicy"));
self.inner.unary(req, path, codec).await
}
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.binaryauthorization.v1beta1.BinauthzManagementServiceV1Beta1", "CreateAttestor"));
self.inner.unary(req, path, codec).await
}
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.binaryauthorization.v1beta1.BinauthzManagementServiceV1Beta1", "GetAttestor"));
self.inner.unary(req, path, codec).await
}
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.binaryauthorization.v1beta1.BinauthzManagementServiceV1Beta1", "UpdateAttestor"));
self.inner.unary(req, path, codec).await
}
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.binaryauthorization.v1beta1.BinauthzManagementServiceV1Beta1", "ListAttestors"));
self.inner.unary(req, path, codec).await
}
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.binaryauthorization.v1beta1.BinauthzManagementServiceV1Beta1", "DeleteAttestor"));
self.inner.unary(req, path, codec).await
}
}
}
...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> SystemPolicyV1Beta1Client<InterceptedService<T, F>>
where
F: tonic::service::Interceptor,
T::ResponseBody: Default,
T: tonic::codegen::Service<http::Request<tonic::body::BoxBody>, Response = http::Response<<T as tonic::client::GrpcService<tonic::body::BoxBody>>::ResponseBody>>,
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.binaryauthorization.v1beta1.SystemPolicyV1Beta1/GetSystemPolicy");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.binaryauthorization.v1beta1.SystemPolicyV1Beta1", "GetSystemPolicy"));
self.inner.unary(req, path, codec).await
}
}
}
