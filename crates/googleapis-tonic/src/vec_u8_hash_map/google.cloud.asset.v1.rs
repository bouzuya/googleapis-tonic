...
pub struct QueryAssetsOutputConfig {
    ...
    pub bigquery_destination:
        ::core::option::Option<query_assets_output_config::BigQueryDestination>,
}
...
pub struct AnalyzerOrgPolicyConstraint {
    ...
    pub constraint_definition:
        ::core::option::Option<analyzer_org_policy_constraint::ConstraintDefinition>,
}
...
pub struct AnalyzeOrgPoliciesResponse {
    ...
    pub org_policy_results:
        ::prost::alloc::vec::Vec<analyze_org_policies_response::OrgPolicyResult>,
    #[prost(message, optional, tag = "2")]
...
pub struct AnalyzeOrgPolicyGovernedAssetsResponse {
    #[prost(message, repeated, tag = "1")]
    pub governed_assets:
        ::prost::alloc::vec::Vec<analyze_org_policy_governed_assets_response::GovernedAsset>,
    #[prost(message, optional, tag = "2")]
    pub constraint: ::core::option::Option<AnalyzerOrgPolicyConstraint>,
    #[prost(string, tag = "3")]
    pub next_page_token: ::prost::alloc::string::String,
...
pub mod asset_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::BatchGetAssetsHistoryResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::AnalyzeIamPolicyResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::AnalyzeMoveResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::QueryAssetsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::AnalyzeOrgPoliciesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        pub async fn analyze_org_policy_governed_containers(
            &mut self,
            request: impl tonic::IntoRequest<super::AnalyzeOrgPolicyGovernedContainersRequest>,
        ) -> std::result::Result<
        ...
        pub async fn analyze_org_policy_governed_assets(
            &mut self,
            request: impl tonic::IntoRequest<super::AnalyzeOrgPolicyGovernedAssetsRequest>,
        ) -> std::result::Result<
