...
TransitEncryptionMode::ServerAuthentication => "TRANSIT_ENCRYPTION_MODE_SERVER_AUTHENTICATION",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"TRANSIT_ENCRYPTION_MODE_SERVER_AUTHENTICATION" => Some(Self::ServerAuthentication),
_ => None,
}
}
}
...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> CloudRedisClusterClient<InterceptedService<T, F>>
where
...
let path = http::uri::PathAndQuery::from_static("/google.cloud.redis.cluster.v1beta1.CloudRedisCluster/ListClusters");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.redis.cluster.v1beta1.CloudRedisCluster", "ListClusters"));
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.redis.cluster.v1beta1.CloudRedisCluster/GetCluster");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.redis.cluster.v1beta1.CloudRedisCluster", "GetCluster"));
self.inner.unary(req, path, codec).await
}
...
pub async fn update_cluster(&mut self, request: impl tonic::IntoRequest<super::UpdateClusterRequest>) -> std::result::Result<tonic::Response<super::super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.redis.cluster.v1beta1.CloudRedisCluster/UpdateCluster");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.redis.cluster.v1beta1.CloudRedisCluster", "UpdateCluster"));
self.inner.unary(req, path, codec).await
}
/// Deletes a specific Redis cluster. Cluster stops serving and data is
/// deleted.
pub async fn delete_cluster(&mut self, request: impl tonic::IntoRequest<super::DeleteClusterRequest>) -> std::result::Result<tonic::Response<super::super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.redis.cluster.v1beta1.CloudRedisCluster/DeleteCluster");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.redis.cluster.v1beta1.CloudRedisCluster", "DeleteCluster"));
self.inner.unary(req, path, codec).await
}
...
pub async fn create_cluster(&mut self, request: impl tonic::IntoRequest<super::CreateClusterRequest>) -> std::result::Result<tonic::Response<super::super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.redis.cluster.v1beta1.CloudRedisCluster/CreateCluster");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.redis.cluster.v1beta1.CloudRedisCluster", "CreateCluster"));
self.inner.unary(req, path, codec).await
}
/// Gets the details of certificate authority information for Redis cluster.
pub async fn get_cluster_certificate_authority(&mut self, request: impl tonic::IntoRequest<super::GetClusterCertificateAuthorityRequest>) -> std::result::Result<tonic::Response<super::CertificateAuthority>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.redis.cluster.v1beta1.CloudRedisCluster/GetClusterCertificateAuthority");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.redis.cluster.v1beta1.CloudRedisCluster", "GetClusterCertificateAuthority"));
self.inner.unary(req, path, codec).await
}
}
}
