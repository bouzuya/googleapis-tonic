...
#[prost(enumeration = "super::super::super::r#type::destination::DestinationEnum", repeated, packed = "false", tag = "6")]
...
pub promotion_effective_time_period: ::core::option::Option<super::super::super::super::r#type::Interval>,
#[prost(message, optional, tag = "26")]
pub promotion_display_time_period: ::core::option::Option<super::super::super::super::r#type::Interval>,
...
#[prost(enumeration = "super::super::super::super::r#type::reporting_context::ReportingContextEnum", tag = "1")]
...
#[prost(enumeration = "super::super::super::super::r#type::reporting_context::ReportingContextEnum", tag = "5")]
pub reporting_context: i32,
#[prost(string, tag = "6")]
...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> PromotionsServiceClient<InterceptedService<T, F>>
where
...
pub async fn insert_promotion(&mut self, request: impl tonic::IntoRequest<super::InsertPromotionRequest>) -> std::result::Result<tonic::Response<super::Promotion>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.shopping.merchant.promotions.v1beta.PromotionsService/InsertPromotion");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.shopping.merchant.promotions.v1beta.PromotionsService", "InsertPromotion"));
...
pub async fn get_promotion(&mut self, request: impl tonic::IntoRequest<super::GetPromotionRequest>) -> std::result::Result<tonic::Response<super::Promotion>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.shopping.merchant.promotions.v1beta.PromotionsService/GetPromotion");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.shopping.merchant.promotions.v1beta.PromotionsService", "GetPromotion"));
self.inner.unary(req, path, codec).await
}
...
pub async fn list_promotions(&mut self, request: impl tonic::IntoRequest<super::ListPromotionsRequest>) -> std::result::Result<tonic::Response<super::ListPromotionsResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.shopping.merchant.promotions.v1beta.PromotionsService/ListPromotions");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.shopping.merchant.promotions.v1beta.PromotionsService", "ListPromotions"));
self.inner.unary(req, path, codec).await
}
}
}
