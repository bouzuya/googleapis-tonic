...
pub uris: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, Uris>,
...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> AerialViewClient<InterceptedService<T, F>>
where
...
pub async fn render_video(&mut self, request: impl tonic::IntoRequest<super::RenderVideoRequest>) -> std::result::Result<tonic::Response<super::RenderVideoResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.maps.aerialview.v1.AerialView/RenderVideo");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.maps.aerialview.v1.AerialView", "RenderVideo"));
...
pub async fn lookup_video(&mut self, request: impl tonic::IntoRequest<super::LookupVideoRequest>) -> std::result::Result<tonic::Response<super::Video>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.maps.aerialview.v1.AerialView/LookupVideo");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.maps.aerialview.v1.AerialView", "LookupVideo"));
self.inner.unary(req, path, codec).await
}
}
}
