...
AssetLinkPrimaryStatusReason::AssetApprovedLabeled => "ASSET_APPROVED_LABELED",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
AssetOfflineEvaluationErrorReasons::PriceAssetDescriptionRepeatsRowHeader => "PRICE_ASSET_DESCRIPTION_REPEATS_ROW_HEADER",
AssetOfflineEvaluationErrorReasons::PriceAssetRepetitiveHeaders => "PRICE_ASSET_REPETITIVE_HEADERS",
AssetOfflineEvaluationErrorReasons::PriceAssetHeaderIncompatibleWithPriceType => "PRICE_ASSET_HEADER_INCOMPATIBLE_WITH_PRICE_TYPE",
AssetOfflineEvaluationErrorReasons::PriceAssetDescriptionIncompatibleWithItemHeader => "PRICE_ASSET_DESCRIPTION_INCOMPATIBLE_WITH_ITEM_HEADER",
AssetOfflineEvaluationErrorReasons::PriceAssetDescriptionHasPriceQualifier => "PRICE_ASSET_DESCRIPTION_HAS_PRICE_QUALIFIER",
AssetOfflineEvaluationErrorReasons::PriceAssetUnsupportedLanguage => "PRICE_ASSET_UNSUPPORTED_LANGUAGE",
AssetOfflineEvaluationErrorReasons::PriceAssetOtherError => "PRICE_ASSET_OTHER_ERROR",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"UNSPECIFIED" => Some(Self::Unspecified),
"UNKNOWN" => Some(Self::Unknown),
"PRICE_ASSET_DESCRIPTION_REPEATS_ROW_HEADER" => Some(Self::PriceAssetDescriptionRepeatsRowHeader),
"PRICE_ASSET_REPETITIVE_HEADERS" => Some(Self::PriceAssetRepetitiveHeaders),
"PRICE_ASSET_HEADER_INCOMPATIBLE_WITH_PRICE_TYPE" => Some(Self::PriceAssetHeaderIncompatibleWithPriceType),
"PRICE_ASSET_DESCRIPTION_INCOMPATIBLE_WITH_ITEM_HEADER" => Some(Self::PriceAssetDescriptionIncompatibleWithItemHeader),
"PRICE_ASSET_DESCRIPTION_HAS_PRICE_QUALIFIER" => Some(Self::PriceAssetDescriptionHasPriceQualifier),
"PRICE_ASSET_UNSUPPORTED_LANGUAGE" => Some(Self::PriceAssetUnsupportedLanguage),
...
ExperimentMetric::ConversionsPerInteractionRate => "CONVERSIONS_PER_INTERACTION_RATE",
...
"COST" => Some(Self::Cost),
"CONVERSIONS_PER_INTERACTION_RATE" => Some(Self::ConversionsPerInteractionRate),
...
ExperimentType::DisplayAutomatedBiddingStrategy => "DISPLAY_AUTOMATED_BIDDING_STRATEGY",
ExperimentType::SearchAutomatedBiddingStrategy => "SEARCH_AUTOMATED_BIDDING_STRATEGY",
ExperimentType::ShoppingAutomatedBiddingStrategy => "SHOPPING_AUTOMATED_BIDDING_STRATEGY",
...
"DISPLAY_AUTOMATED_BIDDING_STRATEGY" => Some(Self::DisplayAutomatedBiddingStrategy),
"SEARCH_AUTOMATED_BIDDING_STRATEGY" => Some(Self::SearchAutomatedBiddingStrategy),
"SHOPPING_AUTOMATED_BIDDING_STRATEGY" => Some(Self::ShoppingAutomatedBiddingStrategy),
...
BrandRequestRejectionReason::ExistingBrandVariant => "EXISTING_BRAND_VARIANT",
BrandRequestRejectionReason::IncorrectInformation => "INCORRECT_INFORMATION",
...
"USE_ACCOUNT_LEVEL_CALL_CONVERSION_ACTION" => Some(Self::UseAccountLevelCallConversionAction),
"USE_RESOURCE_LEVEL_CALL_CONVERSION_ACTION" => Some(Self::UseResourceLevelCallConversionAction),
_ => None,
}
}
}
...
pub fn as_str_name(&self) -> &'static str {
match self {
LocalServicesBusinessRegistrationCheckRejectionReason::Unspecified => "UNSPECIFIED",
LocalServicesBusinessRegistrationCheckRejectionReason::Unknown => "UNKNOWN",
LocalServicesBusinessRegistrationCheckRejectionReason::BusinessNameMismatch => "BUSINESS_NAME_MISMATCH",
LocalServicesBusinessRegistrationCheckRejectionReason::BusinessDetailsMismatch => "BUSINESS_DETAILS_MISMATCH",
LocalServicesBusinessRegistrationCheckRejectionReason::IdNotFound => "ID_NOT_FOUND",
LocalServicesBusinessRegistrationCheckRejectionReason::PoorDocumentImageQuality => "POOR_DOCUMENT_IMAGE_QUALITY",
LocalServicesBusinessRegistrationCheckRejectionReason::DocumentExpired => "DOCUMENT_EXPIRED",
LocalServicesBusinessRegistrationCheckRejectionReason::DocumentInvalid => "DOCUMENT_INVALID",
LocalServicesBusinessRegistrationCheckRejectionReason::DocumentTypeMismatch => "DOCUMENT_TYPE_MISMATCH",
LocalServicesBusinessRegistrationCheckRejectionReason::DocumentUnverifiable => "DOCUMENT_UNVERIFIABLE",
...
LocalServicesInsuranceRejectionReason::BusinessNameMismatch => "BUSINESS_NAME_MISMATCH",
LocalServicesInsuranceRejectionReason::InsuranceAmountInsufficient => "INSURANCE_AMOUNT_INSUFFICIENT",
LocalServicesInsuranceRejectionReason::Expired => "EXPIRED",
LocalServicesInsuranceRejectionReason::NoSignature => "NO_SIGNATURE",
LocalServicesInsuranceRejectionReason::NoPolicyNumber => "NO_POLICY_NUMBER",
LocalServicesInsuranceRejectionReason::NoCommercialGeneralLiability => "NO_COMMERCIAL_GENERAL_LIABILITY",
LocalServicesInsuranceRejectionReason::EditableFormat => "EDITABLE_FORMAT",
LocalServicesInsuranceRejectionReason::CategoryMismatch => "CATEGORY_MISMATCH",
LocalServicesInsuranceRejectionReason::MissingExpirationDate => "MISSING_EXPIRATION_DATE",
LocalServicesInsuranceRejectionReason::PoorQuality => "POOR_QUALITY",
LocalServicesInsuranceRejectionReason::PotentiallyEdited => "POTENTIALLY_EDITED",
LocalServicesInsuranceRejectionReason::WrongDocumentType => "WRONG_DOCUMENT_TYPE",
...
"UNKNOWN" => Some(Self::Unknown),
"BUSINESS_NAME_MISMATCH" => Some(Self::BusinessNameMismatch),
"INSURANCE_AMOUNT_INSUFFICIENT" => Some(Self::InsuranceAmountInsufficient),
"EXPIRED" => Some(Self::Expired),
"NO_SIGNATURE" => Some(Self::NoSignature),
"NO_POLICY_NUMBER" => Some(Self::NoPolicyNumber),
"NO_COMMERCIAL_GENERAL_LIABILITY" => Some(Self::NoCommercialGeneralLiability),
...
LocalServicesLicenseRejectionReason::BusinessNameMismatch => "BUSINESS_NAME_MISMATCH",
...
LocalServicesLicenseRejectionReason::WrongDocumentOrId => "WRONG_DOCUMENT_OR_ID",
...
LocalServicesVerificationArtifactType::BackgroundCheck => "BACKGROUND_CHECK",
LocalServicesVerificationArtifactType::Insurance => "INSURANCE",
LocalServicesVerificationArtifactType::License => "LICENSE",
LocalServicesVerificationArtifactType::BusinessRegistrationCheck => "BUSINESS_REGISTRATION_CHECK",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
AdvertisingChannelSubType::VideoReachTargetFrequency => "VIDEO_REACH_TARGET_FREQUENCY",
...
"CHANNEL_TYPE_AND_SUBSET_SUBTYPES" => Some(Self::ChannelTypeAndSubsetSubtypes),
_ => None,
}
}
}
...
"UNSPECIFIED" => Some(Self::Unspecified),
"UNKNOWN" => Some(Self::Unknown),
"PRICE_TABLE_REPETITIVE_HEADERS" => Some(Self::PriceTableRepetitiveHeaders),
"PRICE_TABLE_REPETITIVE_DESCRIPTION" => Some(Self::PriceTableRepetitiveDescription),
"PRICE_TABLE_INCONSISTENT_ROWS" => Some(Self::PriceTableInconsistentRows),
"PRICE_DESCRIPTION_HAS_PRICE_QUALIFIERS" => Some(Self::PriceDescriptionHasPriceQualifiers),
"PRICE_UNSUPPORTED_LANGUAGE" => Some(Self::PriceUnsupportedLanguage),
"PRICE_TABLE_ROW_HEADER_TABLE_TYPE_MISMATCH" => Some(Self::PriceTableRowHeaderTableTypeMismatch),
"PRICE_TABLE_ROW_HEADER_HAS_PROMOTIONAL_TEXT" => Some(Self::PriceTableRowHeaderHasPromotionalText),
"PRICE_TABLE_ROW_DESCRIPTION_NOT_RELEVANT" => Some(Self::PriceTableRowDescriptionNotRelevant),
"PRICE_TABLE_ROW_DESCRIPTION_HAS_PROMOTIONAL_TEXT" => Some(Self::PriceTableRowDescriptionHasPromotionalText),
"PRICE_TABLE_ROW_HEADER_DESCRIPTION_REPETITIVE" => Some(Self::PriceTableRowHeaderDescriptionRepetitive),
...
"PRICE_HEADER_OR_DESCRIPTION_HAS_PRICE" => Some(Self::PriceHeaderOrDescriptionHasPrice),
"STRUCTURED_SNIPPETS_HEADER_POLICY_VIOLATED" => Some(Self::StructuredSnippetsHeaderPolicyViolated),
"STRUCTURED_SNIPPETS_REPEATED_VALUES" => Some(Self::StructuredSnippetsRepeatedValues),
"STRUCTURED_SNIPPETS_EDITORIAL_GUIDELINES" => Some(Self::StructuredSnippetsEditorialGuidelines),
"STRUCTURED_SNIPPETS_HAS_PROMOTIONAL_TEXT" => Some(Self::StructuredSnippetsHasPromotionalText),
_ => None,
}
}
}
...
LeadFormFieldUserInputType::GovernmentIssuedIdCpfBr => "GOVERNMENT_ISSUED_ID_CPF_BR",
LeadFormFieldUserInputType::GovernmentIssuedIdDniAr => "GOVERNMENT_ISSUED_ID_DNI_AR",
LeadFormFieldUserInputType::GovernmentIssuedIdDniPe => "GOVERNMENT_ISSUED_ID_DNI_PE",
LeadFormFieldUserInputType::GovernmentIssuedIdRutCl => "GOVERNMENT_ISSUED_ID_RUT_CL",
LeadFormFieldUserInputType::GovernmentIssuedIdCcCo => "GOVERNMENT_ISSUED_ID_CC_CO",
LeadFormFieldUserInputType::GovernmentIssuedIdCiEc => "GOVERNMENT_ISSUED_ID_CI_EC",
LeadFormFieldUserInputType::GovernmentIssuedIdRfcMx => "GOVERNMENT_ISSUED_ID_RFC_MX",
...
"TRANSPORTATION_COMMERCIAL_LICENSE_TYPE" => Some(Self::TransportationCommercialLicenseType),
...
AppBiddingGoal::OptimizeForInstallConversionVolume => "OPTIMIZE_FOR_INSTALL_CONVERSION_VOLUME",
AppBiddingGoal::OptimizeForInAppConversionVolume => "OPTIMIZE_FOR_IN_APP_CONVERSION_VOLUME",
AppBiddingGoal::OptimizeForTotalConversionValue => "OPTIMIZE_FOR_TOTAL_CONVERSION_VALUE",
AppBiddingGoal::OptimizeForTargetInAppConversion => "OPTIMIZE_FOR_TARGET_IN_APP_CONVERSION",
AppBiddingGoal::OptimizeForReturnOnAdvertisingSpend => "OPTIMIZE_FOR_RETURN_ON_ADVERTISING_SPEND",
AppBiddingGoal::OptimizeForInstallConversionVolumeWithoutTargetCpi => "OPTIMIZE_FOR_INSTALL_CONVERSION_VOLUME_WITHOUT_TARGET_CPI",
AppBiddingGoal::OptimizeForPreRegistrationConversionVolume => "OPTIMIZE_FOR_PRE_REGISTRATION_CONVERSION_VOLUME",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"UNSPECIFIED" => Some(Self::Unspecified),
"UNKNOWN" => Some(Self::Unknown),
"OPTIMIZE_FOR_INSTALL_CONVERSION_VOLUME" => Some(Self::OptimizeForInstallConversionVolume),
"OPTIMIZE_FOR_IN_APP_CONVERSION_VOLUME" => Some(Self::OptimizeForInAppConversionVolume),
"OPTIMIZE_FOR_TOTAL_CONVERSION_VALUE" => Some(Self::OptimizeForTotalConversionValue),
"OPTIMIZE_FOR_TARGET_IN_APP_CONVERSION" => Some(Self::OptimizeForTargetInAppConversion),
"OPTIMIZE_FOR_RETURN_ON_ADVERTISING_SPEND" => Some(Self::OptimizeForReturnOnAdvertisingSpend),
"OPTIMIZE_FOR_INSTALL_CONVERSION_VOLUME_WITHOUT_TARGET_CPI" => Some(Self::OptimizeForInstallConversionVolumeWithoutTargetCpi),
"OPTIMIZE_FOR_PRE_REGISTRATION_CONVERSION_VOLUME" => Some(Self::OptimizeForPreRegistrationConversionVolume),
_ => None,
}
}
}
...
RecommendationType::ResponsiveSearchAdAsset => "RESPONSIVE_SEARCH_AD_ASSET",
RecommendationType::UpgradeSmartShoppingCampaignToPerformanceMax => "UPGRADE_SMART_SHOPPING_CAMPAIGN_TO_PERFORMANCE_MAX",
RecommendationType::ResponsiveSearchAdImproveAdStrength => "RESPONSIVE_SEARCH_AD_IMPROVE_AD_STRENGTH",
RecommendationType::DisplayExpansionOptIn => "DISPLAY_EXPANSION_OPT_IN",
RecommendationType::UpgradeLocalCampaignToPerformanceMax => "UPGRADE_LOCAL_CAMPAIGN_TO_PERFORMANCE_MAX",
RecommendationType::RaiseTargetCpaBidTooLow => "RAISE_TARGET_CPA_BID_TOO_LOW",
RecommendationType::ForecastingSetTargetRoas => "FORECASTING_SET_TARGET_ROAS",
...
RecommendationType::ShoppingAddMoreIdentifiers => "SHOPPING_ADD_MORE_IDENTIFIERS",
RecommendationType::ShoppingAddSize => "SHOPPING_ADD_SIZE",
RecommendationType::ShoppingAddProductsToCampaign => "SHOPPING_ADD_PRODUCTS_TO_CAMPAIGN",
RecommendationType::ShoppingFixDisapprovedProducts => "SHOPPING_FIX_DISAPPROVED_PRODUCTS",
RecommendationType::ShoppingTargetAllOffers => "SHOPPING_TARGET_ALL_OFFERS",
RecommendationType::ShoppingFixSuspendedMerchantCenterAccount => "SHOPPING_FIX_SUSPENDED_MERCHANT_CENTER_ACCOUNT",
RecommendationType::ShoppingFixMerchantCenterAccountSuspensionWarning => "SHOPPING_FIX_MERCHANT_CENTER_ACCOUNT_SUSPENSION_WARNING",
RecommendationType::ShoppingMigrateRegularShoppingCampaignOffersToPerformanceMax => "SHOPPING_MIGRATE_REGULAR_SHOPPING_CAMPAIGN_OFFERS_TO_PERFORMANCE_MAX",
RecommendationType::DynamicImageExtensionOptIn => "DYNAMIC_IMAGE_EXTENSION_OPT_IN",
...
RecommendationType::ImprovePerformanceMaxAdStrength => "IMPROVE_PERFORMANCE_MAX_AD_STRENGTH",
RecommendationType::MigrateDynamicSearchAdsCampaignToPerformanceMax => "MIGRATE_DYNAMIC_SEARCH_ADS_CAMPAIGN_TO_PERFORMANCE_MAX",
RecommendationType::ForecastingSetTargetCpa => "FORECASTING_SET_TARGET_CPA",
RecommendationType::SetTargetCpa => "SET_TARGET_CPA",
RecommendationType::SetTargetRoas => "SET_TARGET_ROAS",
RecommendationType::MaximizeConversionValueOptIn => "MAXIMIZE_CONVERSION_VALUE_OPT_IN",
RecommendationType::ImproveGoogleTagCoverage => "IMPROVE_GOOGLE_TAG_COVERAGE",
RecommendationType::PerformanceMaxFinalUrlOptIn => "PERFORMANCE_MAX_FINAL_URL_OPT_IN",
RecommendationType::RefreshCustomerMatchList => "REFRESH_CUSTOMER_MATCH_LIST",
RecommendationType::CustomAudienceOptIn => "CUSTOM_AUDIENCE_OPT_IN",
RecommendationType::LeadFormAsset => "LEAD_FORM_ASSET",
RecommendationType::ImproveDemandGenAdStrength => "IMPROVE_DEMAND_GEN_AD_STRENGTH",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"UPGRADE_SMART_SHOPPING_CAMPAIGN_TO_PERFORMANCE_MAX" => Some(Self::UpgradeSmartShoppingCampaignToPerformanceMax),
"RESPONSIVE_SEARCH_AD_IMPROVE_AD_STRENGTH" => Some(Self::ResponsiveSearchAdImproveAdStrength),
"DISPLAY_EXPANSION_OPT_IN" => Some(Self::DisplayExpansionOptIn),
"UPGRADE_LOCAL_CAMPAIGN_TO_PERFORMANCE_MAX" => Some(Self::UpgradeLocalCampaignToPerformanceMax),
...
"SHOPPING_ADD_PRODUCTS_TO_CAMPAIGN" => Some(Self::ShoppingAddProductsToCampaign),
"SHOPPING_FIX_DISAPPROVED_PRODUCTS" => Some(Self::ShoppingFixDisapprovedProducts),
"SHOPPING_TARGET_ALL_OFFERS" => Some(Self::ShoppingTargetAllOffers),
"SHOPPING_FIX_SUSPENDED_MERCHANT_CENTER_ACCOUNT" => Some(Self::ShoppingFixSuspendedMerchantCenterAccount),
"SHOPPING_FIX_MERCHANT_CENTER_ACCOUNT_SUSPENSION_WARNING" => Some(Self::ShoppingFixMerchantCenterAccountSuspensionWarning),
"SHOPPING_MIGRATE_REGULAR_SHOPPING_CAMPAIGN_OFFERS_TO_PERFORMANCE_MAX" => Some(Self::ShoppingMigrateRegularShoppingCampaignOffersToPerformanceMax),
"DYNAMIC_IMAGE_EXTENSION_OPT_IN" => Some(Self::DynamicImageExtensionOptIn),
...
"IMPROVE_PERFORMANCE_MAX_AD_STRENGTH" => Some(Self::ImprovePerformanceMaxAdStrength),
"MIGRATE_DYNAMIC_SEARCH_ADS_CAMPAIGN_TO_PERFORMANCE_MAX" => Some(Self::MigrateDynamicSearchAdsCampaignToPerformanceMax),
...
"MAXIMIZE_CONVERSION_VALUE_OPT_IN" => Some(Self::MaximizeConversionValueOptIn),
"IMPROVE_GOOGLE_TAG_COVERAGE" => Some(Self::ImproveGoogleTagCoverage),
"PERFORMANCE_MAX_FINAL_URL_OPT_IN" => Some(Self::PerformanceMaxFinalUrlOptIn),
...
"IMPROVE_DEMAND_GEN_AD_STRENGTH" => Some(Self::ImproveDemandGenAdStrength),
_ => None,
}
}
}
...
Reason::MerchantCenterAccountHasNoSubmittedProducts => "MERCHANT_CENTER_ACCOUNT_HAS_NO_SUBMITTED_PRODUCTS",
Reason::MerchantCenterAccountHasNoSubmittedProductsInFeed => "MERCHANT_CENTER_ACCOUNT_HAS_NO_SUBMITTED_PRODUCTS_IN_FEED",
Reason::AdsAccountExcludesOffersFromCampaign => "ADS_ACCOUNT_EXCLUDES_OFFERS_FROM_CAMPAIGN",
Reason::AllProductsAreExcludedFromCampaign => "ALL_PRODUCTS_ARE_EXCLUDED_FROM_CAMPAIGN",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"UNSPECIFIED" => Some(Self::Unspecified),
"UNKNOWN" => Some(Self::Unknown),
"MERCHANT_CENTER_ACCOUNT_HAS_NO_SUBMITTED_PRODUCTS" => Some(Self::MerchantCenterAccountHasNoSubmittedProducts),
"MERCHANT_CENTER_ACCOUNT_HAS_NO_SUBMITTED_PRODUCTS_IN_FEED" => Some(Self::MerchantCenterAccountHasNoSubmittedProductsInFeed),
"ADS_ACCOUNT_EXCLUDES_OFFERS_FROM_CAMPAIGN" => Some(Self::AdsAccountExcludesOffersFromCampaign),
"ALL_PRODUCTS_ARE_EXCLUDED_FROM_CAMPAIGN" => Some(Self::AllProductsAreExcludedFromCampaign),
_ => None,
}
}
}
...
SharedSetType::AccountLevelNegativeKeywords => "ACCOUNT_LEVEL_NEGATIVE_KEYWORDS",
...
"ACCOUNT_LEVEL_NEGATIVE_KEYWORDS" => Some(Self::AccountLevelNegativeKeywords),
"BRANDS" => Some(Self::Brands),
_ => None,
}
}
...
ChangeClientType::GoogleAdsRecommendationsSubscription => "GOOGLE_ADS_RECOMMENDATIONS_SUBSCRIPTION",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"OTHER" => Some(Self::Other),
"GOOGLE_ADS_RECOMMENDATIONS_SUBSCRIPTION" => Some(Self::GoogleAdsRecommendationsSubscription),
_ => None,
}
}
}
...
AdGroupPrimaryStatusReason::HasAdsLimitedByPolicy => "HAS_ADS_LIMITED_BY_POLICY",
...
AdGroupPrimaryStatusReason::AdGroupPausedDueToLowActivity => "AD_GROUP_PAUSED_DUE_TO_LOW_ACTIVITY",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"AD_GROUP_PAUSED_DUE_TO_LOW_ACTIVITY" => Some(Self::AdGroupPausedDueToLowActivity),
_ => None,
}
}
}
...
AssetSetType::BusinessProfileDynamicLocationGroup => "BUSINESS_PROFILE_DYNAMIC_LOCATION_GROUP",
...
"BUSINESS_PROFILE_DYNAMIC_LOCATION_GROUP" => Some(Self::BusinessProfileDynamicLocationGroup),
...
AdGroupAdPrimaryStatusReason::AdGroupAdDisapproved => "AD_GROUP_AD_DISAPPROVED",
AdGroupAdPrimaryStatusReason::AdGroupAdUnderReview => "AD_GROUP_AD_UNDER_REVIEW",
AdGroupAdPrimaryStatusReason::AdGroupAdPoorQuality => "AD_GROUP_AD_POOR_QUALITY",
AdGroupAdPrimaryStatusReason::AdGroupAdNoAds => "AD_GROUP_AD_NO_ADS",
AdGroupAdPrimaryStatusReason::AdGroupAdApprovedLabeled => "AD_GROUP_AD_APPROVED_LABELED",
AdGroupAdPrimaryStatusReason::AdGroupAdAreaOfInterestOnly => "AD_GROUP_AD_AREA_OF_INTEREST_ONLY",
AdGroupAdPrimaryStatusReason::AdGroupAdUnderAppeal => "AD_GROUP_AD_UNDER_APPEAL",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"AD_GROUP_AD_AREA_OF_INTEREST_ONLY" => Some(Self::AdGroupAdAreaOfInterestOnly),
...
"UNSPECIFIED" => Some(Self::Unspecified),
"UNKNOWN" => Some(Self::Unknown),
"OPTIMIZE_INSTALLS_TARGET_INSTALL_COST" => Some(Self::OptimizeInstallsTargetInstallCost),
"OPTIMIZE_IN_APP_CONVERSIONS_TARGET_INSTALL_COST" => Some(Self::OptimizeInAppConversionsTargetInstallCost),
"OPTIMIZE_IN_APP_CONVERSIONS_TARGET_CONVERSION_COST" => Some(Self::OptimizeInAppConversionsTargetConversionCost),
"OPTIMIZE_RETURN_ON_ADVERTISING_SPEND" => Some(Self::OptimizeReturnOnAdvertisingSpend),
"OPTIMIZE_PRE_REGISTRATION_CONVERSION_VOLUME" => Some(Self::OptimizePreRegistrationConversionVolume),
"OPTIMIZE_INSTALLS_WITHOUT_TARGET_INSTALL_COST" => Some(Self::OptimizeInstallsWithoutTargetInstallCost),
_ => None,
}
}
}
...
BiddingStrategySystemStatus::LearningCompositionChange => "LEARNING_COMPOSITION_CHANGE",
BiddingStrategySystemStatus::LearningConversionTypeChange => "LEARNING_CONVERSION_TYPE_CHANGE",
BiddingStrategySystemStatus::LearningConversionSettingChange => "LEARNING_CONVERSION_SETTING_CHANGE",
...
BiddingStrategySystemStatus::LimitedByLowPrioritySpend => "LIMITED_BY_LOW_PRIORITY_SPEND",
...
BiddingStrategySystemStatus::MisconfiguredZeroEligibility => "MISCONFIGURED_ZERO_ELIGIBILITY",
BiddingStrategySystemStatus::MisconfiguredConversionTypes => "MISCONFIGURED_CONVERSION_TYPES",
BiddingStrategySystemStatus::MisconfiguredConversionSettings => "MISCONFIGURED_CONVERSION_SETTINGS",
BiddingStrategySystemStatus::MisconfiguredSharedBudget => "MISCONFIGURED_SHARED_BUDGET",
BiddingStrategySystemStatus::MisconfiguredStrategyType => "MISCONFIGURED_STRATEGY_TYPE",
...
CampaignPrimaryStatusReason::BiddingStrategyMisconfigured => "BIDDING_STRATEGY_MISCONFIGURED",
CampaignPrimaryStatusReason::BiddingStrategyLimited => "BIDDING_STRATEGY_LIMITED",
CampaignPrimaryStatusReason::BiddingStrategyLearning => "BIDDING_STRATEGY_LEARNING",
CampaignPrimaryStatusReason::BiddingStrategyConstrained => "BIDDING_STRATEGY_CONSTRAINED",
CampaignPrimaryStatusReason::BudgetConstrained => "BUDGET_CONSTRAINED",
CampaignPrimaryStatusReason::BudgetMisconfigured => "BUDGET_MISCONFIGURED",
CampaignPrimaryStatusReason::SearchVolumeLimited => "SEARCH_VOLUME_LIMITED",
...
CampaignPrimaryStatusReason::HasAdsLimitedByPolicy => "HAS_ADS_LIMITED_BY_POLICY",
CampaignPrimaryStatusReason::HasAdsDisapproved => "HAS_ADS_DISAPPROVED",
CampaignPrimaryStatusReason::MostAdsUnderReview => "MOST_ADS_UNDER_REVIEW",
CampaignPrimaryStatusReason::MissingLeadFormExtension => "MISSING_LEAD_FORM_EXTENSION",
CampaignPrimaryStatusReason::MissingCallExtension => "MISSING_CALL_EXTENSION",
CampaignPrimaryStatusReason::LeadFormExtensionUnderReview => "LEAD_FORM_EXTENSION_UNDER_REVIEW",
CampaignPrimaryStatusReason::LeadFormExtensionDisapproved => "LEAD_FORM_EXTENSION_DISAPPROVED",
CampaignPrimaryStatusReason::CallExtensionUnderReview => "CALL_EXTENSION_UNDER_REVIEW",
CampaignPrimaryStatusReason::CallExtensionDisapproved => "CALL_EXTENSION_DISAPPROVED",
CampaignPrimaryStatusReason::NoMobileApplicationAdGroupCriteria => "NO_MOBILE_APPLICATION_AD_GROUP_CRITERIA",
CampaignPrimaryStatusReason::CampaignGroupPaused => "CAMPAIGN_GROUP_PAUSED",
CampaignPrimaryStatusReason::CampaignGroupAllGroupBudgetsEnded => "CAMPAIGN_GROUP_ALL_GROUP_BUDGETS_ENDED",
CampaignPrimaryStatusReason::AppNotReleased => "APP_NOT_RELEASED",
CampaignPrimaryStatusReason::AppPartiallyReleased => "APP_PARTIALLY_RELEASED",
CampaignPrimaryStatusReason::HasAssetGroupsDisapproved => "HAS_ASSET_GROUPS_DISAPPROVED",
CampaignPrimaryStatusReason::HasAssetGroupsLimitedByPolicy => "HAS_ASSET_GROUPS_LIMITED_BY_POLICY",
CampaignPrimaryStatusReason::MostAssetGroupsUnderReview => "MOST_ASSET_GROUPS_UNDER_REVIEW",
...
"CAMPAIGN_ENDED" => Some(Self::CampaignEnded),
"CAMPAIGN_DRAFT" => Some(Self::CampaignDraft),
"BIDDING_STRATEGY_MISCONFIGURED" => Some(Self::BiddingStrategyMisconfigured),
...
"LEAD_FORM_EXTENSION_UNDER_REVIEW" => Some(Self::LeadFormExtensionUnderReview),
"LEAD_FORM_EXTENSION_DISAPPROVED" => Some(Self::LeadFormExtensionDisapproved),
...
"NO_MOBILE_APPLICATION_AD_GROUP_CRITERIA" => Some(Self::NoMobileApplicationAdGroupCriteria),
"CAMPAIGN_GROUP_PAUSED" => Some(Self::CampaignGroupPaused),
"CAMPAIGN_GROUP_ALL_GROUP_BUDGETS_ENDED" => Some(Self::CampaignGroupAllGroupBudgetsEnded),
...
"HAS_ASSET_GROUPS_LIMITED_BY_POLICY" => Some(Self::HasAssetGroupsLimitedByPolicy),
"MOST_ASSET_GROUPS_UNDER_REVIEW" => Some(Self::MostAssetGroupsUnderReview),
...
"UNSPECIFIED" => Some(Self::Unspecified),
"UNKNOWN" => Some(Self::Unknown),
"PRESCRIPTION_TREATMENT_WEBSITE_EN" => Some(Self::PrescriptionTreatmentWebsiteEn),
"PRESCRIPTION_TREATMENT_WEBSITE_ES" => Some(Self::PrescriptionTreatmentWebsiteEs),
"PRESCRIPTION_DEVICE_WEBSITE_EN" => Some(Self::PrescriptionDeviceWebsiteEn),
"PRESCRIPTION_DEVICE_WEBSITE_ES" => Some(Self::PrescriptionDeviceWebsiteEs),
"MEDICAL_DEVICE_WEBSITE_EN" => Some(Self::MedicalDeviceWebsiteEn),
"MEDICAL_DEVICE_WEBSITE_ES" => Some(Self::MedicalDeviceWebsiteEs),
"PREVENTATIVE_TREATMENT_WEBSITE_EN" => Some(Self::PreventativeTreatmentWebsiteEn),
"PREVENTATIVE_TREATMENT_WEBSITE_ES" => Some(Self::PreventativeTreatmentWebsiteEs),
"PRESCRIPTION_CONTRACEPTION_WEBSITE_EN" => Some(Self::PrescriptionContraceptionWebsiteEn),
"PRESCRIPTION_CONTRACEPTION_WEBSITE_ES" => Some(Self::PrescriptionContraceptionWebsiteEs),
"PRESCRIPTION_VACCINE_WEBSITE_EN" => Some(Self::PrescriptionVaccineWebsiteEn),
"PRESCRIPTION_VACCINE_WEBSITE_ES" => Some(Self::PrescriptionVaccineWebsiteEs),
_ => None,
}
}
}
...
OfflineUserDataJobFailureReason::HighAverageTransactionValue => "HIGH_AVERAGE_TRANSACTION_VALUE",
OfflineUserDataJobFailureReason::LowAverageTransactionValue => "LOW_AVERAGE_TRANSACTION_VALUE",
OfflineUserDataJobFailureReason::NewlyObservedCurrencyCode => "NEWLY_OBSERVED_CURRENCY_CODE",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"UNSPECIFIED" => Some(Self::Unspecified),
"UNKNOWN" => Some(Self::Unknown),
"INSUFFICIENT_MATCHED_TRANSACTIONS" => Some(Self::InsufficientMatchedTransactions),
"INSUFFICIENT_TRANSACTIONS" => Some(Self::InsufficientTransactions),
"HIGH_AVERAGE_TRANSACTION_VALUE" => Some(Self::HighAverageTransactionValue),
...
"UNSPECIFIED" => Some(Self::Unspecified),
"UNKNOWN" => Some(Self::Unknown),
"STORE_SALES_UPLOAD_FIRST_PARTY" => Some(Self::StoreSalesUploadFirstParty),
"STORE_SALES_UPLOAD_THIRD_PARTY" => Some(Self::StoreSalesUploadThirdParty),
"CUSTOMER_MATCH_USER_LIST" => Some(Self::CustomerMatchUserList),
"CUSTOMER_MATCH_WITH_ATTRIBUTES" => Some(Self::CustomerMatchWithAttributes),
_ => None,
}
}
}
...
"TEN_THOUSAND_TO_FIFTY_THOUSAND" => Some(Self::TenThousandToFiftyThousand),
"FIFTY_THOUSAND_TO_ONE_HUNDRED_THOUSAND" => Some(Self::FiftyThousandToOneHundredThousand),
"ONE_HUNDRED_THOUSAND_TO_THREE_HUNDRED_THOUSAND" => Some(Self::OneHundredThousandToThreeHundredThousand),
"THREE_HUNDRED_THOUSAND_TO_FIVE_HUNDRED_THOUSAND" => Some(Self::ThreeHundredThousandToFiveHundredThousand),
"FIVE_HUNDRED_THOUSAND_TO_ONE_MILLION" => Some(Self::FiveHundredThousandToOneMillion),
...
"TWENTY_MILLION_TO_THIRTY_MILLION" => Some(Self::TwentyMillionToThirtyMillion),
"THIRTY_MILLION_TO_FIFTY_MILLION" => Some(Self::ThirtyMillionToFiftyMillion),
...
ConversionTrackingStatus::ConversionTrackingManagedBySelf => "CONVERSION_TRACKING_MANAGED_BY_SELF",
ConversionTrackingStatus::ConversionTrackingManagedByThisManager => "CONVERSION_TRACKING_MANAGED_BY_THIS_MANAGER",
ConversionTrackingStatus::ConversionTrackingManagedByAnotherManager => "CONVERSION_TRACKING_MANAGED_BY_ANOTHER_MANAGER",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"CONVERSION_TRACKING_MANAGED_BY_SELF" => Some(Self::ConversionTrackingManagedBySelf),
"CONVERSION_TRACKING_MANAGED_BY_THIS_MANAGER" => Some(Self::ConversionTrackingManagedByThisManager),
"CONVERSION_TRACKING_MANAGED_BY_ANOTHER_MANAGER" => Some(Self::ConversionTrackingManagedByAnotherManager),
_ => None,
}
}
}
...
"HAS_CAMPAIGN_WITH_SHARED_BUDGET" => Some(Self::HasCampaignWithSharedBudget),
...
LocalServicesVerificationStatus::PartialSubmission => "PARTIAL_SUBMISSION",
LocalServicesVerificationStatus::PendingEscalation => "PENDING_ESCALATION",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"ALTERNATIVE_THUMBNAIL_IMAGE_URL" => Some(Self::AlternativeThumbnailImageUrl),
"FINAL_URLS" => Some(Self::FinalUrls),
"FINAL_MOBILE_URLS" => Some(Self::FinalMobileUrls),
"TRACKING_URL" => Some(Self::TrackingUrl),
"CONTEXTUAL_KEYWORDS" => Some(Self::ContextualKeywords),
...
AssetGroupPrimaryStatusReason::AssetGroupDisapproved => "ASSET_GROUP_DISAPPROVED",
AssetGroupPrimaryStatusReason::AssetGroupUnderReview => "ASSET_GROUP_UNDER_REVIEW",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"GOOGLE_SEARCH_ATTRIBUTION_FIRST_CLICK" => Some(Self::GoogleSearchAttributionFirstClick),
"GOOGLE_SEARCH_ATTRIBUTION_LINEAR" => Some(Self::GoogleSearchAttributionLinear),
"GOOGLE_SEARCH_ATTRIBUTION_TIME_DECAY" => Some(Self::GoogleSearchAttributionTimeDecay),
"GOOGLE_SEARCH_ATTRIBUTION_POSITION_BASED" => Some(Self::GoogleSearchAttributionPositionBased),
"GOOGLE_SEARCH_ATTRIBUTION_DATA_DRIVEN" => Some(Self::GoogleSearchAttributionDataDriven),
_ => None,
}
}
}
...
ConversionActionType::UniversalAnalyticsTransaction => "UNIVERSAL_ANALYTICS_TRANSACTION",
...
"THIRD_PARTY_APP_ANALYTICS_ANDROID_FIRST_OPEN" => Some(Self::ThirdPartyAppAnalyticsAndroidFirstOpen),
"THIRD_PARTY_APP_ANALYTICS_ANDROID_IN_APP_PURCHASE" => Some(Self::ThirdPartyAppAnalyticsAndroidInAppPurchase),
"THIRD_PARTY_APP_ANALYTICS_ANDROID_CUSTOM" => Some(Self::ThirdPartyAppAnalyticsAndroidCustom),
"THIRD_PARTY_APP_ANALYTICS_IOS_FIRST_OPEN" => Some(Self::ThirdPartyAppAnalyticsIosFirstOpen),
"THIRD_PARTY_APP_ANALYTICS_IOS_IN_APP_PURCHASE" => Some(Self::ThirdPartyAppAnalyticsIosInAppPurchase),
"THIRD_PARTY_APP_ANALYTICS_IOS_CUSTOM" => Some(Self::ThirdPartyAppAnalyticsIosCustom),
...
CustomerAcquisitionOptimizationMode::TargetAllEqually => "TARGET_ALL_EQUALLY",
CustomerAcquisitionOptimizationMode::BidHigherForNewCustomer => "BID_HIGHER_FOR_NEW_CUSTOMER",
CustomerAcquisitionOptimizationMode::TargetNewCustomer => "TARGET_NEW_CUSTOMER",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"VIDEO_CARD_ACTION_HEADLINE_CLICKS" => Some(Self::VideoCardActionHeadlineClicks),
...
"PRODUCT_LISTING_AD_MULTICHANNEL_LOCAL" => Some(Self::ProductListingAdMultichannelLocal),
"PRODUCT_LISTING_AD_MULTICHANNEL_ONLINE" => Some(Self::ProductListingAdMultichannelOnline),
"PRODUCT_LISTING_ADS_COUPON" => Some(Self::ProductListingAdsCoupon),
"PRODUCT_LISTING_AD_TRANSACTABLE" => Some(Self::ProductListingAdTransactable),
"PRODUCT_AD_APP_DEEPLINK" => Some(Self::ProductAdAppDeeplink),
"SHOWCASE_AD_CATEGORY_LINK" => Some(Self::ShowcaseAdCategoryLink),
"SHOWCASE_AD_LOCAL_STOREFRONT_LINK" => Some(Self::ShowcaseAdLocalStorefrontLink),
"SHOWCASE_AD_ONLINE_PRODUCT_LINK" => Some(Self::ShowcaseAdOnlineProductLink),
"SHOWCASE_AD_LOCAL_PRODUCT_LINK" => Some(Self::ShowcaseAdLocalProductLink),
...
"SWIPEABLE_GALLERY_AD_SITELINK_ONE" => Some(Self::SwipeableGalleryAdSitelinkOne),
"SWIPEABLE_GALLERY_AD_SITELINK_TWO" => Some(Self::SwipeableGalleryAdSitelinkTwo),
"SWIPEABLE_GALLERY_AD_SITELINK_THREE" => Some(Self::SwipeableGalleryAdSitelinkThree),
"SWIPEABLE_GALLERY_AD_SITELINK_FOUR" => Some(Self::SwipeableGalleryAdSitelinkFour),
"SWIPEABLE_GALLERY_AD_SITELINK_FIVE" => Some(Self::SwipeableGalleryAdSitelinkFive),
"HOTEL_PRICE" => Some(Self::HotelPrice),
"PRICE_EXTENSION" => Some(Self::PriceExtension),
"HOTEL_BOOK_ON_GOOGLE_ROOM_SELECTION" => Some(Self::HotelBookOnGoogleRoomSelection),
...
IdentityVerificationProgram::AdvertiserIdentityVerification => "ADVERTISER_IDENTITY_VERIFICATION",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"UNSPECIFIED" => Some(Self::Unspecified),
"UNKNOWN" => Some(Self::Unknown),
"ADVERTISER_IDENTITY_VERIFICATION" => Some(Self::AdvertiserIdentityVerification),
_ => None,
}
}
}
...
SmartCampaignNotEligibleReason::BusinessProfileLocationRemoved => "BUSINESS_PROFILE_LOCATION_REMOVED",
SmartCampaignNotEligibleReason::AllAdsDisapproved => "ALL_ADS_DISAPPROVED",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"BUSINESS_PROFILE_LOCATION_REMOVED" => Some(Self::BusinessProfileLocationRemoved),
...
IdentityVerificationProgramStatus::PendingUserAction => "PENDING_USER_ACTION",
...
"CONVERSION_SEVEN_TO_EIGHT_DAYS" => Some(Self::ConversionSevenToEightDays),
...
"CONVERSION_ELEVEN_TO_TWELVE_DAYS" => Some(Self::ConversionElevenToTwelveDays),
"CONVERSION_TWELVE_TO_THIRTEEN_DAYS" => Some(Self::ConversionTwelveToThirteenDays),
"CONVERSION_THIRTEEN_TO_FOURTEEN_DAYS" => Some(Self::ConversionThirteenToFourteenDays),
"CONVERSION_FOURTEEN_TO_TWENTY_ONE_DAYS" => Some(Self::ConversionFourteenToTwentyOneDays),
"CONVERSION_TWENTY_ONE_TO_THIRTY_DAYS" => Some(Self::ConversionTwentyOneToThirtyDays),
"CONVERSION_THIRTY_TO_FORTY_FIVE_DAYS" => Some(Self::ConversionThirtyToFortyFiveDays),
"CONVERSION_FORTY_FIVE_TO_SIXTY_DAYS" => Some(Self::ConversionFortyFiveToSixtyDays),
"CONVERSION_SIXTY_TO_NINETY_DAYS" => Some(Self::ConversionSixtyToNinetyDays),
...
"ADJUSTMENT_SEVEN_TO_EIGHT_DAYS" => Some(Self::AdjustmentSevenToEightDays),
...
"ADJUSTMENT_ELEVEN_TO_TWELVE_DAYS" => Some(Self::AdjustmentElevenToTwelveDays),
"ADJUSTMENT_TWELVE_TO_THIRTEEN_DAYS" => Some(Self::AdjustmentTwelveToThirteenDays),
"ADJUSTMENT_THIRTEEN_TO_FOURTEEN_DAYS" => Some(Self::AdjustmentThirteenToFourteenDays),
"ADJUSTMENT_FOURTEEN_TO_TWENTY_ONE_DAYS" => Some(Self::AdjustmentFourteenToTwentyOneDays),
"ADJUSTMENT_TWENTY_ONE_TO_THIRTY_DAYS" => Some(Self::AdjustmentTwentyOneToThirtyDays),
"ADJUSTMENT_THIRTY_TO_FORTY_FIVE_DAYS" => Some(Self::AdjustmentThirtyToFortyFiveDays),
"ADJUSTMENT_FORTY_FIVE_TO_SIXTY_DAYS" => Some(Self::AdjustmentFortyFiveToSixtyDays),
"ADJUSTMENT_SIXTY_TO_NINETY_DAYS" => Some(Self::AdjustmentSixtyToNinetyDays),
"ADJUSTMENT_NINETY_TO_ONE_HUNDRED_AND_FORTY_FIVE_DAYS" => Some(Self::AdjustmentNinetyToOneHundredAndFortyFiveDays),
...
ResourceLimitType::RuleBasedUserListsPerCustomer => "RULE_BASED_USER_LISTS_PER_CUSTOMER",
...
ResourceLimitType::AdImageCampaignAssetsPerCampaign => "AD_IMAGE_CAMPAIGN_ASSETS_PER_CAMPAIGN",
ResourceLimitType::AdImageAdGroupAssetsPerAdGroup => "AD_IMAGE_AD_GROUP_ASSETS_PER_AD_GROUP",
ResourceLimitType::PageFeedAssetSetsPerCustomer => "PAGE_FEED_ASSET_SETS_PER_CUSTOMER",
ResourceLimitType::DynamicEducationFeedAssetSetsPerCustomer => "DYNAMIC_EDUCATION_FEED_ASSET_SETS_PER_CUSTOMER",
ResourceLimitType::AssetsPerPageFeedAssetSet => "ASSETS_PER_PAGE_FEED_ASSET_SET",
ResourceLimitType::AssetsPerDynamicEducationFeedAssetSet => "ASSETS_PER_DYNAMIC_EDUCATION_FEED_ASSET_SET",
ResourceLimitType::DynamicRealEstateAssetSetsPerCustomer => "DYNAMIC_REAL_ESTATE_ASSET_SETS_PER_CUSTOMER",
ResourceLimitType::AssetsPerDynamicRealEstateAssetSet => "ASSETS_PER_DYNAMIC_REAL_ESTATE_ASSET_SET",
ResourceLimitType::DynamicCustomAssetSetsPerCustomer => "DYNAMIC_CUSTOM_ASSET_SETS_PER_CUSTOMER",
ResourceLimitType::AssetsPerDynamicCustomAssetSet => "ASSETS_PER_DYNAMIC_CUSTOM_ASSET_SET",
ResourceLimitType::DynamicHotelsAndRentalsAssetSetsPerCustomer => "DYNAMIC_HOTELS_AND_RENTALS_ASSET_SETS_PER_CUSTOMER",
ResourceLimitType::AssetsPerDynamicHotelsAndRentalsAssetSet => "ASSETS_PER_DYNAMIC_HOTELS_AND_RENTALS_ASSET_SET",
ResourceLimitType::DynamicLocalAssetSetsPerCustomer => "DYNAMIC_LOCAL_ASSET_SETS_PER_CUSTOMER",
ResourceLimitType::AssetsPerDynamicLocalAssetSet => "ASSETS_PER_DYNAMIC_LOCAL_ASSET_SET",
ResourceLimitType::DynamicFlightsAssetSetsPerCustomer => "DYNAMIC_FLIGHTS_ASSET_SETS_PER_CUSTOMER",
ResourceLimitType::AssetsPerDynamicFlightsAssetSet => "ASSETS_PER_DYNAMIC_FLIGHTS_ASSET_SET",
ResourceLimitType::DynamicTravelAssetSetsPerCustomer => "DYNAMIC_TRAVEL_ASSET_SETS_PER_CUSTOMER",
ResourceLimitType::AssetsPerDynamicTravelAssetSet => "ASSETS_PER_DYNAMIC_TRAVEL_ASSET_SET",
ResourceLimitType::DynamicJobsAssetSetsPerCustomer => "DYNAMIC_JOBS_ASSET_SETS_PER_CUSTOMER",
ResourceLimitType::AssetsPerDynamicJobsAssetSet => "ASSETS_PER_DYNAMIC_JOBS_ASSET_SET",
ResourceLimitType::BusinessNameCampaignAssetsPerCampaign => "BUSINESS_NAME_CAMPAIGN_ASSETS_PER_CAMPAIGN",
ResourceLimitType::BusinessLogoCampaignAssetsPerCampaign => "BUSINESS_LOGO_CAMPAIGN_ASSETS_PER_CAMPAIGN",
...
ResourceLimitType::SharedSetsPerAccountForAccountLevelNegativeKeywords => "SHARED_SETS_PER_ACCOUNT_FOR_ACCOUNT_LEVEL_NEGATIVE_KEYWORDS",
ResourceLimitType::AccountLevelNegativeKeywordsPerSharedSet => "ACCOUNT_LEVEL_NEGATIVE_KEYWORDS_PER_SHARED_SET",
ResourceLimitType::EnabledAssetPerHotelPropertyAssetSet => "ENABLED_ASSET_PER_HOTEL_PROPERTY_ASSET_SET",
ResourceLimitType::EnabledHotelPropertyAssetLinksPerAssetGroup => "ENABLED_HOTEL_PROPERTY_ASSET_LINKS_PER_ASSET_GROUP",
ResourceLimitType::BrandsPerSharedSet => "BRANDS_PER_SHARED_SET",
ResourceLimitType::EnabledBrandListCriteriaPerCampaign => "ENABLED_BRAND_LIST_CRITERIA_PER_CAMPAIGN",
ResourceLimitType::SharedSetsPerAccountForBrand => "SHARED_SETS_PER_ACCOUNT_FOR_BRAND",
ResourceLimitType::LookalikeUserListsPerCustomer => "LOOKALIKE_USER_LISTS_PER_CUSTOMER",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"EXPERIMENT_CAMPAIGNS_PER_CUSTOMER" => Some(Self::ExperimentCampaignsPerCustomer),
"HOTEL_CAMPAIGNS_PER_CUSTOMER" => Some(Self::HotelCampaignsPerCustomer),
"SMART_SHOPPING_CAMPAIGNS_PER_CUSTOMER" => Some(Self::SmartShoppingCampaignsPerCustomer),
"AD_GROUPS_PER_CAMPAIGN" => Some(Self::AdGroupsPerCampaign),
"AD_GROUPS_PER_SHOPPING_CAMPAIGN" => Some(Self::AdGroupsPerShoppingCampaign),
"AD_GROUPS_PER_HOTEL_CAMPAIGN" => Some(Self::AdGroupsPerHotelCampaign),
"REPORTING_AD_GROUPS_PER_LOCAL_CAMPAIGN" => Some(Self::ReportingAdGroupsPerLocalCampaign),
"REPORTING_AD_GROUPS_PER_APP_CAMPAIGN" => Some(Self::ReportingAdGroupsPerAppCampaign),
"MANAGED_AD_GROUPS_PER_SMART_CAMPAIGN" => Some(Self::ManagedAdGroupsPerSmartCampaign),
"AD_GROUP_CRITERIA_PER_CUSTOMER" => Some(Self::AdGroupCriteriaPerCustomer),
"BASE_AD_GROUP_CRITERIA_PER_CUSTOMER" => Some(Self::BaseAdGroupCriteriaPerCustomer),
"EXPERIMENT_AD_GROUP_CRITERIA_PER_CUSTOMER" => Some(Self::ExperimentAdGroupCriteriaPerCustomer),
"AD_GROUP_CRITERIA_PER_CAMPAIGN" => Some(Self::AdGroupCriteriaPerCampaign),
"CAMPAIGN_CRITERIA_PER_CUSTOMER" => Some(Self::CampaignCriteriaPerCustomer),
"BASE_CAMPAIGN_CRITERIA_PER_CUSTOMER" => Some(Self::BaseCampaignCriteriaPerCustomer),
"EXPERIMENT_CAMPAIGN_CRITERIA_PER_CUSTOMER" => Some(Self::ExperimentCampaignCriteriaPerCustomer),
"WEBPAGE_CRITERIA_PER_CUSTOMER" => Some(Self::WebpageCriteriaPerCustomer),
"BASE_WEBPAGE_CRITERIA_PER_CUSTOMER" => Some(Self::BaseWebpageCriteriaPerCustomer),
"EXPERIMENT_WEBPAGE_CRITERIA_PER_CUSTOMER" => Some(Self::ExperimentWebpageCriteriaPerCustomer),
"COMBINED_AUDIENCE_CRITERIA_PER_AD_GROUP" => Some(Self::CombinedAudienceCriteriaPerAdGroup),
"CUSTOMER_NEGATIVE_PLACEMENT_CRITERIA_PER_CUSTOMER" => Some(Self::CustomerNegativePlacementCriteriaPerCustomer),
"CUSTOMER_NEGATIVE_YOUTUBE_CHANNEL_CRITERIA_PER_CUSTOMER" => Some(Self::CustomerNegativeYoutubeChannelCriteriaPerCustomer),
"CRITERIA_PER_AD_GROUP" => Some(Self::CriteriaPerAdGroup),
"LISTING_GROUPS_PER_AD_GROUP" => Some(Self::ListingGroupsPerAdGroup),
"EXPLICITLY_SHARED_BUDGETS_PER_CUSTOMER" => Some(Self::ExplicitlySharedBudgetsPerCustomer),
"IMPLICITLY_SHARED_BUDGETS_PER_CUSTOMER" => Some(Self::ImplicitlySharedBudgetsPerCustomer),
"COMBINED_AUDIENCE_CRITERIA_PER_CAMPAIGN" => Some(Self::CombinedAudienceCriteriaPerCampaign),
"NEGATIVE_KEYWORDS_PER_CAMPAIGN" => Some(Self::NegativeKeywordsPerCampaign),
"NEGATIVE_PLACEMENTS_PER_CAMPAIGN" => Some(Self::NegativePlacementsPerCampaign),
"GEO_TARGETS_PER_CAMPAIGN" => Some(Self::GeoTargetsPerCampaign),
"NEGATIVE_IP_BLOCKS_PER_CAMPAIGN" => Some(Self::NegativeIpBlocksPerCampaign),
"PROXIMITIES_PER_CAMPAIGN" => Some(Self::ProximitiesPerCampaign),
"LISTING_SCOPES_PER_SHOPPING_CAMPAIGN" => Some(Self::ListingScopesPerShoppingCampaign),
"LISTING_SCOPES_PER_NON_SHOPPING_CAMPAIGN" => Some(Self::ListingScopesPerNonShoppingCampaign),
"NEGATIVE_KEYWORDS_PER_SHARED_SET" => Some(Self::NegativeKeywordsPerSharedSet),
"NEGATIVE_PLACEMENTS_PER_SHARED_SET" => Some(Self::NegativePlacementsPerSharedSet),
"SHARED_SETS_PER_CUSTOMER_FOR_TYPE_DEFAULT" => Some(Self::SharedSetsPerCustomerForTypeDefault),
"SHARED_SETS_PER_CUSTOMER_FOR_NEGATIVE_PLACEMENT_LIST_LOWER" => Some(Self::SharedSetsPerCustomerForNegativePlacementListLower),
"HOTEL_ADVANCE_BOOKING_WINDOW_BID_MODIFIERS_PER_AD_GROUP" => Some(Self::HotelAdvanceBookingWindowBidModifiersPerAdGroup),
"BIDDING_STRATEGIES_PER_CUSTOMER" => Some(Self::BiddingStrategiesPerCustomer),
"BASIC_USER_LISTS_PER_CUSTOMER" => Some(Self::BasicUserListsPerCustomer),
"LOGICAL_USER_LISTS_PER_CUSTOMER" => Some(Self::LogicalUserListsPerCustomer),
"RULE_BASED_USER_LISTS_PER_CUSTOMER" => Some(Self::RuleBasedUserListsPerCustomer),
"BASE_AD_GROUP_ADS_PER_CUSTOMER" => Some(Self::BaseAdGroupAdsPerCustomer),
"EXPERIMENT_AD_GROUP_ADS_PER_CUSTOMER" => Some(Self::ExperimentAdGroupAdsPerCustomer),
"AD_GROUP_ADS_PER_CAMPAIGN" => Some(Self::AdGroupAdsPerCampaign),
"TEXT_AND_OTHER_ADS_PER_AD_GROUP" => Some(Self::TextAndOtherAdsPerAdGroup),
"IMAGE_ADS_PER_AD_GROUP" => Some(Self::ImageAdsPerAdGroup),
"SHOPPING_SMART_ADS_PER_AD_GROUP" => Some(Self::ShoppingSmartAdsPerAdGroup),
"RESPONSIVE_SEARCH_ADS_PER_AD_GROUP" => Some(Self::ResponsiveSearchAdsPerAdGroup),
"APP_ADS_PER_AD_GROUP" => Some(Self::AppAdsPerAdGroup),
"APP_ENGAGEMENT_ADS_PER_AD_GROUP" => Some(Self::AppEngagementAdsPerAdGroup),
"LOCAL_ADS_PER_AD_GROUP" => Some(Self::LocalAdsPerAdGroup),
"VIDEO_ADS_PER_AD_GROUP" => Some(Self::VideoAdsPerAdGroup),
"LEAD_FORM_CAMPAIGN_ASSETS_PER_CAMPAIGN" => Some(Self::LeadFormCampaignAssetsPerCampaign),
"PROMOTION_CUSTOMER_ASSETS_PER_CUSTOMER" => Some(Self::PromotionCustomerAssetsPerCustomer),
"PROMOTION_CAMPAIGN_ASSETS_PER_CAMPAIGN" => Some(Self::PromotionCampaignAssetsPerCampaign),
"PROMOTION_AD_GROUP_ASSETS_PER_AD_GROUP" => Some(Self::PromotionAdGroupAssetsPerAdGroup),
"CALLOUT_CUSTOMER_ASSETS_PER_CUSTOMER" => Some(Self::CalloutCustomerAssetsPerCustomer),
"CALLOUT_CAMPAIGN_ASSETS_PER_CAMPAIGN" => Some(Self::CalloutCampaignAssetsPerCampaign),
"CALLOUT_AD_GROUP_ASSETS_PER_AD_GROUP" => Some(Self::CalloutAdGroupAssetsPerAdGroup),
"SITELINK_CUSTOMER_ASSETS_PER_CUSTOMER" => Some(Self::SitelinkCustomerAssetsPerCustomer),
"SITELINK_CAMPAIGN_ASSETS_PER_CAMPAIGN" => Some(Self::SitelinkCampaignAssetsPerCampaign),
"SITELINK_AD_GROUP_ASSETS_PER_AD_GROUP" => Some(Self::SitelinkAdGroupAssetsPerAdGroup),
"STRUCTURED_SNIPPET_CUSTOMER_ASSETS_PER_CUSTOMER" => Some(Self::StructuredSnippetCustomerAssetsPerCustomer),
"STRUCTURED_SNIPPET_CAMPAIGN_ASSETS_PER_CAMPAIGN" => Some(Self::StructuredSnippetCampaignAssetsPerCampaign),
"STRUCTURED_SNIPPET_AD_GROUP_ASSETS_PER_AD_GROUP" => Some(Self::StructuredSnippetAdGroupAssetsPerAdGroup),
"MOBILE_APP_CUSTOMER_ASSETS_PER_CUSTOMER" => Some(Self::MobileAppCustomerAssetsPerCustomer),
"MOBILE_APP_CAMPAIGN_ASSETS_PER_CAMPAIGN" => Some(Self::MobileAppCampaignAssetsPerCampaign),
"MOBILE_APP_AD_GROUP_ASSETS_PER_AD_GROUP" => Some(Self::MobileAppAdGroupAssetsPerAdGroup),
"HOTEL_CALLOUT_CUSTOMER_ASSETS_PER_CUSTOMER" => Some(Self::HotelCalloutCustomerAssetsPerCustomer),
"HOTEL_CALLOUT_CAMPAIGN_ASSETS_PER_CAMPAIGN" => Some(Self::HotelCalloutCampaignAssetsPerCampaign),
"HOTEL_CALLOUT_AD_GROUP_ASSETS_PER_AD_GROUP" => Some(Self::HotelCalloutAdGroupAssetsPerAdGroup),
"CALL_CUSTOMER_ASSETS_PER_CUSTOMER" => Some(Self::CallCustomerAssetsPerCustomer),
"CALL_CAMPAIGN_ASSETS_PER_CAMPAIGN" => Some(Self::CallCampaignAssetsPerCampaign),
"CALL_AD_GROUP_ASSETS_PER_AD_GROUP" => Some(Self::CallAdGroupAssetsPerAdGroup),
"PRICE_CUSTOMER_ASSETS_PER_CUSTOMER" => Some(Self::PriceCustomerAssetsPerCustomer),
"PRICE_CAMPAIGN_ASSETS_PER_CAMPAIGN" => Some(Self::PriceCampaignAssetsPerCampaign),
"PRICE_AD_GROUP_ASSETS_PER_AD_GROUP" => Some(Self::PriceAdGroupAssetsPerAdGroup),
"AD_IMAGE_CAMPAIGN_ASSETS_PER_CAMPAIGN" => Some(Self::AdImageCampaignAssetsPerCampaign),
"AD_IMAGE_AD_GROUP_ASSETS_PER_AD_GROUP" => Some(Self::AdImageAdGroupAssetsPerAdGroup),
"PAGE_FEED_ASSET_SETS_PER_CUSTOMER" => Some(Self::PageFeedAssetSetsPerCustomer),
"DYNAMIC_EDUCATION_FEED_ASSET_SETS_PER_CUSTOMER" => Some(Self::DynamicEducationFeedAssetSetsPerCustomer),
"ASSETS_PER_PAGE_FEED_ASSET_SET" => Some(Self::AssetsPerPageFeedAssetSet),
"ASSETS_PER_DYNAMIC_EDUCATION_FEED_ASSET_SET" => Some(Self::AssetsPerDynamicEducationFeedAssetSet),
"DYNAMIC_REAL_ESTATE_ASSET_SETS_PER_CUSTOMER" => Some(Self::DynamicRealEstateAssetSetsPerCustomer),
"ASSETS_PER_DYNAMIC_REAL_ESTATE_ASSET_SET" => Some(Self::AssetsPerDynamicRealEstateAssetSet),
"DYNAMIC_CUSTOM_ASSET_SETS_PER_CUSTOMER" => Some(Self::DynamicCustomAssetSetsPerCustomer),
"ASSETS_PER_DYNAMIC_CUSTOM_ASSET_SET" => Some(Self::AssetsPerDynamicCustomAssetSet),
"DYNAMIC_HOTELS_AND_RENTALS_ASSET_SETS_PER_CUSTOMER" => Some(Self::DynamicHotelsAndRentalsAssetSetsPerCustomer),
"ASSETS_PER_DYNAMIC_HOTELS_AND_RENTALS_ASSET_SET" => Some(Self::AssetsPerDynamicHotelsAndRentalsAssetSet),
"DYNAMIC_LOCAL_ASSET_SETS_PER_CUSTOMER" => Some(Self::DynamicLocalAssetSetsPerCustomer),
"ASSETS_PER_DYNAMIC_LOCAL_ASSET_SET" => Some(Self::AssetsPerDynamicLocalAssetSet),
"DYNAMIC_FLIGHTS_ASSET_SETS_PER_CUSTOMER" => Some(Self::DynamicFlightsAssetSetsPerCustomer),
"ASSETS_PER_DYNAMIC_FLIGHTS_ASSET_SET" => Some(Self::AssetsPerDynamicFlightsAssetSet),
"DYNAMIC_TRAVEL_ASSET_SETS_PER_CUSTOMER" => Some(Self::DynamicTravelAssetSetsPerCustomer),
"ASSETS_PER_DYNAMIC_TRAVEL_ASSET_SET" => Some(Self::AssetsPerDynamicTravelAssetSet),
"DYNAMIC_JOBS_ASSET_SETS_PER_CUSTOMER" => Some(Self::DynamicJobsAssetSetsPerCustomer),
"ASSETS_PER_DYNAMIC_JOBS_ASSET_SET" => Some(Self::AssetsPerDynamicJobsAssetSet),
"BUSINESS_NAME_CAMPAIGN_ASSETS_PER_CAMPAIGN" => Some(Self::BusinessNameCampaignAssetsPerCampaign),
"BUSINESS_LOGO_CAMPAIGN_ASSETS_PER_CAMPAIGN" => Some(Self::BusinessLogoCampaignAssetsPerCampaign),
...
"BASE_CAMPAIGN_FEEDS_PER_CUSTOMER" => Some(Self::BaseCampaignFeedsPerCustomer),
"EXPERIMENT_CAMPAIGN_FEEDS_PER_CUSTOMER" => Some(Self::ExperimentCampaignFeedsPerCustomer),
"AD_GROUP_FEEDS_PER_CUSTOMER" => Some(Self::AdGroupFeedsPerCustomer),
"BASE_AD_GROUP_FEEDS_PER_CUSTOMER" => Some(Self::BaseAdGroupFeedsPerCustomer),
"EXPERIMENT_AD_GROUP_FEEDS_PER_CUSTOMER" => Some(Self::ExperimentAdGroupFeedsPerCustomer),
...
"CAMPAIGN_EXPERIMENTS_PER_CUSTOMER" => Some(Self::CampaignExperimentsPerCustomer),
"EXPERIMENT_ARMS_PER_VIDEO_EXPERIMENT" => Some(Self::ExperimentArmsPerVideoExperiment),
...
"KEYWORD_PLANS_PER_USER_PER_CUSTOMER" => Some(Self::KeywordPlansPerUserPerCustomer),
"KEYWORD_PLAN_AD_GROUP_KEYWORDS_PER_KEYWORD_PLAN" => Some(Self::KeywordPlanAdGroupKeywordsPerKeywordPlan),
"KEYWORD_PLAN_AD_GROUPS_PER_KEYWORD_PLAN" => Some(Self::KeywordPlanAdGroupsPerKeywordPlan),
"KEYWORD_PLAN_NEGATIVE_KEYWORDS_PER_KEYWORD_PLAN" => Some(Self::KeywordPlanNegativeKeywordsPerKeywordPlan),
"KEYWORD_PLAN_CAMPAIGNS_PER_KEYWORD_PLAN" => Some(Self::KeywordPlanCampaignsPerKeywordPlan),
"CONVERSION_ACTIONS_PER_CUSTOMER" => Some(Self::ConversionActionsPerCustomer),
"BATCH_JOB_OPERATIONS_PER_JOB" => Some(Self::BatchJobOperationsPerJob),
"BATCH_JOBS_PER_CUSTOMER" => Some(Self::BatchJobsPerCustomer),
"HOTEL_CHECK_IN_DATE_RANGE_BID_MODIFIERS_PER_AD_GROUP" => Some(Self::HotelCheckInDateRangeBidModifiersPerAdGroup),
"SHARED_SETS_PER_ACCOUNT_FOR_ACCOUNT_LEVEL_NEGATIVE_KEYWORDS" => Some(Self::SharedSetsPerAccountForAccountLevelNegativeKeywords),
"ACCOUNT_LEVEL_NEGATIVE_KEYWORDS_PER_SHARED_SET" => Some(Self::AccountLevelNegativeKeywordsPerSharedSet),
"ENABLED_ASSET_PER_HOTEL_PROPERTY_ASSET_SET" => Some(Self::EnabledAssetPerHotelPropertyAssetSet),
"ENABLED_HOTEL_PROPERTY_ASSET_LINKS_PER_ASSET_GROUP" => Some(Self::EnabledHotelPropertyAssetLinksPerAssetGroup),
"BRANDS_PER_SHARED_SET" => Some(Self::BrandsPerSharedSet),
"ENABLED_BRAND_LIST_CRITERIA_PER_CAMPAIGN" => Some(Self::EnabledBrandListCriteriaPerCampaign),
"SHARED_SETS_PER_ACCOUNT_FOR_BRAND" => Some(Self::SharedSetsPerAccountForBrand),
"LOOKALIKE_USER_LISTS_PER_CUSTOMER" => Some(Self::LookalikeUserListsPerCustomer),
_ => None,
}
}
}
...
ExternalConversionSource::DisplayAndVideo360Floodlight => "DISPLAY_AND_VIDEO_360_FLOODLIGHT",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"DISPLAY_AND_VIDEO_360_FLOODLIGHT" => Some(Self::DisplayAndVideo360Floodlight),
_ => None,
}
}
}
...
"YOUTUBE_AND_GOOGLE_VIDEO_PARTNERS" => Some(Self::YoutubeAndGoogleVideoPartners),
_ => None,
}
}
}
...
AudienceInsightsDimension::YoutubeDynamicLineup => "YOUTUBE_DYNAMIC_LINEUP",
AudienceInsightsDimension::AffinityUserInterest => "AFFINITY_USER_INTEREST",
AudienceInsightsDimension::InMarketUserInterest => "IN_MARKET_USER_INTEREST",
...
pub fn as_str_name(&self) -> &'static str {
match self {
ConvertingUserPriorEngagementTypeAndLtvBucket::Unspecified => "UNSPECIFIED",
...
ConvertingUserPriorEngagementTypeAndLtvBucket::NewAndHighLtv => "NEW_AND_HIGH_LTV",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
