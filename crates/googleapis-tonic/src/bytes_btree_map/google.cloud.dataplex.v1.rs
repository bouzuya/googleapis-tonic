...
pub mod dataplex_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::ListLakesResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
        ...
        ) -> std::result::Result<tonic::Response<super::ListActionsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
...
pub mod data_taxonomy_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::ListDataTaxonomiesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::DataAttributeBinding>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::ListDataAttributesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
...
pub mod catalog_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::ListEntryTypesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::ListAspectTypesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::SearchEntriesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
...
pub struct DataProfileResult {
    ...
    pub post_scan_actions_result:
        ::core::option::Option<data_profile_result::PostScanActionsResult>,
}
...
pub mod data_profile_result {
    ...
    pub struct PostScanActionsResult {
        ...
        pub bigquery_export_result:
            ::core::option::Option<post_scan_actions_result::BigQueryExportResult>,
    }
...
pub mod metadata_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::ListEntitiesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
...
pub struct DataQualityResult {
    ...
    #[prost(message, optional, tag = "8")]
    pub post_scan_actions_result:
        ::core::option::Option<data_quality_result::PostScanActionsResult>,
}
...
pub mod data_quality_rule {
    ...
    pub struct StatisticRangeExpectation {
        #[prost(
            enumeration = "statistic_range_expectation::ColumnStatistic",
            tag = "1"
        )]
        pub statistic: i32,
        #[prost(string, tag = "2")]
...
pub mod data_scan_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::ListDataScansResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::RunDataScanResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::ListDataScanJobsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
...
pub mod data_scan_event {
    ...
    pub struct DataQualityResult {
        ...
        pub dimension_passed:
            ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, bool>,
        #[prost(float, tag = "4")]
        pub score: f32,
        #[prost(btree_map = "string, float", tag = "5")]
        pub dimension_score:
            ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, f32>,
...
pub struct DataQualityScanRuleResult {
    ...
    pub rule_type: i32,
    #[prost(
        enumeration = "data_quality_scan_rule_result::EvaluationType",
        tag = "6"
    )]
