...
match self {
ReconciliationDecisionType::Unspecified => "RECONCILIATION_DECISION_TYPE_UNSPECIFIED",
ReconciliationDecisionType::ReconciliationTerminateSession => "RECONCILIATION_TERMINATE_SESSION",
}
}
...
"RECONCILIATION_TERMINATE_SESSION" => Some(Self::ReconciliationTerminateSession),
_ => None,
}
}
}
...
ConstrainingFactor::SecondaryScaledownSingleRequestLimitReached => "SECONDARY_SCALEDOWN_SINGLE_REQUEST_LIMIT_REACHED",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"SCALING_CAPPED_DUE_TO_LACK_OF_QUOTA" => Some(Self::ScalingCappedDueToLackOfQuota),
...
"SECONDARY_SCALEDOWN_SINGLE_REQUEST_LIMIT_REACHED" => Some(Self::SecondaryScaledownSingleRequestLimitReached),
_ => None,
}
}
}
