...
RequestError::LoginOrLinkedCustomerIdParameterRequired => "LOGIN_OR_LINKED_CUSTOMER_ID_PARAMETER_REQUIRED",
...
"LOGIN_OR_LINKED_CUSTOMER_ID_PARAMETER_REQUIRED" => Some(Self::LoginOrLinkedCustomerIdParameterRequired),
...
#[prost(oneof = "error_code::ErrorCode", tags = "1, 5, 9, 10, 11, 17, 33, 34, 35, 66, 118, 144, 175")]
...
SizeLimitError(i32),
#[prost(enumeration = "super::custom_column_error_enum::CustomColumnError", tag = "144")]
CustomColumnError(i32),
#[prost(enumeration = "super::invalid_parameter_error_enum::InvalidParameterError", tag = "175")]
