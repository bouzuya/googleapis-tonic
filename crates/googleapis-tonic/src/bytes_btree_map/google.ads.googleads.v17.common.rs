...
pub struct AdVideoAssetInfo {
    #[prost(message, optional, tag = "1")]
    pub ad_video_asset_inventory_preferences:
        ::core::option::Option<AdVideoAssetInventoryPreferences>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
...
pub struct BusinessProfileLocationGroup {
    #[prost(message, optional, tag = "1")]
    pub dynamic_business_profile_location_group_filter:
        ::core::option::Option<DynamicBusinessProfileLocationGroupFilter>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct Consent {
    #[prost(
        enumeration = "super::enums::consent_status_enum::ConsentStatus",
        tag = "1"
    )]
...
pub struct Metrics {
    ...
    pub sample_learning_performance_entities:
        ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
    #[prost(string, repeated, tag = "347")]
    pub sample_unrated_performance_entities:
        ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
