...
pub struct IngestConversationsRequest {
    ...
    pub conversation_config:
        ::core::option::Option<ingest_conversations_request::ConversationConfig>,
    #[prost(message, optional, tag = "5")]
    pub redaction_config: ::core::option::Option<RedactionConfig>,
    #[prost(message, optional, tag = "6")]
    pub speech_config: ::core::option::Option<SpeechConfig>,
...
pub struct IngestConversationsMetadata {
    ...
    pub ingest_conversations_stats:
        ::core::option::Option<ingest_conversations_metadata::IngestConversationsStats>,
}
...
pub mod contact_center_insights_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::ListIssueModelsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::ListIssuesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::ListPhraseMatchersResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::CalculateStatsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> std::result::Result<tonic::Response<super::ListViewsResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
