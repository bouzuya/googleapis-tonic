...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> RecaptchaEnterpriseServiceV1Beta1Client<InterceptedService<T, F>>
where
...
{
RecaptchaEnterpriseServiceV1Beta1Client::new(InterceptedService::new(inner, interceptor))
}
...
req.extensions_mut().insert(GrpcMethod::new("google.cloud.recaptchaenterprise.v1beta1.RecaptchaEnterpriseServiceV1Beta1", "CreateAssessment"));
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.recaptchaenterprise.v1beta1.RecaptchaEnterpriseServiceV1Beta1", "AnnotateAssessment"));
self.inner.unary(req, path, codec).await
}
}
}
