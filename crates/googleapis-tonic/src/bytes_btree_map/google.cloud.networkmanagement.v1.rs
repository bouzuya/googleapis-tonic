...
#[prost(oneof = "step::StepInfo", tags = "5, 6, 7, 8, 24, 9, 10, 11, 21, 12, 13, 14, 15, 16, 17, 18, 19, 20, 22, 23, 25, 26, 27, 28")]
...
"START_FROM_PSC_PUBLISHED_SERVICE" => Some(Self::StartFromPscPublishedService),
...
"ARRIVE_AT_INTERNAL_LOAD_BALANCER" => Some(Self::ArriveAtInternalLoadBalancer),
"ARRIVE_AT_EXTERNAL_LOAD_BALANCER" => Some(Self::ArriveAtExternalLoadBalancer),
...
FirewallRuleType::ServerlessVpcAccessManagedFirewallRule => "SERVERLESS_VPC_ACCESS_MANAGED_FIREWALL_RULE",
FirewallRuleType::NetworkFirewallPolicyRule => "NETWORK_FIREWALL_POLICY_RULE",
FirewallRuleType::NetworkRegionalFirewallPolicyRule => "NETWORK_REGIONAL_FIREWALL_POLICY_RULE",
FirewallRuleType::UnsupportedFirewallPolicyRule => "UNSUPPORTED_FIREWALL_POLICY_RULE",
...
"HIERARCHICAL_FIREWALL_POLICY_RULE" => Some(Self::HierarchicalFirewallPolicyRule),
"VPC_FIREWALL_RULE" => Some(Self::VpcFirewallRule),
"IMPLIED_VPC_FIREWALL_RULE" => Some(Self::ImpliedVpcFirewallRule),
"SERVERLESS_VPC_ACCESS_MANAGED_FIREWALL_RULE" => Some(Self::ServerlessVpcAccessManagedFirewallRule),
"NETWORK_FIREWALL_POLICY_RULE" => Some(Self::NetworkFirewallPolicyRule),
"NETWORK_REGIONAL_FIREWALL_POLICY_RULE" => Some(Self::NetworkRegionalFirewallPolicyRule),
"UNSUPPORTED_FIREWALL_POLICY_RULE" => Some(Self::UnsupportedFirewallPolicyRule),
...
GoogleServiceType::GfeProxyOrHealthCheckProber => "GFE_PROXY_OR_HEALTH_CHECK_PROBER",
...
"IAP" => Some(Self::Iap),
"GFE_PROXY_OR_HEALTH_CHECK_PROBER" => Some(Self::GfeProxyOrHealthCheckProber),
...
"GKE_MASTER" => Some(Self::GkeMaster),
"IMPORTED_CUSTOM_ROUTE_NEXT_HOP" => Some(Self::ImportedCustomRouteNextHop),
"CLOUD_SQL_INSTANCE" => Some(Self::CloudSqlInstance),
...
Cause::SourceIpAddressNotInSourceNetwork => "SOURCE_IP_ADDRESS_NOT_IN_SOURCE_NETWORK",
Cause::PermissionDenied => "PERMISSION_DENIED",
Cause::PermissionDeniedNoCloudNatConfigs => "PERMISSION_DENIED_NO_CLOUD_NAT_CONFIGS",
Cause::PermissionDeniedNoNegEndpointConfigs => "PERMISSION_DENIED_NO_NEG_ENDPOINT_CONFIGS",
...
Cause::GkeKonnectivityProxyUnsupported => "GKE_KONNECTIVITY_PROXY_UNSUPPORTED",
...
Cause::GoogleManagedServiceAmbiguousPscEndpoint => "GOOGLE_MANAGED_SERVICE_AMBIGUOUS_PSC_ENDPOINT",
Cause::SourcePscCloudSqlUnsupported => "SOURCE_PSC_CLOUD_SQL_UNSUPPORTED",
Cause::SourceForwardingRuleUnsupported => "SOURCE_FORWARDING_RULE_UNSUPPORTED",
Cause::NonRoutableIpAddress => "NON_ROUTABLE_IP_ADDRESS",
Cause::UnknownIssueInGoogleManagedProject => "UNKNOWN_ISSUE_IN_GOOGLE_MANAGED_PROJECT",
Cause::UnsupportedGoogleManagedProjectConfig => "UNSUPPORTED_GOOGLE_MANAGED_PROJECT_CONFIG",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"DESTINATION_ENDPOINT_NOT_FOUND" => Some(Self::DestinationEndpointNotFound),
"MISMATCHED_DESTINATION_NETWORK" => Some(Self::MismatchedDestinationNetwork),
"UNKNOWN_IP" => Some(Self::UnknownIp),
"SOURCE_IP_ADDRESS_NOT_IN_SOURCE_NETWORK" => Some(Self::SourceIpAddressNotInSourceNetwork),
"PERMISSION_DENIED" => Some(Self::PermissionDenied),
"PERMISSION_DENIED_NO_CLOUD_NAT_CONFIGS" => Some(Self::PermissionDeniedNoCloudNatConfigs),
"PERMISSION_DENIED_NO_NEG_ENDPOINT_CONFIGS" => Some(Self::PermissionDeniedNoNegEndpointConfigs),
...
"GKE_KONNECTIVITY_PROXY_UNSUPPORTED" => Some(Self::GkeKonnectivityProxyUnsupported),
...
"GOOGLE_MANAGED_SERVICE_AMBIGUOUS_PSC_ENDPOINT" => Some(Self::GoogleManagedServiceAmbiguousPscEndpoint),
"SOURCE_PSC_CLOUD_SQL_UNSUPPORTED" => Some(Self::SourcePscCloudSqlUnsupported),
"SOURCE_FORWARDING_RULE_UNSUPPORTED" => Some(Self::SourceForwardingRuleUnsupported),
"NON_ROUTABLE_IP_ADDRESS" => Some(Self::NonRoutableIpAddress),
"UNKNOWN_ISSUE_IN_GOOGLE_MANAGED_PROJECT" => Some(Self::UnknownIssueInGoogleManagedProject),
"UNSUPPORTED_GOOGLE_MANAGED_PROJECT_CONFIG" => Some(Self::UnsupportedGoogleManagedProjectConfig),
_ => None,
}
}
}
...
Cause::RouteNextHopIpAddressNotResolved => "ROUTE_NEXT_HOP_IP_ADDRESS_NOT_RESOLVED",
Cause::RouteNextHopResourceNotFound => "ROUTE_NEXT_HOP_RESOURCE_NOT_FOUND",
Cause::RouteNextHopInstanceWrongNetwork => "ROUTE_NEXT_HOP_INSTANCE_WRONG_NETWORK",
Cause::RouteNextHopInstanceNonPrimaryIp => "ROUTE_NEXT_HOP_INSTANCE_NON_PRIMARY_IP",
Cause::RouteNextHopForwardingRuleIpMismatch => "ROUTE_NEXT_HOP_FORWARDING_RULE_IP_MISMATCH",
Cause::RouteNextHopVpnTunnelNotEstablished => "ROUTE_NEXT_HOP_VPN_TUNNEL_NOT_ESTABLISHED",
Cause::RouteNextHopForwardingRuleTypeInvalid => "ROUTE_NEXT_HOP_FORWARDING_RULE_TYPE_INVALID",
Cause::NoRouteFromInternetToPrivateIpv6Address => "NO_ROUTE_FROM_INTERNET_TO_PRIVATE_IPV6_ADDRESS",
Cause::VpnTunnelLocalSelectorMismatch => "VPN_TUNNEL_LOCAL_SELECTOR_MISMATCH",
Cause::VpnTunnelRemoteSelectorMismatch => "VPN_TUNNEL_REMOTE_SELECTOR_MISMATCH",
...
Cause::PrivateGoogleAccessViaVpnTunnelUnsupported => "PRIVATE_GOOGLE_ACCESS_VIA_VPN_TUNNEL_UNSUPPORTED",
...
Cause::GoogleManagedServiceNoPscEndpoint => "GOOGLE_MANAGED_SERVICE_NO_PSC_ENDPOINT",
Cause::GkePscEndpointMissing => "GKE_PSC_ENDPOINT_MISSING",
Cause::CloudSqlInstanceNoIpAddress => "CLOUD_SQL_INSTANCE_NO_IP_ADDRESS",
Cause::GkeControlPlaneRegionMismatch => "GKE_CONTROL_PLANE_REGION_MISMATCH",
Cause::PublicGkeControlPlaneToPrivateDestination => "PUBLIC_GKE_CONTROL_PLANE_TO_PRIVATE_DESTINATION",
Cause::GkeControlPlaneNoRoute => "GKE_CONTROL_PLANE_NO_ROUTE",
Cause::CloudSqlInstanceNotConfiguredForExternalTraffic => "CLOUD_SQL_INSTANCE_NOT_CONFIGURED_FOR_EXTERNAL_TRAFFIC",
Cause::PublicCloudSqlInstanceToPrivateDestination => "PUBLIC_CLOUD_SQL_INSTANCE_TO_PRIVATE_DESTINATION",
...
Cause::PscEndpointAccessedFromPeeredNetwork => "PSC_ENDPOINT_ACCESSED_FROM_PEERED_NETWORK",
Cause::PscNegProducerEndpointNoGlobalAccess => "PSC_NEG_PRODUCER_ENDPOINT_NO_GLOBAL_ACCESS",
Cause::PscNegProducerForwardingRuleMultiplePorts => "PSC_NEG_PRODUCER_FORWARDING_RULE_MULTIPLE_PORTS",
Cause::CloudSqlPscNegUnsupported => "CLOUD_SQL_PSC_NEG_UNSUPPORTED",
Cause::NoNatSubnetsForPscServiceAttachment => "NO_NAT_SUBNETS_FOR_PSC_SERVICE_ATTACHMENT",
Cause::HybridNegNonDynamicRouteMatched => "HYBRID_NEG_NON_DYNAMIC_ROUTE_MATCHED",
Cause::HybridNegNonLocalDynamicRouteMatched => "HYBRID_NEG_NON_LOCAL_DYNAMIC_ROUTE_MATCHED",
Cause::CloudRunRevisionNotReady => "CLOUD_RUN_REVISION_NOT_READY",
Cause::DroppedInsidePscServiceProducer => "DROPPED_INSIDE_PSC_SERVICE_PRODUCER",
Cause::LoadBalancerHasNoProxySubnet => "LOAD_BALANCER_HAS_NO_PROXY_SUBNET",
...
"ROUTE_NEXT_HOP_IP_ADDRESS_NOT_RESOLVED" => Some(Self::RouteNextHopIpAddressNotResolved),
"ROUTE_NEXT_HOP_RESOURCE_NOT_FOUND" => Some(Self::RouteNextHopResourceNotFound),
"ROUTE_NEXT_HOP_INSTANCE_WRONG_NETWORK" => Some(Self::RouteNextHopInstanceWrongNetwork),
"ROUTE_NEXT_HOP_INSTANCE_NON_PRIMARY_IP" => Some(Self::RouteNextHopInstanceNonPrimaryIp),
"ROUTE_NEXT_HOP_FORWARDING_RULE_IP_MISMATCH" => Some(Self::RouteNextHopForwardingRuleIpMismatch),
"ROUTE_NEXT_HOP_VPN_TUNNEL_NOT_ESTABLISHED" => Some(Self::RouteNextHopVpnTunnelNotEstablished),
"ROUTE_NEXT_HOP_FORWARDING_RULE_TYPE_INVALID" => Some(Self::RouteNextHopForwardingRuleTypeInvalid),
"NO_ROUTE_FROM_INTERNET_TO_PRIVATE_IPV6_ADDRESS" => Some(Self::NoRouteFromInternetToPrivateIpv6Address),
"VPN_TUNNEL_LOCAL_SELECTOR_MISMATCH" => Some(Self::VpnTunnelLocalSelectorMismatch),
"VPN_TUNNEL_REMOTE_SELECTOR_MISMATCH" => Some(Self::VpnTunnelRemoteSelectorMismatch),
"PRIVATE_TRAFFIC_TO_INTERNET" => Some(Self::PrivateTrafficToInternet),
"PRIVATE_GOOGLE_ACCESS_DISALLOWED" => Some(Self::PrivateGoogleAccessDisallowed),
"PRIVATE_GOOGLE_ACCESS_VIA_VPN_TUNNEL_UNSUPPORTED" => Some(Self::PrivateGoogleAccessViaVpnTunnelUnsupported),
...
"FIREWALL_BLOCKING_LOAD_BALANCER_BACKEND_HEALTH_CHECK" => Some(Self::FirewallBlockingLoadBalancerBackendHealthCheck),
"INSTANCE_NOT_RUNNING" => Some(Self::InstanceNotRunning),
"GKE_CLUSTER_NOT_RUNNING" => Some(Self::GkeClusterNotRunning),
"CLOUD_SQL_INSTANCE_NOT_RUNNING" => Some(Self::CloudSqlInstanceNotRunning),
"TRAFFIC_TYPE_BLOCKED" => Some(Self::TrafficTypeBlocked),
"GKE_MASTER_UNAUTHORIZED_ACCESS" => Some(Self::GkeMasterUnauthorizedAccess),
"CLOUD_SQL_INSTANCE_UNAUTHORIZED_ACCESS" => Some(Self::CloudSqlInstanceUnauthorizedAccess),
"DROPPED_INSIDE_GKE_SERVICE" => Some(Self::DroppedInsideGkeService),
"DROPPED_INSIDE_CLOUD_SQL_SERVICE" => Some(Self::DroppedInsideCloudSqlService),
"GOOGLE_MANAGED_SERVICE_NO_PEERING" => Some(Self::GoogleManagedServiceNoPeering),
"GOOGLE_MANAGED_SERVICE_NO_PSC_ENDPOINT" => Some(Self::GoogleManagedServiceNoPscEndpoint),
"GKE_PSC_ENDPOINT_MISSING" => Some(Self::GkePscEndpointMissing),
"CLOUD_SQL_INSTANCE_NO_IP_ADDRESS" => Some(Self::CloudSqlInstanceNoIpAddress),
"GKE_CONTROL_PLANE_REGION_MISMATCH" => Some(Self::GkeControlPlaneRegionMismatch),
"PUBLIC_GKE_CONTROL_PLANE_TO_PRIVATE_DESTINATION" => Some(Self::PublicGkeControlPlaneToPrivateDestination),
"GKE_CONTROL_PLANE_NO_ROUTE" => Some(Self::GkeControlPlaneNoRoute),
"CLOUD_SQL_INSTANCE_NOT_CONFIGURED_FOR_EXTERNAL_TRAFFIC" => Some(Self::CloudSqlInstanceNotConfiguredForExternalTraffic),
"PUBLIC_CLOUD_SQL_INSTANCE_TO_PRIVATE_DESTINATION" => Some(Self::PublicCloudSqlInstanceToPrivateDestination),
...
"FORWARDING_RULE_REGION_MISMATCH" => Some(Self::ForwardingRuleRegionMismatch),
"PSC_CONNECTION_NOT_ACCEPTED" => Some(Self::PscConnectionNotAccepted),
"PSC_ENDPOINT_ACCESSED_FROM_PEERED_NETWORK" => Some(Self::PscEndpointAccessedFromPeeredNetwork),
"PSC_NEG_PRODUCER_ENDPOINT_NO_GLOBAL_ACCESS" => Some(Self::PscNegProducerEndpointNoGlobalAccess),
"PSC_NEG_PRODUCER_FORWARDING_RULE_MULTIPLE_PORTS" => Some(Self::PscNegProducerForwardingRuleMultiplePorts),
"CLOUD_SQL_PSC_NEG_UNSUPPORTED" => Some(Self::CloudSqlPscNegUnsupported),
"NO_NAT_SUBNETS_FOR_PSC_SERVICE_ATTACHMENT" => Some(Self::NoNatSubnetsForPscServiceAttachment),
"HYBRID_NEG_NON_DYNAMIC_ROUTE_MATCHED" => Some(Self::HybridNegNonDynamicRouteMatched),
"HYBRID_NEG_NON_LOCAL_DYNAMIC_ROUTE_MATCHED" => Some(Self::HybridNegNonLocalDynamicRouteMatched),
"CLOUD_RUN_REVISION_NOT_READY" => Some(Self::CloudRunRevisionNotReady),
"DROPPED_INSIDE_PSC_SERVICE_PRODUCER" => Some(Self::DroppedInsidePscServiceProducer),
"LOAD_BALANCER_HAS_NO_PROXY_SUBNET" => Some(Self::LoadBalancerHasNoProxySubnet),
...
#[prost(string, tag = "6")]
pub health_check_uri: ::prost::alloc::string::String,
#[prost(enumeration = "load_balancer_backend_info::HealthCheckFirewallsConfigState", tag = "7")]
...
pub fn as_str_name(&self) -> &'static str {
match self {
HealthCheckFirewallsConfigState::Unspecified => "HEALTH_CHECK_FIREWALLS_CONFIG_STATE_UNSPECIFIED",
HealthCheckFirewallsConfigState::FirewallsConfigured => "FIREWALLS_CONFIGURED",
HealthCheckFirewallsConfigState::FirewallsPartiallyConfigured => "FIREWALLS_PARTIALLY_CONFIGURED",
HealthCheckFirewallsConfigState::FirewallsNotConfigured => "FIREWALLS_NOT_CONFIGURED",
HealthCheckFirewallsConfigState::FirewallsUnsupported => "FIREWALLS_UNSUPPORTED",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
match value {
"HEALTH_CHECK_FIREWALLS_CONFIG_STATE_UNSPECIFIED" => Some(Self::Unspecified),
"FIREWALLS_CONFIGURED" => Some(Self::FirewallsConfigured),
"FIREWALLS_PARTIALLY_CONFIGURED" => Some(Self::FirewallsPartiallyConfigured),
...
LoadBalancerType::InternalTcpProxyLoadBalancer => "INTERNAL_TCP_PROXY_LOAD_BALANCER",
...
LoadBalancerType::TcpUdpInternalLoadBalancer => "TCP_UDP_INTERNAL_LOAD_BALANCER",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"INTERNAL_TCP_PROXY_LOAD_BALANCER" => Some(Self::InternalTcpProxyLoadBalancer),
...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> ReachabilityServiceClient<InterceptedService<T, F>>
where
...
pub async fn list_connectivity_tests(&mut self, request: impl tonic::IntoRequest<super::ListConnectivityTestsRequest>) -> std::result::Result<tonic::Response<super::ListConnectivityTestsResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.networkmanagement.v1.ReachabilityService/ListConnectivityTests");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.networkmanagement.v1.ReachabilityService", "ListConnectivityTests"));
self.inner.unary(req, path, codec).await
}
/// Gets the details of a specific Connectivity Test.
pub async fn get_connectivity_test(&mut self, request: impl tonic::IntoRequest<super::GetConnectivityTestRequest>) -> std::result::Result<tonic::Response<super::ConnectivityTest>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.networkmanagement.v1.ReachabilityService/GetConnectivityTest");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.networkmanagement.v1.ReachabilityService", "GetConnectivityTest"));
self.inner.unary(req, path, codec).await
}
...
pub async fn create_connectivity_test(&mut self, request: impl tonic::IntoRequest<super::CreateConnectivityTestRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.networkmanagement.v1.ReachabilityService/CreateConnectivityTest");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.networkmanagement.v1.ReachabilityService", "CreateConnectivityTest"));
self.inner.unary(req, path, codec).await
}
...
pub async fn update_connectivity_test(&mut self, request: impl tonic::IntoRequest<super::UpdateConnectivityTestRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.networkmanagement.v1.ReachabilityService/UpdateConnectivityTest");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.networkmanagement.v1.ReachabilityService", "UpdateConnectivityTest"));
self.inner.unary(req, path, codec).await
}
...
pub async fn rerun_connectivity_test(&mut self, request: impl tonic::IntoRequest<super::RerunConnectivityTestRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.networkmanagement.v1.ReachabilityService/RerunConnectivityTest");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.networkmanagement.v1.ReachabilityService", "RerunConnectivityTest"));
self.inner.unary(req, path, codec).await
}
/// Deletes a specific `ConnectivityTest`.
pub async fn delete_connectivity_test(&mut self, request: impl tonic::IntoRequest<super::DeleteConnectivityTestRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.networkmanagement.v1.ReachabilityService/DeleteConnectivityTest");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.networkmanagement.v1.ReachabilityService", "DeleteConnectivityTest"));
self.inner.unary(req, path, codec).await
}
}
}
