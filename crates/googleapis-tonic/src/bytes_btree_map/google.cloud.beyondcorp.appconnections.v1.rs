...
pub struct ResolveAppConnectionsResponse {
    ...
    pub app_connection_details:
        ::prost::alloc::vec::Vec<resolve_app_connections_response::AppConnectionDetails>,
    #[prost(string, tag = "2")]
    pub next_page_token: ::prost::alloc::string::String,
    #[prost(string, repeated, tag = "3")]
    pub unreachable: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
...
pub mod app_connections_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::ListAppConnectionsResponse>, tonic::Status>
        {
        ...
        ) -> std::result::Result<tonic::Response<super::ResolveAppConnectionsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
