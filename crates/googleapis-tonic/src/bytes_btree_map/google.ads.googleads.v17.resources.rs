...
pub mod customer_sk_ad_network_conversion_value_schema {
    ...
    pub struct SkAdNetworkConversionValueSchema {
        ...
        >,
        #[prost(message, repeated, tag = "4")]
        pub postback_mappings:
            ::prost::alloc::vec::Vec<sk_ad_network_conversion_value_schema::PostbackMapping>,
    }
    ...
    pub mod sk_ad_network_conversion_value_schema {
        ...
        pub struct PostbackMapping {
            ...
            #[prost(message, optional, tag = "2")]
            pub coarse_grained_conversion_value_mappings:
                ::core::option::Option<CoarseGrainedConversionValueMappings>,
