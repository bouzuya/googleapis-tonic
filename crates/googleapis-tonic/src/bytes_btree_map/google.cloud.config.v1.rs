...
pub struct TerraformBlueprint {
    ...
    pub input_values:
        ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, TerraformVariable>,
...
pub struct ApplyResults {
    ...
    pub outputs:
        ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, TerraformOutput>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct Resource {
    ...
    #[prost(btree_map = "string, message", tag = "3")]
    pub cai_assets:
        ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, ResourceCaiInfo>,
