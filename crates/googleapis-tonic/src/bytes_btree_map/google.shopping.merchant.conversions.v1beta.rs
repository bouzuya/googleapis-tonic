...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> ConversionSourcesServiceClient<InterceptedService<T, F>>
where
...
pub async fn create_conversion_source(&mut self, request: impl tonic::IntoRequest<super::CreateConversionSourceRequest>) -> std::result::Result<tonic::Response<super::ConversionSource>, tonic::Status> {
...
req.extensions_mut().insert(GrpcMethod::new("google.shopping.merchant.conversions.v1beta.ConversionSourcesService", "CreateConversionSource"));
...
pub async fn update_conversion_source(&mut self, request: impl tonic::IntoRequest<super::UpdateConversionSourceRequest>) -> std::result::Result<tonic::Response<super::ConversionSource>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.shopping.merchant.conversions.v1beta.ConversionSourcesService", "UpdateConversionSource"));
self.inner.unary(req, path, codec).await
}
...
pub async fn delete_conversion_source(&mut self, request: impl tonic::IntoRequest<super::DeleteConversionSourceRequest>) -> std::result::Result<tonic::Response<()>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.shopping.merchant.conversions.v1beta.ConversionSourcesService", "DeleteConversionSource"));
self.inner.unary(req, path, codec).await
}
/// Re-enables an archived conversion source. Only Available for Merchant
/// Center Destination conversion sources.
pub async fn undelete_conversion_source(&mut self, request: impl tonic::IntoRequest<super::UndeleteConversionSourceRequest>) -> std::result::Result<tonic::Response<super::ConversionSource>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.shopping.merchant.conversions.v1beta.ConversionSourcesService", "UndeleteConversionSource"));
self.inner.unary(req, path, codec).await
}
/// Fetches a conversion source.
pub async fn get_conversion_source(&mut self, request: impl tonic::IntoRequest<super::GetConversionSourceRequest>) -> std::result::Result<tonic::Response<super::ConversionSource>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.shopping.merchant.conversions.v1beta.ConversionSourcesService", "GetConversionSource"));
self.inner.unary(req, path, codec).await
}
/// Retrieves the list of conversion sources the caller has access to.
pub async fn list_conversion_sources(&mut self, request: impl tonic::IntoRequest<super::ListConversionSourcesRequest>) -> std::result::Result<tonic::Response<super::ListConversionSourcesResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.shopping.merchant.conversions.v1beta.ConversionSourcesService", "ListConversionSources"));
self.inner.unary(req, path, codec).await
}
}
}
