...
pub group_preferenceset_assignments: ::prost::alloc::vec::Vec<report_config::GroupPreferenceSetAssignment>,
}
...
#[prost(message, repeated, tag = "1")]
pub daily_resource_usage_aggregations: ::prost::alloc::vec::Vec<DailyResourceUsageAggregation>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
...
CommitmentPlan::Commitment1YearMonthlyPayments => "COMMITMENT_1_YEAR_MONTHLY_PAYMENTS",
CommitmentPlan::Commitment3YearMonthlyPayments => "COMMITMENT_3_YEAR_MONTHLY_PAYMENTS",
CommitmentPlan::Commitment1YearUpfrontPayment => "COMMITMENT_1_YEAR_UPFRONT_PAYMENT",
CommitmentPlan::Commitment3YearUpfrontPayment => "COMMITMENT_3_YEAR_UPFRONT_PAYMENT",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"COMMITMENT_1_YEAR_MONTHLY_PAYMENTS" => Some(Self::Commitment1YearMonthlyPayments),
"COMMITMENT_3_YEAR_MONTHLY_PAYMENTS" => Some(Self::Commitment3YearMonthlyPayments),
"COMMITMENT_1_YEAR_UPFRONT_PAYMENT" => Some(Self::Commitment1YearUpfrontPayment),
"COMMITMENT_3_YEAR_UPFRONT_PAYMENT" => Some(Self::Commitment3YearUpfrontPayment),
_ => None,
}
}
}
...
pub fn as_str_name(&self) -> &'static str {
match self {
HostMaintenancePolicy::Unspecified => "HOST_MAINTENANCE_POLICY_UNSPECIFIED",
HostMaintenancePolicy::Default => "HOST_MAINTENANCE_POLICY_DEFAULT",
HostMaintenancePolicy::RestartInPlace => "HOST_MAINTENANCE_POLICY_RESTART_IN_PLACE",
HostMaintenancePolicy::MigrateWithinNodeGroup => "HOST_MAINTENANCE_POLICY_MIGRATE_WITHIN_NODE_GROUP",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"HOST_MAINTENANCE_POLICY_MIGRATE_WITHIN_NODE_GROUP" => Some(Self::MigrateWithinNodeGroup),
_ => None,
}
}
}
...
pub machine_series_allocations: ::prost::alloc::vec::Vec<MachineSeriesAllocation>,
...
pub description: ::prost::alloc::string::String,
#[prost(message, optional, tag = "3")]
pub machine_preferences: ::core::option::Option<super::VirtualMachinePreferences>,
#[prost(message, optional, tag = "4")]
pub monthly_cost_total: ::core::option::Option<super::super::super::super::r#type::Money>,
#[prost(message, optional, tag = "5")]
pub monthly_cost_compute: ::core::option::Option<super::super::super::super::r#type::Money>,
#[prost(message, optional, tag = "6")]
pub monthly_cost_os_license: ::core::option::Option<super::super::super::super::r#type::Money>,
#[prost(message, optional, tag = "7")]
pub monthly_cost_network_egress: ::core::option::Option<super::super::super::super::r#type::Money>,
#[prost(message, optional, tag = "8")]
pub monthly_cost_storage: ::core::option::Option<super::super::super::super::r#type::Money>,
#[prost(message, optional, tag = "9")]
pub monthly_cost_other: ::core::option::Option<super::super::super::super::r#type::Money>,
#[prost(message, optional, tag = "10")]
...
pub fn as_str_name(&self) -> &'static str {
match self {
SizingOptimizationStrategy::Unspecified => "SIZING_OPTIMIZATION_STRATEGY_UNSPECIFIED",
SizingOptimizationStrategy::SameAsSource => "SIZING_OPTIMIZATION_STRATEGY_SAME_AS_SOURCE",
SizingOptimizationStrategy::Moderate => "SIZING_OPTIMIZATION_STRATEGY_MODERATE",
SizingOptimizationStrategy::Aggressive => "SIZING_OPTIMIZATION_STRATEGY_AGGRESSIVE",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub fn as_str_name(&self) -> &'static str {
match self {
ComputeMigrationTargetProduct::Unspecified => "COMPUTE_MIGRATION_TARGET_PRODUCT_UNSPECIFIED",
ComputeMigrationTargetProduct::ComputeEngine => "COMPUTE_MIGRATION_TARGET_PRODUCT_COMPUTE_ENGINE",
ComputeMigrationTargetProduct::VmwareEngine => "COMPUTE_MIGRATION_TARGET_PRODUCT_VMWARE_ENGINE",
ComputeMigrationTargetProduct::SoleTenancy => "COMPUTE_MIGRATION_TARGET_PRODUCT_SOLE_TENANCY",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"COMPUTE_MIGRATION_TARGET_PRODUCT_COMPUTE_ENGINE" => Some(Self::ComputeEngine),
...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> MigrationCenterClient<InterceptedService<T, F>>
where
...
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/ListAssets");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "ListAssets"));
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/GetAsset");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "GetAsset"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/UpdateAsset");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "UpdateAsset"));
self.inner.unary(req, path, codec).await
}
/// Updates the parameters of a list of assets.
pub async fn batch_update_assets(&mut self, request: impl tonic::IntoRequest<super::BatchUpdateAssetsRequest>) -> std::result::Result<tonic::Response<super::BatchUpdateAssetsResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/BatchUpdateAssets");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "BatchUpdateAssets"));
self.inner.unary(req, path, codec).await
}
/// Deletes an asset.
pub async fn delete_asset(&mut self, request: impl tonic::IntoRequest<super::DeleteAssetRequest>) -> std::result::Result<tonic::Response<()>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/DeleteAsset");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "DeleteAsset"));
self.inner.unary(req, path, codec).await
}
/// Deletes list of Assets.
pub async fn batch_delete_assets(&mut self, request: impl tonic::IntoRequest<super::BatchDeleteAssetsRequest>) -> std::result::Result<tonic::Response<()>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/BatchDeleteAssets");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "BatchDeleteAssets"));
self.inner.unary(req, path, codec).await
}
/// Reports a set of frames.
pub async fn report_asset_frames(&mut self, request: impl tonic::IntoRequest<super::ReportAssetFramesRequest>) -> std::result::Result<tonic::Response<super::ReportAssetFramesResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/ReportAssetFrames");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "ReportAssetFrames"));
self.inner.unary(req, path, codec).await
}
/// Aggregates the requested fields based on provided function.
pub async fn aggregate_assets_values(&mut self, request: impl tonic::IntoRequest<super::AggregateAssetsValuesRequest>) -> std::result::Result<tonic::Response<super::AggregateAssetsValuesResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/AggregateAssetsValues");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "AggregateAssetsValues"));
self.inner.unary(req, path, codec).await
}
/// Creates an import job.
pub async fn create_import_job(&mut self, request: impl tonic::IntoRequest<super::CreateImportJobRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/CreateImportJob");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "CreateImportJob"));
self.inner.unary(req, path, codec).await
}
/// Lists all import jobs.
pub async fn list_import_jobs(&mut self, request: impl tonic::IntoRequest<super::ListImportJobsRequest>) -> std::result::Result<tonic::Response<super::ListImportJobsResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/ListImportJobs");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "ListImportJobs"));
self.inner.unary(req, path, codec).await
}
/// Gets the details of an import job.
pub async fn get_import_job(&mut self, request: impl tonic::IntoRequest<super::GetImportJobRequest>) -> std::result::Result<tonic::Response<super::ImportJob>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/GetImportJob");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "GetImportJob"));
self.inner.unary(req, path, codec).await
}
/// Deletes an import job.
pub async fn delete_import_job(&mut self, request: impl tonic::IntoRequest<super::DeleteImportJobRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/DeleteImportJob");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "DeleteImportJob"));
self.inner.unary(req, path, codec).await
}
/// Updates an import job.
pub async fn update_import_job(&mut self, request: impl tonic::IntoRequest<super::UpdateImportJobRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/UpdateImportJob");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "UpdateImportJob"));
self.inner.unary(req, path, codec).await
}
/// Validates an import job.
pub async fn validate_import_job(&mut self, request: impl tonic::IntoRequest<super::ValidateImportJobRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/ValidateImportJob");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "ValidateImportJob"));
self.inner.unary(req, path, codec).await
}
/// Runs an import job.
pub async fn run_import_job(&mut self, request: impl tonic::IntoRequest<super::RunImportJobRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/RunImportJob");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "RunImportJob"));
self.inner.unary(req, path, codec).await
}
/// Gets an import data file.
pub async fn get_import_data_file(&mut self, request: impl tonic::IntoRequest<super::GetImportDataFileRequest>) -> std::result::Result<tonic::Response<super::ImportDataFile>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/GetImportDataFile");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "GetImportDataFile"));
self.inner.unary(req, path, codec).await
}
/// List import data files.
pub async fn list_import_data_files(&mut self, request: impl tonic::IntoRequest<super::ListImportDataFilesRequest>) -> std::result::Result<tonic::Response<super::ListImportDataFilesResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/ListImportDataFiles");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "ListImportDataFiles"));
self.inner.unary(req, path, codec).await
}
/// Creates an import data file.
pub async fn create_import_data_file(&mut self, request: impl tonic::IntoRequest<super::CreateImportDataFileRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/CreateImportDataFile");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "CreateImportDataFile"));
self.inner.unary(req, path, codec).await
}
/// Delete an import data file.
pub async fn delete_import_data_file(&mut self, request: impl tonic::IntoRequest<super::DeleteImportDataFileRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/DeleteImportDataFile");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "DeleteImportDataFile"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/ListGroups");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "ListGroups"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/GetGroup");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "GetGroup"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/CreateGroup");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "CreateGroup"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/UpdateGroup");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "UpdateGroup"));
self.inner.unary(req, path, codec).await
}
/// Deletes a group.
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/DeleteGroup");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "DeleteGroup"));
self.inner.unary(req, path, codec).await
}
/// Adds assets to a group.
pub async fn add_assets_to_group(&mut self, request: impl tonic::IntoRequest<super::AddAssetsToGroupRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/AddAssetsToGroup");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "AddAssetsToGroup"));
self.inner.unary(req, path, codec).await
}
/// Removes assets from a group.
pub async fn remove_assets_from_group(&mut self, request: impl tonic::IntoRequest<super::RemoveAssetsFromGroupRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/RemoveAssetsFromGroup");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "RemoveAssetsFromGroup"));
self.inner.unary(req, path, codec).await
}
/// Lists all error frames in a given source and location.
pub async fn list_error_frames(&mut self, request: impl tonic::IntoRequest<super::ListErrorFramesRequest>) -> std::result::Result<tonic::Response<super::ListErrorFramesResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/ListErrorFrames");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "ListErrorFrames"));
self.inner.unary(req, path, codec).await
}
/// Gets the details of an error frame.
pub async fn get_error_frame(&mut self, request: impl tonic::IntoRequest<super::GetErrorFrameRequest>) -> std::result::Result<tonic::Response<super::ErrorFrame>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/GetErrorFrame");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "GetErrorFrame"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/ListSources");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "ListSources"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/GetSource");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "GetSource"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/CreateSource");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "CreateSource"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/UpdateSource");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "UpdateSource"));
self.inner.unary(req, path, codec).await
}
/// Deletes a source.
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/DeleteSource");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "DeleteSource"));
self.inner.unary(req, path, codec).await
}
/// Lists all the preference sets in a given project and location.
pub async fn list_preference_sets(&mut self, request: impl tonic::IntoRequest<super::ListPreferenceSetsRequest>) -> std::result::Result<tonic::Response<super::ListPreferenceSetsResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/ListPreferenceSets");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "ListPreferenceSets"));
self.inner.unary(req, path, codec).await
}
/// Gets the details of a preference set.
pub async fn get_preference_set(&mut self, request: impl tonic::IntoRequest<super::GetPreferenceSetRequest>) -> std::result::Result<tonic::Response<super::PreferenceSet>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/GetPreferenceSet");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "GetPreferenceSet"));
self.inner.unary(req, path, codec).await
}
/// Creates a new preference set in a given project and location.
pub async fn create_preference_set(&mut self, request: impl tonic::IntoRequest<super::CreatePreferenceSetRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/CreatePreferenceSet");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "CreatePreferenceSet"));
self.inner.unary(req, path, codec).await
}
/// Updates the parameters of a preference set.
pub async fn update_preference_set(&mut self, request: impl tonic::IntoRequest<super::UpdatePreferenceSetRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/UpdatePreferenceSet");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "UpdatePreferenceSet"));
self.inner.unary(req, path, codec).await
}
/// Deletes a preference set.
pub async fn delete_preference_set(&mut self, request: impl tonic::IntoRequest<super::DeletePreferenceSetRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/DeletePreferenceSet");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "DeletePreferenceSet"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/GetSettings");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "GetSettings"));
self.inner.unary(req, path, codec).await
}
/// Updates the regional-level project settings.
pub async fn update_settings(&mut self, request: impl tonic::IntoRequest<super::UpdateSettingsRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/UpdateSettings");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "UpdateSettings"));
self.inner.unary(req, path, codec).await
}
/// Creates a report configuration.
pub async fn create_report_config(&mut self, request: impl tonic::IntoRequest<super::CreateReportConfigRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/CreateReportConfig");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "CreateReportConfig"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/GetReportConfig");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "GetReportConfig"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/ListReportConfigs");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "ListReportConfigs"));
self.inner.unary(req, path, codec).await
}
/// Deletes a ReportConfig.
pub async fn delete_report_config(&mut self, request: impl tonic::IntoRequest<super::DeleteReportConfigRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/DeleteReportConfig");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "DeleteReportConfig"));
self.inner.unary(req, path, codec).await
}
/// Creates a report.
pub async fn create_report(&mut self, request: impl tonic::IntoRequest<super::CreateReportRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/CreateReport");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "CreateReport"));
self.inner.unary(req, path, codec).await
}
/// Gets details of a single Report.
pub async fn get_report(&mut self, request: impl tonic::IntoRequest<super::GetReportRequest>) -> std::result::Result<tonic::Response<super::Report>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/GetReport");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "GetReport"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/ListReports");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "ListReports"));
self.inner.unary(req, path, codec).await
}
/// Deletes a Report.
pub async fn delete_report(&mut self, request: impl tonic::IntoRequest<super::DeleteReportRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.migrationcenter.v1.MigrationCenter/DeleteReport");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.migrationcenter.v1.MigrationCenter", "DeleteReport"));
self.inner.unary(req, path, codec).await
}
}
}
