...
let path = http::uri::PathAndQuery::from_static("/google.cloud.videointelligence.v1.VideoIntelligenceService/AnnotateVideo");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.videointelligence.v1.VideoIntelligenceService", "AnnotateVideo"));
