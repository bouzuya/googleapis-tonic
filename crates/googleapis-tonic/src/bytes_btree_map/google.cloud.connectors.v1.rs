...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> ConnectorsClient<InterceptedService<T, F>>
where
...
let path = http::uri::PathAndQuery::from_static("/google.cloud.connectors.v1.Connectors/ListConnections");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.connectors.v1.Connectors", "ListConnections"));
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.connectors.v1.Connectors/GetConnection");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.connectors.v1.Connectors", "GetConnection"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.connectors.v1.Connectors/CreateConnection");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.connectors.v1.Connectors", "CreateConnection"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.connectors.v1.Connectors/UpdateConnection");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.connectors.v1.Connectors", "UpdateConnection"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.connectors.v1.Connectors/DeleteConnection");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.connectors.v1.Connectors", "DeleteConnection"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.connectors.v1.Connectors/ListProviders");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.connectors.v1.Connectors", "ListProviders"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.connectors.v1.Connectors/GetProvider");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.connectors.v1.Connectors", "GetProvider"));
self.inner.unary(req, path, codec).await
}
/// Lists Connectors in a given project and location.
pub async fn list_connectors(&mut self, request: impl tonic::IntoRequest<super::ListConnectorsRequest>) -> std::result::Result<tonic::Response<super::ListConnectorsResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.connectors.v1.Connectors/ListConnectors");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.connectors.v1.Connectors", "ListConnectors"));
self.inner.unary(req, path, codec).await
}
/// Gets details of a single Connector.
pub async fn get_connector(&mut self, request: impl tonic::IntoRequest<super::GetConnectorRequest>) -> std::result::Result<tonic::Response<super::Connector>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.connectors.v1.Connectors/GetConnector");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.connectors.v1.Connectors", "GetConnector"));
self.inner.unary(req, path, codec).await
}
/// Lists Connector Versions in a given project and location.
pub async fn list_connector_versions(&mut self, request: impl tonic::IntoRequest<super::ListConnectorVersionsRequest>) -> std::result::Result<tonic::Response<super::ListConnectorVersionsResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.connectors.v1.Connectors/ListConnectorVersions");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.connectors.v1.Connectors", "ListConnectorVersions"));
self.inner.unary(req, path, codec).await
}
/// Gets details of a single connector version.
pub async fn get_connector_version(&mut self, request: impl tonic::IntoRequest<super::GetConnectorVersionRequest>) -> std::result::Result<tonic::Response<super::ConnectorVersion>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.connectors.v1.Connectors/GetConnectorVersion");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.connectors.v1.Connectors", "GetConnectorVersion"));
self.inner.unary(req, path, codec).await
}
/// Gets schema metadata of a connection.
/// SchemaMetadata is a singleton resource for each connection.
pub async fn get_connection_schema_metadata(&mut self, request: impl tonic::IntoRequest<super::GetConnectionSchemaMetadataRequest>) -> std::result::Result<tonic::Response<super::ConnectionSchemaMetadata>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.connectors.v1.Connectors/GetConnectionSchemaMetadata");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.connectors.v1.Connectors", "GetConnectionSchemaMetadata"));
self.inner.unary(req, path, codec).await
}
/// Refresh runtime schema of a connection.
pub async fn refresh_connection_schema_metadata(&mut self, request: impl tonic::IntoRequest<super::RefreshConnectionSchemaMetadataRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.connectors.v1.Connectors/RefreshConnectionSchemaMetadata");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.connectors.v1.Connectors", "RefreshConnectionSchemaMetadata"));
self.inner.unary(req, path, codec).await
}
/// List schema of a runtime entities filtered by entity name.
pub async fn list_runtime_entity_schemas(&mut self, request: impl tonic::IntoRequest<super::ListRuntimeEntitySchemasRequest>) -> std::result::Result<tonic::Response<super::ListRuntimeEntitySchemasResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.connectors.v1.Connectors/ListRuntimeEntitySchemas");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.connectors.v1.Connectors", "ListRuntimeEntitySchemas"));
self.inner.unary(req, path, codec).await
}
/// List schema of a runtime actions filtered by action name.
pub async fn list_runtime_action_schemas(&mut self, request: impl tonic::IntoRequest<super::ListRuntimeActionSchemasRequest>) -> std::result::Result<tonic::Response<super::ListRuntimeActionSchemasResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.connectors.v1.Connectors/ListRuntimeActionSchemas");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.connectors.v1.Connectors", "ListRuntimeActionSchemas"));
self.inner.unary(req, path, codec).await
}
/// Gets the runtimeConfig of a location.
/// RuntimeConfig is a singleton resource for each location.
pub async fn get_runtime_config(&mut self, request: impl tonic::IntoRequest<super::GetRuntimeConfigRequest>) -> std::result::Result<tonic::Response<super::RuntimeConfig>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.connectors.v1.Connectors/GetRuntimeConfig");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.connectors.v1.Connectors", "GetRuntimeConfig"));
self.inner.unary(req, path, codec).await
}
/// GetGlobalSettings gets settings of a project.
/// GlobalSettings is a singleton resource.
pub async fn get_global_settings(&mut self, request: impl tonic::IntoRequest<super::GetGlobalSettingsRequest>) -> std::result::Result<tonic::Response<super::Settings>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.connectors.v1.Connectors/GetGlobalSettings");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.connectors.v1.Connectors", "GetGlobalSettings"));
self.inner.unary(req, path, codec).await
}
}
}
