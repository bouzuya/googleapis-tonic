...
pub notification_settings: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, NotificationSettings>,
#[prost(string, tag = "3")]
...
NotificationType::SecurityPrivacyAdvisory => "NOTIFICATION_TYPE_SECURITY_PRIVACY_ADVISORY",
...
"NOTIFICATION_TYPE_SECURITY_PRIVACY_ADVISORY" => Some(Self::SecurityPrivacyAdvisory),
...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> AdvisoryNotificationsServiceClient<InterceptedService<T, F>>
where
...
pub async fn list_notifications(&mut self, request: impl tonic::IntoRequest<super::ListNotificationsRequest>) -> std::result::Result<tonic::Response<super::ListNotificationsResponse>, tonic::Status> {
...
req.extensions_mut().insert(GrpcMethod::new("google.cloud.advisorynotifications.v1.AdvisoryNotificationsService", "ListNotifications"));
self.inner.unary(req, path, codec).await
}
/// Gets a notification.
pub async fn get_notification(&mut self, request: impl tonic::IntoRequest<super::GetNotificationRequest>) -> std::result::Result<tonic::Response<super::Notification>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.advisorynotifications.v1.AdvisoryNotificationsService", "GetNotification"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.advisorynotifications.v1.AdvisoryNotificationsService/GetSettings");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.advisorynotifications.v1.AdvisoryNotificationsService", "GetSettings"));
self.inner.unary(req, path, codec).await
}
...
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.advisorynotifications.v1.AdvisoryNotificationsService", "UpdateSettings"));
self.inner.unary(req, path, codec).await
}
}
}
