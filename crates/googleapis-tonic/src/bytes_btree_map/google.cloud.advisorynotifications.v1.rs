...
pub struct Settings {
    ...
    pub notification_settings:
        ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, NotificationSettings>,
    #[prost(string, tag = "3")]
...
pub mod advisory_notifications_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::ListNotificationsResponse>, tonic::Status>
        {
