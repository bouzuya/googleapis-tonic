...
pub values: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, ::prost::alloc::string::String>,
#[prost(btree_map = "string, string", tag = "2")]
pub match_target_labels: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, ::prost::alloc::string::String>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Strategy {
...
pub deploy_parameters: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, ::prost::alloc::string::String>,
...
#[prost(string, tag = "5")]
pub id: ::prost::alloc::string::String,
#[prost(enumeration = "deploy_policy::Invoker", repeated, packed = "false", tag = "6")]
...
#[prost(message, optional, tag = "3")]
pub start_time_of_day: ::core::option::Option<super::super::super::r#type::TimeOfDay>,
#[prost(message, optional, tag = "4")]
...
FailureCause::DeploymentStrategyNotSupported => "DEPLOYMENT_STRATEGY_NOT_SUPPORTED",
FailureCause::RenderFeatureNotSupported => "RENDER_FEATURE_NOT_SUPPORTED",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"DEPLOYMENT_STRATEGY_NOT_SUPPORTED" => Some(Self::DeploymentStrategyNotSupported),
"RENDER_FEATURE_NOT_SUPPORTED" => Some(Self::RenderFeatureNotSupported),
_ => None,
}
}
}
...
pub phase_artifacts: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, target_artifact::PhaseArtifact>,
...
FailureCause::VerificationConfigNotFound => "VERIFICATION_CONFIG_NOT_FOUND",
FailureCause::CloudBuildRequestFailed => "CLOUD_BUILD_REQUEST_FAILED",
FailureCause::OperationFeatureNotSupported => "OPERATION_FEATURE_NOT_SUPPORTED",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"VERIFICATION_CONFIG_NOT_FOUND" => Some(Self::VerificationConfigNotFound),
"CLOUD_BUILD_REQUEST_FAILED" => Some(Self::CloudBuildRequestFailed),
"OPERATION_FEATURE_NOT_SUPPORTED" => Some(Self::OperationFeatureNotSupported),
_ => None,
}
}
}
...
SkaffoldSupportState::MaintenanceMode => "SKAFFOLD_SUPPORT_STATE_MAINTENANCE_MODE",
...
pub async fn list_delivery_pipelines(&mut self, request: impl tonic::IntoRequest<super::ListDeliveryPipelinesRequest>) -> std::result::Result<tonic::Response<super::ListDeliveryPipelinesResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/ListDeliveryPipelines");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "ListDeliveryPipelines"));
self.inner.unary(req, path, codec).await
}
/// Gets details of a single DeliveryPipeline.
pub async fn get_delivery_pipeline(&mut self, request: impl tonic::IntoRequest<super::GetDeliveryPipelineRequest>) -> std::result::Result<tonic::Response<super::DeliveryPipeline>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/GetDeliveryPipeline");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "GetDeliveryPipeline"));
self.inner.unary(req, path, codec).await
}
/// Creates a new DeliveryPipeline in a given project and location.
pub async fn create_delivery_pipeline(&mut self, request: impl tonic::IntoRequest<super::CreateDeliveryPipelineRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/CreateDeliveryPipeline");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "CreateDeliveryPipeline"));
self.inner.unary(req, path, codec).await
}
/// Updates the parameters of a single DeliveryPipeline.
pub async fn update_delivery_pipeline(&mut self, request: impl tonic::IntoRequest<super::UpdateDeliveryPipelineRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/UpdateDeliveryPipeline");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "UpdateDeliveryPipeline"));
self.inner.unary(req, path, codec).await
}
/// Deletes a single DeliveryPipeline.
pub async fn delete_delivery_pipeline(&mut self, request: impl tonic::IntoRequest<super::DeleteDeliveryPipelineRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/DeleteDeliveryPipeline");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "DeleteDeliveryPipeline"));
self.inner.unary(req, path, codec).await
}
/// Lists Targets in a given project and location.
pub async fn list_targets(&mut self, request: impl tonic::IntoRequest<super::ListTargetsRequest>) -> std::result::Result<tonic::Response<super::ListTargetsResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/ListTargets");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "ListTargets"));
self.inner.unary(req, path, codec).await
}
/// Creates a `Rollout` to roll back the specified target.
pub async fn rollback_target(&mut self, request: impl tonic::IntoRequest<super::RollbackTargetRequest>) -> std::result::Result<tonic::Response<super::RollbackTargetResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/RollbackTarget");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "RollbackTarget"));
self.inner.unary(req, path, codec).await
}
/// Gets details of a single Target.
pub async fn get_target(&mut self, request: impl tonic::IntoRequest<super::GetTargetRequest>) -> std::result::Result<tonic::Response<super::Target>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/GetTarget");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "GetTarget"));
self.inner.unary(req, path, codec).await
}
/// Creates a new Target in a given project and location.
pub async fn create_target(&mut self, request: impl tonic::IntoRequest<super::CreateTargetRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/CreateTarget");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "CreateTarget"));
self.inner.unary(req, path, codec).await
}
/// Updates the parameters of a single Target.
pub async fn update_target(&mut self, request: impl tonic::IntoRequest<super::UpdateTargetRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/UpdateTarget");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "UpdateTarget"));
self.inner.unary(req, path, codec).await
}
/// Deletes a single Target.
pub async fn delete_target(&mut self, request: impl tonic::IntoRequest<super::DeleteTargetRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/DeleteTarget");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "DeleteTarget"));
self.inner.unary(req, path, codec).await
}
/// Lists CustomTargetTypes in a given project and location.
pub async fn list_custom_target_types(&mut self, request: impl tonic::IntoRequest<super::ListCustomTargetTypesRequest>) -> std::result::Result<tonic::Response<super::ListCustomTargetTypesResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/ListCustomTargetTypes");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "ListCustomTargetTypes"));
self.inner.unary(req, path, codec).await
}
/// Gets details of a single CustomTargetType.
pub async fn get_custom_target_type(&mut self, request: impl tonic::IntoRequest<super::GetCustomTargetTypeRequest>) -> std::result::Result<tonic::Response<super::CustomTargetType>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/GetCustomTargetType");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "GetCustomTargetType"));
self.inner.unary(req, path, codec).await
}
/// Creates a new CustomTargetType in a given project and location.
pub async fn create_custom_target_type(&mut self, request: impl tonic::IntoRequest<super::CreateCustomTargetTypeRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/CreateCustomTargetType");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "CreateCustomTargetType"));
self.inner.unary(req, path, codec).await
}
/// Updates a single CustomTargetType.
pub async fn update_custom_target_type(&mut self, request: impl tonic::IntoRequest<super::UpdateCustomTargetTypeRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/UpdateCustomTargetType");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "UpdateCustomTargetType"));
self.inner.unary(req, path, codec).await
}
/// Deletes a single CustomTargetType.
pub async fn delete_custom_target_type(&mut self, request: impl tonic::IntoRequest<super::DeleteCustomTargetTypeRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/DeleteCustomTargetType");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "DeleteCustomTargetType"));
self.inner.unary(req, path, codec).await
}
/// Lists Releases in a given project and location.
pub async fn list_releases(&mut self, request: impl tonic::IntoRequest<super::ListReleasesRequest>) -> std::result::Result<tonic::Response<super::ListReleasesResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/ListReleases");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "ListReleases"));
self.inner.unary(req, path, codec).await
}
/// Gets details of a single Release.
pub async fn get_release(&mut self, request: impl tonic::IntoRequest<super::GetReleaseRequest>) -> std::result::Result<tonic::Response<super::Release>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/GetRelease");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "GetRelease"));
self.inner.unary(req, path, codec).await
}
/// Creates a new Release in a given project and location.
pub async fn create_release(&mut self, request: impl tonic::IntoRequest<super::CreateReleaseRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/CreateRelease");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "CreateRelease"));
self.inner.unary(req, path, codec).await
}
/// Abandons a Release in the Delivery Pipeline.
pub async fn abandon_release(&mut self, request: impl tonic::IntoRequest<super::AbandonReleaseRequest>) -> std::result::Result<tonic::Response<super::AbandonReleaseResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/AbandonRelease");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "AbandonRelease"));
self.inner.unary(req, path, codec).await
}
/// Creates a new DeployPolicy in a given project and location.
pub async fn create_deploy_policy(&mut self, request: impl tonic::IntoRequest<super::CreateDeployPolicyRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/CreateDeployPolicy");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "CreateDeployPolicy"));
self.inner.unary(req, path, codec).await
}
/// Updates the parameters of a single DeployPolicy.
pub async fn update_deploy_policy(&mut self, request: impl tonic::IntoRequest<super::UpdateDeployPolicyRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/UpdateDeployPolicy");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "UpdateDeployPolicy"));
self.inner.unary(req, path, codec).await
}
/// Deletes a single DeployPolicy.
pub async fn delete_deploy_policy(&mut self, request: impl tonic::IntoRequest<super::DeleteDeployPolicyRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/DeleteDeployPolicy");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "DeleteDeployPolicy"));
self.inner.unary(req, path, codec).await
}
/// Lists DeployPolicies in a given project and location.
pub async fn list_deploy_policies(&mut self, request: impl tonic::IntoRequest<super::ListDeployPoliciesRequest>) -> std::result::Result<tonic::Response<super::ListDeployPoliciesResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/ListDeployPolicies");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "ListDeployPolicies"));
self.inner.unary(req, path, codec).await
}
/// Gets details of a single DeployPolicy.
pub async fn get_deploy_policy(&mut self, request: impl tonic::IntoRequest<super::GetDeployPolicyRequest>) -> std::result::Result<tonic::Response<super::DeployPolicy>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/GetDeployPolicy");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "GetDeployPolicy"));
self.inner.unary(req, path, codec).await
}
/// Approves a Rollout.
pub async fn approve_rollout(&mut self, request: impl tonic::IntoRequest<super::ApproveRolloutRequest>) -> std::result::Result<tonic::Response<super::ApproveRolloutResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/ApproveRollout");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "ApproveRollout"));
self.inner.unary(req, path, codec).await
}
/// Advances a Rollout in a given project and location.
pub async fn advance_rollout(&mut self, request: impl tonic::IntoRequest<super::AdvanceRolloutRequest>) -> std::result::Result<tonic::Response<super::AdvanceRolloutResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/AdvanceRollout");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "AdvanceRollout"));
self.inner.unary(req, path, codec).await
}
/// Cancels a Rollout in a given project and location.
pub async fn cancel_rollout(&mut self, request: impl tonic::IntoRequest<super::CancelRolloutRequest>) -> std::result::Result<tonic::Response<super::CancelRolloutResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/CancelRollout");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "CancelRollout"));
self.inner.unary(req, path, codec).await
}
/// Lists Rollouts in a given project and location.
pub async fn list_rollouts(&mut self, request: impl tonic::IntoRequest<super::ListRolloutsRequest>) -> std::result::Result<tonic::Response<super::ListRolloutsResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/ListRollouts");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "ListRollouts"));
self.inner.unary(req, path, codec).await
}
/// Gets details of a single Rollout.
pub async fn get_rollout(&mut self, request: impl tonic::IntoRequest<super::GetRolloutRequest>) -> std::result::Result<tonic::Response<super::Rollout>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/GetRollout");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "GetRollout"));
self.inner.unary(req, path, codec).await
}
/// Creates a new Rollout in a given project and location.
pub async fn create_rollout(&mut self, request: impl tonic::IntoRequest<super::CreateRolloutRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/CreateRollout");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "CreateRollout"));
self.inner.unary(req, path, codec).await
}
/// Ignores the specified Job in a Rollout.
pub async fn ignore_job(&mut self, request: impl tonic::IntoRequest<super::IgnoreJobRequest>) -> std::result::Result<tonic::Response<super::IgnoreJobResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/IgnoreJob");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "IgnoreJob"));
self.inner.unary(req, path, codec).await
}
/// Retries the specified Job in a Rollout.
pub async fn retry_job(&mut self, request: impl tonic::IntoRequest<super::RetryJobRequest>) -> std::result::Result<tonic::Response<super::RetryJobResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/RetryJob");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "RetryJob"));
self.inner.unary(req, path, codec).await
}
/// Lists JobRuns in a given project and location.
pub async fn list_job_runs(&mut self, request: impl tonic::IntoRequest<super::ListJobRunsRequest>) -> std::result::Result<tonic::Response<super::ListJobRunsResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/ListJobRuns");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "ListJobRuns"));
self.inner.unary(req, path, codec).await
}
/// Gets details of a single JobRun.
pub async fn get_job_run(&mut self, request: impl tonic::IntoRequest<super::GetJobRunRequest>) -> std::result::Result<tonic::Response<super::JobRun>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/GetJobRun");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "GetJobRun"));
self.inner.unary(req, path, codec).await
}
/// Terminates a Job Run in a given project and location.
pub async fn terminate_job_run(&mut self, request: impl tonic::IntoRequest<super::TerminateJobRunRequest>) -> std::result::Result<tonic::Response<super::TerminateJobRunResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/TerminateJobRun");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "TerminateJobRun"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/GetConfig");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "GetConfig"));
self.inner.unary(req, path, codec).await
}
/// Creates a new Automation in a given project and location.
pub async fn create_automation(&mut self, request: impl tonic::IntoRequest<super::CreateAutomationRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/CreateAutomation");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "CreateAutomation"));
self.inner.unary(req, path, codec).await
}
/// Updates the parameters of a single Automation resource.
pub async fn update_automation(&mut self, request: impl tonic::IntoRequest<super::UpdateAutomationRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/UpdateAutomation");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "UpdateAutomation"));
self.inner.unary(req, path, codec).await
}
/// Deletes a single Automation resource.
pub async fn delete_automation(&mut self, request: impl tonic::IntoRequest<super::DeleteAutomationRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/DeleteAutomation");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "DeleteAutomation"));
self.inner.unary(req, path, codec).await
}
/// Gets details of a single Automation.
pub async fn get_automation(&mut self, request: impl tonic::IntoRequest<super::GetAutomationRequest>) -> std::result::Result<tonic::Response<super::Automation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/GetAutomation");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "GetAutomation"));
self.inner.unary(req, path, codec).await
}
/// Lists Automations in a given project and location.
pub async fn list_automations(&mut self, request: impl tonic::IntoRequest<super::ListAutomationsRequest>) -> std::result::Result<tonic::Response<super::ListAutomationsResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/ListAutomations");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "ListAutomations"));
self.inner.unary(req, path, codec).await
}
/// Gets details of a single AutomationRun.
pub async fn get_automation_run(&mut self, request: impl tonic::IntoRequest<super::GetAutomationRunRequest>) -> std::result::Result<tonic::Response<super::AutomationRun>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/GetAutomationRun");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "GetAutomationRun"));
self.inner.unary(req, path, codec).await
}
/// Lists AutomationRuns in a given project and location.
pub async fn list_automation_runs(&mut self, request: impl tonic::IntoRequest<super::ListAutomationRunsRequest>) -> std::result::Result<tonic::Response<super::ListAutomationRunsResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/ListAutomationRuns");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "ListAutomationRuns"));
self.inner.unary(req, path, codec).await
}
...
pub async fn cancel_automation_run(&mut self, request: impl tonic::IntoRequest<super::CancelAutomationRunRequest>) -> std::result::Result<tonic::Response<super::CancelAutomationRunResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.deploy.v1.CloudDeploy/CancelAutomationRun");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.deploy.v1.CloudDeploy", "CancelAutomationRun"));
self.inner.unary(req, path, codec).await
}
}
}
...
pub verdict: i32,
#[prost(enumeration = "deploy_policy_evaluation_event::PolicyVerdictOverride", repeated, tag = "13")]
...
pub fn as_str_name(&self) -> &'static str {
match self {
PolicyVerdictOverride::Unspecified => "POLICY_VERDICT_OVERRIDE_UNSPECIFIED",
