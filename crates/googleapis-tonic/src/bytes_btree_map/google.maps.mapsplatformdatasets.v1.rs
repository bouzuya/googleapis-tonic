...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> MapsPlatformDatasetsClient<InterceptedService<T, F>>
where
...
let path = http::uri::PathAndQuery::from_static("/google.maps.mapsplatformdatasets.v1.MapsPlatformDatasets/CreateDataset");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.maps.mapsplatformdatasets.v1.MapsPlatformDatasets", "CreateDataset"));
self.inner.unary(req, path, codec).await
}
/// Updates the metadata for the dataset.
pub async fn update_dataset_metadata(&mut self, request: impl tonic::IntoRequest<super::UpdateDatasetMetadataRequest>) -> std::result::Result<tonic::Response<super::Dataset>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.maps.mapsplatformdatasets.v1.MapsPlatformDatasets/UpdateDatasetMetadata");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.maps.mapsplatformdatasets.v1.MapsPlatformDatasets", "UpdateDatasetMetadata"));
self.inner.unary(req, path, codec).await
}
/// Gets the dataset.
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.maps.mapsplatformdatasets.v1.MapsPlatformDatasets/GetDataset");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.maps.mapsplatformdatasets.v1.MapsPlatformDatasets", "GetDataset"));
self.inner.unary(req, path, codec).await
}
/// Gets all the errors of a dataset.
pub async fn fetch_dataset_errors(&mut self, request: impl tonic::IntoRequest<super::FetchDatasetErrorsRequest>) -> std::result::Result<tonic::Response<super::FetchDatasetErrorsResponse>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.maps.mapsplatformdatasets.v1.MapsPlatformDatasets/FetchDatasetErrors");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.maps.mapsplatformdatasets.v1.MapsPlatformDatasets", "FetchDatasetErrors"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.maps.mapsplatformdatasets.v1.MapsPlatformDatasets/ListDatasets");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.maps.mapsplatformdatasets.v1.MapsPlatformDatasets", "ListDatasets"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.maps.mapsplatformdatasets.v1.MapsPlatformDatasets/DeleteDataset");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.maps.mapsplatformdatasets.v1.MapsPlatformDatasets", "DeleteDataset"));
self.inner.unary(req, path, codec).await
}
}
}
