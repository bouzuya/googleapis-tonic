...
pub field_schemas: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, super::DataSchemaDetails>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub elements: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, AnnotationValue>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
