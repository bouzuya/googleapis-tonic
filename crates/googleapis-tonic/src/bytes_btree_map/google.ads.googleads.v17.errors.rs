...
"INVALID_DOMESTIC_PHONE_NUMBER_FORMAT" => Some(Self::InvalidDomesticPhoneNumberFormat),
"INVALID_PHONE_NUMBER" => Some(Self::InvalidPhoneNumber),
"PHONE_NUMBER_NOT_SUPPORTED_FOR_COUNTRY" => Some(Self::PhoneNumberNotSupportedForCountry),
...
"CALLTRACKING_NOT_SUPPORTED_FOR_COUNTRY" => Some(Self::CalltrackingNotSupportedForCountry),
"CUSTOMER_NOT_IN_ALLOWLIST_FOR_CALLTRACKING" => Some(Self::CustomerNotInAllowlistForCalltracking),
...
"MISSING_ENHANCED_SITELINK_DESCRIPTION_LINE" => Some(Self::MissingEnhancedSitelinkDescriptionLine),
"REVIEW_EXTENSION_SOURCE_INELIGIBLE" => Some(Self::ReviewExtensionSourceIneligible),
"HYPHENS_IN_REVIEW_EXTENSION_SNIPPET" => Some(Self::HyphensInReviewExtensionSnippet),
"DOUBLE_QUOTES_IN_REVIEW_EXTENSION_SNIPPET" => Some(Self::DoubleQuotesInReviewExtensionSnippet),
...
"SOURCE_NAME_IN_REVIEW_EXTENSION_TEXT" => Some(Self::SourceNameInReviewExtensionText),
"CARRIER_SPECIFIC_SHORT_NUMBER_NOT_ALLOWED" => Some(Self::CarrierSpecificShortNumberNotAllowed),
...
"INVALID_FINAL_URL_FOR_APP_DOWNLOAD_URL" => Some(Self::InvalidFinalUrlForAppDownloadUrl),
...
"NUMBER_TYPE_WITH_CALLTRACKING_NOT_SUPPORTED_FOR_COUNTRY" => Some(Self::NumberTypeWithCalltrackingNotSupportedForCountry),
...
"PRICE_EXTENSION_HAS_DUPLICATED_HEADERS" => Some(Self::PriceExtensionHasDuplicatedHeaders),
"ITEM_HAS_DUPLICATED_HEADER_AND_DESCRIPTION" => Some(Self::ItemHasDuplicatedHeaderAndDescription),
...
"VALUE_TRACK_PARAMETER_NOT_SUPPORTED" => Some(Self::ValueTrackParameterNotSupported),
"UNSUPPORTED_VALUE_IN_SELECTED_LANGUAGE" => Some(Self::UnsupportedValueInSelectedLanguage),
"INVALID_IOS_APP_LINK" => Some(Self::InvalidIosAppLink),
"MISSING_IOS_APP_LINK_OR_IOS_APP_STORE_ID" => Some(Self::MissingIosAppLinkOrIosAppStoreId),
"PROMOTION_INVALID_TIME" => Some(Self::PromotionInvalidTime),
"PROMOTION_CANNOT_SET_PERCENT_OFF_AND_MONEY_AMOUNT_OFF" => Some(Self::PromotionCannotSetPercentOffAndMoneyAmountOff),
"PROMOTION_CANNOT_SET_PROMOTION_CODE_AND_ORDERS_OVER_AMOUNT" => Some(Self::PromotionCannotSetPromotionCodeAndOrdersOverAmount),
...
"CUSTOMER_CONSENT_FOR_CALL_RECORDING_REQUIRED" => Some(Self::CustomerConsentForCallRecordingRequired),
...
"EMAIL_DELIVERY_NOT_AVAILABLE_IN_COUNTRY" => Some(Self::EmailDeliveryNotAvailableInCountry),
...
"IMAGE_ERROR_ASPECT_RATIO_NOT_ALLOWED" => Some(Self::ImageErrorAspectRatioNotAllowed),
...
"CANNOT_RESTATE_CONVERSION_ACTION_THAT_ALWAYS_USES_DEFAULT_CONVERSION_VALUE" => Some(Self::CannotRestateConversionActionThatAlwaysUsesDefaultConversionValue),
...
"CUSTOMER_NOT_ACCEPTED_CUSTOMER_DATA_TERMS" => Some(Self::CustomerNotAcceptedCustomerDataTerms),
"CONVERSION_ACTION_NOT_ELIGIBLE_FOR_ENHANCEMENT" => Some(Self::ConversionActionNotEligibleForEnhancement),
"INVALID_USER_IDENTIFIER" => Some(Self::InvalidUserIdentifier),
"UNSUPPORTED_USER_IDENTIFIER" => Some(Self::UnsupportedUserIdentifier),
"GCLID_DATE_TIME_PAIR_AND_ORDER_ID_BOTH_SET" => Some(Self::GclidDateTimePairAndOrderIdBothSet),
...
"CUSTOMER_DATA_POLICY_PROHIBITS_ENHANCEMENT" => Some(Self::CustomerDataPolicyProhibitsEnhancement),
...
"TOO_RECENT_CONVERSION_ACTION" => Some(Self::TooRecentConversionAction),
"CONVERSION_TRACKING_NOT_ENABLED_AT_IMPRESSION_TIME" => Some(Self::ConversionTrackingNotEnabledAtImpressionTime),
"EXTERNAL_ATTRIBUTION_DATA_SET_FOR_NON_EXTERNALLY_ATTRIBUTED_CONVERSION_ACTION" => Some(Self::ExternalAttributionDataSetForNonExternallyAttributedConversionAction),
"EXTERNAL_ATTRIBUTION_DATA_NOT_SET_FOR_EXTERNALLY_ATTRIBUTED_CONVERSION_ACTION" => Some(Self::ExternalAttributionDataNotSetForExternallyAttributedConversionAction),
"ORDER_ID_NOT_PERMITTED_FOR_EXTERNALLY_ATTRIBUTED_CONVERSION_ACTION" => Some(Self::OrderIdNotPermittedForExternallyAttributedConversionAction),
...
"CONVERSION_TRACKING_NOT_ENABLED_AT_CALL_TIME" => Some(Self::ConversionTrackingNotEnabledAtCallTime),
...
"DUPLICATE_CLICK_CONVERSION_IN_REQUEST" => Some(Self::DuplicateClickConversionInRequest),
"DUPLICATE_CALL_CONVERSION_IN_REQUEST" => Some(Self::DuplicateCallConversionInRequest),
...
"CONVERSION_NOT_COMPLIANT_WITH_ATT_POLICY" => Some(Self::ConversionNotCompliantWithAttPolicy),
"CLICK_NOT_FOUND" => Some(Self::ClickNotFound),
"INVALID_USER_IDENTIFIER" => Some(Self::InvalidUserIdentifier),
"EXTERNALLY_ATTRIBUTED_CONVERSION_ACTION_NOT_PERMITTED_WITH_USER_IDENTIFIER" => Some(Self::ExternallyAttributedConversionActionNotPermittedWithUserIdentifier),
"UNSUPPORTED_USER_IDENTIFIER" => Some(Self::UnsupportedUserIdentifier),
...
"ONE_PER_CLICK_CONVERSION_ACTION_NOT_PERMITTED_WITH_BRAID" => Some(Self::OnePerClickConversionActionNotPermittedWithBraid),
"CUSTOMER_DATA_POLICY_PROHIBITS_ENHANCED_CONVERSIONS" => Some(Self::CustomerDataPolicyProhibitsEnhancedConversions),
"CUSTOMER_NOT_ACCEPTED_CUSTOMER_DATA_TERMS" => Some(Self::CustomerNotAcceptedCustomerDataTerms),
"ORDER_ID_CONTAINS_PII" => Some(Self::OrderIdContainsPii),
"CUSTOMER_NOT_ENABLED_ENHANCED_CONVERSIONS_FOR_LEADS" => Some(Self::CustomerNotEnabledEnhancedConversionsForLeads),
"INVALID_JOB_ID" => Some(Self::InvalidJobId),
"NO_CONVERSION_ACTION_FOUND" => Some(Self::NoConversionActionFound),
"INVALID_CONVERSION_ACTION_TYPE" => Some(Self::InvalidConversionActionType),
_ => None,
...
"INVALID_STRING_DATE_TIME_SECONDS_WITH_OFFSET" => Some(Self::InvalidStringDateTimeSecondsWithOffset),
"EARLIER_THAN_MINIMUM_DATE" => Some(Self::EarlierThanMinimumDate),
"LATER_THAN_MAXIMUM_DATE" => Some(Self::LaterThanMaximumDate),
"DATE_RANGE_MINIMUM_DATE_LATER_THAN_MAXIMUM_DATE" => Some(Self::DateRangeMinimumDateLaterThanMaximumDate),
"DATE_RANGE_MINIMUM_AND_MAXIMUM_DATES_BOTH_NULL" => Some(Self::DateRangeMinimumAndMaximumDatesBothNull),
_ => None,
}
}
}
...
"RESOURCE_DOES_NOT_SUPPORT_VALIDATE_ONLY" => Some(Self::ResourceDoesNotSupportValidateOnly),
"OPERATION_DOES_NOT_SUPPORT_PARTIAL_FAILURE" => Some(Self::OperationDoesNotSupportPartialFailure),
...
"UNSPECIFIED" => Some(Self::Unspecified),
"UNKNOWN" => Some(Self::Unknown),
"CUSTOMER_NOT_ALLOWLISTED_FOR_THIS_FEATURE" => Some(Self::CustomerNotAllowlistedForThisFeature),
_ => None,
}
}
}
...
"CUSTOMER_NOT_ALLOWED_FOR_SHOPPING_PERFORMANCE_MAX" => Some(Self::CustomerNotAllowedForShoppingPerformanceMax),
_ => None,
}
}
}
...
"UNSPECIFIED" => Some(Self::Unspecified),
"UNKNOWN" => Some(Self::Unknown),
"FEED_ALREADY_EXISTS_FOR_PLACEHOLDER_TYPE" => Some(Self::FeedAlreadyExistsForPlaceholderType),
...
"CANNOT_OPERATE_ON_REMOVED_ADGROUP_FEED" => Some(Self::CannotOperateOnRemovedAdgroupFeed),
"INVALID_PLACEHOLDER_TYPE" => Some(Self::InvalidPlaceholderType),
"MISSING_FEEDMAPPING_FOR_PLACEHOLDER_TYPE" => Some(Self::MissingFeedmappingForPlaceholderType),
...
"UNSPECIFIED" => Some(Self::Unspecified),
"UNKNOWN" => Some(Self::Unknown),
"CLIENT_ALREADY_INVITED_BY_THIS_MANAGER" => Some(Self::ClientAlreadyInvitedByThisManager),
"CLIENT_ALREADY_MANAGED_IN_HIERARCHY" => Some(Self::ClientAlreadyManagedInHierarchy),
...
"CANNOT_HIDE_OR_UNHIDE_MANAGER_ACCOUNTS" => Some(Self::CannotHideOrUnhideManagerAccounts),
"CUSTOMER_HAS_TOO_MANY_ACCOUNTS_AT_MANAGER" => Some(Self::CustomerHasTooManyAccountsAtManager),
...
BatchJobError::AssetGroupAndAssetGroupAssetTransactionFailure => "ASSET_GROUP_AND_ASSET_GROUP_ASSET_TRANSACTION_FAILURE",
BatchJobError::AssetGroupListingGroupFilterTransactionFailure => "ASSET_GROUP_LISTING_GROUP_FILTER_TRANSACTION_FAILURE",
...
"UNSPECIFIED" => Some(Self::Unspecified),
"UNKNOWN" => Some(Self::Unknown),
"CANNOT_MODIFY_JOB_AFTER_JOB_STARTS_RUNNING" => Some(Self::CannotModifyJobAfterJobStartsRunning),
...
"ASSET_GROUP_AND_ASSET_GROUP_ASSET_TRANSACTION_FAILURE" => Some(Self::AssetGroupAndAssetGroupAssetTransactionFailure),
"ASSET_GROUP_LISTING_GROUP_FILTER_TRANSACTION_FAILURE" => Some(Self::AssetGroupListingGroupFilterTransactionFailure),
...
IdentityVerificationError::BillingNotOnMonthlyInvoicing => "BILLING_NOT_ON_MONTHLY_INVOICING",
IdentityVerificationError::VerificationAlreadyStarted => "VERIFICATION_ALREADY_STARTED",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"BILLING_NOT_ON_MONTHLY_INVOICING" => Some(Self::BillingNotOnMonthlyInvoicing),
...
AssetGroupAssetError::HotelPropertyAssetNotLinkedToCampaign => "HOTEL_PROPERTY_ASSET_NOT_LINKED_TO_CAMPAIGN",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"EXPANDABLE_TAGS_NOT_ALLOWED_IN_DESCRIPTION" => Some(Self::ExpandableTagsNotAllowedInDescription),
"AD_CUSTOMIZER_NOT_SUPPORTED" => Some(Self::AdCustomizerNotSupported),
"HOTEL_PROPERTY_ASSET_NOT_LINKED_TO_CAMPAIGN" => Some(Self::HotelPropertyAssetNotLinkedToCampaign),
_ => None,
}
}
}
...
"FEED_ALREADY_EXISTS_FOR_PLACEHOLDER_TYPE" => Some(Self::FeedAlreadyExistsForPlaceholderType),
"CANNOT_CREATE_FOR_REMOVED_FEED" => Some(Self::CannotCreateForRemovedFeed),
"CANNOT_CREATE_ALREADY_EXISTING_CAMPAIGN_FEED" => Some(Self::CannotCreateAlreadyExistingCampaignFeed),
"CANNOT_MODIFY_REMOVED_CAMPAIGN_FEED" => Some(Self::CannotModifyRemovedCampaignFeed),
"INVALID_PLACEHOLDER_TYPE" => Some(Self::InvalidPlaceholderType),
"MISSING_FEEDMAPPING_FOR_PLACEHOLDER_TYPE" => Some(Self::MissingFeedmappingForPlaceholderType),
"NO_EXISTING_LOCATION_CUSTOMER_FEED" => Some(Self::NoExistingLocationCustomerFeed),
...
AssetLinkError::CannotLinkToAutomaticallyCreatedAsset => "CANNOT_LINK_TO_AUTOMATICALLY_CREATED_ASSET",
AssetLinkError::CannotModifyAssetLinkSource => "CANNOT_MODIFY_ASSET_LINK_SOURCE",
AssetLinkError::CannotLinkLocationLeadFormWithoutLocationAsset => "CANNOT_LINK_LOCATION_LEAD_FORM_WITHOUT_LOCATION_ASSET",
...
"FIELD_TYPE_INCOMPATIBLE_WITH_ASSET_TYPE" => Some(Self::FieldTypeIncompatibleWithAssetType),
"FIELD_TYPE_INCOMPATIBLE_WITH_CAMPAIGN_TYPE" => Some(Self::FieldTypeIncompatibleWithCampaignType),
"INCOMPATIBLE_ADVERTISING_CHANNEL_TYPE" => Some(Self::IncompatibleAdvertisingChannelType),
"IMAGE_NOT_WITHIN_SPECIFIED_DIMENSION_RANGE" => Some(Self::ImageNotWithinSpecifiedDimensionRange),
"INVALID_PINNED_FIELD" => Some(Self::InvalidPinnedField),
"MEDIA_BUNDLE_ASSET_FILE_SIZE_TOO_LARGE" => Some(Self::MediaBundleAssetFileSizeTooLarge),
"NOT_ENOUGH_AVAILABLE_ASSET_LINKS_FOR_VALID_COMBINATION" => Some(Self::NotEnoughAvailableAssetLinksForValidCombination),
"NOT_ENOUGH_AVAILABLE_ASSET_LINKS_WITH_FALLBACK" => Some(Self::NotEnoughAvailableAssetLinksWithFallback),
"NOT_ENOUGH_AVAILABLE_ASSET_LINKS_WITH_FALLBACK_FOR_VALID_COMBINATION" => Some(Self::NotEnoughAvailableAssetLinksWithFallbackForValidCombination),
...
"CANNOT_CREATE_AUTOMATICALLY_CREATED_LINKS" => Some(Self::CannotCreateAutomaticallyCreatedLinks),
"CANNOT_LINK_TO_AUTOMATICALLY_CREATED_ASSET" => Some(Self::CannotLinkToAutomaticallyCreatedAsset),
"CANNOT_MODIFY_ASSET_LINK_SOURCE" => Some(Self::CannotModifyAssetLinkSource),
"CANNOT_LINK_LOCATION_LEAD_FORM_WITHOUT_LOCATION_ASSET" => Some(Self::CannotLinkLocationLeadFormWithoutLocationAsset),
...
"UNSPECIFIED" => Some(Self::Unspecified),
"UNKNOWN" => Some(Self::Unknown),
"CANNOT_USE_CAMPAIGN_GOAL_FOR_SEARCH_ADS_360_MANAGED_CAMPAIGN" => Some(Self::CannotUseCampaignGoalForSearchAds360ManagedCampaign),
"CANNOT_USE_STORE_SALE_GOAL_FOR_PERFORMANCE_MAX_CAMPAIGN" => Some(Self::CannotUseStoreSaleGoalForPerformanceMaxCampaign),
_ => None,
}
}
}
...
"UNSPECIFIED" => Some(Self::Unspecified),
"UNKNOWN" => Some(Self::Unknown),
"CANNOT_CONVERT_ATTRIBUTE_VALUE_FROM_STRING" => Some(Self::CannotConvertAttributeValueFromString),
"CANNOT_OPERATE_ON_REMOVED_FEED_ITEM" => Some(Self::CannotOperateOnRemovedFeedItem),
"DATE_TIME_MUST_BE_IN_ACCOUNT_TIME_ZONE" => Some(Self::DateTimeMustBeInAccountTimeZone),
...
"SIZE_TOO_LARGE_FOR_MULTI_VALUE_ATTRIBUTE" => Some(Self::SizeTooLargeForMultiValueAttribute),
"LEGACY_FEED_TYPE_READ_ONLY" => Some(Self::LegacyFeedTypeReadOnly),
_ => None,
}
}
...
ConversionActionError::CannotSetRuleBasedAttributionModels => "CANNOT_SET_RULE_BASED_ATTRIBUTION_MODELS",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"TWO_CONVERSION_ACTIONS_BIDDING_ON_SAME_APP_DOWNLOAD" => Some(Self::TwoConversionActionsBiddingOnSameAppDownload),
"BIDDING_ON_SAME_APP_DOWNLOAD_AS_GLOBAL_ACTION" => Some(Self::BiddingOnSameAppDownloadAsGlobalAction),
"DATA_DRIVEN_MODEL_WAS_NEVER_GENERATED" => Some(Self::DataDrivenModelWasNeverGenerated),
...
"CANNOT_SET_RULE_BASED_ATTRIBUTION_MODELS" => Some(Self::CannotSetRuleBasedAttributionModels),
_ => None,
}
}
}
...
"CANNOT_CREATE_EXPERIMENT_WITH_SHARED_BUDGET" => Some(Self::CannotCreateExperimentWithSharedBudget),
"CANNOT_CREATE_EXPERIMENT_FOR_REMOVED_BASE_CAMPAIGN" => Some(Self::CannotCreateExperimentForRemovedBaseCampaign),
"CANNOT_CREATE_EXPERIMENT_FOR_NON_PROPOSED_DRAFT" => Some(Self::CannotCreateExperimentForNonProposedDraft),
...
"EXPERIMENT_DURATIONS_MUST_NOT_OVERLAP" => Some(Self::ExperimentDurationsMustNotOverlap),
"EXPERIMENT_DURATION_MUST_BE_WITHIN_CAMPAIGN_DURATION" => Some(Self::ExperimentDurationMustBeWithinCampaignDuration),
"CANNOT_MUTATE_EXPERIMENT_DUE_TO_STATUS" => Some(Self::CannotMutateExperimentDueToStatus),
_ => None,
}
}
}
...
"CANNOT_SELECT_STANDARD_ICON_WITH_OTHER_TYPES" => Some(Self::CannotSelectStandardIconWithOtherTypes),
"CANNOT_SPECIFY_MEDIA_FILE_ID_AND_DATA" => Some(Self::CannotSpecifyMediaFileIdAndData),
"DUPLICATE_MEDIA" => Some(Self::DuplicateMedia),
"EMPTY_FIELD" => Some(Self::EmptyField),
"RESOURCE_REFERENCED_IN_MULTIPLE_OPS" => Some(Self::ResourceReferencedInMultipleOps),
"FIELD_NOT_SUPPORTED_FOR_MEDIA_SUB_TYPE" => Some(Self::FieldNotSupportedForMediaSubType),
...
"MEDIA_TYPE_DOES_NOT_MATCH_MEDIA_FILE_TYPE" => Some(Self::MediaTypeDoesNotMatchMediaFileType),
...
"YOU_TUBE_VIDEO_HAS_NON_POSITIVE_DURATION" => Some(Self::YouTubeVideoHasNonPositiveDuration),
...
"UNSPECIFIED" => Some(Self::Unspecified),
"UNKNOWN" => Some(Self::Unknown),
"CUSTOMER_CANNOT_CREATE_SHARED_SET_OF_THIS_TYPE" => Some(Self::CustomerCannotCreateSharedSetOfThisType),
"DUPLICATE_NAME" => Some(Self::DuplicateName),
...
AdError::DuplicateImageAcrossCarouselCards => "DUPLICATE_IMAGE_ACROSS_CAROUSEL_CARDS",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"UNSPECIFIED" => Some(Self::Unspecified),
"UNKNOWN" => Some(Self::Unknown),
"AD_CUSTOMIZERS_NOT_SUPPORTED_FOR_AD_TYPE" => Some(Self::AdCustomizersNotSupportedForAdType),
...
"CANNOT_SET_FIELD_WITH_ORIGIN_AD_ID_SET" => Some(Self::CannotSetFieldWithOriginAdIdSet),
"CANNOT_SET_FIELD_WITH_AD_ID_SET_FOR_SHARING" => Some(Self::CannotSetFieldWithAdIdSetForSharing),
"CANNOT_SET_ALLOW_FLEXIBLE_COLOR_FALSE" => Some(Self::CannotSetAllowFlexibleColorFalse),
"CANNOT_SET_COLOR_CONTROL_WHEN_NATIVE_FORMAT_SETTING" => Some(Self::CannotSetColorControlWhenNativeFormatSetting),
...
"CUSTOMER_NOT_APPROVED_THIRDPARTY_ADS" => Some(Self::CustomerNotApprovedThirdpartyAds),
"CUSTOMER_NOT_APPROVED_THIRDPARTY_REDIRECT_ADS" => Some(Self::CustomerNotApprovedThirdpartyRedirectAds),
"CUSTOMER_NOT_ELIGIBLE" => Some(Self::CustomerNotEligible),
"CUSTOMER_NOT_ELIGIBLE_FOR_UPDATING_BEACON_URL" => Some(Self::CustomerNotEligibleForUpdatingBeaconUrl),
...
"EMPTY_FIELD" => Some(Self::EmptyField),
"FEED_ATTRIBUTE_MUST_HAVE_MAPPING_FOR_TYPE_ID" => Some(Self::FeedAttributeMustHaveMappingForTypeId),
"FEED_ATTRIBUTE_MAPPING_TYPE_MISMATCH" => Some(Self::FeedAttributeMappingTypeMismatch),
...
"INCONSISTENT_STATUS_IN_TEMPLATE_UNION" => Some(Self::InconsistentStatusInTemplateUnion),
...
"INVALID_ATTRIBUTES_FOR_MOBILE_IMAGE" => Some(Self::InvalidAttributesForMobileImage),
...
"INVALID_COUNTRY_CODE" => Some(Self::InvalidCountryCode),
"INVALID_EXPANDED_DYNAMIC_SEARCH_AD_TAG" => Some(Self::InvalidExpandedDynamicSearchAdTag),
...
"INVALID_RICH_MEDIA_CERTIFIED_VENDOR_FORMAT_ID" => Some(Self::InvalidRichMediaCertifiedVendorFormatId),
"INVALID_TEMPLATE_DATA" => Some(Self::InvalidTemplateData),
"INVALID_TEMPLATE_ELEMENT_FIELD_TYPE" => Some(Self::InvalidTemplateElementFieldType),
...
"MISSING_MARKETING_IMAGE_OR_PRODUCT_VIDEOS" => Some(Self::MissingMarketingImageOrProductVideos),
...
"MULTIPLE_DISTINCT_FEEDS_UNSUPPORTED" => Some(Self::MultipleDistinctFeedsUnsupported),
...
"URL_SCHEME_BEFORE_EXPANDED_DYNAMIC_SEARCH_AD_TAG" => Some(Self::UrlSchemeBeforeExpandedDynamicSearchAdTag),
"USER_DOES_NOT_HAVE_ACCESS_TO_TEMPLATE" => Some(Self::UserDoesNotHaveAccessToTemplate),
...
"INCOMPATIBLE_AD_TYPE_AND_DEVICE_PREFERENCE" => Some(Self::IncompatibleAdTypeAndDevicePreference),
"CALLTRACKING_NOT_SUPPORTED_FOR_COUNTRY" => Some(Self::CalltrackingNotSupportedForCountry),
"CARRIER_SPECIFIC_SHORT_NUMBER_NOT_ALLOWED" => Some(Self::CarrierSpecificShortNumberNotAllowed),
"DISALLOWED_NUMBER_TYPE" => Some(Self::DisallowedNumberType),
"PHONE_NUMBER_NOT_SUPPORTED_FOR_COUNTRY" => Some(Self::PhoneNumberNotSupportedForCountry),
"PHONE_NUMBER_NOT_SUPPORTED_WITH_CALLTRACKING_FOR_COUNTRY" => Some(Self::PhoneNumberNotSupportedWithCalltrackingForCountry),
"PREMIUM_RATE_NUMBER_NOT_ALLOWED" => Some(Self::PremiumRateNumberNotAllowed),
"VANITY_PHONE_NUMBER_NOT_ALLOWED" => Some(Self::VanityPhoneNumberNotAllowed),
"INVALID_CALL_CONVERSION_TYPE_ID" => Some(Self::InvalidCallConversionTypeId),
"CANNOT_DISABLE_CALL_CONVERSION_AND_SET_CONVERSION_TYPE_ID" => Some(Self::CannotDisableCallConversionAndSetConversionTypeId),
"CANNOT_SET_PATH2_WITHOUT_PATH1" => Some(Self::CannotSetPath2WithoutPath1),
"MISSING_DYNAMIC_SEARCH_ADS_SETTING_DOMAIN_NAME" => Some(Self::MissingDynamicSearchAdsSettingDomainName),
...
"PRODUCT_TYPE_NOT_SUPPORTED_IN_THIS_CAMPAIGN" => Some(Self::ProductTypeNotSupportedInThisCampaign),
"PLACEHOLDER_CANNOT_HAVE_EMPTY_DEFAULT_VALUE" => Some(Self::PlaceholderCannotHaveEmptyDefaultValue),
"PLACEHOLDER_COUNTDOWN_FUNCTION_CANNOT_HAVE_DEFAULT_VALUE" => Some(Self::PlaceholderCountdownFunctionCannotHaveDefaultValue),
"PLACEHOLDER_DEFAULT_VALUE_MISSING" => Some(Self::PlaceholderDefaultValueMissing),
"UNEXPECTED_PLACEHOLDER_DEFAULT_VALUE" => Some(Self::UnexpectedPlaceholderDefaultValue),
"AD_CUSTOMIZERS_MAY_NOT_BE_ADJACENT" => Some(Self::AdCustomizersMayNotBeAdjacent),
"UPDATING_AD_WITH_NO_ENABLED_ASSOCIATION" => Some(Self::UpdatingAdWithNoEnabledAssociation),
"CALL_AD_VERIFICATION_URL_FINAL_URL_DOES_NOT_HAVE_SAME_DOMAIN" => Some(Self::CallAdVerificationUrlFinalUrlDoesNotHaveSameDomain),
"CALL_AD_FINAL_URL_AND_VERIFICATION_URL_CANNOT_BOTH_BE_EMPTY" => Some(Self::CallAdFinalUrlAndVerificationUrlCannotBothBeEmpty),
...
"MORE_THAN_ONE_COUNTDOWN_TAG_TYPE_EXISTS" => Some(Self::MoreThanOneCountdownTagTypeExists),
"DATE_TIME_IN_COUNTDOWN_TAG_IS_INVALID" => Some(Self::DateTimeInCountdownTagIsInvalid),
"DATE_TIME_IN_COUNTDOWN_TAG_IS_PAST" => Some(Self::DateTimeInCountdownTagIsPast),
"UNRECOGNIZED_AD_CUSTOMIZER_TAG_FOUND" => Some(Self::UnrecognizedAdCustomizerTagFound),
"CUSTOMIZER_TYPE_FORBIDDEN_FOR_FIELD" => Some(Self::CustomizerTypeForbiddenForField),
"INVALID_CUSTOMIZER_ATTRIBUTE_NAME" => Some(Self::InvalidCustomizerAttributeName),
"STORE_MISMATCH" => Some(Self::StoreMismatch),
"MISSING_REQUIRED_IMAGE_ASPECT_RATIO" => Some(Self::MissingRequiredImageAspectRatio),
"MISMATCHED_ASPECT_RATIOS" => Some(Self::MismatchedAspectRatios),
"DUPLICATE_IMAGE_ACROSS_CAROUSEL_CARDS" => Some(Self::DuplicateImageAcrossCarouselCards),
_ => None,
}
}
}
...
AssetGroupError::FinalUrlContainsInvalidDomainName => "FINAL_URL_CONTAINS_INVALID_DOMAIN_NAME",
AssetGroupError::AdCustomizerNotSupported => "AD_CUSTOMIZER_NOT_SUPPORTED",
AssetGroupError::CannotMutateAssetGroupForRemovedCampaign => "CANNOT_MUTATE_ASSET_GROUP_FOR_REMOVED_CAMPAIGN",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"UNKNOWN" => Some(Self::Unknown),
"DUPLICATE_NAME" => Some(Self::DuplicateName),
"CANNOT_ADD_ASSET_GROUP_FOR_CAMPAIGN_TYPE" => Some(Self::CannotAddAssetGroupForCampaignType),
...
"NOT_ENOUGH_SQUARE_MARKETING_IMAGE_ASSET" => Some(Self::NotEnoughSquareMarketingImageAsset),
"NOT_ENOUGH_LOGO_ASSET" => Some(Self::NotEnoughLogoAsset),
"FINAL_URL_SHOPPING_MERCHANT_HOME_PAGE_URL_DOMAINS_DIFFER" => Some(Self::FinalUrlShoppingMerchantHomePageUrlDomainsDiffer),
...
"FINAL_URL_CONTAINS_INVALID_DOMAIN_NAME" => Some(Self::FinalUrlContainsInvalidDomainName),
"AD_CUSTOMIZER_NOT_SUPPORTED" => Some(Self::AdCustomizerNotSupported),
"CANNOT_MUTATE_ASSET_GROUP_FOR_REMOVED_CAMPAIGN" => Some(Self::CannotMutateAssetGroupForRemovedCampaign),
_ => None,
}
}
}
...
CurrencyError::ValueNotMultipleOfBillableUnit => "VALUE_NOT_MULTIPLE_OF_BILLABLE_UNIT",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
BiddingError::BiddingStrategyAndBudgetMustBeAligned => "BIDDING_STRATEGY_AND_BUDGET_MUST_BE_ALIGNED",
BiddingError::BiddingStrategyAndBudgetMustBeAttachedToTheSameCampaignsToAlign => "BIDDING_STRATEGY_AND_BUDGET_MUST_BE_ATTACHED_TO_THE_SAME_CAMPAIGNS_TO_ALIGN",
BiddingError::BiddingStrategyAndBudgetMustBeRemovedTogether => "BIDDING_STRATEGY_AND_BUDGET_MUST_BE_REMOVED_TOGETHER",
BiddingError::CpcBidFloorMicrosGreaterThanCpcBidCeilingMicros => "CPC_BID_FLOOR_MICROS_GREATER_THAN_CPC_BID_CEILING_MICROS",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"UNSPECIFIED" => Some(Self::Unspecified),
"UNKNOWN" => Some(Self::Unknown),
"BIDDING_STRATEGY_TRANSITION_NOT_ALLOWED" => Some(Self::BiddingStrategyTransitionNotAllowed),
"CANNOT_ATTACH_BIDDING_STRATEGY_TO_CAMPAIGN" => Some(Self::CannotAttachBiddingStrategyToCampaign),
"INVALID_ANONYMOUS_BIDDING_STRATEGY_TYPE" => Some(Self::InvalidAnonymousBiddingStrategyType),
"INVALID_BIDDING_STRATEGY_TYPE" => Some(Self::InvalidBiddingStrategyType),
"INVALID_BID" => Some(Self::InvalidBid),
"BIDDING_STRATEGY_NOT_AVAILABLE_FOR_ACCOUNT_TYPE" => Some(Self::BiddingStrategyNotAvailableForAccountType),
"CANNOT_CREATE_CAMPAIGN_WITH_BIDDING_STRATEGY" => Some(Self::CannotCreateCampaignWithBiddingStrategy),
"CANNOT_TARGET_CONTENT_NETWORK_ONLY_WITH_CAMPAIGN_LEVEL_POP_BIDDING_STRATEGY" => Some(Self::CannotTargetContentNetworkOnlyWithCampaignLevelPopBiddingStrategy),
"BIDDING_STRATEGY_NOT_SUPPORTED_WITH_AD_SCHEDULE" => Some(Self::BiddingStrategyNotSupportedWithAdSchedule),
"PAY_PER_CONVERSION_NOT_AVAILABLE_FOR_CUSTOMER" => Some(Self::PayPerConversionNotAvailableForCustomer),
"PAY_PER_CONVERSION_NOT_ALLOWED_WITH_TARGET_CPA" => Some(Self::PayPerConversionNotAllowedWithTargetCpa),
"BIDDING_STRATEGY_NOT_ALLOWED_FOR_SEARCH_ONLY_CAMPAIGNS" => Some(Self::BiddingStrategyNotAllowedForSearchOnlyCampaigns),
"BIDDING_STRATEGY_NOT_SUPPORTED_IN_DRAFTS_OR_EXPERIMENTS" => Some(Self::BiddingStrategyNotSupportedInDraftsOrExperiments),
"BIDDING_STRATEGY_TYPE_DOES_NOT_SUPPORT_PRODUCT_TYPE_ADGROUP_CRITERION" => Some(Self::BiddingStrategyTypeDoesNotSupportProductTypeAdgroupCriterion),
...
"BIDDING_STRATEGY_TYPE_INCOMPATIBLE_WITH_SHARED_BUDGET" => Some(Self::BiddingStrategyTypeIncompatibleWithSharedBudget),
"BIDDING_STRATEGY_AND_BUDGET_MUST_BE_ALIGNED" => Some(Self::BiddingStrategyAndBudgetMustBeAligned),
"BIDDING_STRATEGY_AND_BUDGET_MUST_BE_ATTACHED_TO_THE_SAME_CAMPAIGNS_TO_ALIGN" => Some(Self::BiddingStrategyAndBudgetMustBeAttachedToTheSameCampaignsToAlign),
"BIDDING_STRATEGY_AND_BUDGET_MUST_BE_REMOVED_TOGETHER" => Some(Self::BiddingStrategyAndBudgetMustBeRemovedTogether),
"CPC_BID_FLOOR_MICROS_GREATER_THAN_CPC_BID_CEILING_MICROS" => Some(Self::CpcBidFloorMicrosGreaterThanCpcBidCeilingMicros),
_ => None,
}
}
}
...
VideoCampaignError::MutateRequiresReservation => "MUTATE_REQUIRES_RESERVATION",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
CustomerLifecycleGoalError::CustomerAcquisitionValueMissing => "CUSTOMER_ACQUISITION_VALUE_MISSING",
CustomerLifecycleGoalError::CustomerAcquisitionInvalidValue => "CUSTOMER_ACQUISITION_INVALID_VALUE",
CustomerLifecycleGoalError::CustomerAcquisitionInvalidHighLifetimeValue => "CUSTOMER_ACQUISITION_INVALID_HIGH_LIFETIME_VALUE",
CustomerLifecycleGoalError::CustomerAcquisitionValueCannotBeCleared => "CUSTOMER_ACQUISITION_VALUE_CANNOT_BE_CLEARED",
CustomerLifecycleGoalError::CustomerAcquisitionHighLifetimeValueCannotBeCleared => "CUSTOMER_ACQUISITION_HIGH_LIFETIME_VALUE_CANNOT_BE_CLEARED",
CustomerLifecycleGoalError::InvalidExistingUserList => "INVALID_EXISTING_USER_LIST",
CustomerLifecycleGoalError::InvalidHighLifetimeValueUserList => "INVALID_HIGH_LIFETIME_VALUE_USER_LIST",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"CUSTOMER_ACQUISITION_INVALID_HIGH_LIFETIME_VALUE" => Some(Self::CustomerAcquisitionInvalidHighLifetimeValue),
"CUSTOMER_ACQUISITION_VALUE_CANNOT_BE_CLEARED" => Some(Self::CustomerAcquisitionValueCannotBeCleared),
"CUSTOMER_ACQUISITION_HIGH_LIFETIME_VALUE_CANNOT_BE_CLEARED" => Some(Self::CustomerAcquisitionHighLifetimeValueCannotBeCleared),
"INVALID_EXISTING_USER_LIST" => Some(Self::InvalidExistingUserList),
"INVALID_HIGH_LIFETIME_VALUE_USER_LIST" => Some(Self::InvalidHighLifetimeValueUserList),
_ => None,
}
}
}
...
AssetSetError::AssetSetSourceIncompatibleWithParentAssetSet => "ASSET_SET_SOURCE_INCOMPATIBLE_WITH_PARENT_ASSET_SET",
AssetSetError::AssetSetTypeCannotBeLinkedToCustomer => "ASSET_SET_TYPE_CANNOT_BE_LINKED_TO_CUSTOMER",
AssetSetError::InvalidChainIds => "INVALID_CHAIN_IDS",
AssetSetError::LocationSyncAssetSetDoesNotSupportRelationshipType => "LOCATION_SYNC_ASSET_SET_DOES_NOT_SUPPORT_RELATIONSHIP_TYPE",
AssetSetError::NotUniqueEnabledLocationSyncTypedAssetSet => "NOT_UNIQUE_ENABLED_LOCATION_SYNC_TYPED_ASSET_SET",
...
AssetSetError::CannotDeleteAsEnabledLinkagesExist => "CANNOT_DELETE_AS_ENABLED_LINKAGES_EXIST",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"ASSET_SET_SOURCE_INCOMPATIBLE_WITH_PARENT_ASSET_SET" => Some(Self::AssetSetSourceIncompatibleWithParentAssetSet),
"ASSET_SET_TYPE_CANNOT_BE_LINKED_TO_CUSTOMER" => Some(Self::AssetSetTypeCannotBeLinkedToCustomer),
"INVALID_CHAIN_IDS" => Some(Self::InvalidChainIds),
"LOCATION_SYNC_ASSET_SET_DOES_NOT_SUPPORT_RELATIONSHIP_TYPE" => Some(Self::LocationSyncAssetSetDoesNotSupportRelationshipType),
"NOT_UNIQUE_ENABLED_LOCATION_SYNC_TYPED_ASSET_SET" => Some(Self::NotUniqueEnabledLocationSyncTypedAssetSet),
...
"CANNOT_DELETE_AS_ENABLED_LINKAGES_EXIST" => Some(Self::CannotDeleteAsEnabledLinkagesExist),
_ => None,
}
}
}
...
"COUNTDOWN_INVALID_START_DAYS_BEFORE" => Some(Self::CountdownInvalidStartDaysBefore),
...
AuthorizationError::CloudProjectNotUnderOrganization => "CLOUD_PROJECT_NOT_UNDER_ORGANIZATION",
AuthorizationError::ActionNotPermittedForSuspendedAccount => "ACTION_NOT_PERMITTED_FOR_SUSPENDED_ACCOUNT",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"INVALID_LOGIN_CUSTOMER_ID_SERVING_CUSTOMER_ID_COMBINATION" => Some(Self::InvalidLoginCustomerIdServingCustomerIdCombination),
...
"CLOUD_PROJECT_NOT_UNDER_ORGANIZATION" => Some(Self::CloudProjectNotUnderOrganization),
"ACTION_NOT_PERMITTED_FOR_SUSPENDED_ACCOUNT" => Some(Self::ActionNotPermittedForSuspendedAccount),
_ => None,
}
}
}
...
"MUTATE_ACTION_NOT_PERMITTED_FOR_CLIENT" => Some(Self::MutateActionNotPermittedForClient),
"OPERATION_NOT_PERMITTED_FOR_CAMPAIGN_TYPE" => Some(Self::OperationNotPermittedForCampaignType),
"CREATE_AS_REMOVED_NOT_PERMITTED" => Some(Self::CreateAsRemovedNotPermitted),
"OPERATION_NOT_PERMITTED_FOR_REMOVED_RESOURCE" => Some(Self::OperationNotPermittedForRemovedResource),
"OPERATION_NOT_PERMITTED_FOR_AD_GROUP_TYPE" => Some(Self::OperationNotPermittedForAdGroupType),
...
"UNSPECIFIED" => Some(Self::Unspecified),
"UNKNOWN" => Some(Self::Unknown),
"EXTERNAL_REMARKETING_USER_LIST_MUTATE_NOT_SUPPORTED" => Some(Self::ExternalRemarketingUserListMutateNotSupported),
...
"CAN_NOT_ADD_LOGICAL_LIST_AS_LOGICAL_LIST_OPERAND" => Some(Self::CanNotAddLogicalListAsLogicalListOperand),
"INVALID_USER_LIST_LOGICAL_RULE_OPERAND" => Some(Self::InvalidUserListLogicalRuleOperand),
...
"CANNOT_MODIFY_BILLABLE_RECORD_COUNT" => Some(Self::CannotModifyBillableRecordCount),
"APP_ID_NOT_SET" => Some(Self::AppIdNotSet),
"USERLIST_NAME_IS_RESERVED_FOR_SYSTEM_LIST" => Some(Self::UserlistNameIsReservedForSystemList),
"ADVERTISER_NOT_ON_ALLOWLIST_FOR_USING_UPLOADED_DATA" => Some(Self::AdvertiserNotOnAllowlistForUsingUploadedData),
"RULE_TYPE_IS_NOT_SUPPORTED" => Some(Self::RuleTypeIsNotSupported),
"CAN_NOT_ADD_A_SIMILAR_USERLIST_AS_LOGICAL_LIST_OPERAND" => Some(Self::CanNotAddASimilarUserlistAsLogicalListOperand),
"CAN_NOT_MIX_CRM_BASED_IN_LOGICAL_LIST_WITH_OTHER_LISTS" => Some(Self::CanNotMixCrmBasedInLogicalListWithOtherLists),
...
"UNKNOWN" => Some(Self::Unknown),
"NAME_ALREADY_USED" => Some(Self::NameAlreadyUsed),
"CUSTOM_INTEREST_MEMBER_ID_AND_TYPE_PARAMETER_NOT_PRESENT_IN_REMOVE" => Some(Self::CustomInterestMemberIdAndTypeParameterNotPresentInRemove),
...
"INVALID_CUSTOM_INTEREST_MEMBER_TYPE" => Some(Self::InvalidCustomInterestMemberType),
...
"FEED_ALREADY_EXISTS_FOR_PLACEHOLDER_TYPE" => Some(Self::FeedAlreadyExistsForPlaceholderType),
"CANNOT_CREATE_FOR_REMOVED_FEED" => Some(Self::CannotCreateForRemovedFeed),
"CANNOT_CREATE_ALREADY_EXISTING_CUSTOMER_FEED" => Some(Self::CannotCreateAlreadyExistingCustomerFeed),
"CANNOT_MODIFY_REMOVED_CUSTOMER_FEED" => Some(Self::CannotModifyRemovedCustomerFeed),
"INVALID_PLACEHOLDER_TYPE" => Some(Self::InvalidPlaceholderType),
"MISSING_FEEDMAPPING_FOR_PLACEHOLDER_TYPE" => Some(Self::MissingFeedmappingForPlaceholderType),
"PLACEHOLDER_TYPE_NOT_ALLOWED_ON_CUSTOMER_FEED" => Some(Self::PlaceholderTypeNotAllowedOnCustomerFeed),
_ => None,
}
}
}
...
"UNSPECIFIED" => Some(Self::Unspecified),
"UNKNOWN" => Some(Self::Unknown),
"CRITERION_TYPE_NOT_ALLOWED_FOR_SHARED_SET_TYPE" => Some(Self::CriterionTypeNotAllowedForSharedSetType),
_ => None,
}
}
}
...
"INVALID_TAG_IN_TRACKING_URL_TEMPLATE" => Some(Self::InvalidTagInTrackingUrlTemplate),
"MISSING_TRACKING_URL_TEMPLATE_TAG" => Some(Self::MissingTrackingUrlTemplateTag),
"MISSING_PROTOCOL_IN_TRACKING_URL_TEMPLATE" => Some(Self::MissingProtocolInTrackingUrlTemplate),
"INVALID_PROTOCOL_IN_TRACKING_URL_TEMPLATE" => Some(Self::InvalidProtocolInTrackingUrlTemplate),
"MALFORMED_TRACKING_URL_TEMPLATE" => Some(Self::MalformedTrackingUrlTemplate),
"MISSING_HOST_IN_TRACKING_URL_TEMPLATE" => Some(Self::MissingHostInTrackingUrlTemplate),
"INVALID_TLD_IN_TRACKING_URL_TEMPLATE" => Some(Self::InvalidTldInTrackingUrlTemplate),
"REDUNDANT_NESTED_TRACKING_URL_TEMPLATE_TAG" => Some(Self::RedundantNestedTrackingUrlTemplateTag),
"INVALID_FINAL_URL" => Some(Self::InvalidFinalUrl),
...
"REDUNDANT_NESTED_FINAL_MOBILE_URL_TAG" => Some(Self::RedundantNestedFinalMobileUrlTag),
"MISSING_PROTOCOL_IN_FINAL_MOBILE_URL" => Some(Self::MissingProtocolInFinalMobileUrl),
"INVALID_PROTOCOL_IN_FINAL_MOBILE_URL" => Some(Self::InvalidProtocolInFinalMobileUrl),
...
"URL_CUSTOM_PARAMETERS_COUNT_EXCEEDS_LIMIT" => Some(Self::UrlCustomParametersCountExceedsLimit),
"INVALID_CHARACTERS_IN_URL_CUSTOM_PARAMETER_KEY" => Some(Self::InvalidCharactersInUrlCustomParameterKey),
"INVALID_CHARACTERS_IN_URL_CUSTOM_PARAMETER_VALUE" => Some(Self::InvalidCharactersInUrlCustomParameterValue),
"INVALID_TAG_IN_URL_CUSTOM_PARAMETER_VALUE" => Some(Self::InvalidTagInUrlCustomParameterValue),
"REDUNDANT_NESTED_URL_CUSTOM_PARAMETER_TAG" => Some(Self::RedundantNestedUrlCustomParameterTag),
...
"GOOGLE_CONSUMER_ACCOUNT_NOT_ALLOWED" => Some(Self::GoogleConsumerAccountNotAllowed),
"INVALID_INVITATION_ID" => Some(Self::InvalidInvitationId),
"EMAIL_ADDRESS_ALREADY_HAS_PENDING_INVITATION" => Some(Self::EmailAddressAlreadyHasPendingInvitation),
...
AccountBudgetProposalError::InvalidMasterServiceAgreement => "INVALID_MASTER_SERVICE_AGREEMENT",
...
"MULTIPLE_BUDGETS_NOT_ALLOWED_FOR_UNAPPROVED_BILLING_SETUP" => Some(Self::MultipleBudgetsNotAllowedForUnapprovedBillingSetup),
"CANNOT_UPDATE_START_TIME_FOR_STARTED_BUDGET" => Some(Self::CannotUpdateStartTimeForStartedBudget),
"SPENDING_LIMIT_LOWER_THAN_ACCRUED_COST_NOT_ALLOWED" => Some(Self::SpendingLimitLowerThanAccruedCostNotAllowed),
"UPDATE_IS_NO_OP" => Some(Self::UpdateIsNoOp),
"END_TIME_MUST_FOLLOW_START_TIME" => Some(Self::EndTimeMustFollowStartTime),
"BUDGET_DATE_RANGE_INCOMPATIBLE_WITH_BILLING_SETUP" => Some(Self::BudgetDateRangeIncompatibleWithBillingSetup),
...
"CANNOT_OPERATE_ON_REMOVED_ADGROUPAD" => Some(Self::CannotOperateOnRemovedAdgroupad),
...
"CANNOT_OVERRIDE_OPTED_OUT_CAMPAIGN_CRITERION_BID_MODIFIER" => Some(Self::CannotOverrideOptedOutCampaignCriterionBidModifier),
_ => None,
}
}
}
...
"UNSPECIFIED" => Some(Self::Unspecified),
"UNKNOWN" => Some(Self::Unknown),
"AD_GROUP_CRITERION_LABEL_DOES_NOT_EXIST" => Some(Self::AdGroupCriterionLabelDoesNotExist),
"AD_GROUP_CRITERION_LABEL_ALREADY_EXISTS" => Some(Self::AdGroupCriterionLabelAlreadyExists),
"CANNOT_ADD_LABEL_TO_NEGATIVE_CRITERION" => Some(Self::CannotAddLabelToNegativeCriterion),
...
"MISSING_DESTINATION_URL_TAG" => Some(Self::MissingDestinationUrlTag),
"KEYWORD_LEVEL_BID_NOT_SUPPORTED_FOR_MANUALCPM" => Some(Self::KeywordLevelBidNotSupportedForManualcpm),
...
"CAMPAIGN_TYPE_NOT_COMPATIBLE_WITH_PARTIAL_FAILURE" => Some(Self::CampaignTypeNotCompatibleWithPartialFailure),
"OPERATIONS_FOR_TOO_MANY_SHOPPING_ADGROUPS" => Some(Self::OperationsForTooManyShoppingAdgroups),
"CANNOT_MODIFY_URL_FIELDS_WITH_DUPLICATE_ELEMENTS" => Some(Self::CannotModifyUrlFieldsWithDuplicateElements),
"CANNOT_SET_WITHOUT_FINAL_URLS" => Some(Self::CannotSetWithoutFinalUrls),
"CANNOT_CLEAR_FINAL_URLS_IF_FINAL_MOBILE_URLS_EXIST" => Some(Self::CannotClearFinalUrlsIfFinalMobileUrlsExist),
"CANNOT_CLEAR_FINAL_URLS_IF_FINAL_APP_URLS_EXIST" => Some(Self::CannotClearFinalUrlsIfFinalAppUrlsExist),
"CANNOT_CLEAR_FINAL_URLS_IF_TRACKING_URL_TEMPLATE_EXISTS" => Some(Self::CannotClearFinalUrlsIfTrackingUrlTemplateExists),
"CANNOT_CLEAR_FINAL_URLS_IF_URL_CUSTOM_PARAMETERS_EXIST" => Some(Self::CannotClearFinalUrlsIfUrlCustomParametersExist),
"CANNOT_SET_BOTH_DESTINATION_URL_AND_FINAL_URLS" => Some(Self::CannotSetBothDestinationUrlAndFinalUrls),
"CANNOT_SET_BOTH_DESTINATION_URL_AND_TRACKING_URL_TEMPLATE" => Some(Self::CannotSetBothDestinationUrlAndTrackingUrlTemplate),
"FINAL_URLS_NOT_SUPPORTED_FOR_CRITERION_TYPE" => Some(Self::FinalUrlsNotSupportedForCriterionType),
"FINAL_MOBILE_URLS_NOT_SUPPORTED_FOR_CRITERION_TYPE" => Some(Self::FinalMobileUrlsNotSupportedForCriterionType),
_ => None,
}
}
}
...
AdGroupError::InvalidExcludedParentAssetSetType => "INVALID_EXCLUDED_PARENT_ASSET_SET_TYPE",
AdGroupError::CannotAddAdGroupForCampaignType => "CANNOT_ADD_AD_GROUP_FOR_CAMPAIGN_TYPE",
...
"BID_TOO_BIG" => Some(Self::BidTooBig),
"BID_TYPE_AND_BIDDING_STRATEGY_MISMATCH" => Some(Self::BidTypeAndBiddingStrategyMismatch),
...
"INVALID_CONTENT_BID_CRITERION_TYPE_GROUP" => Some(Self::InvalidContentBidCriterionTypeGroup),
"AD_GROUP_TYPE_NOT_VALID_FOR_ADVERTISING_CHANNEL_TYPE" => Some(Self::AdGroupTypeNotValidForAdvertisingChannelType),
"ADGROUP_TYPE_NOT_SUPPORTED_FOR_CAMPAIGN_SALES_COUNTRY" => Some(Self::AdgroupTypeNotSupportedForCampaignSalesCountry),
"CANNOT_ADD_ADGROUP_OF_TYPE_DSA_TO_CAMPAIGN_WITHOUT_DSA_SETTING" => Some(Self::CannotAddAdgroupOfTypeDsaToCampaignWithoutDsaSetting),
"PROMOTED_HOTEL_AD_GROUPS_NOT_AVAILABLE_FOR_CUSTOMER" => Some(Self::PromotedHotelAdGroupsNotAvailableForCustomer),
"INVALID_EXCLUDED_PARENT_ASSET_FIELD_TYPE" => Some(Self::InvalidExcludedParentAssetFieldType),
"INVALID_EXCLUDED_PARENT_ASSET_SET_TYPE" => Some(Self::InvalidExcludedParentAssetSetType),
"CANNOT_ADD_AD_GROUP_FOR_CAMPAIGN_TYPE" => Some(Self::CannotAddAdGroupForCampaignType),
"INVALID_STATUS" => Some(Self::InvalidStatus),
_ => None,
}
}
...
AssetError::MobileAppInvalidFinalUrlForAppDownloadUrl => "MOBILE_APP_INVALID_FINAL_URL_FOR_APP_DOWNLOAD_URL",
AssetError::NameRequiredForAssetType => "NAME_REQUIRED_FOR_ASSET_TYPE",
AssetError::LeadFormLegacyQualifyingQuestionsDisallowed => "LEAD_FORM_LEGACY_QUALIFYING_QUESTIONS_DISALLOWED",
...
AssetError::CannotModifyAutomaticallyCreatedAsset => "CANNOT_MODIFY_AUTOMATICALLY_CREATED_ASSET",
AssetError::LeadFormLocationAnswerTypeDisallowed => "LEAD_FORM_LOCATION_ANSWER_TYPE_DISALLOWED",
...
"UNSPECIFIED" => Some(Self::Unspecified),
"UNKNOWN" => Some(Self::Unknown),
"CUSTOMER_NOT_ON_ALLOWLIST_FOR_ASSET_TYPE" => Some(Self::CustomerNotOnAllowlistForAssetType),
...
"INVALID_CALL_TO_ACTION_TEXT" => Some(Self::InvalidCallToActionText),
"LEAD_FORM_INVALID_FIELDS_COMBINATION" => Some(Self::LeadFormInvalidFieldsCombination),
"LEAD_FORM_MISSING_AGREEMENT" => Some(Self::LeadFormMissingAgreement),
"INVALID_ASSET_STATUS" => Some(Self::InvalidAssetStatus),
"FIELD_CANNOT_BE_MODIFIED_FOR_ASSET_TYPE" => Some(Self::FieldCannotBeModifiedForAssetType),
"SCHEDULES_CANNOT_OVERLAP" => Some(Self::SchedulesCannotOverlap),
"PROMOTION_CANNOT_SET_PERCENT_OFF_AND_MONEY_AMOUNT_OFF" => Some(Self::PromotionCannotSetPercentOffAndMoneyAmountOff),
"PROMOTION_CANNOT_SET_PROMOTION_CODE_AND_ORDERS_OVER_AMOUNT" => Some(Self::PromotionCannotSetPromotionCodeAndOrdersOverAmount),
"TOO_MANY_DECIMAL_PLACES_SPECIFIED" => Some(Self::TooManyDecimalPlacesSpecified),
"DUPLICATE_ASSETS_WITH_DIFFERENT_FIELD_VALUE" => Some(Self::DuplicateAssetsWithDifferentFieldValue),
"CALL_CARRIER_SPECIFIC_SHORT_NUMBER_NOT_ALLOWED" => Some(Self::CallCarrierSpecificShortNumberNotAllowed),
"CALL_CUSTOMER_CONSENT_FOR_CALL_RECORDING_REQUIRED" => Some(Self::CallCustomerConsentForCallRecordingRequired),
...
"CALL_INVALID_DOMESTIC_PHONE_NUMBER_FORMAT" => Some(Self::CallInvalidDomesticPhoneNumberFormat),
"CALL_INVALID_PHONE_NUMBER" => Some(Self::CallInvalidPhoneNumber),
"CALL_PHONE_NUMBER_NOT_SUPPORTED_FOR_COUNTRY" => Some(Self::CallPhoneNumberNotSupportedForCountry),
"CALL_PREMIUM_RATE_NUMBER_NOT_ALLOWED" => Some(Self::CallPremiumRateNumberNotAllowed),
"CALL_VANITY_PHONE_NUMBER_NOT_ALLOWED" => Some(Self::CallVanityPhoneNumberNotAllowed),
...
"MOBILE_APP_INVALID_FINAL_URL_FOR_APP_DOWNLOAD_URL" => Some(Self::MobileAppInvalidFinalUrlForAppDownloadUrl),
"NAME_REQUIRED_FOR_ASSET_TYPE" => Some(Self::NameRequiredForAssetType),
"LEAD_FORM_LEGACY_QUALIFYING_QUESTIONS_DISALLOWED" => Some(Self::LeadFormLegacyQualifyingQuestionsDisallowed),
...
"CANNOT_MODIFY_AUTOMATICALLY_CREATED_ASSET" => Some(Self::CannotModifyAutomaticallyCreatedAsset),
"LEAD_FORM_LOCATION_ANSWER_TYPE_DISALLOWED" => Some(Self::LeadFormLocationAnswerTypeDisallowed),
...
AssetGroupListingGroupFilterError::DimensionTypeNotAllowed => "DIMENSION_TYPE_NOT_ALLOWED",
AssetGroupListingGroupFilterError::DuplicateWebpageFilterUnderAssetGroup => "DUPLICATE_WEBPAGE_FILTER_UNDER_ASSET_GROUP",
AssetGroupListingGroupFilterError::ListingSourceNotAllowed => "LISTING_SOURCE_NOT_ALLOWED",
AssetGroupListingGroupFilterError::FilterExclusionNotAllowed => "FILTER_EXCLUSION_NOT_ALLOWED",
AssetGroupListingGroupFilterError::MultipleListingSources => "MULTIPLE_LISTING_SOURCES",
AssetGroupListingGroupFilterError::MultipleWebpageConditionTypesNotAllowed => "MULTIPLE_WEBPAGE_CONDITION_TYPES_NOT_ALLOWED",
AssetGroupListingGroupFilterError::MultipleWebpageTypesPerAssetGroup => "MULTIPLE_WEBPAGE_TYPES_PER_ASSET_GROUP",
AssetGroupListingGroupFilterError::PageFeedFilterHasParent => "PAGE_FEED_FILTER_HAS_PARENT",
AssetGroupListingGroupFilterError::MultipleOperationsOnOneNode => "MULTIPLE_OPERATIONS_ON_ONE_NODE",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"SUBDIVISION_MUST_HAVE_EVERYTHING_ELSE_CHILD" => Some(Self::SubdivisionMustHaveEverythingElseChild),
"DIFFERENT_DIMENSION_TYPE_BETWEEN_SIBLINGS" => Some(Self::DifferentDimensionTypeBetweenSiblings),
"SAME_DIMENSION_VALUE_BETWEEN_SIBLINGS" => Some(Self::SameDimensionValueBetweenSiblings),
"SAME_DIMENSION_TYPE_BETWEEN_ANCESTORS" => Some(Self::SameDimensionTypeBetweenAncestors),
"MULTIPLE_ROOTS" => Some(Self::MultipleRoots),
"INVALID_DIMENSION_VALUE" => Some(Self::InvalidDimensionValue),
"MUST_REFINE_HIERARCHICAL_PARENT_TYPE" => Some(Self::MustRefineHierarchicalParentType),
...
"CANNOT_REFINE_HIERARCHICAL_EVERYTHING_ELSE" => Some(Self::CannotRefineHierarchicalEverythingElse),
"DIMENSION_TYPE_NOT_ALLOWED" => Some(Self::DimensionTypeNotAllowed),
"DUPLICATE_WEBPAGE_FILTER_UNDER_ASSET_GROUP" => Some(Self::DuplicateWebpageFilterUnderAssetGroup),
...
"MULTIPLE_WEBPAGE_CONDITION_TYPES_NOT_ALLOWED" => Some(Self::MultipleWebpageConditionTypesNotAllowed),
"MULTIPLE_WEBPAGE_TYPES_PER_ASSET_GROUP" => Some(Self::MultipleWebpageTypesPerAssetGroup),
...
AssetGroupSignalError::SearchThemePolicyViolation => "SEARCH_THEME_POLICY_VIOLATION",
AssetGroupSignalError::AudienceWithWrongAssetGroupId => "AUDIENCE_WITH_WRONG_ASSET_GROUP_ID",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"INCOMPATIBLE_ASSET_SET_TYPE_WITH_CAMPAIGN_TYPE" => Some(Self::IncompatibleAssetSetTypeWithCampaignType),
...
AudienceError::AudienceSegmentTypeNotSupported => "AUDIENCE_SEGMENT_TYPE_NOT_SUPPORTED",
...
AudienceError::CannotChangeFromCustomerToAssetGroupScope => "CANNOT_CHANGE_FROM_CUSTOMER_TO_ASSET_GROUP_SCOPE",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"AUDIENCE_SEGMENT_TYPE_NOT_SUPPORTED" => Some(Self::AudienceSegmentTypeNotSupported),
...
"CANNOT_CHANGE_FROM_CUSTOMER_TO_ASSET_GROUP_SCOPE" => Some(Self::CannotChangeFromCustomerToAssetGroupScope),
_ => None,
}
}
}
...
"UNSPECIFIED" => Some(Self::Unspecified),
"UNKNOWN" => Some(Self::Unknown),
"DIMENSION_INCOMPATIBLE_WITH_TOPIC_AUDIENCE_COMBINATIONS" => Some(Self::DimensionIncompatibleWithTopicAudienceCombinations),
_ => None,
}
}
}
...
AuthenticationError::OrganizationNotAssociatedWithDeveloperToken => "ORGANIZATION_NOT_ASSOCIATED_WITH_DEVELOPER_TOKEN",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"GOOGLE_ACCOUNT_AUTHENTICATION_FAILED" => Some(Self::GoogleAccountAuthenticationFailed),
"GOOGLE_ACCOUNT_USER_AND_ADS_USER_MISMATCH" => Some(Self::GoogleAccountUserAndAdsUserMismatch),
...
"ORGANIZATION_NOT_ASSOCIATED_WITH_DEVELOPER_TOKEN" => Some(Self::OrganizationNotAssociatedWithDeveloperToken),
_ => None,
}
}
}
...
"UNKNOWN" => Some(Self::Unknown),
"DUPLICATE_NAME" => Some(Self::DuplicateName),
"CANNOT_CHANGE_BIDDING_STRATEGY_TYPE" => Some(Self::CannotChangeBiddingStrategyType),
...
"INCOMPATIBLE_BIDDING_STRATEGY_AND_BIDDING_STRATEGY_GOAL_TYPE" => Some(Self::IncompatibleBiddingStrategyAndBiddingStrategyGoalType),
_ => None,
}
}
}
...
BillingSetupError::PaymentsProfileNeedsServiceAgreementAcceptance => "PAYMENTS_PROFILE_NEEDS_SERVICE_AGREEMENT_ACCEPTANCE",
...
BillingSetupError::TooManyBillingSetupsForPaymentsAccount => "TOO_MANY_BILLING_SETUPS_FOR_PAYMENTS_ACCOUNT",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"CANNOT_REMOVE_STARTED_BILLING_SETUP" => Some(Self::CannotRemoveStartedBillingSetup),
"CANNOT_CHANGE_BILLING_TO_SAME_PAYMENTS_ACCOUNT" => Some(Self::CannotChangeBillingToSamePaymentsAccount),
"BILLING_SETUP_NOT_PERMITTED_FOR_CUSTOMER_STATUS" => Some(Self::BillingSetupNotPermittedForCustomerStatus),
"INVALID_PAYMENTS_ACCOUNT" => Some(Self::InvalidPaymentsAccount),
"BILLING_SETUP_NOT_PERMITTED_FOR_CUSTOMER_CATEGORY" => Some(Self::BillingSetupNotPermittedForCustomerCategory),
...
"PAYMENTS_PROFILE_NEEDS_SERVICE_AGREEMENT_ACCEPTANCE" => Some(Self::PaymentsProfileNeedsServiceAgreementAcceptance),
"PAYMENTS_ACCOUNT_INELIGIBLE_CURRENCY_CODE_MISMATCH" => Some(Self::PaymentsAccountIneligibleCurrencyCodeMismatch),
"FUTURE_START_TIME_PROHIBITED" => Some(Self::FutureStartTimeProhibited),
"TOO_MANY_BILLING_SETUPS_FOR_PAYMENTS_ACCOUNT" => Some(Self::TooManyBillingSetupsForPaymentsAccount),
_ => None,
}
}
}
...
"CAMPAIGN_BUDGET_PERIOD_NOT_AVAILABLE" => Some(Self::CampaignBudgetPeriodNotAvailable),
"CANNOT_MODIFY_FIELD_OF_IMPLICITLY_SHARED_CAMPAIGN_BUDGET" => Some(Self::CannotModifyFieldOfImplicitlySharedCampaignBudget),
"CANNOT_UPDATE_CAMPAIGN_BUDGET_TO_IMPLICITLY_SHARED" => Some(Self::CannotUpdateCampaignBudgetToImplicitlyShared),
"CANNOT_UPDATE_CAMPAIGN_BUDGET_TO_EXPLICITLY_SHARED_WITHOUT_NAME" => Some(Self::CannotUpdateCampaignBudgetToExplicitlySharedWithoutName),
"CANNOT_UPDATE_CAMPAIGN_BUDGET_TO_EXPLICITLY_SHARED" => Some(Self::CannotUpdateCampaignBudgetToExplicitlyShared),
"CANNOT_USE_IMPLICITLY_SHARED_CAMPAIGN_BUDGET_WITH_MULTIPLE_CAMPAIGNS" => Some(Self::CannotUseImplicitlySharedCampaignBudgetWithMultipleCampaigns),
"DUPLICATE_NAME" => Some(Self::DuplicateName),
"MONEY_AMOUNT_IN_WRONG_CURRENCY" => Some(Self::MoneyAmountInWrongCurrency),
"MONEY_AMOUNT_LESS_THAN_CURRENCY_MINIMUM_CPC" => Some(Self::MoneyAmountLessThanCurrencyMinimumCpc),
"MONEY_AMOUNT_TOO_LARGE" => Some(Self::MoneyAmountTooLarge),
"NEGATIVE_MONEY_AMOUNT" => Some(Self::NegativeMoneyAmount),
"NON_MULTIPLE_OF_MINIMUM_CURRENCY_UNIT" => Some(Self::NonMultipleOfMinimumCurrencyUnit),
"TOTAL_BUDGET_AMOUNT_MUST_BE_UNSET_FOR_BUDGET_PERIOD_DAILY" => Some(Self::TotalBudgetAmountMustBeUnsetForBudgetPeriodDaily),
"INVALID_PERIOD" => Some(Self::InvalidPeriod),
"CANNOT_USE_ACCELERATED_DELIVERY_MODE" => Some(Self::CannotUseAcceleratedDeliveryMode),
"BUDGET_AMOUNT_MUST_BE_UNSET_FOR_CUSTOM_BUDGET_PERIOD" => Some(Self::BudgetAmountMustBeUnsetForCustomBudgetPeriod),
_ => None,
}
}
}
...
CampaignCriterionError::CannotRemoveAllLocationsDueToTooManyCountryExclusions => "CANNOT_REMOVE_ALL_LOCATIONS_DUE_TO_TOO_MANY_COUNTRY_EXCLUSIONS",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"CANNOT_SET_STATUS_FOR_EXCLUDED_CRITERIA" => Some(Self::CannotSetStatusForExcludedCriteria),
"CANNOT_TARGET_AND_EXCLUDE" => Some(Self::CannotTargetAndExclude),
"TOO_MANY_OPERATIONS" => Some(Self::TooManyOperations),
"OPERATOR_NOT_SUPPORTED_FOR_CRITERION_TYPE" => Some(Self::OperatorNotSupportedForCriterionType),
"SHOPPING_CAMPAIGN_SALES_COUNTRY_NOT_SUPPORTED_FOR_SALES_CHANNEL" => Some(Self::ShoppingCampaignSalesCountryNotSupportedForSalesChannel),
...
"CANNOT_SET_NEGATIVE_KEYWORD_THEME_CONSTANT_CRITERION" => Some(Self::CannotSetNegativeKeywordThemeConstantCriterion),
"INVALID_KEYWORD_THEME_CONSTANT" => Some(Self::InvalidKeywordThemeConstant),
"MISSING_KEYWORD_THEME_CONSTANT_OR_FREE_FORM_KEYWORD_THEME" => Some(Self::MissingKeywordThemeConstantOrFreeFormKeywordTheme),
"CANNOT_TARGET_BOTH_PROXIMITY_AND_LOCATION_CRITERIA_FOR_SMART_CAMPAIGN" => Some(Self::CannotTargetBothProximityAndLocationCriteriaForSmartCampaign),
"CANNOT_TARGET_MULTIPLE_PROXIMITY_CRITERIA_FOR_SMART_CAMPAIGN" => Some(Self::CannotTargetMultipleProximityCriteriaForSmartCampaign),
"LOCATION_NOT_LAUNCHED_FOR_LOCAL_SERVICES_CAMPAIGN" => Some(Self::LocationNotLaunchedForLocalServicesCampaign),
"LOCATION_INVALID_FOR_LOCAL_SERVICES_CAMPAIGN" => Some(Self::LocationInvalidForLocalServicesCampaign),
"CANNOT_TARGET_COUNTRY_FOR_LOCAL_SERVICES_CAMPAIGN" => Some(Self::CannotTargetCountryForLocalServicesCampaign),
"LOCATION_NOT_IN_HOME_COUNTRY_FOR_LOCAL_SERVICES_CAMPAIGN" => Some(Self::LocationNotInHomeCountryForLocalServicesCampaign),
"CANNOT_ADD_OR_REMOVE_LOCATION_FOR_LOCAL_SERVICES_CAMPAIGN" => Some(Self::CannotAddOrRemoveLocationForLocalServicesCampaign),
"AT_LEAST_ONE_POSITIVE_LOCATION_REQUIRED_FOR_LOCAL_SERVICES_CAMPAIGN" => Some(Self::AtLeastOnePositiveLocationRequiredForLocalServicesCampaign),
"AT_LEAST_ONE_LOCAL_SERVICE_ID_CRITERION_REQUIRED_FOR_LOCAL_SERVICES_CAMPAIGN" => Some(Self::AtLeastOneLocalServiceIdCriterionRequiredForLocalServicesCampaign),
"LOCAL_SERVICE_ID_NOT_FOUND_FOR_CATEGORY" => Some(Self::LocalServiceIdNotFoundForCategory),
"CANNOT_ATTACH_BRAND_LIST_TO_NON_QUALIFIED_SEARCH_CAMPAIGN" => Some(Self::CannotAttachBrandListToNonQualifiedSearchCampaign),
"CANNOT_REMOVE_ALL_LOCATIONS_DUE_TO_TOO_MANY_COUNTRY_EXCLUSIONS" => Some(Self::CannotRemoveAllLocationsDueToTooManyCountryExclusions),
_ => None,
}
}
}
...
"INVALID_STATUS_TRANSITION_FROM_REMOVED" => Some(Self::InvalidStatusTransitionFromRemoved),
"INVALID_STATUS_TRANSITION_FROM_PROMOTED" => Some(Self::InvalidStatusTransitionFromPromoted),
"INVALID_STATUS_TRANSITION_FROM_PROMOTE_FAILED" => Some(Self::InvalidStatusTransitionFromPromoteFailed),
...
"MAX_NUMBER_OF_DRAFTS_PER_CAMPAIGN_REACHED" => Some(Self::MaxNumberOfDraftsPerCampaignReached),
...
CampaignError::LocalServicesDuplicateCategoryBid => "LOCAL_SERVICES_DUPLICATE_CATEGORY_BID",
CampaignError::LocalServicesInvalidCategoryBid => "LOCAL_SERVICES_INVALID_CATEGORY_BID",
CampaignError::LocalServicesMissingCategoryBid => "LOCAL_SERVICES_MISSING_CATEGORY_BID",
...
CampaignError::InvalidExcludedParentAssetSetType => "INVALID_EXCLUDED_PARENT_ASSET_SET_TYPE",
CampaignError::AssetSetNotAHotelPropertyAssetSet => "ASSET_SET_NOT_A_HOTEL_PROPERTY_ASSET_SET",
CampaignError::HotelPropertyAssetSetOnlyForPerformanceMaxForTravelGoals => "HOTEL_PROPERTY_ASSET_SET_ONLY_FOR_PERFORMANCE_MAX_FOR_TRAVEL_GOALS",
CampaignError::AverageDailySpendTooHigh => "AVERAGE_DAILY_SPEND_TOO_HIGH",
CampaignError::CannotAttachToRemovedCampaignGroup => "CANNOT_ATTACH_TO_REMOVED_CAMPAIGN_GROUP",
...
CampaignError::CannotSetMoreThanOneConversionAction => "CANNOT_SET_MORE_THAN_ONE_CONVERSION_ACTION",
CampaignError::NotCompatibleWithBudgetType => "NOT_COMPATIBLE_WITH_BUDGET_TYPE",
CampaignError::NotCompatibleWithUploadClicksConversion => "NOT_COMPATIBLE_WITH_UPLOAD_CLICKS_CONVERSION",
CampaignError::AppIdMustMatchConversionActionAppId => "APP_ID_MUST_MATCH_CONVERSION_ACTION_APP_ID",
CampaignError::ConversionActionWithDownloadCategoryNotAllowed => "CONVERSION_ACTION_WITH_DOWNLOAD_CATEGORY_NOT_ALLOWED",
CampaignError::ConversionActionWithDownloadCategoryRequired => "CONVERSION_ACTION_WITH_DOWNLOAD_CATEGORY_REQUIRED",
CampaignError::ConversionTrackingNotEnabled => "CONVERSION_TRACKING_NOT_ENABLED",
CampaignError::NotCompatibleWithBiddingStrategyType => "NOT_COMPATIBLE_WITH_BIDDING_STRATEGY_TYPE",
CampaignError::NotCompatibleWithGoogleAttributionConversions => "NOT_COMPATIBLE_WITH_GOOGLE_ATTRIBUTION_CONVERSIONS",
...
CampaignError::InvalidNumberOfAdvertisingPartnerIds => "INVALID_NUMBER_OF_ADVERTISING_PARTNER_IDS",
CampaignError::CannotTargetDisplayNetworkWithoutYoutube => "CANNOT_TARGET_DISPLAY_NETWORK_WITHOUT_YOUTUBE",
CampaignError::CannotLinkToComparisonShoppingServiceAccount => "CANNOT_LINK_TO_COMPARISON_SHOPPING_SERVICE_ACCOUNT",
CampaignError::CannotTargetNetworkForComparisonShoppingServiceLinkedAccounts => "CANNOT_TARGET_NETWORK_FOR_COMPARISON_SHOPPING_SERVICE_LINKED_ACCOUNTS",
CampaignError::CannotModifyTextAssetAutomationWithEnabledTrial => "CANNOT_MODIFY_TEXT_ASSET_AUTOMATION_WITH_ENABLED_TRIAL",
CampaignError::DynamicTextAssetCannotOptOutWithFinalUrlExpansionOptIn => "DYNAMIC_TEXT_ASSET_CANNOT_OPT_OUT_WITH_FINAL_URL_EXPANSION_OPT_IN",
CampaignError::CannotSetCampaignKeywordMatchType => "CANNOT_SET_CAMPAIGN_KEYWORD_MATCH_TYPE",
CampaignError::CannotDisableBroadMatchWhenKeywordConversionInProcess => "CANNOT_DISABLE_BROAD_MATCH_WHEN_KEYWORD_CONVERSION_IN_PROCESS",
CampaignError::CannotDisableBroadMatchWhenTargetingBrands => "CANNOT_DISABLE_BROAD_MATCH_WHEN_TARGETING_BRANDS",
CampaignError::CannotEnableBroadMatchForBaseCampaignWithPromotingTrial => "CANNOT_ENABLE_BROAD_MATCH_FOR_BASE_CAMPAIGN_WITH_PROMOTING_TRIAL",
CampaignError::CannotEnableBroadMatchForPromotingTrialCampaign => "CANNOT_ENABLE_BROAD_MATCH_FOR_PROMOTING_TRIAL_CAMPAIGN",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"CANNOT_TARGET_SEARCH_NETWORK_WITHOUT_GOOGLE_SEARCH" => Some(Self::CannotTargetSearchNetworkWithoutGoogleSearch),
"CANNOT_TARGET_GOOGLE_SEARCH_FOR_CPM_CAMPAIGN" => Some(Self::CannotTargetGoogleSearchForCpmCampaign),
"CAMPAIGN_MUST_TARGET_AT_LEAST_ONE_NETWORK" => Some(Self::CampaignMustTargetAtLeastOneNetwork),
"CANNOT_TARGET_PARTNER_SEARCH_NETWORK" => Some(Self::CannotTargetPartnerSearchNetwork),
"CANNOT_TARGET_CONTENT_NETWORK_ONLY_WITH_CRITERIA_LEVEL_BIDDING_STRATEGY" => Some(Self::CannotTargetContentNetworkOnlyWithCriteriaLevelBiddingStrategy),
"CAMPAIGN_DURATION_MUST_CONTAIN_ALL_RUNNABLE_TRIALS" => Some(Self::CampaignDurationMustContainAllRunnableTrials),
...
"INVALID_AD_SERVING_OPTIMIZATION_STATUS" => Some(Self::InvalidAdServingOptimizationStatus),
"INVALID_TRACKING_URL" => Some(Self::InvalidTrackingUrl),
"CANNOT_SET_BOTH_TRACKING_URL_TEMPLATE_AND_TRACKING_SETTING" => Some(Self::CannotSetBothTrackingUrlTemplateAndTrackingSetting),
"MAX_IMPRESSIONS_NOT_IN_RANGE" => Some(Self::MaxImpressionsNotInRange),
"TIME_UNIT_NOT_SUPPORTED" => Some(Self::TimeUnitNotSupported),
"INVALID_OPERATION_IF_SERVING_STATUS_HAS_ENDED" => Some(Self::InvalidOperationIfServingStatusHasEnded),
...
"CANNOT_CHANGE_BUDGET_ON_CAMPAIGN_WITH_TRIALS" => Some(Self::CannotChangeBudgetOnCampaignWithTrials),
...
"ADVERTISING_CHANNEL_TYPE_NOT_AVAILABLE_FOR_ACCOUNT_TYPE" => Some(Self::AdvertisingChannelTypeNotAvailableForAccountType),
"INVALID_ADVERTISING_CHANNEL_SUB_TYPE" => Some(Self::InvalidAdvertisingChannelSubType),
"AT_LEAST_ONE_CONVERSION_MUST_BE_SELECTED" => Some(Self::AtLeastOneConversionMustBeSelected),
"CANNOT_SET_AD_ROTATION_MODE" => Some(Self::CannotSetAdRotationMode),
"CANNOT_MODIFY_START_DATE_IF_ALREADY_STARTED" => Some(Self::CannotModifyStartDateIfAlreadyStarted),
...
"CANNOT_USE_SHARED_CAMPAIGN_BUDGET_WHILE_PART_OF_CAMPAIGN_GROUP" => Some(Self::CannotUseSharedCampaignBudgetWhilePartOfCampaignGroup),
"APP_NOT_FOUND" => Some(Self::AppNotFound),
"SHOPPING_ENABLE_LOCAL_NOT_SUPPORTED_FOR_CAMPAIGN_TYPE" => Some(Self::ShoppingEnableLocalNotSupportedForCampaignType),
"MERCHANT_NOT_ALLOWED_FOR_COMPARISON_LISTING_ADS" => Some(Self::MerchantNotAllowedForComparisonListingAds),
...
"NOT_COMPATIBLE_WITH_VIEW_THROUGH_CONVERSION_OPTIMIZATION" => Some(Self::NotCompatibleWithViewThroughConversionOptimization),
"INVALID_EXCLUDED_PARENT_ASSET_FIELD_TYPE" => Some(Self::InvalidExcludedParentAssetFieldType),
"CANNOT_CREATE_APP_PRE_REGISTRATION_FOR_NON_ANDROID_APP" => Some(Self::CannotCreateAppPreRegistrationForNonAndroidApp),
"APP_NOT_AVAILABLE_TO_CREATE_APP_PRE_REGISTRATION_CAMPAIGN" => Some(Self::AppNotAvailableToCreateAppPreRegistrationCampaign),
"INCOMPATIBLE_BUDGET_TYPE" => Some(Self::IncompatibleBudgetType),
"LOCAL_SERVICES_DUPLICATE_CATEGORY_BID" => Some(Self::LocalServicesDuplicateCategoryBid),
"LOCAL_SERVICES_INVALID_CATEGORY_BID" => Some(Self::LocalServicesInvalidCategoryBid),
"LOCAL_SERVICES_MISSING_CATEGORY_BID" => Some(Self::LocalServicesMissingCategoryBid),
...
"INVALID_EXCLUDED_PARENT_ASSET_SET_TYPE" => Some(Self::InvalidExcludedParentAssetSetType),
"ASSET_SET_NOT_A_HOTEL_PROPERTY_ASSET_SET" => Some(Self::AssetSetNotAHotelPropertyAssetSet),
"HOTEL_PROPERTY_ASSET_SET_ONLY_FOR_PERFORMANCE_MAX_FOR_TRAVEL_GOALS" => Some(Self::HotelPropertyAssetSetOnlyForPerformanceMaxForTravelGoals),
"AVERAGE_DAILY_SPEND_TOO_HIGH" => Some(Self::AverageDailySpendTooHigh),
"CANNOT_ATTACH_TO_REMOVED_CAMPAIGN_GROUP" => Some(Self::CannotAttachToRemovedCampaignGroup),
...
"CANNOT_SET_MORE_THAN_ONE_CONVERSION_ACTION" => Some(Self::CannotSetMoreThanOneConversionAction),
"NOT_COMPATIBLE_WITH_BUDGET_TYPE" => Some(Self::NotCompatibleWithBudgetType),
"NOT_COMPATIBLE_WITH_UPLOAD_CLICKS_CONVERSION" => Some(Self::NotCompatibleWithUploadClicksConversion),
"APP_ID_MUST_MATCH_CONVERSION_ACTION_APP_ID" => Some(Self::AppIdMustMatchConversionActionAppId),
"CONVERSION_ACTION_WITH_DOWNLOAD_CATEGORY_NOT_ALLOWED" => Some(Self::ConversionActionWithDownloadCategoryNotAllowed),
"CONVERSION_ACTION_WITH_DOWNLOAD_CATEGORY_REQUIRED" => Some(Self::ConversionActionWithDownloadCategoryRequired),
"CONVERSION_TRACKING_NOT_ENABLED" => Some(Self::ConversionTrackingNotEnabled),
"NOT_COMPATIBLE_WITH_BIDDING_STRATEGY_TYPE" => Some(Self::NotCompatibleWithBiddingStrategyType),
"NOT_COMPATIBLE_WITH_GOOGLE_ATTRIBUTION_CONVERSIONS" => Some(Self::NotCompatibleWithGoogleAttributionConversions),
...
"INVALID_NUMBER_OF_ADVERTISING_PARTNER_IDS" => Some(Self::InvalidNumberOfAdvertisingPartnerIds),
"CANNOT_TARGET_DISPLAY_NETWORK_WITHOUT_YOUTUBE" => Some(Self::CannotTargetDisplayNetworkWithoutYoutube),
"CANNOT_LINK_TO_COMPARISON_SHOPPING_SERVICE_ACCOUNT" => Some(Self::CannotLinkToComparisonShoppingServiceAccount),
"CANNOT_TARGET_NETWORK_FOR_COMPARISON_SHOPPING_SERVICE_LINKED_ACCOUNTS" => Some(Self::CannotTargetNetworkForComparisonShoppingServiceLinkedAccounts),
"CANNOT_MODIFY_TEXT_ASSET_AUTOMATION_WITH_ENABLED_TRIAL" => Some(Self::CannotModifyTextAssetAutomationWithEnabledTrial),
"DYNAMIC_TEXT_ASSET_CANNOT_OPT_OUT_WITH_FINAL_URL_EXPANSION_OPT_IN" => Some(Self::DynamicTextAssetCannotOptOutWithFinalUrlExpansionOptIn),
"CANNOT_SET_CAMPAIGN_KEYWORD_MATCH_TYPE" => Some(Self::CannotSetCampaignKeywordMatchType),
"CANNOT_DISABLE_BROAD_MATCH_WHEN_KEYWORD_CONVERSION_IN_PROCESS" => Some(Self::CannotDisableBroadMatchWhenKeywordConversionInProcess),
"CANNOT_DISABLE_BROAD_MATCH_WHEN_TARGETING_BRANDS" => Some(Self::CannotDisableBroadMatchWhenTargetingBrands),
"CANNOT_ENABLE_BROAD_MATCH_FOR_BASE_CAMPAIGN_WITH_PROMOTING_TRIAL" => Some(Self::CannotEnableBroadMatchForBaseCampaignWithPromotingTrial),
"CANNOT_ENABLE_BROAD_MATCH_FOR_PROMOTING_TRIAL_CAMPAIGN" => Some(Self::CannotEnableBroadMatchForPromotingTrialCampaign),
_ => None,
}
}
}
...
"CUSTOMER_ACQUISITION_INVALID_OPTIMIZATION_MODE" => Some(Self::CustomerAcquisitionInvalidOptimizationMode),
"INCOMPATIBLE_BIDDING_STRATEGY" => Some(Self::IncompatibleBiddingStrategy),
"MISSING_PURCHASE_GOAL" => Some(Self::MissingPurchaseGoal),
"CUSTOMER_ACQUISITION_INVALID_HIGH_LIFETIME_VALUE" => Some(Self::CustomerAcquisitionInvalidHighLifetimeValue),
"CUSTOMER_ACQUISITION_UNSUPPORTED_CAMPAIGN_TYPE" => Some(Self::CustomerAcquisitionUnsupportedCampaignType),
"CUSTOMER_ACQUISITION_INVALID_VALUE" => Some(Self::CustomerAcquisitionInvalidValue),
"CUSTOMER_ACQUISITION_VALUE_MISSING" => Some(Self::CustomerAcquisitionValueMissing),
"CUSTOMER_ACQUISITION_MISSING_EXISTING_CUSTOMER_DEFINITION" => Some(Self::CustomerAcquisitionMissingExistingCustomerDefinition),
"CUSTOMER_ACQUISITION_MISSING_HIGH_VALUE_CUSTOMER_DEFINITION" => Some(Self::CustomerAcquisitionMissingHighValueCustomerDefinition),
_ => None,
}
}
}
...
"UNSPECIFIED" => Some(Self::Unspecified),
"UNKNOWN" => Some(Self::Unknown),
"OPERATION_NOT_PERMITTED_FOR_CONTEXT" => Some(Self::OperationNotPermittedForContext),
"OPERATION_NOT_PERMITTED_FOR_REMOVED_RESOURCE" => Some(Self::OperationNotPermittedForRemovedResource),
_ => None,
}
}
...
"UNKNOWN" => Some(Self::Unknown),
"CANNOT_USE_CAMPAIGN_GOAL_FOR_SEARCH_ADS_360_MANAGED_CAMPAIGN" => Some(Self::CannotUseCampaignGoalForSearchAds360ManagedCampaign),
"CUSTOM_GOAL_DOES_NOT_BELONG_TO_GOOGLE_ADS_CONVERSION_CUSTOMER" => Some(Self::CustomGoalDoesNotBelongToGoogleAdsConversionCustomer),
...
"STORE_SALE_STORE_VISIT_CANNOT_BE_BOTH_INCLUDED" => Some(Self::StoreSaleStoreVisitCannotBeBothIncluded),
"PERFORMANCE_MAX_CAMPAIGN_CANNOT_USE_CUSTOM_GOAL_WITH_STORE_SALES" => Some(Self::PerformanceMaxCampaignCannotUseCustomGoalWithStoreSales),
_ => None,
}
}
}
...
"CONFLICTING_INCLUDED_AND_EXCLUDED_GEO_TARGET" => Some(Self::ConflictingIncludedAndExcludedGeoTarget),
"CONFLICTING_CONDITIONS" => Some(Self::ConflictingConditions),
"CANNOT_REMOVE_IF_INCLUDED_IN_VALUE_RULE_SET" => Some(Self::CannotRemoveIfIncludedInValueRuleSet),
"CONDITION_NOT_ALLOWED" => Some(Self::ConditionNotAllowed),
"FIELD_MUST_BE_UNSET" => Some(Self::FieldMustBeUnset),
"CANNOT_PAUSE_UNLESS_VALUE_RULE_SET_IS_PAUSED" => Some(Self::CannotPauseUnlessValueRuleSetIsPaused),
...
ConversionValueRuleSetError::IneligibleConversionActionCategories => "INELIGIBLE_CONVERSION_ACTION_CATEGORIES",
ConversionValueRuleSetError::DimensionNoConditionUsedWithOtherDimensions => "DIMENSION_NO_CONDITION_USED_WITH_OTHER_DIMENSIONS",
ConversionValueRuleSetError::DimensionNoConditionNotAllowed => "DIMENSION_NO_CONDITION_NOT_ALLOWED",
ConversionValueRuleSetError::UnsupportedConversionActionCategories => "UNSUPPORTED_CONVERSION_ACTION_CATEGORIES",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"DIMENSIONS_UPDATE_ONLY_ALLOW_APPEND" => Some(Self::DimensionsUpdateOnlyAllowAppend),
...
"CANNOT_PAUSE_UNLESS_ALL_VALUE_RULES_ARE_PAUSED" => Some(Self::CannotPauseUnlessAllValueRulesArePaused),
"SHOULD_PAUSE_WHEN_ALL_VALUE_RULES_ARE_PAUSED" => Some(Self::ShouldPauseWhenAllValueRulesArePaused),
"VALUE_RULES_NOT_SUPPORTED_FOR_CAMPAIGN_TYPE" => Some(Self::ValueRulesNotSupportedForCampaignType),
"INELIGIBLE_CONVERSION_ACTION_CATEGORIES" => Some(Self::IneligibleConversionActionCategories),
"DIMENSION_NO_CONDITION_USED_WITH_OTHER_DIMENSIONS" => Some(Self::DimensionNoConditionUsedWithOtherDimensions),
"DIMENSION_NO_CONDITION_NOT_ALLOWED" => Some(Self::DimensionNoConditionNotAllowed),
"UNSUPPORTED_CONVERSION_ACTION_CATEGORIES" => Some(Self::UnsupportedConversionActionCategories),
_ => None,
}
}
}
...
CriterionError::CannotSetBothAssetSetAndFeed => "CANNOT_SET_BOTH_ASSET_SET_AND_FEED",
CriterionError::CannotSetFeedOrFeedItemSetsForCustomer => "CANNOT_SET_FEED_OR_FEED_ITEM_SETS_FOR_CUSTOMER",
CriterionError::CannotSetAssetSetFieldForCustomer => "CANNOT_SET_ASSET_SET_FIELD_FOR_CUSTOMER",
CriterionError::CannotSetGeoTargetConstantsWithAssetSets => "CANNOT_SET_GEO_TARGET_CONSTANTS_WITH_ASSET_SETS",
CriterionError::CannotSetAssetSetsWithFeedItemSets => "CANNOT_SET_ASSET_SETS_WITH_FEED_ITEM_SETS",
...
CriterionError::OneAudienceAllowedPerAssetGroup => "ONE_AUDIENCE_ALLOWED_PER_ASSET_GROUP",
CriterionError::AudienceNotEligibleForCampaignType => "AUDIENCE_NOT_ELIGIBLE_FOR_CAMPAIGN_TYPE",
CriterionError::AudienceNotAllowedToAttachWhenAudienceGroupedSetToFalse => "AUDIENCE_NOT_ALLOWED_TO_ATTACH_WHEN_AUDIENCE_GROUPED_SET_TO_FALSE",
CriterionError::CannotTargetCustomerMatchUserList => "CANNOT_TARGET_CUSTOMER_MATCH_USER_LIST",
CriterionError::NegativeKeywordSharedSetDoesNotExist => "NEGATIVE_KEYWORD_SHARED_SET_DOES_NOT_EXIST",
CriterionError::CannotAddRemovedNegativeKeywordSharedSet => "CANNOT_ADD_REMOVED_NEGATIVE_KEYWORD_SHARED_SET",
CriterionError::CannotHaveMultipleNegativeKeywordListPerAccount => "CANNOT_HAVE_MULTIPLE_NEGATIVE_KEYWORD_LIST_PER_ACCOUNT",
CriterionError::CustomerCannotAddCriterionOfThisType => "CUSTOMER_CANNOT_ADD_CRITERION_OF_THIS_TYPE",
CriterionError::CannotTargetSimilarUserList => "CANNOT_TARGET_SIMILAR_USER_LIST",
CriterionError::CannotAddAudienceSegmentCriterionWhenAudienceGroupedIsSet => "CANNOT_ADD_AUDIENCE_SEGMENT_CRITERION_WHEN_AUDIENCE_GROUPED_IS_SET",
...
CriterionError::CannotAddRemovedBrandSharedSet => "CANNOT_ADD_REMOVED_BRAND_SHARED_SET",
CriterionError::OnlyExclusionBrandListAllowedForCampaignType => "ONLY_EXCLUSION_BRAND_LIST_ALLOWED_FOR_CAMPAIGN_TYPE",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"PLACEMENT_URL_HAS_MULTIPLE_SITES_IN_LINE" => Some(Self::PlacementUrlHasMultipleSitesInLine),
"PLACEMENT_IS_NOT_AVAILABLE_FOR_TARGETING_OR_EXCLUSION" => Some(Self::PlacementIsNotAvailableForTargetingOrExclusion),
...
"YOUTUBE_VERTICAL_CHANNEL_DEPRECATED" => Some(Self::YoutubeVerticalChannelDeprecated),
"YOUTUBE_DEMOGRAPHIC_CHANNEL_DEPRECATED" => Some(Self::YoutubeDemographicChannelDeprecated),
...
"CANNOT_ADD_DISPLAY_ONLY_LISTS_TO_SEARCH_ONLY_CAMPAIGNS" => Some(Self::CannotAddDisplayOnlyListsToSearchOnlyCampaigns),
"CANNOT_ADD_DISPLAY_ONLY_LISTS_TO_SEARCH_CAMPAIGNS" => Some(Self::CannotAddDisplayOnlyListsToSearchCampaigns),
"CANNOT_ADD_DISPLAY_ONLY_LISTS_TO_SHOPPING_CAMPAIGNS" => Some(Self::CannotAddDisplayOnlyListsToShoppingCampaigns),
"CANNOT_ADD_USER_INTERESTS_TO_SEARCH_CAMPAIGNS" => Some(Self::CannotAddUserInterestsToSearchCampaigns),
"CANNOT_SET_BIDS_ON_CRITERION_TYPE_IN_SEARCH_CAMPAIGNS" => Some(Self::CannotSetBidsOnCriterionTypeInSearchCampaigns),
"CANNOT_ADD_URLS_TO_CRITERION_TYPE_FOR_CAMPAIGN_TYPE" => Some(Self::CannotAddUrlsToCriterionTypeForCampaignType),
...
"PROXIMITY_GEOPOINT_AND_ADDRESS_BOTH_CANNOT_BE_NULL" => Some(Self::ProximityGeopointAndAddressBothCannotBeNull),
...
"AD_SCHEDULE_INTERVAL_CANNOT_SPAN_MULTIPLE_DAYS" => Some(Self::AdScheduleIntervalCannotSpanMultipleDays),
"AD_SCHEDULE_INVALID_TIME_INTERVAL" => Some(Self::AdScheduleInvalidTimeInterval),
"AD_SCHEDULE_EXCEEDED_INTERVALS_PER_DAY_LIMIT" => Some(Self::AdScheduleExceededIntervalsPerDayLimit),
"AD_SCHEDULE_CRITERION_ID_MISMATCHING_FIELDS" => Some(Self::AdScheduleCriterionIdMismatchingFields),
"CANNOT_BID_MODIFY_CRITERION_TYPE" => Some(Self::CannotBidModifyCriterionType),
"CANNOT_BID_MODIFY_CRITERION_CAMPAIGN_OPTED_OUT" => Some(Self::CannotBidModifyCriterionCampaignOptedOut),
"CANNOT_BID_MODIFY_NEGATIVE_CRITERION" => Some(Self::CannotBidModifyNegativeCriterion),
"BID_MODIFIER_ALREADY_EXISTS" => Some(Self::BidModifierAlreadyExists),
"FEED_ID_NOT_ALLOWED" => Some(Self::FeedIdNotAllowed),
"ACCOUNT_INELIGIBLE_FOR_CRITERIA_TYPE" => Some(Self::AccountIneligibleForCriteriaType),
"CRITERIA_TYPE_INVALID_FOR_BIDDING_STRATEGY" => Some(Self::CriteriaTypeInvalidForBiddingStrategy),
...
"CANNOT_SET_GEO_TARGET_CONSTANTS_WITH_FEED_ITEM_SETS" => Some(Self::CannotSetGeoTargetConstantsWithFeedItemSets),
"CANNOT_SET_BOTH_ASSET_SET_AND_FEED" => Some(Self::CannotSetBothAssetSetAndFeed),
"CANNOT_SET_FEED_OR_FEED_ITEM_SETS_FOR_CUSTOMER" => Some(Self::CannotSetFeedOrFeedItemSetsForCustomer),
"CANNOT_SET_ASSET_SET_FIELD_FOR_CUSTOMER" => Some(Self::CannotSetAssetSetFieldForCustomer),
"CANNOT_SET_GEO_TARGET_CONSTANTS_WITH_ASSET_SETS" => Some(Self::CannotSetGeoTargetConstantsWithAssetSets),
"CANNOT_SET_ASSET_SETS_WITH_FEED_ITEM_SETS" => Some(Self::CannotSetAssetSetsWithFeedItemSets),
...
"CANNOT_ATTACH_CRITERIA_AT_CAMPAIGN_AND_ADGROUP" => Some(Self::CannotAttachCriteriaAtCampaignAndAdgroup),
"HOTEL_LENGTH_OF_STAY_OVERLAPS_WITH_EXISTING_CRITERION" => Some(Self::HotelLengthOfStayOverlapsWithExistingCriterion),
"HOTEL_ADVANCE_BOOKING_WINDOW_OVERLAPS_WITH_EXISTING_CRITERION" => Some(Self::HotelAdvanceBookingWindowOverlapsWithExistingCriterion),
"FIELD_INCOMPATIBLE_WITH_NEGATIVE_TARGETING" => Some(Self::FieldIncompatibleWithNegativeTargeting),
...
"WEBPAGE_CONDITION_URL_CANNOT_BE_EMPTY" => Some(Self::WebpageConditionUrlCannotBeEmpty),
"WEBPAGE_CONDITION_URL_UNSUPPORTED_PROTOCOL" => Some(Self::WebpageConditionUrlUnsupportedProtocol),
"WEBPAGE_CONDITION_URL_CANNOT_BE_IP_ADDRESS" => Some(Self::WebpageConditionUrlCannotBeIpAddress),
"WEBPAGE_CONDITION_URL_DOMAIN_NOT_CONSISTENT_WITH_CAMPAIGN_SETTING" => Some(Self::WebpageConditionUrlDomainNotConsistentWithCampaignSetting),
"WEBPAGE_CONDITION_URL_CANNOT_BE_PUBLIC_SUFFIX" => Some(Self::WebpageConditionUrlCannotBePublicSuffix),
"WEBPAGE_CONDITION_URL_INVALID_PUBLIC_SUFFIX" => Some(Self::WebpageConditionUrlInvalidPublicSuffix),
"WEBPAGE_CONDITION_URL_VALUE_TRACK_VALUE_NOT_SUPPORTED" => Some(Self::WebpageConditionUrlValueTrackValueNotSupported),
"WEBPAGE_CRITERION_URL_EQUALS_CAN_HAVE_ONLY_ONE_CONDITION" => Some(Self::WebpageCriterionUrlEqualsCanHaveOnlyOneCondition),
"WEBPAGE_CRITERION_NOT_SUPPORTED_ON_NON_DSA_AD_GROUP" => Some(Self::WebpageCriterionNotSupportedOnNonDsaAdGroup),
"CANNOT_TARGET_USER_LIST_FOR_SMART_DISPLAY_CAMPAIGNS" => Some(Self::CannotTargetUserListForSmartDisplayCampaigns),
"CANNOT_TARGET_PLACEMENTS_FOR_SEARCH_CAMPAIGNS" => Some(Self::CannotTargetPlacementsForSearchCampaigns),
"LISTING_SCOPE_TOO_MANY_DIMENSION_TYPES" => Some(Self::ListingScopeTooManyDimensionTypes),
"LISTING_SCOPE_TOO_MANY_IN_OPERATORS" => Some(Self::ListingScopeTooManyInOperators),
"LISTING_SCOPE_IN_OPERATOR_NOT_SUPPORTED" => Some(Self::ListingScopeInOperatorNotSupported),
...
"CANNOT_SET_BIDS_ON_LISTING_GROUP_SUBDIVISION" => Some(Self::CannotSetBidsOnListingGroupSubdivision),
"INVALID_LISTING_GROUP_HIERARCHY" => Some(Self::InvalidListingGroupHierarchy),
"LISTING_GROUP_UNIT_CANNOT_HAVE_CHILDREN" => Some(Self::ListingGroupUnitCannotHaveChildren),
"LISTING_GROUP_SUBDIVISION_REQUIRES_OTHERS_CASE" => Some(Self::ListingGroupSubdivisionRequiresOthersCase),
"LISTING_GROUP_REQUIRES_SAME_DIMENSION_TYPE_AS_SIBLINGS" => Some(Self::ListingGroupRequiresSameDimensionTypeAsSiblings),
...
"LISTING_GROUP_ADD_MAY_ONLY_USE_TEMP_ID" => Some(Self::ListingGroupAddMayOnlyUseTempId),
...
"ADVERTISER_NOT_ON_ALLOWLIST_FOR_COMBINED_AUDIENCE_ON_DISPLAY" => Some(Self::AdvertiserNotOnAllowlistForCombinedAudienceOnDisplay),
"CANNOT_TARGET_REMOVED_COMBINED_AUDIENCE" => Some(Self::CannotTargetRemovedCombinedAudience),
"INVALID_COMBINED_AUDIENCE_ID" => Some(Self::InvalidCombinedAudienceId),
"CANNOT_TARGET_REMOVED_CUSTOM_AUDIENCE" => Some(Self::CannotTargetRemovedCustomAudience),
"HOTEL_CHECK_IN_DATE_RANGE_OVERLAPS_WITH_EXISTING_CRITERION" => Some(Self::HotelCheckInDateRangeOverlapsWithExistingCriterion),
"HOTEL_CHECK_IN_DATE_RANGE_START_DATE_TOO_EARLY" => Some(Self::HotelCheckInDateRangeStartDateTooEarly),
"HOTEL_CHECK_IN_DATE_RANGE_END_DATE_TOO_LATE" => Some(Self::HotelCheckInDateRangeEndDateTooLate),
"HOTEL_CHECK_IN_DATE_RANGE_REVERSED" => Some(Self::HotelCheckInDateRangeReversed),
"BROAD_MATCH_MODIFIER_KEYWORD_NOT_ALLOWED" => Some(Self::BroadMatchModifierKeywordNotAllowed),
"ONE_AUDIENCE_ALLOWED_PER_ASSET_GROUP" => Some(Self::OneAudienceAllowedPerAssetGroup),
"AUDIENCE_NOT_ELIGIBLE_FOR_CAMPAIGN_TYPE" => Some(Self::AudienceNotEligibleForCampaignType),
"AUDIENCE_NOT_ALLOWED_TO_ATTACH_WHEN_AUDIENCE_GROUPED_SET_TO_FALSE" => Some(Self::AudienceNotAllowedToAttachWhenAudienceGroupedSetToFalse),
"CANNOT_TARGET_CUSTOMER_MATCH_USER_LIST" => Some(Self::CannotTargetCustomerMatchUserList),
"NEGATIVE_KEYWORD_SHARED_SET_DOES_NOT_EXIST" => Some(Self::NegativeKeywordSharedSetDoesNotExist),
"CANNOT_ADD_REMOVED_NEGATIVE_KEYWORD_SHARED_SET" => Some(Self::CannotAddRemovedNegativeKeywordSharedSet),
"CANNOT_HAVE_MULTIPLE_NEGATIVE_KEYWORD_LIST_PER_ACCOUNT" => Some(Self::CannotHaveMultipleNegativeKeywordListPerAccount),
"CUSTOMER_CANNOT_ADD_CRITERION_OF_THIS_TYPE" => Some(Self::CustomerCannotAddCriterionOfThisType),
"CANNOT_TARGET_SIMILAR_USER_LIST" => Some(Self::CannotTargetSimilarUserList),
"CANNOT_ADD_AUDIENCE_SEGMENT_CRITERION_WHEN_AUDIENCE_GROUPED_IS_SET" => Some(Self::CannotAddAudienceSegmentCriterionWhenAudienceGroupedIsSet),
...
"ONLY_EXCLUSION_BRAND_LIST_ALLOWED_FOR_CAMPAIGN_TYPE" => Some(Self::OnlyExclusionBrandListAllowedForCampaignType),
_ => None,
}
}
}
...
"MEMBER_TYPE_AND_PARAMETER_ALREADY_EXISTED" => Some(Self::MemberTypeAndParameterAlreadyExisted),
"INVALID_MEMBER_TYPE" => Some(Self::InvalidMemberType),
"MEMBER_TYPE_AND_VALUE_DOES_NOT_MATCH" => Some(Self::MemberTypeAndValueDoesNotMatch),
...
CustomConversionGoalError::DuplicateConversionActionList => "DUPLICATE_CONVERSION_ACTION_LIST",
CustomConversionGoalError::NonBiddableConversionActionNotEligibleForCustomGoal => "NON_BIDDABLE_CONVERSION_ACTION_NOT_ELIGIBLE_FOR_CUSTOM_GOAL",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"CANNOT_REMOVE_LINKED_CUSTOM_CONVERSION_GOAL" => Some(Self::CannotRemoveLinkedCustomConversionGoal),
...
"NON_BIDDABLE_CONVERSION_ACTION_NOT_ELIGIBLE_FOR_CUSTOM_GOAL" => Some(Self::NonBiddableConversionActionNotEligibleForCustomGoal),
_ => None,
}
}
}
...
"MANAGER_HAS_MAX_NUMBER_OF_LINKED_ACCOUNTS" => Some(Self::ManagerHasMaxNumberOfLinkedAccounts),
"CANNOT_UNLINK_ACCOUNT_WITHOUT_ACTIVE_USER" => Some(Self::CannotUnlinkAccountWithoutActiveUser),
"CANNOT_REMOVE_LAST_CLIENT_ACCOUNT_OWNER" => Some(Self::CannotRemoveLastClientAccountOwner),
"CANNOT_CHANGE_ROLE_BY_NON_ACCOUNT_OWNER" => Some(Self::CannotChangeRoleByNonAccountOwner),
"CANNOT_CHANGE_ROLE_FOR_NON_ACTIVE_LINK_ACCOUNT" => Some(Self::CannotChangeRoleForNonActiveLinkAccount),
"DUPLICATE_CHILD_FOUND" => Some(Self::DuplicateChildFound),
"TEST_ACCOUNT_LINKS_TOO_MANY_CHILD_ACCOUNTS" => Some(Self::TestAccountLinksTooManyChildAccounts),
_ => None,
}
}
}
...
CustomerSkAdNetworkConversionValueSchemaError::LinkCodeNotFound => "LINK_CODE_NOT_FOUND",
CustomerSkAdNetworkConversionValueSchemaError::InvalidEventCounter => "INVALID_EVENT_COUNTER",
CustomerSkAdNetworkConversionValueSchemaError::InvalidEventName => "INVALID_EVENT_NAME",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"UNSPECIFIED" => Some(Self::Unspecified),
"UNKNOWN" => Some(Self::Unknown),
"DUPLICATE_CUSTOMIZER_ATTRIBUTE_NAME" => Some(Self::DuplicateCustomizerAttributeName),
_ => None,
}
}
}
...
ExperimentArmError::ExperimentArmCountLimitExceeded => "EXPERIMENT_ARM_COUNT_LIMIT_EXCEEDED",
...
ExperimentArmError::CannotSetTreatmentArmCampaign => "CANNOT_SET_TREATMENT_ARM_CAMPAIGN",
ExperimentArmError::CannotModifyCampaignIds => "CANNOT_MODIFY_CAMPAIGN_IDS",
ExperimentArmError::CannotModifyCampaignWithoutSuffixSet => "CANNOT_MODIFY_CAMPAIGN_WITHOUT_SUFFIX_SET",
ExperimentArmError::CannotMutateTrafficSplitAfterStart => "CANNOT_MUTATE_TRAFFIC_SPLIT_AFTER_START",
ExperimentArmError::CannotAddCampaignWithSharedBudget => "CANNOT_ADD_CAMPAIGN_WITH_SHARED_BUDGET",
ExperimentArmError::CannotAddCampaignWithCustomBudget => "CANNOT_ADD_CAMPAIGN_WITH_CUSTOM_BUDGET",
ExperimentArmError::CannotAddCampaignsWithDynamicAssetsEnabled => "CANNOT_ADD_CAMPAIGNS_WITH_DYNAMIC_ASSETS_ENABLED",
ExperimentArmError::UnsupportedCampaignAdvertisingChannelSubType => "UNSUPPORTED_CAMPAIGN_ADVERTISING_CHANNEL_SUB_TYPE",
ExperimentArmError::CannotAddBaseCampaignWithDateRange => "CANNOT_ADD_BASE_CAMPAIGN_WITH_DATE_RANGE",
ExperimentArmError::BiddingStrategyNotSupportedInExperiments => "BIDDING_STRATEGY_NOT_SUPPORTED_IN_EXPERIMENTS",
ExperimentArmError::TrafficSplitNotSupportedForChannelType => "TRAFFIC_SPLIT_NOT_SUPPORTED_FOR_CHANNEL_TYPE",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"UNSPECIFIED" => Some(Self::Unspecified),
"UNKNOWN" => Some(Self::Unknown),
"EXPERIMENT_ARM_COUNT_LIMIT_EXCEEDED" => Some(Self::ExperimentArmCountLimitExceeded),
...
"CANNOT_MODIFY_CAMPAIGN_WITHOUT_SUFFIX_SET" => Some(Self::CannotModifyCampaignWithoutSuffixSet),
"CANNOT_MUTATE_TRAFFIC_SPLIT_AFTER_START" => Some(Self::CannotMutateTrafficSplitAfterStart),
"CANNOT_ADD_CAMPAIGN_WITH_SHARED_BUDGET" => Some(Self::CannotAddCampaignWithSharedBudget),
"CANNOT_ADD_CAMPAIGN_WITH_CUSTOM_BUDGET" => Some(Self::CannotAddCampaignWithCustomBudget),
"CANNOT_ADD_CAMPAIGNS_WITH_DYNAMIC_ASSETS_ENABLED" => Some(Self::CannotAddCampaignsWithDynamicAssetsEnabled),
"UNSUPPORTED_CAMPAIGN_ADVERTISING_CHANNEL_SUB_TYPE" => Some(Self::UnsupportedCampaignAdvertisingChannelSubType),
"CANNOT_ADD_BASE_CAMPAIGN_WITH_DATE_RANGE" => Some(Self::CannotAddBaseCampaignWithDateRange),
"BIDDING_STRATEGY_NOT_SUPPORTED_IN_EXPERIMENTS" => Some(Self::BiddingStrategyNotSupportedInExperiments),
"TRAFFIC_SPLIT_NOT_SUPPORTED_FOR_CHANNEL_TYPE" => Some(Self::TrafficSplitNotSupportedForChannelType),
_ => None,
}
}
}
...
ExperimentError::CannotModifyRemovedExperiment => "CANNOT_MODIFY_REMOVED_EXPERIMENT",
...
ExperimentError::OverlappingMembersAndDateRange => "OVERLAPPING_MEMBERS_AND_DATE_RANGE",
...
ExperimentError::SumTrialArmTrafficUnequalsToTrialTrafficSplitDenominator => "SUM_TRIAL_ARM_TRAFFIC_UNEQUALS_TO_TRIAL_TRAFFIC_SPLIT_DENOMINATOR",
ExperimentError::CannotModifyTrafficSplitAfterStart => "CANNOT_MODIFY_TRAFFIC_SPLIT_AFTER_START",
...
ExperimentError::CannotHaveMultipleControlArms => "CANNOT_HAVE_MULTIPLE_CONTROL_ARMS",
...
ExperimentError::CannotCreateExperimentCampaignWithSharedBudget => "CANNOT_CREATE_EXPERIMENT_CAMPAIGN_WITH_SHARED_BUDGET",
ExperimentError::CannotCreateExperimentCampaignWithCustomBudget => "CANNOT_CREATE_EXPERIMENT_CAMPAIGN_WITH_CUSTOM_BUDGET",
ExperimentError::StatusTransitionInvalid => "STATUS_TRANSITION_INVALID",
ExperimentError::DuplicateExperimentCampaignName => "DUPLICATE_EXPERIMENT_CAMPAIGN_NAME",
ExperimentError::CannotRemoveInCreationExperiment => "CANNOT_REMOVE_IN_CREATION_EXPERIMENT",
ExperimentError::CannotAddCampaignWithDeprecatedAdTypes => "CANNOT_ADD_CAMPAIGN_WITH_DEPRECATED_AD_TYPES",
ExperimentError::CannotEnableSyncForUnsupportedExperimentType => "CANNOT_ENABLE_SYNC_FOR_UNSUPPORTED_EXPERIMENT_TYPE",
ExperimentError::InvalidDurationForAnExperiment => "INVALID_DURATION_FOR_AN_EXPERIMENT",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"SUM_TRIAL_ARM_TRAFFIC_UNEQUALS_TO_TRIAL_TRAFFIC_SPLIT_DENOMINATOR" => Some(Self::SumTrialArmTrafficUnequalsToTrialTrafficSplitDenominator),
"CANNOT_MODIFY_TRAFFIC_SPLIT_AFTER_START" => Some(Self::CannotModifyTrafficSplitAfterStart),
...
"CANNOT_CREATE_EXPERIMENT_CAMPAIGN_WITH_SHARED_BUDGET" => Some(Self::CannotCreateExperimentCampaignWithSharedBudget),
"CANNOT_CREATE_EXPERIMENT_CAMPAIGN_WITH_CUSTOM_BUDGET" => Some(Self::CannotCreateExperimentCampaignWithCustomBudget),
...
"CANNOT_REMOVE_IN_CREATION_EXPERIMENT" => Some(Self::CannotRemoveInCreationExperiment),
"CANNOT_ADD_CAMPAIGN_WITH_DEPRECATED_AD_TYPES" => Some(Self::CannotAddCampaignWithDeprecatedAdTypes),
"CANNOT_ENABLE_SYNC_FOR_UNSUPPORTED_EXPERIMENT_TYPE" => Some(Self::CannotEnableSyncForUnsupportedExperimentType),
"INVALID_DURATION_FOR_AN_EXPERIMENT" => Some(Self::InvalidDurationForAnExperiment),
_ => None,
}
}
}
...
"CANNOT_HAVE_RESTRICTION_ON_EMPTY_GEO_TARGETING" => Some(Self::CannotHaveRestrictionOnEmptyGeoTargeting),
"CANNOT_SET_WITH_FINAL_URLS" => Some(Self::CannotSetWithFinalUrls),
"CANNOT_SET_WITHOUT_FINAL_URLS" => Some(Self::CannotSetWithoutFinalUrls),
"INVALID_PHONE_NUMBER" => Some(Self::InvalidPhoneNumber),
"PHONE_NUMBER_NOT_SUPPORTED_FOR_COUNTRY" => Some(Self::PhoneNumberNotSupportedForCountry),
...
"CUSTOMER_NOT_ON_ALLOWLIST_FOR_CALLTRACKING" => Some(Self::CustomerNotOnAllowlistForCalltracking),
"CALLTRACKING_NOT_SUPPORTED_FOR_COUNTRY" => Some(Self::CalltrackingNotSupportedForCountry),
"CUSTOMER_CONSENT_FOR_CALL_RECORDING_REQUIRED" => Some(Self::CustomerConsentForCallRecordingRequired),
"INVALID_APP_ID" => Some(Self::InvalidAppId),
"QUOTES_IN_REVIEW_EXTENSION_SNIPPET" => Some(Self::QuotesInReviewExtensionSnippet),
...
"INCONSISTENT_CURRENCY_CODES" => Some(Self::InconsistentCurrencyCodes),
"PRICE_EXTENSION_HAS_DUPLICATED_HEADERS" => Some(Self::PriceExtensionHasDuplicatedHeaders),
"PRICE_ITEM_HAS_DUPLICATED_HEADER_AND_DESCRIPTION" => Some(Self::PriceItemHasDuplicatedHeaderAndDescription),
"PRICE_EXTENSION_HAS_TOO_FEW_ITEMS" => Some(Self::PriceExtensionHasTooFewItems),
...
"CANNOT_OPERATE_ON_REMOVED_FEED_ITEM" => Some(Self::CannotOperateOnRemovedFeedItem),
"PHONE_NUMBER_NOT_SUPPORTED_WITH_CALLTRACKING_FOR_COUNTRY" => Some(Self::PhoneNumberNotSupportedWithCalltrackingForCountry),
"CONFLICTING_CALL_CONVERSION_SETTINGS" => Some(Self::ConflictingCallConversionSettings),
...
"CANNOT_OPERATE_ON_FEED_WITH_MULTIPLE_MAPPINGS" => Some(Self::CannotOperateOnFeedWithMultipleMappings),
"CANNOT_OPERATE_ON_FEED_WITH_KEY_ATTRIBUTES" => Some(Self::CannotOperateOnFeedWithKeyAttributes),
"INVALID_PRICE_FORMAT" => Some(Self::InvalidPriceFormat),
"PROMOTION_INVALID_TIME" => Some(Self::PromotionInvalidTime),
"TOO_MANY_DECIMAL_PLACES_SPECIFIED" => Some(Self::TooManyDecimalPlacesSpecified),
...
"INVALID_FEED_TYPE" => Some(Self::InvalidFeedType),
"INVALID_FEED_TYPE_FOR_CUSTOMER_EXTENSION_SETTING" => Some(Self::InvalidFeedTypeForCustomerExtensionSetting),
"CANNOT_CHANGE_FEED_ITEM_ON_CREATE" => Some(Self::CannotChangeFeedItemOnCreate),
"CANNOT_UPDATE_NEWLY_CREATED_EXTENSION" => Some(Self::CannotUpdateNewlyCreatedExtension),
"NO_EXISTING_AD_GROUP_EXTENSION_SETTING_FOR_TYPE" => Some(Self::NoExistingAdGroupExtensionSettingForType),
"NO_EXISTING_CAMPAIGN_EXTENSION_SETTING_FOR_TYPE" => Some(Self::NoExistingCampaignExtensionSettingForType),
"NO_EXISTING_CUSTOMER_EXTENSION_SETTING_FOR_TYPE" => Some(Self::NoExistingCustomerExtensionSettingForType),
"AD_GROUP_EXTENSION_SETTING_ALREADY_EXISTS" => Some(Self::AdGroupExtensionSettingAlreadyExists),
"CAMPAIGN_EXTENSION_SETTING_ALREADY_EXISTS" => Some(Self::CampaignExtensionSettingAlreadyExists),
"CUSTOMER_EXTENSION_SETTING_ALREADY_EXISTS" => Some(Self::CustomerExtensionSettingAlreadyExists),
"AD_GROUP_FEED_ALREADY_EXISTS_FOR_PLACEHOLDER_TYPE" => Some(Self::AdGroupFeedAlreadyExistsForPlaceholderType),
"CAMPAIGN_FEED_ALREADY_EXISTS_FOR_PLACEHOLDER_TYPE" => Some(Self::CampaignFeedAlreadyExistsForPlaceholderType),
"CUSTOMER_FEED_ALREADY_EXISTS_FOR_PLACEHOLDER_TYPE" => Some(Self::CustomerFeedAlreadyExistsForPlaceholderType),
"VALUE_OUT_OF_RANGE" => Some(Self::ValueOutOfRange),
...
"QUOTES_IN_REVIEW_EXTENSION_SNIPPET" => Some(Self::QuotesInReviewExtensionSnippet),
"HYPHENS_IN_REVIEW_EXTENSION_SNIPPET" => Some(Self::HyphensInReviewExtensionSnippet),
"REVIEW_EXTENSION_SOURCE_NOT_ELIGIBLE" => Some(Self::ReviewExtensionSourceNotEligible),
"SOURCE_NAME_IN_REVIEW_EXTENSION_TEXT" => Some(Self::SourceNameInReviewExtensionText),
...
"INCOMPATIBLE_UNDERLYING_MATCHING_FUNCTION" => Some(Self::IncompatibleUnderlyingMatchingFunction),
"START_DATE_AFTER_END_DATE" => Some(Self::StartDateAfterEndDate),
"INVALID_PRICE_FORMAT" => Some(Self::InvalidPriceFormat),
"PROMOTION_INVALID_TIME" => Some(Self::PromotionInvalidTime),
"PROMOTION_CANNOT_SET_PERCENT_DISCOUNT_AND_MONEY_DISCOUNT" => Some(Self::PromotionCannotSetPercentDiscountAndMoneyDiscount),
"PROMOTION_CANNOT_SET_PROMOTION_CODE_AND_ORDERS_OVER_AMOUNT" => Some(Self::PromotionCannotSetPromotionCodeAndOrdersOverAmount),
"TOO_MANY_DECIMAL_PLACES_SPECIFIED" => Some(Self::TooManyDecimalPlacesSpecified),
"INVALID_LANGUAGE_CODE" => Some(Self::InvalidLanguageCode),
"UNSUPPORTED_LANGUAGE" => Some(Self::UnsupportedLanguage),
...
"ATTRIBUTES_DO_NOT_MATCH_EXISTING_ATTRIBUTES" => Some(Self::AttributesDoNotMatchExistingAttributes),
"CANNOT_SPECIFY_USER_ORIGIN_FOR_SYSTEM_FEED" => Some(Self::CannotSpecifyUserOriginForSystemFeed),
"CANNOT_SPECIFY_GOOGLE_ORIGIN_FOR_NON_SYSTEM_FEED" => Some(Self::CannotSpecifyGoogleOriginForNonSystemFeed),
"CANNOT_SPECIFY_FEED_ATTRIBUTES_FOR_SYSTEM_FEED" => Some(Self::CannotSpecifyFeedAttributesForSystemFeed),
"CANNOT_UPDATE_FEED_ATTRIBUTES_WITH_ORIGIN_GOOGLE" => Some(Self::CannotUpdateFeedAttributesWithOriginGoogle),
...
"NEW_ATTRIBUTE_CANNOT_BE_PART_OF_UNIQUE_KEY" => Some(Self::NewAttributeCannotBePartOfUniqueKey),
"TOO_MANY_ATTRIBUTES" => Some(Self::TooManyAttributes),
"INVALID_BUSINESS_ACCOUNT" => Some(Self::InvalidBusinessAccount),
"BUSINESS_ACCOUNT_CANNOT_ACCESS_LOCATION_ACCOUNT" => Some(Self::BusinessAccountCannotAccessLocationAccount),
...
"CANNOT_HAVE_LOCATION_AND_AFFILIATE_LOCATION_FEEDS" => Some(Self::CannotHaveLocationAndAffiliateLocationFeeds),
...
"TARGET_LIMIT_EXCEEDED_FOR_GIVEN_TYPE" => Some(Self::TargetLimitExceededForGivenType),
"TOO_MANY_SCHEDULES_PER_DAY" => Some(Self::TooManySchedulesPerDay),
"CANNOT_HAVE_ENABLED_CAMPAIGN_AND_ENABLED_AD_GROUP_TARGETS" => Some(Self::CannotHaveEnabledCampaignAndEnabledAdGroupTargets),
...
"CANNOT_OPERATE_ON_MAPPINGS_FOR_SYSTEM_GENERATED_FEED" => Some(Self::CannotOperateOnMappingsForSystemGeneratedFeed),
"MULTIPLE_MAPPINGS_FOR_PLACEHOLDER_TYPE" => Some(Self::MultipleMappingsForPlaceholderType),
"MULTIPLE_MAPPINGS_FOR_CRITERION_TYPE" => Some(Self::MultipleMappingsForCriterionType),
"MULTIPLE_MAPPINGS_FOR_PLACEHOLDER_FIELD" => Some(Self::MultipleMappingsForPlaceholderField),
"MULTIPLE_MAPPINGS_FOR_CRITERION_FIELD" => Some(Self::MultipleMappingsForCriterionField),
"UNEXPECTED_ATTRIBUTE_FIELD_MAPPINGS" => Some(Self::UnexpectedAttributeFieldMappings),
"LOCATION_PLACEHOLDER_ONLY_FOR_PLACES_FEEDS" => Some(Self::LocationPlaceholderOnlyForPlacesFeeds),
"CANNOT_MODIFY_MAPPINGS_FOR_TYPED_FEED" => Some(Self::CannotModifyMappingsForTypedFeed),
"INVALID_PLACEHOLDER_TYPE_FOR_NON_SYSTEM_GENERATED_FEED" => Some(Self::InvalidPlaceholderTypeForNonSystemGeneratedFeed),
"INVALID_PLACEHOLDER_TYPE_FOR_SYSTEM_GENERATED_FEED_TYPE" => Some(Self::InvalidPlaceholderTypeForSystemGeneratedFeedType),
"ATTRIBUTE_FIELD_MAPPING_MISSING_FIELD" => Some(Self::AttributeFieldMappingMissingField),
"LEGACY_FEED_TYPE_READ_ONLY" => Some(Self::LegacyFeedTypeReadOnly),
_ => None,
}
}
...
"INVALID_FUNCTION_FOR_CALL_PLACEHOLDER" => Some(Self::InvalidFunctionForCallPlaceholder),
...
"INVALID_FUNCTION_FOR_FEED_WITH_FIXED_SCHEMA" => Some(Self::InvalidFunctionForFeedWithFixedSchema),
...
"FEED_ATTRIBUTE_OPERAND_ARGUMENT_NOT_INTEGER" => Some(Self::FeedAttributeOperandArgumentNotInteger),
...
"BILLING_SETUP_NOT_ON_MONTHLY_INVOICING" => Some(Self::BillingSetupNotOnMonthlyInvoicing),
...
"DAILY_BUDGET_TOO_MANY_FRACTIONAL_DIGITS" => Some(Self::DailyBudgetTooManyFractionalDigits),
"INVALID_VALUE" => Some(Self::InvalidValue),
...
"CANNOT_APPLY_LABEL_TO_DISABLED_AD_GROUP_CRITERION" => Some(Self::CannotApplyLabelToDisabledAdGroupCriterion),
"CANNOT_APPLY_LABEL_TO_NEGATIVE_AD_GROUP_CRITERION" => Some(Self::CannotApplyLabelToNegativeAdGroupCriterion),
...
"CANNOT_ATTACH_NON_MANAGER_LABEL_TO_CUSTOMER" => Some(Self::CannotAttachNonManagerLabelToCustomer),
_ => None,
}
}
}
...
"UNSPECIFIED" => Some(Self::Unspecified),
"UNKNOWN" => Some(Self::Unknown),
"ACCOUNTS_NOT_COMPATIBLE_FOR_LINKING" => Some(Self::AccountsNotCompatibleForLinking),
...
"SUSPENDED_ACCOUNT_CANNOT_ADD_CLIENTS" => Some(Self::SuspendedAccountCannotAddClients),
...
"FILE_TOO_LARGE" => Some(Self::FileTooLarge),
"GOOGLE_WEB_DESIGNER_ZIP_FILE_NOT_PUBLISHED" => Some(Self::GoogleWebDesignerZipFileNotPublished),
"INVALID_INPUT" => Some(Self::InvalidInput),
...
"UNEXPECTED_SIZE" => Some(Self::UnexpectedSize),
"UNSUPPORTED_GOOGLE_WEB_DESIGNER_ENVIRONMENT" => Some(Self::UnsupportedGoogleWebDesignerEnvironment),
"UNSUPPORTED_HTML5_FEATURE" => Some(Self::UnsupportedHtml5Feature),
"URL_IN_MEDIA_BUNDLE_NOT_SSL_COMPLIANT" => Some(Self::UrlInMediaBundleNotSslCompliant),
...
"MEDIA_BUNDLE_NOT_COMPATIBLE_TO_PRODUCT_TYPE" => Some(Self::MediaBundleNotCompatibleToProductType),
"MEDIA_BUNDLE_REJECTED_BY_MULTIPLE_ASSET_SPECS" => Some(Self::MediaBundleRejectedByMultipleAssetSpecs),
...
"CANNOT_UPLOAD_MEDIA_TYPE_THROUGH_API" => Some(Self::CannotUploadMediaTypeThroughApi),
...
"MULTIPLIER_NOT_ALLOWED_FOR_BIDDING_STRATEGY" => Some(Self::MultiplierNotAllowedForBiddingStrategy),
"MULTIPLIER_NOT_ALLOWED_WHEN_BASE_BID_IS_MISSING" => Some(Self::MultiplierNotAllowedWhenBaseBidIsMissing),
"NO_MULTIPLIER_SPECIFIED" => Some(Self::NoMultiplierSpecified),
"MULTIPLIER_CAUSES_BID_TO_EXCEED_DAILY_BUDGET" => Some(Self::MultiplierCausesBidToExceedDailyBudget),
"MULTIPLIER_CAUSES_BID_TO_EXCEED_MONTHLY_BUDGET" => Some(Self::MultiplierCausesBidToExceedMonthlyBudget),
"MULTIPLIER_CAUSES_BID_TO_EXCEED_CUSTOM_BUDGET" => Some(Self::MultiplierCausesBidToExceedCustomBudget),
"MULTIPLIER_CAUSES_BID_TO_EXCEED_MAX_ALLOWED_BID" => Some(Self::MultiplierCausesBidToExceedMaxAllowedBid),
"BID_LESS_THAN_MIN_ALLOWED_BID_WITH_MULTIPLIER" => Some(Self::BidLessThanMinAllowedBidWithMultiplier),
"MULTIPLIER_AND_BIDDING_STRATEGY_TYPE_MISMATCH" => Some(Self::MultiplierAndBiddingStrategyTypeMismatch),
_ => None,
}
}
}
...
OfflineUserDataJobError::OperationLevelConsentProvided => "OPERATION_LEVEL_CONSENT_PROVIDED",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"NOT_ON_ALLOWLIST_FOR_STORE_SALES_DIRECT" => Some(Self::NotOnAllowlistForStoreSalesDirect),
"NOT_ON_ALLOWLIST_FOR_UNIFIED_STORE_SALES" => Some(Self::NotOnAllowlistForUnifiedStoreSales),
...
"CUSTOMER_NOT_ACCEPTED_CUSTOMER_DATA_TERMS" => Some(Self::CustomerNotAcceptedCustomerDataTerms),
"ATTRIBUTES_NOT_APPLICABLE_FOR_CUSTOMER_MATCH_USER_LIST" => Some(Self::AttributesNotApplicableForCustomerMatchUserList),
"LIFETIME_VALUE_BUCKET_NOT_IN_RANGE" => Some(Self::LifetimeValueBucketNotInRange),
"INCOMPATIBLE_USER_IDENTIFIER_FOR_ATTRIBUTES" => Some(Self::IncompatibleUserIdentifierForAttributes),
"FUTURE_TIME_NOT_ALLOWED" => Some(Self::FutureTimeNotAllowed),
"LAST_PURCHASE_TIME_LESS_THAN_ACQUISITION_TIME" => Some(Self::LastPurchaseTimeLessThanAcquisitionTime),
"CUSTOMER_IDENTIFIER_NOT_ALLOWED" => Some(Self::CustomerIdentifierNotAllowed),
"INVALID_ITEM_ID" => Some(Self::InvalidItemId),
"FIRST_PURCHASE_TIME_GREATER_THAN_LAST_PURCHASE_TIME" => Some(Self::FirstPurchaseTimeGreaterThanLastPurchaseTime),
"INVALID_LIFECYCLE_STAGE" => Some(Self::InvalidLifecycleStage),
"INVALID_EVENT_VALUE" => Some(Self::InvalidEventValue),
"EVENT_ATTRIBUTE_ALL_FIELDS_ARE_REQUIRED" => Some(Self::EventAttributeAllFieldsAreRequired),
"OPERATION_LEVEL_CONSENT_PROVIDED" => Some(Self::OperationLevelConsentProvided),
_ => None,
}
}
}
...
"UNSPECIFIED" => Some(Self::Unspecified),
"UNKNOWN" => Some(Self::Unknown),
"UNSUPPORTED_AD_TYPE_FOR_IGNORABLE_POLICY_TOPICS" => Some(Self::UnsupportedAdTypeForIgnorablePolicyTopics),
"UNSUPPORTED_AD_TYPE_FOR_EXEMPT_POLICY_VIOLATION_KEYS" => Some(Self::UnsupportedAdTypeForExemptPolicyViolationKeys),
"CANNOT_SET_BOTH_IGNORABLE_POLICY_TOPICS_AND_EXEMPT_POLICY_VIOLATION_KEYS" => Some(Self::CannotSetBothIgnorablePolicyTopicsAndExemptPolicyViolationKeys),
_ => None,
}
}
}
...
ProductLinkInvitationError::CustomerNotPermittedToCreateInvitation => "CUSTOMER_NOT_PERMITTED_TO_CREATE_INVITATION",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"CUSTOMER_NOT_PERMITTED_TO_CREATE_INVITATION" => Some(Self::CustomerNotPermittedToCreateInvitation),
_ => None,
}
}
}
...
"EXPECTED_DIMENSION_FIELD_IN_SELECT_CLAUSE" => Some(Self::ExpectedDimensionFieldInSelectClause),
...
"EXPECTED_REFERENCED_FIELD_IN_SELECT_CLAUSE" => Some(Self::ExpectedReferencedFieldInSelectClause),
"EXPECTED_SELECT" => Some(Self::ExpectedSelect),
"EXPECTED_SINGLE_VALUE" => Some(Self::ExpectedSingleValue),
"EXPECTED_VALUE_WITH_BETWEEN_OPERATOR" => Some(Self::ExpectedValueWithBetweenOperator),
"INVALID_DATE_FORMAT" => Some(Self::InvalidDateFormat),
"MISALIGNED_DATE_FOR_FILTER" => Some(Self::MisalignedDateForFilter),
"INVALID_STRING_VALUE" => Some(Self::InvalidStringValue),
"INVALID_VALUE_WITH_BETWEEN_OPERATOR" => Some(Self::InvalidValueWithBetweenOperator),
...
"PROHIBITED_FIELD_COMBINATION_IN_SELECT_CLAUSE" => Some(Self::ProhibitedFieldCombinationInSelectClause),
...
"PROHIBITED_RESOURCE_TYPE_IN_FROM_CLAUSE" => Some(Self::ProhibitedResourceTypeInFromClause),
"PROHIBITED_RESOURCE_TYPE_IN_SELECT_CLAUSE" => Some(Self::ProhibitedResourceTypeInSelectClause),
"PROHIBITED_RESOURCE_TYPE_IN_WHERE_CLAUSE" => Some(Self::ProhibitedResourceTypeInWhereClause),
"PROHIBITED_METRIC_IN_SELECT_OR_WHERE_CLAUSE" => Some(Self::ProhibitedMetricInSelectOrWhereClause),
"PROHIBITED_SEGMENT_IN_SELECT_OR_WHERE_CLAUSE" => Some(Self::ProhibitedSegmentInSelectOrWhereClause),
"PROHIBITED_SEGMENT_WITH_METRIC_IN_SELECT_OR_WHERE_CLAUSE" => Some(Self::ProhibitedSegmentWithMetricInSelectOrWhereClause),
"LIMIT_VALUE_TOO_LOW" => Some(Self::LimitValueTooLow),
"PROHIBITED_NEWLINE_IN_STRING" => Some(Self::ProhibitedNewlineInString),
"PROHIBITED_VALUE_COMBINATION_IN_LIST" => Some(Self::ProhibitedValueCombinationInList),
"PROHIBITED_VALUE_COMBINATION_WITH_BETWEEN_OPERATOR" => Some(Self::ProhibitedValueCombinationWithBetweenOperator),
...
ReachPlanError::NotForecastableNotEnoughInventory => "NOT_FORECASTABLE_NOT_ENOUGH_INVENTORY",
ReachPlanError::NotForecastableAccountNotEnabled => "NOT_FORECASTABLE_ACCOUNT_NOT_ENABLED",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"NOT_FORECASTABLE_NOT_ENOUGH_INVENTORY" => Some(Self::NotForecastableNotEnoughInventory),
"NOT_FORECASTABLE_ACCOUNT_NOT_ENABLED" => Some(Self::NotForecastableAccountNotEnabled),
_ => None,
}
}
}
...
RecommendationError::RecommendationTypeApplyNotSupported => "RECOMMENDATION_TYPE_APPLY_NOT_SUPPORTED",
RecommendationError::InvalidMultiplier => "INVALID_MULTIPLIER",
RecommendationError::AdvertisingChannelTypeGenerateNotSupported => "ADVERTISING_CHANNEL_TYPE_GENERATE_NOT_SUPPORTED",
RecommendationError::RecommendationTypeGenerateNotSupported => "RECOMMENDATION_TYPE_GENERATE_NOT_SUPPORTED",
RecommendationError::RecommendationTypesCannotBeEmpty => "RECOMMENDATION_TYPES_CANNOT_BE_EMPTY",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"RECOMMENDATION_TYPE_APPLY_NOT_SUPPORTED" => Some(Self::RecommendationTypeApplyNotSupported),
"INVALID_MULTIPLIER" => Some(Self::InvalidMultiplier),
"ADVERTISING_CHANNEL_TYPE_GENERATE_NOT_SUPPORTED" => Some(Self::AdvertisingChannelTypeGenerateNotSupported),
"RECOMMENDATION_TYPE_GENERATE_NOT_SUPPORTED" => Some(Self::RecommendationTypeGenerateNotSupported),
"RECOMMENDATION_TYPES_CANNOT_BE_EMPTY" => Some(Self::RecommendationTypesCannotBeEmpty),
_ => None,
}
}
}
...
"CANNOT_BE_EXECUTED_BY_MANAGER_ACCOUNT" => Some(Self::CannotBeExecutedByManagerAccount),
...
"LOGIN_CUSTOMER_ID_PARAMETER_MISSING" => Some(Self::LoginCustomerIdParameterMissing),
"VALIDATE_ONLY_REQUEST_HAS_PAGE_TOKEN" => Some(Self::ValidateOnlyRequestHasPageToken),
"CANNOT_RETURN_SUMMARY_ROW_FOR_REQUEST_WITHOUT_METRICS" => Some(Self::CannotReturnSummaryRowForRequestWithoutMetrics),
"CANNOT_RETURN_SUMMARY_ROW_FOR_VALIDATE_ONLY_REQUESTS" => Some(Self::CannotReturnSummaryRowForValidateOnlyRequests),
"INCONSISTENT_RETURN_SUMMARY_ROW_VALUE" => Some(Self::InconsistentReturnSummaryRowValue),
"TOTAL_RESULTS_COUNT_NOT_ORIGINALLY_REQUESTED" => Some(Self::TotalResultsCountNotOriginallyRequested),
...
SearchTermInsightError::FilteringNotAllowedWithSegments => "FILTERING_NOT_ALLOWED_WITH_SEGMENTS",
SearchTermInsightError::LimitNotAllowedWithSegments => "LIMIT_NOT_ALLOWED_WITH_SEGMENTS",
SearchTermInsightError::MissingFieldInSelectClause => "MISSING_FIELD_IN_SELECT_CLAUSE",
SearchTermInsightError::RequiresFilterBySingleResource => "REQUIRES_FILTER_BY_SINGLE_RESOURCE",
SearchTermInsightError::SortingNotAllowedWithSegments => "SORTING_NOT_ALLOWED_WITH_SEGMENTS",
SearchTermInsightError::SummaryRowNotAllowedWithSegments => "SUMMARY_ROW_NOT_ALLOWED_WITH_SEGMENTS",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"UNSPECIFIED" => Some(Self::Unspecified),
"UNKNOWN" => Some(Self::Unknown),
"FILTERING_NOT_ALLOWED_WITH_SEGMENTS" => Some(Self::FilteringNotAllowedWithSegments),
...
"SUMMARY_ROW_NOT_ALLOWED_WITH_SEGMENTS" => Some(Self::SummaryRowNotAllowedWithSegments),
_ => None,
}
}
}
...
ShoppingProductError::UnsupportedDateSegmentation => "UNSUPPORTED_DATE_SEGMENTATION",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"UNSUPPORTED_DATE_SEGMENTATION" => Some(Self::UnsupportedDateSegmentation),
_ => None,
}
}
}
...
SmartCampaignError::BusinessNameOrBusinessLocationIdMissing => "BUSINESS_NAME_OR_BUSINESS_LOCATION_ID_MISSING",
SmartCampaignError::RequiredSuggestionFieldMissing => "REQUIRED_SUGGESTION_FIELD_MISSING",
SmartCampaignError::GeoTargetsRequired => "GEO_TARGETS_REQUIRED",
SmartCampaignError::CannotDetermineSuggestionLocale => "CANNOT_DETERMINE_SUGGESTION_LOCALE",
...
"INVALID_CAMPAIGN" => Some(Self::InvalidCampaign),
"BUSINESS_NAME_OR_BUSINESS_LOCATION_ID_MISSING" => Some(Self::BusinessNameOrBusinessLocationIdMissing),
...
"CANNOT_REGENERATE_SHAREABLE_LINK_ID_FOR_REMOVED_LINK" => Some(Self::CannotRegenerateShareableLinkIdForRemovedLink),
_ => None,
}
}
}
...
"UNSPECIFIED" => Some(Self::Unspecified),
"UNKNOWN" => Some(Self::Unknown),
"OPERATIONS_FOR_CUSTOMER_MATCH_NOT_ALLOWED" => Some(Self::OperationsForCustomerMatchNotAllowed),
"TOO_MANY_USER_IDENTIFIERS" => Some(Self::TooManyUserIdentifiers),
...
UserListCustomerTypeError::ConflictingCustomerTypes => "CONFLICTING_CUSTOMER_TYPES",
...
UserListCustomerTypeError::ConversionTrackingNotEnabledOrNotMccManagerAccount => "CONVERSION_TRACKING_NOT_ENABLED_OR_NOT_MCC_MANAGER_ACCOUNT",
UserListCustomerTypeError::TooManyUserListsForTheCustomerType => "TOO_MANY_USER_LISTS_FOR_THE_CUSTOMER_TYPE",
}
}
/// Creates an enum from field names used in the ProtoBuf definition.
pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
"CONVERSION_TRACKING_NOT_ENABLED_OR_NOT_MCC_MANAGER_ACCOUNT" => Some(Self::ConversionTrackingNotEnabledOrNotMccManagerAccount),
"TOO_MANY_USER_LISTS_FOR_THE_CUSTOMER_TYPE" => Some(Self::TooManyUserListsForTheCustomerType),
_ => None,
}
}
}
...
CampaignError(i32),
#[prost(enumeration = "super::video_campaign_error_enum::VideoCampaignError", tag = "182")]
...
#[prost(enumeration = "super::recommendation_subscription_error_enum::RecommendationSubscriptionError", tag = "180")]
...
AudienceError(i32),
#[prost(enumeration = "super::search_term_insight_error_enum::SearchTermInsightError", tag = "174")]
SearchTermInsightError(i32),
#[prost(enumeration = "super::smart_campaign_error_enum::SmartCampaignError", tag = "147")]
...
#[prost(enumeration = "super::product_link_error_enum::ProductLinkError", tag = "169")]
ProductLinkError(i32),
#[prost(enumeration = "super::customer_sk_ad_network_conversion_value_schema_error_enum::CustomerSkAdNetworkConversionValueSchemaError", tag = "170")]
CustomerSkAdNetworkConversionValueSchemaError(i32),
#[prost(enumeration = "super::currency_error_enum::CurrencyError", tag = "171")]
CurrencyError(i32),
#[prost(enumeration = "super::asset_group_signal_error_enum::AssetGroupSignalError", tag = "176")]
AssetGroupSignalError(i32),
#[prost(enumeration = "super::product_link_invitation_error_enum::ProductLinkInvitationError", tag = "177")]
ProductLinkInvitationError(i32),
#[prost(enumeration = "super::customer_lifecycle_goal_error_enum::CustomerLifecycleGoalError", tag = "178")]
CustomerLifecycleGoalError(i32),
#[prost(enumeration = "super::campaign_lifecycle_goal_error_enum::CampaignLifecycleGoalError", tag = "179")]
CampaignLifecycleGoalError(i32),
#[prost(enumeration = "super::identity_verification_error_enum::IdentityVerificationError", tag = "181")]
IdentityVerificationError(i32),
#[prost(enumeration = "super::user_list_customer_type_error_enum::UserListCustomerTypeError", tag = "183")]
UserListCustomerTypeError(i32),
#[prost(enumeration = "super::shopping_product_error_enum::ShoppingProductError", tag = "184")]
