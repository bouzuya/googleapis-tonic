...
#[prost(enumeration = "threat_justification::JustificationLabel", repeated, tag = "1")]
...
"SOCIAL_ENGINEERING" => Some(Self::SocialEngineering),
"UNWANTED_SOFTWARE" => Some(Self::UnwantedSoftware),
"SOCIAL_ENGINEERING_EXTENDED_COVERAGE" => Some(Self::SocialEngineeringExtendedCoverage),
_ => None,
}
}
}
...
pub fn with_interceptor<F>(inner: T, interceptor: F) -> WebRiskServiceClient<InterceptedService<T, F>>
where
...
let path = http::uri::PathAndQuery::from_static("/google.cloud.webrisk.v1.WebRiskService/ComputeThreatListDiff");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.webrisk.v1.WebRiskService", "ComputeThreatListDiff"));
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.webrisk.v1.WebRiskService/SearchUris");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.webrisk.v1.WebRiskService", "SearchUris"));
self.inner.unary(req, path, codec).await
}
...
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.webrisk.v1.WebRiskService/SearchHashes");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.webrisk.v1.WebRiskService", "SearchHashes"));
self.inner.unary(req, path, codec).await
}
...
pub async fn create_submission(&mut self, request: impl tonic::IntoRequest<super::CreateSubmissionRequest>) -> std::result::Result<tonic::Response<super::Submission>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.webrisk.v1.WebRiskService/CreateSubmission");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.webrisk.v1.WebRiskService", "CreateSubmission"));
self.inner.unary(req, path, codec).await
}
...
/// allowlisted projects can use this method during Early Access. Please reach
/// out to Sales or your customer engineer to obtain access.
pub async fn submit_uri(&mut self, request: impl tonic::IntoRequest<super::SubmitUriRequest>) -> std::result::Result<tonic::Response<super::super::super::super::longrunning::Operation>, tonic::Status> {
self.inner.ready().await.map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
let codec = tonic::codec::ProstCodec::default();
let path = http::uri::PathAndQuery::from_static("/google.cloud.webrisk.v1.WebRiskService/SubmitUri");
let mut req = request.into_request();
req.extensions_mut().insert(GrpcMethod::new("google.cloud.webrisk.v1.WebRiskService", "SubmitUri"));
self.inner.unary(req, path, codec).await
}
}
}
