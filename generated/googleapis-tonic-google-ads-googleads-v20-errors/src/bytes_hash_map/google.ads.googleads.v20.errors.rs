...
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct ClickViewErrorEnum {}
/// Nested message and enum types in `ClickViewErrorEnum`.
pub mod click_view_error_enum {
    ...
    #[repr(i32)]
    pub enum ClickViewError {
        /// Enum unspecified.
        Unspecified = 0,
        /// The received error code is not known in this version.
        Unknown = 1,
        /// Missing filter on a single day.
        ExpectedFilterOnASingleDay = 2,
    ...
    impl ClickViewError {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Self::Unspecified => "UNSPECIFIED",
                Self::Unknown => "UNKNOWN",
                Self::ExpectedFilterOnASingleDay => "EXPECTED_FILTER_ON_A_SINGLE_DAY",
                Self::DateTooOld => "DATE_TOO_OLD",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "EXPECTED_FILTER_ON_A_SINGLE_DAY" => {
                    Some(Self::ExpectedFilterOnASingleDay)
                }
                "DATE_TOO_OLD" => Some(Self::DateTooOld),
                _ => None,
            }
        }
    }
...
pub mod criterion_error_enum {
    ...
    pub enum CriterionError {
        ...
        MissingEuPoliticalAdvertisingSelfDeclaration = 176,
    }
    impl CriterionError {
        /// String value of the enum field names used in the ProtoBuf definition.
        ///
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::MissingEuPoliticalAdvertisingSelfDeclaration => {
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "MISSING_EU_POLITICAL_ADVERTISING_SELF_DECLARATION" => {
                    Some(Self::MissingEuPoliticalAdvertisingSelfDeclaration)
                }
                _ => None,
            }
        }
...
pub mod experiment_error_enum {
    ...
    pub enum ExperimentError {
        ...
        MissingEuPoliticalAdvertisingSelfDeclaration = 31,
    }
...
pub mod recommendation_error_enum {
    ...
    pub enum RecommendationError {
        ...
        /// PERFORMANCE_MAX.
        MerchantCenterAccountIdNotSupportedAdvertisingChannelType = 36,
    }
    impl RecommendationError {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::MerchantCenterAccountIdNotSupportedAdvertisingChannelType => {
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "MERCHANT_CENTER_ACCOUNT_ID_NOT_SUPPORTED_ADVERTISING_CHANNEL_TYPE" => {
                    Some(Self::MerchantCenterAccountIdNotSupportedAdvertisingChannelType)
                }
                _ => None,
            }
        }
...
pub mod user_list_customer_type_error_enum {
    ...
    pub enum UserListCustomerTypeError {
        ...
        /// 1. Purchasers - Qualified Leads
        /// 1. Purchasers - Cart Abandoners
...
pub mod error_code {
    ...
    pub enum ErrorCode {
        ...
        #[prost(
            enumeration = "super::click_view_error_enum::ClickViewError",
            tag = "113"
        )]
        ClickViewError(i32),
