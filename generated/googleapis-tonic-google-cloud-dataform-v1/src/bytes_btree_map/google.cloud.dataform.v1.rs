...
pub struct SearchResult {
    /// The entry's contents.
    #[prost(oneof = "search_result::Entry", tags = "1, 2")]
    pub entry: ::core::option::Option<search_result::Entry>,
}
...
pub mod search_result {
    ...
    pub enum Entry {
        ...
        #[prost(message, tag = "1")]
        File(super::FileSearchResult),
        /// Details when search result is a directory.
        #[prost(message, tag = "2")]
        Directory(super::DirectorySearchResult),
    }
}
...
pub struct WorkflowInvocation {
    ...
    /// `projects/*/locations/*/repositories/*/compilationResults/*`.
    #[prost(string, tag = "7")]
    pub resolved_compilation_result: ::prost::alloc::string::String,
    /// Output only. Only set if the repository has a KMS Key.
...
pub mod dataform_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_repository(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("google.cloud.dataform.v1.Dataform", "GetRepository"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn commit_repository_changes(
            ...
            tonic::Response<super::CommitRepositoryChangesResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn get_workspace(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("google.cloud.dataform.v1.Dataform", "GetWorkspace"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn pull_git_commits(
            ...
            tonic::Response<super::PullGitCommitsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn push_git_commits(
            ...
            tonic::Response<super::PushGitCommitsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn commit_workspace_changes(
            ...
            tonic::Response<super::CommitWorkspaceChangesResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn reset_workspace_changes(
            ...
            tonic::Response<super::ResetWorkspaceChangesResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("google.cloud.dataform.v1.Dataform", "FetchFileDiff"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("google.cloud.dataform.v1.Dataform", "SearchFiles"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("google.cloud.dataform.v1.Dataform", "MakeDirectory"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn remove_directory(
            ...
            tonic::Response<super::RemoveDirectoryResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("google.cloud.dataform.v1.Dataform", "MoveDirectory"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("google.cloud.dataform.v1.Dataform", "ReadFile"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn remove_file(
            ...
            tonic::Response<super::RemoveFileResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("google.cloud.dataform.v1.Dataform", "RemoveFile"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("google.cloud.dataform.v1.Dataform", "MoveFile"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("google.cloud.dataform.v1.Dataform", "WriteFile"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn cancel_workflow_invocation(
            ...
            tonic::Response<super::CancelWorkflowInvocationResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn get_config(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("google.cloud.dataform.v1.Dataform", "GetConfig"),
                );
            self.inner.unary(req, path, codec).await
        }
