...
pub struct Contact {
    ...
    pub company_display_name: ::core::option::Option<::prost::alloc::string::String>,
}
/// Wrapper message for
...
pub struct CustomTargetingValue {
    ...
    /// `networks/{network_code}/customTargetingKeys/{custom_targeting_key_id}`
    #[prost(string, tag = "8")]
    pub custom_targeting_key: ::prost::alloc::string::String,
...
pub mod report {
    ...
    pub enum Metric {
        ...
        AdServerUnfilteredImpressions = 260,
    ...
    impl Metric {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::AdServerUnfilteredImpressions => "AD_SERVER_UNFILTERED_IMPRESSIONS",
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "AD_SERVER_UNFILTERED_IMPRESSIONS" => {
                    Some(Self::AdServerUnfilteredImpressions)
                }
...
pub struct ReportDefinition {
    ...
    /// zone.
    #[prost(enumeration = "report::TimeZoneSource", tag = "20")]
