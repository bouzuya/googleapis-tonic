...
impl AccessRight {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::ApiDeveloper => "API_DEVELOPER",
        }
    }
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "API_DEVELOPER" => Some(Self::ApiDeveloper),
            _ => None,
        }
    }
}
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct GetAccountRelationshipRequest {
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct UpdateAccountRelationshipRequest {
    /// Required. The new version of the account relationship.
    #[prost(message, optional, tag = "1")]
    pub account_relationship: ::core::option::Option<AccountRelationship>,
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct ListAccountRelationshipsRequest {
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ListAccountRelationshipsResponse {
    /// The account relationships that match your filter.
    #[prost(message, repeated, tag = "1")]
    pub account_relationships: ::prost::alloc::vec::Vec<AccountRelationship>,
...
/// Generated client implementations.
pub mod account_relationships_service_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    #[derive(Debug, Clone)]
    pub struct AccountRelationshipsServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl<T> AccountRelationshipsServiceClient<T>
    where
        T: tonic::client::GrpcService<tonic::body::Body>,
        T::Error: Into<StdError>,
        T::ResponseBody: Body<Data = Bytes> + std::marker::Send + 'static,
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> AccountRelationshipsServiceClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            AccountRelationshipsServiceClient::new(
        ...
        pub async fn get_account_relationship(
            &mut self,
            request: impl tonic::IntoRequest<super::GetAccountRelationshipRequest>,
        ) -> std::result::Result<
            tonic::Response<super::AccountRelationship>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        /// access.
        pub async fn update_account_relationship(
            &mut self,
            request: impl tonic::IntoRequest<super::UpdateAccountRelationshipRequest>,
        ) -> std::result::Result<
            tonic::Response<super::AccountRelationship>,
            tonic::Status,
        > {
        ...
        pub async fn list_account_relationships(
            &mut self,
            request: impl tonic::IntoRequest<super::ListAccountRelationshipsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListAccountRelationshipsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
pub struct AccountService {
    ...
    /// immutable.
    #[prost(enumeration = "account_service::Mutability", tag = "5")]
    pub mutability: i32,
    ...
    #[prost(
        oneof = "account_service::ServiceType",
        tags = "100, 101, 102, 103, 104, 105"
    )]
    pub service_type: ::core::option::Option<account_service::ServiceType>,
}
/// Nested message and enum types in `AccountService`.
pub mod account_service {
    ...
    impl Mutability {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Self::Unspecified => "MUTABILITY_UNSPECIFIED",
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                "MUTABILITY_UNSPECIFIED" => Some(Self::Unspecified),
    ...
    pub enum ServiceType {
        ...
        ProductsManagement(super::ProductsManagement),
        ...
        CampaignsManagement(super::CampaignsManagement),
        ...
        AccountManagement(super::AccountManagement),
        ...
        AccountAggregation(super::AccountAggregation),
        ...
        LocalListingManagement(super::LocalListingManagement),
        ...
        ComparisonShopping(super::ComparisonShopping),
    }
}
/// Request to get an account service.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct GetAccountServiceRequest {
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct ListAccountServicesRequest {
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ListAccountServicesResponse {
    /// The account services that match your filter.
    #[prost(message, repeated, tag = "1")]
    pub account_services: ::prost::alloc::vec::Vec<AccountService>,
    /// A page token. You can send the `page_token` to get the next page.
    /// Only included in the `list` response if there are more pages.
    #[prost(string, tag = "2")]
    pub next_page_token: ::prost::alloc::string::String,
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct ProposeAccountServiceRequest {
    ...
    #[prost(message, optional, tag = "4")]
    pub account_service: ::core::option::Option<AccountService>,
}
/// Request to approve an account service.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct ApproveAccountServiceRequest {
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct RejectAccountServiceRequest {
...
pub struct ProductsManagement {}
/// `CampaignManagement` payload.
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct CampaignsManagement {}
...
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct LocalListingManagement {}
/// `ComparisonShopping` payload.
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct ComparisonShopping {}
...
pub mod handshake {
    ...
    impl Actor {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Self::Unspecified => "ACTOR_UNSPECIFIED",
                Self::Account => "ACCOUNT",
                Self::OtherParty => "OTHER_PARTY",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                "ACTOR_UNSPECIFIED" => Some(Self::Unspecified),
                "ACCOUNT" => Some(Self::Account),
                "OTHER_PARTY" => Some(Self::OtherParty),
                _ => None,
            }
        }
    }
...
/// Generated client implementations.
pub mod account_services_service_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    #[derive(Debug, Clone)]
    pub struct AccountServicesServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl<T> AccountServicesServiceClient<T>
    where
        T: tonic::client::GrpcService<tonic::body::Body>,
        T::Error: Into<StdError>,
        T::ResponseBody: Body<Data = Bytes> + std::marker::Send + 'static,
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> AccountServicesServiceClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            AccountServicesServiceClient::new(
                InterceptedService::new(inner, interceptor),
            )
        }
        /// Compress requests with the given encoding.
        ...
        pub async fn get_account_service(
            &mut self,
            request: impl tonic::IntoRequest<super::GetAccountServiceRequest>,
        ) -> std::result::Result<tonic::Response<super::AccountService>, tonic::Status> {
            self.inner
                .ready()
                .await
                .map_err(|e| {
        ...
        pub async fn list_account_services(
            &mut self,
            request: impl tonic::IntoRequest<super::ListAccountServicesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListAccountServicesResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn propose_account_service(
            &mut self,
            request: impl tonic::IntoRequest<super::ProposeAccountServiceRequest>,
        ) -> std::result::Result<tonic::Response<super::AccountService>, tonic::Status> {
            self.inner
                .ready()
                .await
        ...
        pub async fn approve_account_service(
            &mut self,
            request: impl tonic::IntoRequest<super::ApproveAccountServiceRequest>,
        ) -> std::result::Result<tonic::Response<super::AccountService>, tonic::Status> {
            self.inner
                .ready()
                .await
        ...
        /// rejected).
        pub async fn reject_account_service(
            &mut self,
            request: impl tonic::IntoRequest<super::RejectAccountServiceRequest>,
...
pub mod user_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_user(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.shopping.merchant.accounts.v1.UserService/GetUser",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn create_user(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.shopping.merchant.accounts.v1.UserService/CreateUser",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn delete_user(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.shopping.merchant.accounts.v1.UserService/DeleteUser",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn update_user(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.shopping.merchant.accounts.v1.UserService/UpdateUser",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.shopping.merchant.accounts.v1.UserService/ListUsers",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn verify_self(
            &mut self,
            request: impl tonic::IntoRequest<super::VerifySelfRequest>,
        ) -> std::result::Result<tonic::Response<super::User>, tonic::Status> {
            self.inner
                .ready()
                .await
...
pub struct CreateAndConfigureAccountRequest {
    ...
    pub user: ::prost::alloc::vec::Vec<create_and_configure_account_request::AddUser>,
    ...
    pub set_alias: ::prost::alloc::vec::Vec<
        create_and_configure_account_request::SetAliasForRelationship,
    >,
}
...
pub mod create_and_configure_account_request {
    ...
    pub struct AddUser {
        ...
        #[prost(message, optional, tag = "3")]
        pub verification_mail_settings: ::core::option::Option<
            super::VerificationMailSettings,
        >,
    }
    ...
    pub struct AddAccountService {
        ...
        #[prost(
            oneof = "add_account_service::ServiceType",
            tags = "103, 104, 105, 106, 107"
        )]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "google.shopping.merchant.accounts.v1.AutofeedSettingsService",
                        "GetAutofeedSettings",
                    ),
                );
            self.inner.unary(req, path, codec).await
...
pub struct DeveloperRegistration {
    ...
    pub gcp_ids: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
}
/// Request message for the RegisterGCP method.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct RegisterGcpRequest {
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct UnregisterGcpRequest {
    /// Required. The name of the developer registration to be created for the
    /// merchant account that the GCP will be registered with. Format:
    /// `accounts/{account}/developerRegistration`
    #[prost(string, tag = "1")]
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct GetDeveloperRegistrationRequest {
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct GetAccountForGcpRegistrationResponse {
    /// The name of the merchant account id that the GCP is registered with.
    #[prost(string, tag = "1")]
    pub name: ::prost::alloc::string::String,
}
/// Generated client implementations.
pub mod developer_registration_service_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    #[derive(Debug, Clone)]
    pub struct DeveloperRegistrationServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl<T> DeveloperRegistrationServiceClient<T>
    where
        T: tonic::client::GrpcService<tonic::body::Body>,
        T::Error: Into<StdError>,
        T::ResponseBody: Body<Data = Bytes> + std::marker::Send + 'static,
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> DeveloperRegistrationServiceClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            DeveloperRegistrationServiceClient::new(
                InterceptedService::new(inner, interceptor),
            )
        }
        /// Compress requests with the given encoding.
        ...
        /// on.
        pub async fn register_gcp(
            &mut self,
            request: impl tonic::IntoRequest<super::RegisterGcpRequest>,
        ) -> std::result::Result<
            tonic::Response<super::DeveloperRegistration>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn get_developer_registration(
            &mut self,
            request: impl tonic::IntoRequest<super::GetDeveloperRegistrationRequest>,
        ) -> std::result::Result<
            tonic::Response<super::DeveloperRegistration>,
            tonic::Status,
        > {
        ...
        pub async fn unregister_gcp(
            &mut self,
            request: impl tonic::IntoRequest<super::UnregisterGcpRequest>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status> {
            self.inner
                .ready()
                .await
        ...
        pub async fn get_account_for_gcp_registration(
            &mut self,
            request: impl tonic::IntoRequest<()>,
        ) -> std::result::Result<
            tonic::Response<super::GetAccountForGcpRegistrationResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
pub mod homepage_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_homepage(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.shopping.merchant.accounts.v1.HomepageService/GetHomepage",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn update_homepage(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.shopping.merchant.accounts.v1.HomepageService/UpdateHomepage",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn claim_homepage(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.shopping.merchant.accounts.v1.HomepageService/ClaimHomepage",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn unclaim_homepage(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.shopping.merchant.accounts.v1.HomepageService/UnclaimHomepage",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod programs_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_program(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.shopping.merchant.accounts.v1.ProgramsService/GetProgram",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.shopping.merchant.accounts.v1.ProgramsService/ListPrograms",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn enable_program(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.shopping.merchant.accounts.v1.ProgramsService/EnableProgram",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn disable_program(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.shopping.merchant.accounts.v1.ProgramsService/DisableProgram",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod regions_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_region(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.shopping.merchant.accounts.v1.RegionsService/GetRegion",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn create_region(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.shopping.merchant.accounts.v1.RegionsService/CreateRegion",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn update_region(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.shopping.merchant.accounts.v1.RegionsService/UpdateRegion",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn delete_region(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.shopping.merchant.accounts.v1.RegionsService/DeleteRegion",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.shopping.merchant.accounts.v1.RegionsService/ListRegions",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub struct ShippingSettings {
    ...
    ///    creation.
    ///
    /// 1. After the initial creation, call the `get` method to obtain an etag and
    ///    the current shipping setting data before calling `insert`.
    ///
    /// 1. Modify the shipping setting information.
    ///
    /// 1. Call the `insert` method with the shipping setting information
    ///    and the etag obtained in step 2.
    ///
    /// 1. If the shipping setting data changes between step 2 and step 4, the
...
pub mod shipping_settings_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.shopping.merchant.accounts.v1.ShippingSettingsService/GetShippingSettings",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "google.shopping.merchant.accounts.v1.ShippingSettingsService",
                        "GetShippingSettings",
                    ),
                );
            self.inner.unary(req, path, codec).await
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.shopping.merchant.accounts.v1.ShippingSettingsService/InsertShippingSettings",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "google.shopping.merchant.accounts.v1.TermsOfServiceAgreementStateService",
...
pub struct AcceptTermsOfServiceResponse {
    ...
    #[prost(message, optional, tag = "1")]
    pub terms_of_service_agreement_state: ::core::option::Option<
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_terms_of_service(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "google.shopping.merchant.accounts.v1.TermsOfServiceService",
                        "GetTermsOfService",
                    ),
                );
            self.inner.unary(req, path, codec).await
        ...
        pub async fn accept_terms_of_service(
            ...
            tonic::Response<super::AcceptTermsOfServiceResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
