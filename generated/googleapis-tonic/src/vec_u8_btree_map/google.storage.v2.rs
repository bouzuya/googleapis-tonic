...
pub struct ListBucketsResponse {
    ...
    /// unreachable = \[
    /// "projects/*/buckets/bucket1",
    /// "projects/*/buckets/bucket2",
...
pub struct ReadObjectRequest {
    ...
    /// If no mask is specified, it defaults to all fields except `metadata.  owner` and `metadata.acl`.
    /// `*` might be used to mean "all fields".
...
pub struct GetObjectRequest {
    ...
    pub common_object_request_params: ::core::option::Option<CommonObjectRequestParams>,
    /// Mask specifying which fields to read.
    /// If no mask is specified, it defaults to all fields except `metadata.  acl` and `metadata.owner`.
    /// `*` might be used to mean "all fields".
    #[prost(message, optional, tag = "10")]
    pub read_mask: ::core::option::Option<::prost_types::FieldMask>,
    /// Optional. Restore token used to differentiate soft-deleted objects with the
...
pub struct ObjectChecksums {
    ...
    /// crc32c hashes. This value is equivalent to running `cat object.txt |  openssl md5 -binary`
