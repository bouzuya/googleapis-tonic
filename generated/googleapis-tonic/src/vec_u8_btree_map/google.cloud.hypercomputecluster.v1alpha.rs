...
pub struct NewOnDemandInstancesConfig {
    ...
    pub atm_tags: ::prost::alloc::collections::BTreeMap<
        ::prost::alloc::string::String,
        ::prost::alloc::string::String,
    >,
...
pub struct Configs {
    ...
    pub user_configs: ::prost::alloc::collections::BTreeMap<
        ::prost::alloc::string::String,
        ::prost::alloc::string::String,
    >,
    /// Optional. Software configs.
    #[prost(btree_map = "string, string", tag = "2")]
    pub software_configs: ::prost::alloc::collections::BTreeMap<
        ::prost::alloc::string::String,
        ::prost::alloc::string::String,
    >,
    /// Optional. Hardware configs.
    #[prost(btree_map = "string, string", tag = "3")]
    pub hardware_configs: ::prost::alloc::collections::BTreeMap<
        ::prost::alloc::string::String,
        ::prost::alloc::string::String,
    >,
}
