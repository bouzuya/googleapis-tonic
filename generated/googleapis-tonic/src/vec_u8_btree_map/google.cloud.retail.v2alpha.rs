...
pub mod output_config {
    ...
    pub struct GcsDestination {
        ...
        /// gs://bucket/folder/item\_  gs://bucket/folder/item_foo.json
        #[prost(string, tag = "1")]
...
pub struct ExportProductsRequest {
    ...
    /// type.
    /// For example, `lastModifiedTime > "2012-04-23T18:25:43.511Z"  lastModifiedTime<"2012-04-23T18:25:43.511Z" productType=primary`
    ///
...
pub struct ExportUserEventsRequest {
    ...
    /// For example, `eventTime > "2012-04-23T18:25:43.511Z"  eventsMissingCatalogItems eventTime<"2012-04-23T18:25:43.511Z"  eventType=search`
    ///
...
pub mod rule {
    ...
    pub struct PinAction {
        ...
        #[prost(btree_map = "int64, string", tag = "1")]
        pub pin_map: ::prost::alloc::collections::BTreeMap<
            i64,
            ::prost::alloc::string::String,
        >,
    }
...
pub struct LocalInventory {
    ...
    /// or custom attributes for similar behaviour. See [here](<https://cloud.google.com/retail/docs/local-inventory-updates#local-inventory-update-methods>)
    /// for more details.
    #[prost(enumeration = "local_inventory::Availability", tag = "5")]
...
/// Nested message and enum types in `LocalInventory`.
...
pub struct PinControlMetadata {
    ...
    #[prost(btree_map = "int64, message", tag = "1")]
    pub all_matched_pins: ::prost::alloc::collections::BTreeMap<
        i64,
    ...
    pub dropped_pins: ::prost::alloc::collections::BTreeMap<
        i64,
        pin_control_metadata::ProductPins,
    >,
}
