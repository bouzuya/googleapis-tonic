...
pub struct BackupConfiguration {
    ...
    #[prost(enumeration = "backup_configuration::BackupTier", optional, tag = "11")]
...
pub struct DatabaseInstance {
    ...
    #[prost(btree_map = "string, string", tag = "60")]
...
pub mod sql_backups_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_backup(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("google.cloud.sql.v1.SqlBackupsService", "GetBackup"),
                );
            self.inner.unary(req, path, codec).await
        }
...
/// Generated client implementations.
pub mod sql_feature_eligibility_service_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    #[derive(Debug, Clone)]
    pub struct SqlFeatureEligibilityServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl<T> SqlFeatureEligibilityServiceClient<T>
    where
        T: tonic::client::GrpcService<tonic::body::Body>,
        T::Error: Into<StdError>,
        T::ResponseBody: Body<Data = Bytes> + std::marker::Send + 'static,
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> SqlFeatureEligibilityServiceClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            SqlFeatureEligibilityServiceClient::new(
                InterceptedService::new(inner, interceptor),
            )
        }
        /// Compress requests with the given encoding.
