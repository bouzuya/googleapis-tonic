...
pub struct AssetEnrichment {
    #[prost(oneof = "asset_enrichment::EnrichmentData", tags = "7")]
    pub enrichment_data: ::core::option::Option<asset_enrichment::EnrichmentData>,
}
/// Nested message and enum types in `AssetEnrichment`.
pub mod asset_enrichment {
    ...
    pub enum EnrichmentData {
        ...
        #[prost(message, tag = "7")]
        ResourceOwners(super::ResourceOwners),
    }
}
...
pub struct ResourceSearchResult {
    ...
    pub enrichments: ::prost::alloc::vec::Vec<AssetEnrichment>,
