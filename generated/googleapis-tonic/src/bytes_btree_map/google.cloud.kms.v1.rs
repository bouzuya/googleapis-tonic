    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "MODIFIED_CUSTOMER_INITIATED_ACCESS" => {
                Some(#[allow(deprecated)] Self::ModifiedCustomerInitiatedAccess)
            }
            "MODIFIED_GOOGLE_INITIATED_SYSTEM_OPERATION" => {
                Some(#[allow(deprecated)] Self::ModifiedGoogleInitiatedSystemOperation)
            }
            "GOOGLE_RESPONSE_TO_PRODUCTION_ALERT" => {
...
pub struct ChallengeReply {
    ...
    #[prost(bytes = "bytes", tag = "1")]
    pub signed_challenge: ::prost::bytes::Bytes,
...
pub struct DecapsulateResponse {
    ...
    /// public key.
    #[prost(bytes = "bytes", tag = "2")]
    pub shared_secret: ::prost::bytes::Bytes,
    /// Integrity verification field. A CRC32C checksum of the returned
