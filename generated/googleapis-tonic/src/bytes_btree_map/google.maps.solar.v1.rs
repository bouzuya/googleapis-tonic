...
impl Experiment {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "EXPERIMENT_UNSPECIFIED",
            Self::ExpandedCoverage => "EXPANDED_COVERAGE",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "EXPERIMENT_UNSPECIFIED" => Some(Self::Unspecified),
            "EXPANDED_COVERAGE" => Some(Self::ExpandedCoverage),
            _ => None,
        }
    }
}
