...
impl FileOriginType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "FILE_ORIGIN_TYPE_UNSPECIFIED",
            Self::UserProvided => "USER_PROVIDED",
            Self::AiGenerated => "AI_GENERATED",
            Self::InternallyGenerated => "INTERNALLY_GENERATED",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "FILE_ORIGIN_TYPE_UNSPECIFIED" => Some(Self::Unspecified),
            "USER_PROVIDED" => Some(Self::UserProvided),
            "AI_GENERATED" => Some(Self::AiGenerated),
            "INTERNALLY_GENERATED" => Some(Self::InternallyGenerated),
            _ => None,
        }
    }
}
...
pub mod session {
    ...
    pub struct Turn {
        ...
        pub query_config: ::prost::alloc::collections::BTreeMap<
            ::prost::alloc::string::String,
            ::prost::alloc::string::String,
        >,
    }
...
pub struct ImageCharacteristics {
    ...
    #[prost(enumeration = "image_characteristics::ColorSpace", tag = "3")]
    pub color_space: i32,
    /// Output only. Bit depth of the image (e.g., 8-bit, 16-bit).
    #[prost(int32, tag = "4")]
    pub bit_depth: i32,
}
/// Nested message and enum types in `ImageCharacteristics`.
    ...
    impl ColorSpace {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::Yuv => "YUV",
                Self::OtherColorSpace => "OTHER_COLOR_SPACE",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "YUV" => Some(Self::Yuv),
                "OTHER_COLOR_SPACE" => Some(Self::OtherColorSpace),
                _ => None,
            }
        }
    }
...
pub struct FileCharacteristics {
    ...
    pub characteristics: ::prost::alloc::collections::BTreeMap<
        ::prost::alloc::string::String,
        ::prost::alloc::string::String,
    >,
}
...
pub struct FileView {
    ...
    /// the view.
    #[prost(oneof = "file_view::Characteristics", tags = "6, 7, 8")]
    pub characteristics: ::core::option::Option<file_view::Characteristics>,
}
/// Nested message and enum types in `FileView`.
pub mod file_view {
    /// Characteristics of the media view, allowing for flexible extensions.
    /// Metadata is always internally generated by the process creating
    /// the view.
    ...
    pub enum Characteristics {
        ...
        #[prost(message, tag = "6")]
        ImageCharacteristics(super::ImageCharacteristics),
        /// Output only. Characteristics of a video media view.
        #[prost(message, tag = "7")]
        VideoCharacteristics(super::VideoCharacteristics),
        /// Output only. Characteristics of other file types.
        #[prost(message, tag = "8")]
        FileCharacteristics(super::FileCharacteristics),
    }
}
...
pub struct FileMetadata {
    ...
    #[prost(string, tag = "9")]
    pub original_uri: ::prost::alloc::string::String,
    /// Optional. The type of the original source of the file.
    #[prost(enumeration = "FileSource", tag = "10")]
    pub original_source_type: i32,
    ...
    /// will be updated.
    #[prost(message, optional, tag = "13")]
    pub last_add_time: ::core::option::Option<::prost_types::Timestamp>,
    ...
    #[prost(enumeration = "FileOriginType", tag = "21")]
    ...
    pub views: ::prost::alloc::collections::BTreeMap<
        ::prost::alloc::string::String,
        FileView,
    >,
}
...
impl FileSource {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::Inline => "FILE_SOURCE_INLINE",
            Self::Local => "FILE_SOURCE_LOCAL",
            Self::CloudStorage => "FILE_SOURCE_CLOUD_STORAGE",
            Self::CloudDrive => "FILE_SOURCE_CLOUD_DRIVE",
            Self::Url => "FILE_SOURCE_URL",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "FILE_SOURCE_INLINE" => Some(Self::Inline),
            "FILE_SOURCE_LOCAL" => Some(Self::Local),
            "FILE_SOURCE_CLOUD_STORAGE" => Some(Self::CloudStorage),
            "FILE_SOURCE_CLOUD_DRIVE" => Some(Self::CloudDrive),
            "FILE_SOURCE_URL" => Some(Self::Url),
            _ => None,
        }
    }
}
