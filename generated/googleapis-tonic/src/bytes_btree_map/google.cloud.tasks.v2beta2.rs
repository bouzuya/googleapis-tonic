...
pub struct AppEngineRouting {
    ...
    ///   \[instance\]\[google.cloud.tasks.v2beta2.AppEngineRouting.instance\] `+ '.' +` \[service\]\[google.cloud.tasks.v2beta2.AppEngineRouting.service\]
    ///
    /// * `instance_dot_version =`
    ///   \[instance\]\[google.cloud.tasks.v2beta2.AppEngineRouting.instance\] `+ '.' +` \[version\]\[google.cloud.tasks.v2beta2.AppEngineRouting.version\]
    ///
    /// * `instance_dot_version_dot_service =`
    ///   \[instance\]\[google.cloud.tasks.v2beta2.AppEngineRouting.instance\] `+ '.' +` \[version\]\[google.cloud.tasks.v2beta2.AppEngineRouting.version\] `+ '.' +` \[service\]\[google.cloud.tasks.v2beta2.AppEngineRouting.service\]
    ///
