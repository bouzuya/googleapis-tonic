...
pub struct ProductAttributes {
    ...
    /// the item.
    #[prost(enumeration = "AgeGroup", optional, tag = "18")]
    pub age_group: ::core::option::Option<i32>,
    /// [Availability](<https://support.google.com/merchants/answer/6324448>) status
    /// of the item.
    #[prost(enumeration = "Availability", optional, tag = "19")]
    ...
    #[prost(enumeration = "SizeSystem", optional, tag = "49")]
    pub size_system: ::core::option::Option<i32>,
    ...
    #[prost(enumeration = "SizeType", repeated, tag = "50")]
    pub size_types: ::prost::alloc::vec::Vec<i32>,
    /// The [energy efficiency
    /// class](<https://support.google.com/merchants/answer/7562785>) as defined in
    /// EU directive 2010/30/EU.
    #[prost(enumeration = "EnergyEfficiencyClass", optional, tag = "53")]
    pub energy_efficiency_class: ::core::option::Option<i32>,
    /// The [energy efficiency
    /// class](<https://support.google.com/merchants/answer/7562785>) as defined in
    /// EU directive 2010/30/EU.
    #[prost(enumeration = "EnergyEfficiencyClass", optional, tag = "54")]
    pub min_energy_efficiency_class: ::core::option::Option<i32>,
    /// The [energy efficiency
    /// class](<https://support.google.com/merchants/answer/7562785>) as defined in
    /// EU directive 2010/30/EU.
    #[prost(enumeration = "EnergyEfficiencyClass", optional, tag = "55")]
    pub max_energy_efficiency_class: ::core::option::Option<i32>,
    ...
    /// for the item.
    #[prost(enumeration = "PickupMethod", optional, tag = "80")]
    pub pickup_method: ::core::option::Option<i32>,
    /// Item store pickup timeline. For more information, see
    /// [Pickup SLA](<https://support.google.com/merchants/answer/14635400>).
    #[prost(enumeration = "PickupSla", optional, tag = "81")]
    pub pickup_sla: ::core::option::Option<i32>,
    ...
    pub included_destinations: ::prost::alloc::vec::Vec<i32>,
    ...
    pub excluded_destinations: ::prost::alloc::vec::Vec<i32>,
    ...
    #[prost(enumeration = "Pause", optional, tag = "13")]
    pub pause: ::core::option::Option<i32>,
    ...
    pub certifications: ::prost::alloc::vec::Vec<ProductCertification>,
    /// Structured title, for algorithmically (AI)-generated titles.
    #[prost(message, optional, tag = "132")]
    pub structured_title: ::core::option::Option<StructuredTitle>,
    /// Structured description, for algorithmically (AI)-generated descriptions.
    #[prost(message, optional, tag = "133")]
    pub structured_description: ::core::option::Option<StructuredDescription>,
...
pub struct ProductInstallment {
    ...
    #[prost(enumeration = "CreditType", optional, tag = "4")]
...
pub struct ProductCertification {
    ...
    #[prost(enumeration = "CertificationAuthority", optional, tag = "1")]
    pub certification_authority: ::core::option::Option<i32>,
    /// The name of the certification.
    #[prost(enumeration = "CertificationName", optional, tag = "2")]
    pub certification_name: ::core::option::Option<i32>,
...
pub struct StructuredTitle {
    ...
    #[prost(enumeration = "DigitalSourceType", optional, tag = "1")]
    pub digital_source_type: ::core::option::Option<i32>,
    /// The title text
...
impl AgeGroup {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "AGE_GROUP_UNSPECIFIED",
            Self::Adult => "ADULT",
            Self::Kids => "KIDS",
...
impl Availability {
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "LIMITED_AVAILABILITY" => Some(Self::LimitedAvailability),
...
impl SizeSystem {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "SIZE_SYSTEM_UNSPECIFIED",
            Self::Au => "AU",
            Self::Br => "BR",
            Self::Cn => "CN",
            Self::De => "DE",
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "SIZE_SYSTEM_UNSPECIFIED" => Some(Self::Unspecified),
            "AU" => Some(Self::Au),
            "BR" => Some(Self::Br),
            "CN" => Some(Self::Cn),
            "DE" => Some(Self::De),
...
impl EnergyEfficiencyClass {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "ENERGY_EFFICIENCY_CLASS_UNSPECIFIED",
            Self::Appp => "APPP",
            Self::App => "APP",
            Self::Ap => "AP",
            Self::A => "A",
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "ENERGY_EFFICIENCY_CLASS_UNSPECIFIED" => Some(Self::Unspecified),
            "APPP" => Some(Self::Appp),
            "APP" => Some(Self::App),
            "AP" => Some(Self::Ap),
            "A" => Some(Self::A),
...
impl PickupMethod {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "PICKUP_METHOD_UNSPECIFIED",
            Self::NotSupported => "NOT_SUPPORTED",
            Self::Buy => "BUY",
            Self::Reserve => "RESERVE",
            Self::ShipToStore => "SHIP_TO_STORE",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "PICKUP_METHOD_UNSPECIFIED" => Some(Self::Unspecified),
            "NOT_SUPPORTED" => Some(Self::NotSupported),
            "BUY" => Some(Self::Buy),
            "RESERVE" => Some(Self::Reserve),
            "SHIP_TO_STORE" => Some(Self::ShipToStore),
            _ => None,
        }
    }
}
...
impl PickupSla {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "PICKUP_SLA_UNSPECIFIED",
            Self::SameDay => "SAME_DAY",
            Self::NextDay => "NEXT_DAY",
            Self::TwoDay => "TWO_DAY",
            Self::ThreeDay => "THREE_DAY",
            Self::FourDay => "FOUR_DAY",
            Self::FiveDay => "FIVE_DAY",
            Self::SixDay => "SIX_DAY",
            Self::MultiWeek => "MULTI_WEEK",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "PICKUP_SLA_UNSPECIFIED" => Some(Self::Unspecified),
            "SAME_DAY" => Some(Self::SameDay),
            "NEXT_DAY" => Some(Self::NextDay),
            "TWO_DAY" => Some(Self::TwoDay),
            "THREE_DAY" => Some(Self::ThreeDay),
            "FOUR_DAY" => Some(Self::FourDay),
            "FIVE_DAY" => Some(Self::FiveDay),
            "SIX_DAY" => Some(Self::SixDay),
            "MULTI_WEEK" => Some(Self::MultiWeek),
            _ => None,
        }
    }
}
...
impl Pause {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "PAUSE_UNSPECIFIED",
            Self::Ads => "ADS",
            Self::All => "ALL",
        }
    }
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "PAUSE_UNSPECIFIED" => Some(Self::Unspecified),
            "ADS" => Some(Self::Ads),
            "ALL" => Some(Self::All),
            _ => None,
        }
...
impl CertificationAuthority {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "CERTIFICATION_AUTHORITY_UNSPECIFIED",
            Self::Ademe => "ADEME",
            Self::Bmwk => "BMWK",
            Self::Epa => "EPA",
            Self::Ec => "EC",
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "CERTIFICATION_AUTHORITY_UNSPECIFIED" => Some(Self::Unspecified),
            "ADEME" => Some(Self::Ademe),
            "BMWK" => Some(Self::Bmwk),
            "EPA" => Some(Self::Epa),
            "EC" => Some(Self::Ec),
            _ => None,
...
pub enum CertificationName {
    ...
    VehicleEnergyEfficiency = 5,
    /// For the CO2 class of a vehicle with a discharged battery.
    VehicleEnergyEfficiencyDischargedBattery = 6,
}
impl CertificationName {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "CERTIFICATION_NAME_UNSPECIFIED",
            Self::EnergyStar => "ENERGY_STAR",
            Self::EnergyStarMostEfficient => "ENERGY_STAR_MOST_EFFICIENT",
            Self::Eprel => "EPREL",
            Self::EuEcolabel => "EU_ECOLABEL",
            Self::VehicleEnergyEfficiency => "VEHICLE_ENERGY_EFFICIENCY",
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "CERTIFICATION_NAME_UNSPECIFIED" => Some(Self::Unspecified),
            "ENERGY_STAR" => Some(Self::EnergyStar),
            "ENERGY_STAR_MOST_EFFICIENT" => Some(Self::EnergyStarMostEfficient),
            "EPREL" => Some(Self::Eprel),
            "EU_ECOLABEL" => Some(Self::EuEcolabel),
            "VEHICLE_ENERGY_EFFICIENCY" => Some(Self::VehicleEnergyEfficiency),
            "VEHICLE_ENERGY_EFFICIENCY_DISCHARGED_BATTERY" => {
                Some(Self::VehicleEnergyEfficiencyDischargedBattery)
            }
            _ => None,
        }
    }
...
impl DigitalSourceType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "DIGITAL_SOURCE_TYPE_UNSPECIFIED",
...
pub struct ProductInput {
    ...
    pub product_attributes: ::core::option::Option<ProductAttributes>,
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn insert_product_input(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "google.shopping.merchant.products.v1.ProductInputsService",
                        "InsertProductInput",
                    ),
                );
