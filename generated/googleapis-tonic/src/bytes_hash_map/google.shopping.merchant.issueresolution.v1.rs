...
pub struct ListAggregateProductStatusesResponse {
    ...
    pub aggregate_product_statuses: ::prost::alloc::vec::Vec<AggregateProductStatus>,
...
pub struct AggregateProductStatus {
    ...
    pub stats: ::core::option::Option<aggregate_product_status::Stats>,
    /// The product issues that affect the given reporting context and country.
    #[prost(message, repeated, tag = "6")]
    pub item_level_issues: ::prost::alloc::vec::Vec<
        aggregate_product_status::ItemLevelIssue,
    >,
}
/// Nested message and enum types in `AggregateProductStatus`.
pub mod aggregate_product_status {
    ...
    pub struct ItemLevelIssue {
        ...
        #[prost(enumeration = "item_level_issue::Resolution", tag = "3")]
        pub resolution: i32,
...
pub mod aggregate_product_statuses_service_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    #[derive(Debug, Clone)]
    pub struct AggregateProductStatusesServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl<T> AggregateProductStatusesServiceClient<T>
    where
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> AggregateProductStatusesServiceClient<InterceptedService<T, F>>
        where
        ...
        {
            AggregateProductStatusesServiceClient::new(
        ...
        /// additional results.
        pub async fn list_aggregate_product_statuses(
            &mut self,
            request: impl tonic::IntoRequest<super::ListAggregateProductStatusesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListAggregateProductStatusesResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "google.shopping.merchant.issueresolution.v1.AggregateProductStatusesService",
