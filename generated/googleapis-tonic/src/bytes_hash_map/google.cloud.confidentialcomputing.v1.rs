...
pub mod nvidia_attestation {
    ...
    pub struct GpuInfo {
        ...
        pub attestation_certificate_chain: ::prost::bytes::Bytes,
        ...
        pub attestation_report: ::prost::bytes::Bytes,
    }
...
pub mod tpm_attestation {
    ...
    pub struct Quote {
        ...
        pub pcr_values: ::std::collections::HashMap<i32, ::prost::bytes::Bytes>,
...
pub struct GceShieldedIdentity {
    ...
    pub ak_cert_chain: ::prost::alloc::vec::Vec<::prost::bytes::Bytes>,
}
