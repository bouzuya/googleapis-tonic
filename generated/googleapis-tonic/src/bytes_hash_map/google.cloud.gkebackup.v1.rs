...
pub struct BackupChannel {
    ...
    /// destination project.
    #[prost(string, tag = "9")]
    pub destination_project_id: ::prost::alloc::string::String,
}
...
pub struct BackupPlanBinding {
    ...
    #[prost(message, optional, tag = "7")]
    pub backup_plan_details: ::core::option::Option<
        backup_plan_binding::BackupPlanDetails,
    >,
    /// Output only. `etag` is used for optimistic concurrency control as a way to
...
/// Nested message and enum types in `BackupPlanBinding`.
...
pub struct CreateBackupChannelRequest {
    ...
    #[prost(message, optional, tag = "2")]
    pub backup_channel: ::core::option::Option<BackupChannel>,
    ...
    #[prost(string, tag = "3")]
    pub backup_channel_id: ::prost::alloc::string::String,
}
...
pub struct ListBackupChannelsResponse {
    ...
    #[prost(message, repeated, tag = "1")]
    pub backup_channels: ::prost::alloc::vec::Vec<BackupChannel>,
    /// A token which may be sent as
...
pub struct ListBackupPlanBindingsResponse {
    ...
    #[prost(message, repeated, tag = "1")]
    pub backup_plan_bindings: ::prost::alloc::vec::Vec<BackupPlanBinding>,
    /// A token which may be sent as
...
pub struct CreateRestoreChannelRequest {
    ...
    #[prost(message, optional, tag = "2")]
    pub restore_channel: ::core::option::Option<RestoreChannel>,
    ...
    /// If the user does not provide a name, a uuid will be used as the name.
    #[prost(string, tag = "3")]
    pub restore_channel_id: ::prost::alloc::string::String,
}
...
pub struct ListRestoreChannelsResponse {
    ...
    #[prost(message, repeated, tag = "1")]
    pub restore_channels: ::prost::alloc::vec::Vec<RestoreChannel>,
    /// A token which may be sent as
...
pub struct ListRestorePlanBindingsResponse {
    ...
    #[prost(message, repeated, tag = "1")]
    pub restore_plan_bindings: ::prost::alloc::vec::Vec<RestorePlanBinding>,
    /// A token which may be sent as
...
pub mod backup_for_gke_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn create_backup_channel(
            &mut self,
            request: impl tonic::IntoRequest<super::CreateBackupChannelRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::super::longrunning::Operation>,
            tonic::Status,
        > {
        ...
        pub async fn list_backup_channels(
            &mut self,
            request: impl tonic::IntoRequest<super::ListBackupChannelsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListBackupChannelsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn get_backup_channel(
            &mut self,
            request: impl tonic::IntoRequest<super::GetBackupChannelRequest>,
        ) -> std::result::Result<tonic::Response<super::BackupChannel>, tonic::Status> {
            self.inner
                .ready()
                .await
                .map_err(|e| {
        ...
        pub async fn update_backup_channel(
            &mut self,
            request: impl tonic::IntoRequest<super::UpdateBackupChannelRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::super::longrunning::Operation>,
            tonic::Status,
        > {
        ...
        pub async fn delete_backup_channel(
            &mut self,
            request: impl tonic::IntoRequest<super::DeleteBackupChannelRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::super::longrunning::Operation>,
            tonic::Status,
        > {
        ...
        pub async fn list_backup_plan_bindings(
            &mut self,
            request: impl tonic::IntoRequest<super::ListBackupPlanBindingsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListBackupPlanBindingsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn get_backup_plan_binding(
            &mut self,
            request: impl tonic::IntoRequest<super::GetBackupPlanBindingRequest>,
        ) -> std::result::Result<
            tonic::Response<super::BackupPlanBinding>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn create_restore_channel(
            &mut self,
            request: impl tonic::IntoRequest<super::CreateRestoreChannelRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::super::longrunning::Operation>,
            tonic::Status,
        > {
        ...
        pub async fn list_restore_channels(
            &mut self,
            request: impl tonic::IntoRequest<super::ListRestoreChannelsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListRestoreChannelsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn get_restore_channel(
            &mut self,
            request: impl tonic::IntoRequest<super::GetRestoreChannelRequest>,
        ) -> std::result::Result<tonic::Response<super::RestoreChannel>, tonic::Status> {
            self.inner
                .ready()
                .await
                .map_err(|e| {
        ...
        pub async fn update_restore_channel(
            &mut self,
            request: impl tonic::IntoRequest<super::UpdateRestoreChannelRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::super::longrunning::Operation>,
            tonic::Status,
        > {
        ...
        pub async fn delete_restore_channel(
            &mut self,
            request: impl tonic::IntoRequest<super::DeleteRestoreChannelRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::super::longrunning::Operation>,
            tonic::Status,
        > {
        ...
        pub async fn list_restore_plan_bindings(
            &mut self,
            request: impl tonic::IntoRequest<super::ListRestorePlanBindingsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListRestorePlanBindingsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn get_restore_plan_binding(
            &mut self,
            request: impl tonic::IntoRequest<super::GetRestorePlanBindingRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RestorePlanBinding>,
            tonic::Status,
        > {
            self.inner
                .ready()
