...
pub struct SearchHashesRequest {
    ...
    pub hash_prefixes: ::prost::alloc::vec::Vec<::prost::bytes::Bytes>,
}
...
pub struct FullHash {
    ...
    pub full_hash: ::prost::bytes::Bytes,
...
pub struct HashList {
    ...
    #[prost(bytes = "bytes", tag = "7")]
    pub sha256_checksum: ::prost::bytes::Bytes,
...
pub struct BatchGetHashListsRequest {
    ...
    pub version: ::prost::alloc::vec::Vec<::prost::bytes::Bytes>,
