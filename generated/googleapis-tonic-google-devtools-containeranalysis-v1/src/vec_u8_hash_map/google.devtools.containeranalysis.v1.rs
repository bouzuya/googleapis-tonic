...
pub struct ExportSbomRequest {
    ...
    #[prost(oneof = "export_sbom_request::Target", tags = "2")]
    pub target: ::core::option::Option<export_sbom_request::Target>,
}
/// Nested message and enum types in `ExportSBOMRequest`.
...
pub struct ExportSbomResponse {
    ...
    #[prost(string, tag = "1")]
    pub discovery_occurrence: ::prost::alloc::string::String,
}
