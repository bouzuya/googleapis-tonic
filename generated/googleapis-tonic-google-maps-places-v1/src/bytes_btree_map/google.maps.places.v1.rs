...
pub struct AddressDescriptor {
    ...
    pub landmarks: ::prost::alloc::vec::Vec<address_descriptor::Landmark>,
    /// A ranked list of containing or adjacent areas. The most recognizable and
    /// precise areas are ranked first.
    #[prost(message, repeated, tag = "2")]
    pub areas: ::prost::alloc::vec::Vec<address_descriptor::Area>,
}
/// Nested message and enum types in `AddressDescriptor`.
pub mod address_descriptor {
    ...
    pub struct Landmark {
        ...
        /// landmark.
        #[prost(enumeration = "landmark::SpatialRelationship", tag = "5")]
        pub spatial_relationship: i32,
        ...
        impl SpatialRelationship {
            ...
            pub fn as_str_name(&self) -> &'static str {
                match self {
                    ...
                    Self::Within => "WITHIN",
                    Self::Beside => "BESIDE",
                    Self::AcrossTheRoad => "ACROSS_THE_ROAD",
                    Self::DownTheRoad => "DOWN_THE_ROAD",
                    Self::AroundTheCorner => "AROUND_THE_CORNER",
                    Self::Behind => "BEHIND",
                }
            }
            ...
            pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
                match value {
                    ...
                    "ACROSS_THE_ROAD" => Some(Self::AcrossTheRoad),
                    "DOWN_THE_ROAD" => Some(Self::DownTheRoad),
                    "AROUND_THE_CORNER" => Some(Self::AroundTheCorner),
    ...
    pub struct Area {
        ...
        /// Defines the spatial relationship between the target location and the
        /// area.
        #[prost(enumeration = "area::Containment", tag = "4")]
        pub containment: i32,
    }
    /// Nested message and enum types in `Area`.
    pub mod area {
        /// Defines the spatial relationship between the target location and the
        /// area.
        #[derive(
        ...
        impl Containment {
            ...
            pub fn as_str_name(&self) -> &'static str {
                match self {
                    Self::Unspecified => "CONTAINMENT_UNSPECIFIED",
                    Self::Within => "WITHIN",
            ...
            pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
                match value {
                    "CONTAINMENT_UNSPECIFIED" => Some(Self::Unspecified),
                    "WITHIN" => Some(Self::Within),
...
pub struct Review {
    ...
    pub visit_date: ::core::option::Option<super::super::super::r#type::Date>,
}
/// Experimental: See
...
pub struct Place {
    ...
    pub review_summary: ::core::option::Option<place::ReviewSummary>,
    /// The summary of amenities near the EV charging station.
    #[prost(message, optional, tag = "89")]
    pub ev_charge_amenity_summary: ::core::option::Option<place::EvChargeAmenitySummary>,
    ...
    pub consumer_alert: ::core::option::Option<place::ConsumerAlert>,
...
pub mod place {
    ...
    pub struct GenerativeSummary {
        ...
        #[prost(string, tag = "4")]
        pub overview_flag_content_uri: ::prost::alloc::string::String,
    ...
    pub struct EvChargeAmenitySummary {
        ...
        /// provided.
        #[prost(message, optional, tag = "1")]
        pub overview: ::core::option::Option<super::ContentBlock>,
        /// A summary of the nearby coffee options.
        #[prost(message, optional, tag = "2")]
        pub coffee: ::core::option::Option<super::ContentBlock>,
    ...
    pub struct NeighborhoodSummary {
        ...
        #[prost(message, optional, tag = "2")]
        pub description: ::core::option::Option<super::ContentBlock>,
        /// A link where users can flag a problem with the summary.
        #[prost(string, tag = "3")]
        pub flag_content_uri: ::prost::alloc::string::String,
        /// The AI disclosure message "Summarized with Gemini"
    ...
    pub struct ConsumerAlert {
        ...
        #[prost(message, optional, tag = "2")]
        pub details: ::core::option::Option<consumer_alert::Details>,
        /// The language code of the consumer alert message. This is a BCP 47
        /// language code.
        #[prost(string, tag = "3")]
        pub language_code: ::prost::alloc::string::String,
    }
    /// Nested message and enum types in `ConsumerAlert`.
    pub mod consumer_alert {
        ...
        pub struct Details {
            ...
            /// information.
            #[prost(message, optional, tag = "3")]
            pub about_link: ::core::option::Option<details::Link>,
        }
