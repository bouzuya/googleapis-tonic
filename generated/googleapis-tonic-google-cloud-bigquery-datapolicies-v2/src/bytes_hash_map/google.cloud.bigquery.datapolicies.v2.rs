...
pub struct DataMaskingPolicy {
    ...
    #[prost(oneof = "data_masking_policy::MaskingExpression", tags = "1, 2")]
    ...
    impl PredefinedExpression {
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "RANDOM_HASH" => Some(Self::RandomHash),
                _ => None,
            }
        }
    }
