...
pub struct CampaignReservationQuote {
    ...
    #[prost(int64, tag = "3")]
    pub max_budget_micros: i64,
    /// The possible duration of the hold, in seconds.
    #[prost(int64, tag = "4")]
    pub possible_hold_duration_seconds: i64,
    /// The suggested quote for the campaign.
    #[prost(oneof = "campaign_reservation_quote::SuggestedQuote", tags = "2")]
    pub suggested_quote: ::core::option::Option<
        campaign_reservation_quote::SuggestedQuote,
    >,
}
/// Nested message and enum types in `CampaignReservationQuote`.
pub mod campaign_reservation_quote {
    /// The suggested quote for the campaign.
    #[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Oneof)]
    pub enum SuggestedQuote {
...
pub struct AdVideoAssetInfo {
    ...
    pub ad_video_asset_feature_control: ::core::option::Option<
...
pub struct AppAdInfo {
    ...
    #[prost(message, optional, tag = "7")]
    pub app_deep_link: ::core::option::Option<AdAppDeepLinkAsset>,
}
...
pub struct DemandGenMultiAssetAdInfo {
    ...
    /// is 20.
    #[prost(message, repeated, tag = "10")]
    pub tall_portrait_marketing_images: ::prost::alloc::vec::Vec<AdImageAsset>,
...
pub struct AdditionalApplicationInfo {
    ...
    #[prost(
        enumeration = "super::enums::application_instance_enum::ApplicationInstance",
        tag = "2"
    )]
    pub application_instance: i32,
}
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct VerticalAdsItemGroupRuleListInfo {
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct VerticalAdsItemGroupRuleInfo {
    /// Each value represents a dimension for which we can set an item group rule.
    #[prost(
        oneof = "vertical_ads_item_group_rule_info::Dimension",
        tags = "1, 2, 3, 4, 6"
    )]
    pub dimension: ::core::option::Option<vertical_ads_item_group_rule_info::Dimension>,
}
/// Nested message and enum types in `VerticalAdsItemGroupRuleInfo`.
pub mod vertical_ads_item_group_rule_info {
    /// Each value represents a dimension for which we can set an item group rule.
    #[derive(Clone, PartialEq, Eq, Hash, ::prost::Oneof)]
    pub enum Dimension {
        /// The id specifying a particular Vertical Ad listing.
        #[prost(string, tag = "1")]
        ItemCode(::prost::alloc::string::String),
        /// The resource name of the Geo Target Constant for the country.
        #[prost(string, tag = "2")]
        CountryCriterionId(::prost::alloc::string::String),
        /// The resource name of the Geo Target Constant for the region.
        #[prost(string, tag = "3")]
        RegionCriterionId(::prost::alloc::string::String),
        /// The resource name of the Geo Target Constant for the city.
        #[prost(string, tag = "4")]
        CityCriterionId(::prost::alloc::string::String),
...
pub struct PromotionAsset {
    ...
    #[prost(string, tag = "14")]
    pub terms_and_conditions_text: ::prost::alloc::string::String,
    /// URI to the terms and conditions of the promotion.
    #[prost(string, tag = "15")]
    pub terms_and_conditions_uri: ::prost::alloc::string::String,
    ...
    /// amount.
    #[prost(oneof = "promotion_asset::PromotionTrigger", tags = "5, 6, 16, 17")]
...
pub mod promotion_asset {
    ...
    pub enum PromotionTrigger {
        ...
        /// for the promotion.
        #[prost(message, tag = "16")]
        PromotionBarcodeInfo(super::PromotionBarcodeInfo),
        /// QR code info used to generate promotion QR code for user to be eligible
        /// for the promotion.
        #[prost(message, tag = "17")]
        PromotionQrCodeInfo(super::PromotionQrCodeInfo),
    }
}
/// Barcode info to generate promotion barcode.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct PromotionBarcodeInfo {
    /// Barcode type used to generate barcode with the correct format.
    #[prost(
        enumeration = "super::enums::promotion_barcode_type_enum::PromotionBarcodeType",
        tag = "1"
    )]
    pub r#type: i32,
    /// Promotion message to be encoded in the barcode.
    #[prost(string, tag = "2")]
    pub barcode_content: ::prost::alloc::string::String,
}
/// QR code info to generate promotion QR code.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct PromotionQrCodeInfo {
    /// Promotion message to be encoded in the QR code.
    #[prost(string, tag = "1")]
    pub qr_code_content: ::prost::alloc::string::String,
}
/// A Callout asset.
#[derive(Clone, PartialEq, ::prost::Message)]
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct BusinessMessageAsset {
    /// Required. Message provider of the business message asset.
    #[prost(
        enumeration = "super::enums::business_message_provider_enum::BusinessMessageProvider",
        tag = "1"
    )]
    pub message_provider: i32,
    /// Required. A welcome message to prompt the user to initiate a conversation.
    #[prost(string, tag = "2")]
    pub starter_message: ::prost::alloc::string::String,
    /// A call to action for the business message asset.
    #[prost(message, optional, tag = "3")]
    pub call_to_action: ::core::option::Option<BusinessMessageCallToActionInfo>,
    /// Message provider information to use for messaging.
    #[prost(oneof = "business_message_asset::MessageProviderData", tags = "5, 6, 7")]
    pub message_provider_data: ::core::option::Option<
        business_message_asset::MessageProviderData,
    >,
}
/// Nested message and enum types in `BusinessMessageAsset`.
pub mod business_message_asset {
    /// Message provider information to use for messaging.
    #[derive(Clone, PartialEq, Eq, Hash, ::prost::Oneof)]
    pub enum MessageProviderData {
        /// Whatsapp.
        #[prost(message, tag = "5")]
        WhatsappInfo(super::WhatsappBusinessMessageInfo),
        /// Facebook Messenger.
        #[prost(message, tag = "6")]
        FacebookMessengerInfo(super::FacebookMessengerBusinessMessageInfo),
        /// Zalo.
        #[prost(message, tag = "7")]
        ZaloInfo(super::ZaloBusinessMessageInfo),
    }
}
/// Whatsapp information to use for messaging.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct WhatsappBusinessMessageInfo {
    /// Required. Two-letter country code of the phone number. Examples: 'US',
    /// 'us'.
    #[prost(string, tag = "1")]
    pub country_code: ::prost::alloc::string::String,
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct FacebookMessengerBusinessMessageInfo {
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct ZaloBusinessMessageInfo {
    /// Zalo identifiers used for starting a chat on Zalo.
    /// One of `oa_id` or `custom_name` must be set.
    #[prost(oneof = "zalo_business_message_info::ZaloId", tags = "1, 2")]
    pub zalo_id: ::core::option::Option<zalo_business_message_info::ZaloId>,
}
/// Nested message and enum types in `ZaloBusinessMessageInfo`.
pub mod zalo_business_message_info {
    /// Zalo identifiers used for starting a chat on Zalo.
    /// One of `oa_id` or `custom_name` must be set.
    #[derive(Clone, PartialEq, Eq, Hash, ::prost::Oneof)]
    pub enum ZaloId {
        ...
        #[prost(string, tag = "2")]
        CustomName(::prost::alloc::string::String),
    }
}
/// Display information that encourages the user to take action.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct BusinessMessageCallToActionInfo {
    /// Required. Pre-defined call to action text.
    #[prost(
        enumeration = "super::enums::business_message_call_to_action_type_enum::BusinessMessageCallToActionType",
        tag = "1"
    )]
    pub call_to_action_selection: i32,
...
pub struct AppDeepLinkAsset {
    ...
    #[prost(string, tag = "1")]
    pub app_deep_link_uri: ::prost::alloc::string::String,
}
/// A YouTube video list asset.
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct YouTubeVideoListAsset {
...
pub mod audience_insights_attribute_metadata {
    ...
    pub enum DimensionMetadata {
        ...
        #[prost(message, tag = "10")]
        YoutubeVideoMetadata(super::YouTubeVideoAttributeMetadata),
        /// Special metadata for a YouTube Lineup.
        #[prost(message, tag = "14")]
        LineupAttributeMetadata(super::LineupAttributeMetadata),
        ...
        #[prost(message, tag = "11")]
        UserInterestAttributeMetadata(super::UserInterestAttributeMetadata),
        /// Special metadata for a Knowledge Graph Entity.
        #[prost(message, tag = "12")]
        KnowledgeGraphAttributeMetadata(super::KnowledgeGraphAttributeMetadata),
        /// Special metadata for a User List.
        #[prost(message, tag = "15")]
        UserListAttributeMetadata(super::UserListAttributeMetadata),
    }
}
...
pub struct AudienceInsightsAttribute {
    ...
    #[prost(
        ...
        tags = "1, 2, 3, 4, 5, 6, 13, 8, 9, 10, 11, 12, 14"
    )]
...
pub mod audience_insights_attribute {
    ...
    pub enum Attribute {
        ...
        Lineup(super::AudienceInsightsLineup),
        /// A Parental Status value (parent, or not a parent).
        #[prost(message, tag = "8")]
        ParentalStatus(super::ParentalStatusInfo),
        /// A household income percentile range.
        #[prost(message, tag = "9")]
        IncomeRange(super::IncomeRangeInfo),
        /// A YouTube channel.
        #[prost(message, tag = "10")]
        YoutubeChannel(super::YouTubeChannelInfo),
        /// A YouTube video.
        #[prost(message, tag = "11")]
        YoutubeVideo(super::YouTubeVideoInfo),
        /// A device type. (Mobile, Desktop, Tablet)
        #[prost(message, tag = "12")]
        Device(super::DeviceInfo),
        /// A User List.
        #[prost(message, tag = "14")]
        UserList(super::UserListInfo),
    }
}
...
/// A YouTube Lineup.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct AudienceInsightsLineup {
    /// Required. The numeric ID of the lineup.
    #[prost(string, tag = "1")]
    pub lineup_id: ::prost::alloc::string::String,
}
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct YouTubeVideoAttributeMetadata {
    ...
    #[prost(
        enumeration = "super::enums::you_tube_video_property_enum::YouTubeVideoProperty",
        repeated,
        tag = "6"
    )]
    pub video_properties: ::prost::alloc::vec::Vec<i32>,
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct LineupAttributeMetadata {
    /// The national market associated with the lineup.
    #[prost(message, optional, tag = "1")]
    pub inventory_country: ::core::option::Option<LocationInfo>,
    ...
    pub sample_channels: ::prost::alloc::vec::Vec<
        lineup_attribute_metadata::SampleChannel,
    >,
}
/// Nested message and enum types in `LineupAttributeMetadata`.
pub mod lineup_attribute_metadata {
    /// A YouTube channel returned as an example of the content in a lineup.
    #[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
    pub struct SampleChannel {
        /// A YouTube channel.
        #[prost(message, optional, tag = "1")]
        pub youtube_channel: ::core::option::Option<super::YouTubeChannelInfo>,
...
pub struct LocationAttributeMetadata {
    ...
    /// in.
    #[prost(message, optional, tag = "1")]
    pub country_location: ::core::option::Option<LocationInfo>,
}
/// Metadata associated with a User Interest attribute.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct UserInterestAttributeMetadata {
    /// English language text description of the user interest category (200
    /// characters max).
    #[prost(string, tag = "1")]
    pub user_interest_description: ::prost::alloc::string::String,
}
...
pub struct KnowledgeGraphAttributeMetadata {
    ...
    pub entity_capabilities: ::prost::alloc::vec::Vec<i32>,
    /// A list of CATEGORY attributes related to this entity.
    #[prost(message, repeated, tag = "2")]
    pub related_categories: ::prost::alloc::vec::Vec<AudienceInsightsAttributeMetadata>,
}
/// Metadata associated with a User List attribute.
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct UserListAttributeMetadata {
    /// The user list type.
    #[prost(enumeration = "super::enums::user_list_type_enum::UserListType", tag = "1")]
    pub user_list_type: i32,
}
/// A group of audience attributes with metadata, returned in response to a
/// search.
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct AudienceInsightsAttributeMetadataGroup {
...
pub struct MaximizeConversionValue {
    ...
    /// ROAS.
    #[prost(int64, optional, tag = "5")]
    pub target_roas_tolerance_percent_millis: ::core::option::Option<i64>,
}
...
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct TargetCpc {
    /// Average CPC target.
    /// This target should be greater than or equal to minimum billable unit based
    /// on the currency for the account.
    #[prost(int64, tag = "1")]
    pub target_cpc_micros: i64,
}
/// Lifecycle goal optimization value settings.
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct CustomerLifecycleOptimizationValueSettings {
    ...
    pub additional_value: ::core::option::Option<f64>,
    ...
    pub additional_high_lifetime_value: ::core::option::Option<f64>,
}
/// Campaign Goal settings.
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct CampaignGoalSettings {}
/// Nested message and enum types in `CampaignGoalSettings`.
pub mod campaign_goal_settings {
    /// Retention campaign goal settings.
    #[derive(Clone, Copy, PartialEq, ::prost::Message)]
    pub struct CampaignRetentionGoalSettings {
        /// Retention goal campaign specific value settings.
        #[prost(message, optional, tag = "1")]
        pub value_settings_override: ::core::option::Option<
            super::CustomerLifecycleOptimizationValueSettings,
        >,
        ...
        /// target_option.
        #[prost(
            enumeration = "super::super::enums::customer_lifecycle_optimization_mode_enum::CustomerLifecycleOptimizationMode",
            tag = "2"
        )]
        pub target_option: i32,
    }
}
...
/// Nested message and enum types in `GoalSetting`.
pub mod goal_setting {
    /// Retention goal settings.
    #[derive(Clone, Copy, PartialEq, ::prost::Message)]
    pub struct RetentionGoal {
...
pub struct Metrics {
    ...
    #[prost(double, optional, tag = "405")]
    pub trueview_average_cpv: ::core::option::Option<f64>,
    ...
    /// ads.
    #[prost(double, optional, tag = "406")]
    pub video_trueview_view_rate: ::core::option::Option<f64>,
    /// The number of TrueView views your video ads received.
    #[prost(int64, optional, tag = "407")]
    pub video_trueview_views: ::core::option::Option<i64>,
    ...
    #[prost(double, optional, tag = "366")]
    pub results_conversions_purchase: ::core::option::Option<f64>,
    ...
    #[prost(double, optional, tag = "408")]
    pub video_trueview_view_rate_in_feed: ::core::option::Option<f64>,
    /// The number of TrueView views divided by number of impressions that can
    /// potentially lead to TrueView views for in-stream formats.
    #[prost(double, optional, tag = "409")]
    pub video_trueview_view_rate_in_stream: ::core::option::Option<f64>,
    /// The number of TrueView views divided by number of impressions that can
    /// potentially lead to TrueView views for Shorts ads.
    #[prost(double, optional, tag = "410")]
    pub video_trueview_view_rate_shorts: ::core::option::Option<f64>,
    ...
    #[prost(double, optional, tag = "382")]
    pub platform_comparable_conversions_from_interactions_rate: ::core::option::Option<
        f64,
    >,
    ...
    /// optimize for these conversions.
    #[prost(double, optional, tag = "383")]
    pub platform_comparable_conversions: ::core::option::Option<f64>,
    ...
    /// these conversions.
    #[prost(double, optional, tag = "384")]
    pub platform_comparable_conversions_value: ::core::option::Option<f64>,
    /// The value of conversions divided by the cost of ad interactions. This only
    /// includes conversion actions for which include_in_conversions_metric
    /// attribute is set to true. If you use conversion-based bidding, your bid
    /// strategies will optimize for these conversions.
    #[prost(double, optional, tag = "385")]
    pub platform_comparable_conversions_value_per_cost: ::core::option::Option<f64>,
    ...
    /// conversion-based bidding, your bid strategies will optimize for these
    /// conversions.
    #[prost(double, optional, tag = "386")]
    pub platform_comparable_conversions_by_conversion_date: ::core::option::Option<f64>,
    ...
    /// attribute is set to true. If you use conversion-based bidding, your bid
    /// strategies will optimize for these conversions.
    #[prost(double, optional, tag = "387")]
    pub platform_comparable_conversions_value_by_conversion_date: ::core::option::Option<
        f64,
    >,
    ...
    /// conversion-based bidding, your bid strategies will optimize for these
    /// conversions.
    #[prost(double, optional, tag = "388")]
    pub platform_comparable_conversions_from_interactions_value_per_interaction: ::core::option::Option<
        f64,
    >,
    ...
    /// conversion-based bidding, your bid strategies will optimize for these
    /// conversions.
    #[prost(double, optional, tag = "389")]
    pub cost_per_platform_comparable_conversion: ::core::option::Option<f64>,
    ...
    /// conversion-based bidding, your bid strategies will optimize for these
    /// conversions.
    #[prost(double, optional, tag = "390")]
    pub value_per_platform_comparable_conversion: ::core::option::Option<f64>,
    /// The value of platform comparable conversions divided by the number of
    ...
    /// attribute is set to true. If you use conversion-based bidding, your bid
    /// strategies will optimize for these conversions.
    #[prost(double, optional, tag = "391")]
    pub value_per_platform_comparable_conversions_by_conversion_date: ::core::option::Option<
        f64,
    >,
    /// The cost of the platform comparable conversion in the currency of the
    /// authorized customer.
    #[prost(double, optional, tag = "392")]
    ...
    pub value_adjustment: ::core::option::Option<f64>,
    /// The conversion value rule adjustment from all conversions in all conversion
    /// categories.
    #[prost(double, optional, tag = "399")]
    pub all_value_adjustment: ::core::option::Option<f64>,
    /// Unique query intent cluster count for clicks.
    #[prost(int64, optional, tag = "400")]
    pub clicks_unique_query_clusters: ::core::option::Option<i64>,
    /// Unique query intent cluster count for conversions.
    #[prost(int64, optional, tag = "401")]
    pub conversions_unique_query_clusters: ::core::option::Option<i64>,
    /// Unique query intent cluster count for impressions.
    #[prost(int64, optional, tag = "402")]
    pub impressions_unique_query_clusters: ::core::option::Option<i64>,
    ...
    #[prost(int64, optional, tag = "403")]
    pub video_watch_time_duration_millis: ::core::option::Option<i64>,
    /// Average video watch time duration in milliseconds for video impressions
    /// that started playing.
    #[prost(int64, optional, tag = "404")]
    pub average_video_watch_time_duration_millis: ::core::option::Option<i64>,
    /// This feature is available to allowlisted accounts only.
    #[prost(int64, optional, tag = "411")]
    pub svr: ::core::option::Option<i64>,
    /// The number of impressions for which Active View could measure if the ad was
    /// audible.
    #[prost(int64, optional, tag = "412")]
    pub active_view_audibility_measurable_impressions: ::core::option::Option<i64>,
    /// The number of impressions for which Active View could measure if the ad was
    /// audible, divided by the total number of impressions with Active View audio
    /// enabled.
    #[prost(double, optional, tag = "413")]
    pub active_view_audibility_measurable_impressions_rate: ::core::option::Option<f64>,
    ...
    #[prost(double, optional, tag = "414")]
    pub active_view_audibility_invalid_measurable_impressions_rate: ::core::option::Option<
        f64,
    >,
    /// The number of impressions for which Active View could measure audibility,
    ...
    #[prost(double, optional, tag = "415")]
    pub active_view_audibility_invalid_givt_measurable_impressions_rate: ::core::option::Option<
        f64,
    >,
    /// The number of impressions that were audible (volume > 0%) at any point
    /// during the ad playback.
    #[prost(int64, optional, tag = "416")]
    pub active_view_audible_impressions: ::core::option::Option<i64>,
    /// The number of impressions that were audible (volume > 0%) at any point
    /// during the ad playback, divided by the total number of impressions
    /// measurable for audibility.
    #[prost(double, optional, tag = "417")]
    pub active_view_audible_impressions_rate: ::core::option::Option<f64>,
    /// The number of impressions that were audible for at least 2 seconds
    /// (cumulative).
    #[prost(int64, optional, tag = "418")]
    pub active_view_audible_two_seconds_impressions: ::core::option::Option<i64>,
    /// The number of impressions that were audible for at least 2 seconds
    /// (cumulative), divided by the total number of impressions measurable for
    /// audibility.
    #[prost(double, optional, tag = "419")]
    pub active_view_audible_two_seconds_impressions_rate: ::core::option::Option<f64>,
    /// The number of impressions that were audible for at least 30 seconds
    /// (cumulative).
    #[prost(int64, optional, tag = "420")]
    pub active_view_audible_thirty_seconds_impressions: ::core::option::Option<i64>,
    /// The number of impressions that were audible for at least 30 seconds
    /// (cumulative), divided by the total number of impressions measurable for
    /// audibility.
    #[prost(double, optional, tag = "421")]
    pub active_view_audible_thirty_seconds_impressions_rate: ::core::option::Option<f64>,
    ...
    /// audibility.
    #[prost(double, optional, tag = "422")]
    pub active_view_audible_quartile_p25_rate: ::core::option::Option<f64>,
    /// The number of impressions that were audible at the second quartile of the
    /// ad playback, divided by the total number of impressions measurable for
    /// audibility.
    #[prost(double, optional, tag = "423")]
    pub active_view_audible_quartile_p50_rate: ::core::option::Option<f64>,
    /// The number of impressions that were audible at the third quartile of the
    /// ad playback, divided by the total number of impressions measurable for
    /// audibility.
    #[prost(double, optional, tag = "424")]
    pub active_view_audible_quartile_p75_rate: ::core::option::Option<f64>,
    /// The number of impressions that were audible at the fourth quartile of the
    /// ad playback, divided by the total number of impressions measurable for
    /// audibility.
    #[prost(double, optional, tag = "425")]
    pub active_view_audible_quartile_p100_rate: ::core::option::Option<f64>,
    /// The number of biddable first in app conversions where the app install was
    /// driven by interaction with a web campaign.
    #[prost(int64, optional, tag = "426")]
    pub biddable_indirect_install_first_in_app_conversion_micros: ::core::option::Option<
        i64,
    >,
}
/// Search volume range.
...
pub struct Segments {
    ...
    /// ad_network_type.
    #[prost(
        enumeration = "super::enums::ad_sub_network_type_enum::AdSubNetworkType",
        tag = "204"
    )]
    pub ad_sub_network_type: i32,
    ...
    #[prost(
        enumeration = "super::enums::landing_page_source_enum::LandingPageSource",
        tag = "200"
    )]
    pub landing_page_source: i32,
    ...
    #[prost(string, optional, tag = "193")]
    pub travel_destination_city: ::core::option::Option<::prost::alloc::string::String>,
    /// The country the user is searching for at query time.
    #[prost(string, optional, tag = "194")]
    pub travel_destination_country: ::core::option::Option<
        ::prost::alloc::string::String,
    >,
    /// The region the user is searching for at query time.
    #[prost(string, optional, tag = "195")]
    pub travel_destination_region: ::core::option::Option<
        ::prost::alloc::string::String,
    >,
    ...
    #[prost(enumeration = "super::enums::match_type_enum::MatchType", tag = "199")]
    pub match_type: i32,
    /// Position of the ad.
    ...
    /// (Standard).
    #[prost(
        enumeration = "super::enums::search_term_match_source_enum::SearchTermMatchSource",
        tag = "198"
    )]
    pub search_term_match_source: i32,
    ...
    pub search_term_targeting_status: i32,
    ...
    #[prost(bool, optional, tag = "202")]
    pub ad_using_product_data: ::core::option::Option<bool>,
    ...
    pub ad_using_video: ::core::option::Option<bool>,
}
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct CustomerThirdPartyIntegrationPartners {
    /// Allowed third party integration partners for YouTube viewability
    /// verification.
    #[prost(message, repeated, tag = "1")]
    pub viewability_integration_partners: ::prost::alloc::vec::Vec<
        CustomerThirdPartyViewabilityIntegrationPartner,
    >,
    /// Allowed third party integration partners for Brand Lift verification.
    #[prost(message, repeated, tag = "2")]
    pub brand_lift_integration_partners: ::prost::alloc::vec::Vec<
        CustomerThirdPartyBrandLiftIntegrationPartner,
    >,
    /// Allowed third party integration partners for brand safety verification.
    #[prost(message, repeated, tag = "3")]
    pub brand_safety_integration_partners: ::prost::alloc::vec::Vec<
        CustomerThirdPartyBrandSafetyIntegrationPartner,
    >,
    /// Allowed third party integration partners for reach verification.
    #[prost(message, repeated, tag = "4")]
    pub reach_integration_partners: ::prost::alloc::vec::Vec<
        CustomerThirdPartyReachIntegrationPartner,
    >,
}
/// Container for third party viewability integration data for Customer.
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct CustomerThirdPartyViewabilityIntegrationPartner {
    /// Allowed third party integration partners for YouTube viewability
    /// verification.
    #[prost(
        enumeration = "super::enums::third_party_viewability_integration_partner_enum::ThirdPartyViewabilityIntegrationPartner",
        tag = "1"
    )]
    pub viewability_integration_partner: i32,
    /// If true, cost data can be shared with this vendor.
    #[prost(bool, tag = "2")]
    pub allow_share_cost: bool,
}
/// Container for third party brand safety integration data for Customer.
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct CustomerThirdPartyBrandSafetyIntegrationPartner {
    /// Allowed third party integration partners for brand safety verification.
    #[prost(
        enumeration = "super::enums::third_party_brand_safety_integration_partner_enum::ThirdPartyBrandSafetyIntegrationPartner",
        tag = "1"
    )]
    pub brand_safety_integration_partner: i32,
}
/// Container for third party Brand Lift integration data for Customer.
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct CustomerThirdPartyBrandLiftIntegrationPartner {
    /// Allowed Third Party integration partners for Brand Lift verification.
    #[prost(
        enumeration = "super::enums::third_party_brand_lift_integration_partner_enum::ThirdPartyBrandLiftIntegrationPartner",
        tag = "1"
    )]
    pub brand_lift_integration_partner: i32,
    /// If true, cost data can be shared with this vendor.
    #[prost(bool, tag = "2")]
    pub allow_share_cost: bool,
}
...
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct CustomerThirdPartyReachIntegrationPartner {
    /// Allowed Third Party integration partners for reach verification.
    #[prost(
        enumeration = "super::enums::third_party_reach_integration_partner_enum::ThirdPartyReachIntegrationPartner",
        tag = "1"
    )]
    pub reach_integration_partner: i32,
    /// If true, cost data can be shared with this vendor.
    #[prost(bool, tag = "2")]
    pub allow_share_cost: bool,
}
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct CampaignThirdPartyIntegrationPartners {
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct CampaignThirdPartyViewabilityIntegrationPartner {
    /// Allowed third party integration partners for YouTube viewability
    /// verification.
    #[prost(
        enumeration = "super::enums::third_party_viewability_integration_partner_enum::ThirdPartyViewabilityIntegrationPartner",
    ...
    #[prost(message, optional, tag = "2")]
    pub viewability_integration_partner_data: ::core::option::Option<
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct CampaignThirdPartyBrandSafetyIntegrationPartner {
    /// Allowed third party integration partners for brand safety verification.
    #[prost(
        enumeration = "super::enums::third_party_brand_safety_integration_partner_enum::ThirdPartyBrandSafetyIntegrationPartner",
        tag = "1"
    ...
    /// optional metadata for partners to join or attach data to Ads campaigns.
    #[prost(message, optional, tag = "2")]
    pub brand_safety_integration_partner_data: ::core::option::Option<
        ThirdPartyIntegrationPartnerData,
    >,
}
/// Container for third party Brand Lift integration data for Campaign.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct CampaignThirdPartyBrandLiftIntegrationPartner {
    /// Allowed third party integration partners for Brand Lift verification.
    #[prost(
        enumeration = "super::enums::third_party_brand_lift_integration_partner_enum::ThirdPartyBrandLiftIntegrationPartner",
        tag = "1"
    ...
    /// optional metadata for partners to join or attach data to Ads campaigns.
    #[prost(message, optional, tag = "2")]
    pub brand_lift_integration_partner_data: ::core::option::Option<
        ThirdPartyIntegrationPartnerData,
    >,
    /// If true, then cost data will be shared with this vendor.
    #[prost(bool, tag = "3")]
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct CampaignThirdPartyReachIntegrationPartner {
    /// Allowed third party integration partners for reach verification.
    #[prost(
        enumeration = "super::enums::third_party_reach_integration_partner_enum::ThirdPartyReachIntegrationPartner",
        tag = "1"
    ...
    /// optional metadata for partners to join or attach data to Ads campaigns.
    #[prost(message, optional, tag = "2")]
    pub reach_integration_partner_data: ::core::option::Option<
        ThirdPartyIntegrationPartnerData,
    >,
    /// If true, then cost data will be shared with this vendor.
    #[prost(bool, tag = "3")]
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct ThirdPartyIntegrationPartnerData {
    ...
    #[prost(string, tag = "2")]
    pub third_party_placement_id: ::prost::alloc::string::String,
}
