...
pub struct CsvOptions {
    ...
    pub null_markers: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
    ...
    #[prost(string, tag = "10")]
    pub source_column_match: ::prost::alloc::string::String,
}
...
pub mod job_configuration_load {
    ...
    impl SourceColumnMatch {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Self::Unspecified => "SOURCE_COLUMN_MATCH_UNSPECIFIED",
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                "SOURCE_COLUMN_MATCH_UNSPECIFIED" => Some(Self::Unspecified),
...
pub struct JobStatistics2 {
    ...
    /// * `CREATE_TABLE_AS_SELECT`: [`CREATE TABLE AS  SELECT`](<https://cloud.google.com/bigquery/docs/reference/standard-sql/data-definition-language#create_table_statement>)
    ///   statement.
    ...
    ///   statement.
    /// * `ALTER_SCHEMA`: [`ALTER  SCHEMA`](<https://cloud.google.com/bigquery/docs/reference/standard-sql/data-definition-language#alter_schema_set_options_statement>)
    ///   statement.
    /// * `SCRIPT`:
