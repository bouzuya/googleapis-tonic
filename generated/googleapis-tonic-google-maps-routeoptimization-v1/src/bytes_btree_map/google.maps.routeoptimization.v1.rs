    ...
    impl SolvingMode {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::TransformAndReturnRequest => "TRANSFORM_AND_RETURN_REQUEST",
            }
        }
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "TRANSFORM_AND_RETURN_REQUEST" => Some(Self::TransformAndReturnRequest),
                _ => None,
            }
        }
    }
...
pub struct OptimizeToursResponse {
    ...
    pub processed_request: ::core::option::Option<OptimizeToursRequest>,
...
pub struct ShipmentModel {
    ...
    pub objectives: ::prost::alloc::vec::Vec<shipment_model::Objective>,
...
pub mod shipment_model {
    ...
    pub struct Objective {
        ...
        #[prost(enumeration = "objective::Type", optional, tag = "1")]
        ...
        impl Type {
            ...
            pub fn as_str_name(&self) -> &'static str {
                match self {
                    ...
                    Self::MinWorkingTime => "MIN_WORKING_TIME",
                    Self::MinTravelTime => "MIN_TRAVEL_TIME",
                    Self::MinNumVehicles => "MIN_NUM_VEHICLES",
                }
            }
            /// Creates an enum from field names used in the ProtoBuf definition.
            pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
                match value {
                    ...
                    "MIN_DISTANCE" => Some(Self::MinDistance),
                    "MIN_WORKING_TIME" => Some(Self::MinWorkingTime),
                    "MIN_TRAVEL_TIME" => Some(Self::MinTravelTime),
                    "MIN_NUM_VEHICLES" => Some(Self::MinNumVehicles),
                    _ => None,
                }
            }
        }
...
pub mod shipment {
    ...
    pub struct VisitRequest {
        ...
        pub avoid_u_turns: ::core::option::Option<bool>,
    }
...
pub mod vehicle {
    ...
    pub struct LoadLimit {
        ...
        /// for more details.
        #[prost(message, optional, tag = "6")]
        pub cost_per_kilometer: ::core::option::Option<load_limit::LoadCost>,
        ...
        /// for more details.
        #[prost(message, optional, tag = "7")]
        pub cost_per_traveled_hour: ::core::option::Option<load_limit::LoadCost>,
    }
    ...
    pub mod load_limit {
        ...
        pub struct LoadCost {
            ...
            /// Must be >= 0.
            #[prost(int64, optional, tag = "1")]
            pub load_threshold: ::core::option::Option<i64>,
            /// Cost of moving a unit of load, for each unit between 0 and threshold.
            /// Must be a finite value, and >= 0.
            #[prost(double, optional, tag = "2")]
            pub cost_per_unit_below_threshold: ::core::option::Option<f64>,
            ...
            pub cost_per_unit_above_threshold: ::core::option::Option<f64>,
        }
    }
...
pub mod break_rule {
    ...
    pub struct FrequencyConstraint {
        ...
        /// does not include at least partially a break of `duration >=  min_break_duration`. Must be positive.
        #[prost(message, optional, tag = "2")]
...
pub struct ShipmentRoute {
    ...
    pub vehicle_fullness: ::core::option::Option<VehicleFullness>,
...
pub mod shipment_route {
    ...
    pub struct Visit {
        ...
        pub injected_solution_location_token: ::core::option::Option<i32>,
    }
...
pub struct SkippedShipment {
    ...
    /// Experimental: This field's behavior or existence may change in future.
    #[prost(double, optional, tag = "5")]
    pub estimated_incompatible_vehicle_ratio: ::core::option::Option<f64>,
...
pub mod skipped_shipment {
    ...
    pub struct Reason {
        ...
        /// Experimental: This field's behavior or existence may change in future.
        #[prost(int32, repeated, tag = "5")]
        pub example_vehicle_indices: ::prost::alloc::vec::Vec<i32>,
        ...
        impl Code {
            ...
            pub fn as_str_name(&self) -> &'static str {
                match self {
                    ...
                    Self::VehicleIgnored => "VEHICLE_IGNORED",
                    Self::ShipmentIgnored => "SHIPMENT_IGNORED",
                    ...
                    Self::ZeroPenaltyCost => "ZERO_PENALTY_COST",
                }
            }
            /// Creates an enum from field names used in the ProtoBuf definition.
            pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
                match value {
                    ...
                    "VEHICLE_IGNORED" => Some(Self::VehicleIgnored),
                    "SHIPMENT_IGNORED" => Some(Self::ShipmentIgnored),
                    "SKIPPED_IN_INJECTED_SOLUTION_CONSTRAINT" => {
                        Some(Self::SkippedInInjectedSolutionConstraint)
                    }
                    "VEHICLE_ROUTE_IS_FULLY_SEQUENCE_CONSTRAINED" => {
                        Some(Self::VehicleRouteIsFullySequenceConstrained)
                    }
                    "ZERO_PENALTY_COST" => Some(Self::ZeroPenaltyCost),
                    _ => None,
                }
            }
        }
...
pub struct AggregatedMetrics {
    ...
    pub performed_mandatory_shipment_count: ::core::option::Option<i32>,
    /// The sum of the
    /// \[Shipment.penalty_cost\]\[google.maps.routeoptimization.v1.Shipment.penalty_cost\]
    ...
    pub performed_shipment_penalty_cost_sum: ::core::option::Option<f64>,
...
pub struct VehicleFullness {
    ...
    pub max_fullness: ::core::option::Option<f64>,
    /// The ratio between
    /// \[AggregatedMetrics.travel_distance_meters\]\[google.maps.routeoptimization.v1.AggregatedMetrics.travel_distance_meters\]
    /// and
    /// \[Vehicle.route_distance_limit\]\[google.maps.routeoptimization.v1.Vehicle.route_distance_limit\].
    ...
    /// is unset, this field will be unset.
    #[prost(double, optional, tag = "3")]
    pub travel_duration: ::core::option::Option<f64>,
    ...
    /// is unset, this field will be unset.
    #[prost(double, optional, tag = "4")]
    pub active_duration: ::core::option::Option<f64>,
    ...
    #[prost(double, optional, tag = "5")]
    pub max_load: ::core::option::Option<f64>,
    ...
    /// instead.
    #[prost(double, optional, tag = "6")]
    pub active_span: ::core::option::Option<f64>,
}
...
pub mod route_optimization_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        /// for more details.
        pub async fn optimize_tours_long_running(
            &mut self,
            request: impl tonic::IntoRequest<super::OptimizeToursRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::super::longrunning::Operation>,
        ...
        /// https://developers.google.com/maps/tt/route-optimization/experimental/otlr/make-request
        /// for more details.
        pub async fn optimize_tours_uri(
            &mut self,
            request: impl tonic::IntoRequest<super::OptimizeToursUriRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::super::longrunning::Operation>,
            tonic::Status,
        > {
