...
pub struct AgentContextReference {
    ...
    #[prost(string, tag = "1")]
    pub context_set_id: ::prost::alloc::string::String,
}
...
pub mod datasource_references {
    ...
    pub enum References {
        ...
        /// method.
        #[prost(message, tag = "8")]
        Alloydb(super::AlloyDbReference),
        /// Reference to a Spanner database. Only supported for the `QueryData`
        /// method.
        #[prost(message, tag = "9")]
        SpannerReference(super::SpannerReference),
...
pub struct AlloyDbReference {
    ...
    pub database_reference: ::core::option::Option<AlloyDbDatabaseReference>,
...
pub struct SpannerReference {
    ...
    /// to include.
    #[prost(message, optional, tag = "1")]
    pub database_reference: ::core::option::Option<SpannerDatabaseReference>,
    /// Optional. Parameters for retrieving data from Agent Context.
    ...
    impl Engine {
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "GOOGLE_SQL" => Some(Self::GoogleSql),
...
pub struct CloudSqlReference {
    ...
    /// to include.
    #[prost(message, optional, tag = "1")]
    pub database_reference: ::core::option::Option<CloudSqlDatabaseReference>,
    /// Optional. Parameters for retrieving data from Agent Context.
    #[prost(message, optional, tag = "2")]
    pub agent_context_reference: ::core::option::Option<AgentContextReference>,
}
...
pub mod datasource {
    ...
    pub enum Reference {
        ...
        AlloyDbReference(super::AlloyDbReference),
...
pub struct QueryDataContext {
    ...
    #[prost(message, optional, tag = "2")]
    pub parameterized_secure_view_parameters: ::core::option::Option<
