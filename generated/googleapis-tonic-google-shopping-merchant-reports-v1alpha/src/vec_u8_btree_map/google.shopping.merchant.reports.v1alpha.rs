...
/// query.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct YoutubeCreatorPerformanceView {
    /// Date in the merchant timezone to which metrics apply. Segment.
    ///
    /// Condition on `date` is required in the `WHERE` clause.
    #[prost(message, optional, tag = "1")]
    ...
    #[prost(message, optional, tag = "4")]
    pub gross_sales: ::core::option::Option<super::super::super::r#type::Price>,
    /// The commissions amount (pending and paid).
    #[prost(message, optional, tag = "5")]
    pub commissions: ::core::option::Option<super::super::super::r#type::Price>,
    /// The number of orders.
    #[prost(int64, optional, tag = "6")]
    pub orders: ::core::option::Option<i64>,
...
/// query.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct YoutubeContentPerformanceView {
    /// Date in the merchant timezone to which metrics apply. Segment.
    ///
    /// Condition on `date` is required in the `WHERE` clause.
    #[prost(message, optional, tag = "1")]
    ...
    /// The channel title.
    #[prost(string, optional, tag = "4")]
    pub channel_title: ::core::option::Option<::prost::alloc::string::String>,
    /// The channel id.
    #[prost(string, optional, tag = "5")]
    pub channel_id: ::core::option::Option<::prost::alloc::string::String>,
    /// The gross sales amount, before refunds.
...
/// query.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct YoutubeProductPerformanceView {
    /// Date in the merchant timezone to which metrics apply. Segment.
    ///
    /// Condition on `date` is required in the `WHERE` clause.
    #[prost(message, optional, tag = "1")]
    ...
    #[prost(int64, optional, tag = "4")]
    pub distinct_video_count: ::core::option::Option<i64>,
    /// The number of distinct creator channels the product was shown on.
    #[prost(int64, optional, tag = "5")]
    pub distinct_creator_count: ::core::option::Option<i64>,
    /// The gross sales amount, before refunds.
    #[prost(message, optional, tag = "6")]
    pub gross_sales: ::core::option::Option<super::super::super::r#type::Price>,
    /// The commissions amount (pending and paid).
