...
pub struct SalesforceProfile {
    ...
    #[prost(oneof = "salesforce_profile::Credentials", tags = "2, 3")]
    pub credentials: ::core::option::Option<salesforce_profile::Credentials>,
}
...
pub struct SalesforceOrg {
    ...
    #[prost(message, repeated, tag = "1")]
    pub objects: ::prost::alloc::vec::Vec<SalesforceObject>,
}
/// Salesforce object.
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct BigQueryDestinationConfig {
    ...
    #[prost(message, optional, tag = "1")]
    pub blmt_config: ::core::option::Option<big_query_destination_config::BlmtConfig>,
...
pub mod big_query_destination_config {
    ...
    pub struct BlmtConfig {
        ...
        #[prost(enumeration = "blmt_config::FileFormat", tag = "4")]
        pub file_format: i32,
        /// Required. The table format.
        #[prost(enumeration = "blmt_config::TableFormat", tag = "5")]
        pub table_format: i32,
    }
    /// Nested message and enum types in `BlmtConfig`.
    pub mod blmt_config {
...
pub mod cdc_strategy {
    ...
    pub mod specific_start_position {
        ...
        pub enum Position {
            ...
            #[prost(message, tag = "104")]
            MysqlGtidPosition(super::super::MysqlGtidPosition),
        }
    }
    /// The position to start reading from when starting, resuming, or recovering
    /// the stream.
...
pub struct MysqlGtidPosition {
    ...
    #[prost(string, tag = "1")]
    pub gtid_set: ::prost::alloc::string::String,
}
