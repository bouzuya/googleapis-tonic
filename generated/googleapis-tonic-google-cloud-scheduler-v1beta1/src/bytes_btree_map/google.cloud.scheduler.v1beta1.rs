...
pub struct AppEngineRouting {
    ...
    ///
    /// * `version_dot_service =`
    ///   \[version\]\[google.cloud.scheduler.v1beta1.AppEngineRouting.version\] `+ '.' +` \[service\]\[google.cloud.scheduler.v1beta1.AppEngineRouting.service\]
    ///
    /// * `instance =`
    ///   \[instance\]\[google.cloud.scheduler.v1beta1.AppEngineRouting.instance\]
    ///
    /// * `instance_dot_service =`
    ///   \[instance\]\[google.cloud.scheduler.v1beta1.AppEngineRouting.instance\] `+ '.' +` \[service\]\[google.cloud.scheduler.v1beta1.AppEngineRouting.service\]
    ///
    /// * `instance_dot_version =`
    ///   \[instance\]\[google.cloud.scheduler.v1beta1.AppEngineRouting.instance\] `+ '.' +` \[version\]\[google.cloud.scheduler.v1beta1.AppEngineRouting.version\]
    ///
...
pub struct ListJobsRequest {
    ...
    /// retrieved. If `filter` equals `labels.foo=value1 labels.foo=value2` then only jobs which are labeled with
    ...
    /// Cloud Scheduler API. If the field is set to true, the jobs in the \_\_cron
...
pub struct DeleteJobRequest {
    ...
    pub name: ::prost::alloc::string::String,
    /// This field is used to manage the legacy App Engine Cron jobs using the
    /// Cloud Scheduler API. If the field is set to true, the job in the \_\_cron
