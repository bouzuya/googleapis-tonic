...
pub struct Source {
    /// Location of source.
    #[prost(oneof = "source::Source", tags = "2, 3, 5, 8, 9")]
...
pub mod source {
    ...
    pub enum Source {
        ...
        #[prost(message, tag = "9")]
        ConnectedRepository(super::ConnectedRepository),
    }
}
...
pub struct SourceProvenance {
    ...
    #[prost(message, optional, tag = "10")]
    pub resolved_connected_repository: ::core::option::Option<ConnectedRepository>,
    /// Output only. A copy of the build's `source.git_source`, if exists, with any
    /// revisions resolved.
    #[prost(message, optional, tag = "11")]
    pub resolved_git_source: ::core::option::Option<GitSource>,
...
pub mod cloud_build_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_default_service_account(
            &mut self,
            request: impl tonic::IntoRequest<super::GetDefaultServiceAccountRequest>,
        ) -> std::result::Result<
            tonic::Response<super::DefaultServiceAccount>,
            tonic::Status,
        > {
            self.inner
                .ready()
