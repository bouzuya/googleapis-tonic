...
pub struct HttpOperationDetails {
    ...
    pub query_params: ::prost::alloc::collections::BTreeMap<
        ::prost::alloc::string::String,
...
pub mod http_operation_details {
    ...
    pub struct HttpResponse {
        ...
        #[prost(btree_map = "int32, int64", tag = "2")]
        pub response_codes: ::prost::alloc::collections::BTreeMap<i32, i64>,
    }
    /// Type of data
    #[derive(
        Clone,
...
pub struct PluginInstance {
    ...
    pub additional_config: ::prost::alloc::collections::BTreeMap<
        ::prost::alloc::string::String,
        ConfigVariable,
    >,
