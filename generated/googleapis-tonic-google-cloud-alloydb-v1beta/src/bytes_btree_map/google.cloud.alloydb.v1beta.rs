...
pub struct Cluster {
    ...
    /// ```
    #[prost(btree_map = "string, string", tag = "41")]
...
pub struct Instance {
    ...
    pub observability_config: ::core::option::Option<
...
pub struct UpgradeClusterRequest {
    ...
    #[prost(enumeration = "DatabaseVersion", tag = "2")]
    pub version: i32,
    /// Optional. An optional request ID to identify requests. Specify a unique
    /// request ID so that if you must retry your request, the server ignores the
    /// request if it has already been completed. The server guarantees that for at
...
pub struct UpgradeClusterResponse {
    ...
    #[prost(enumeration = "upgrade_cluster_response::Status", tag = "1")]
    pub status: i32,
    ...
    pub cluster_upgrade_details: ::prost::alloc::vec::Vec<
        upgrade_cluster_response::ClusterUpgradeDetails,
    >,
}
/// Nested message and enum types in `UpgradeClusterResponse`.
pub mod upgrade_cluster_response {
    ...
    pub struct InstanceUpgradeDetails {
        ...
        /// Instance type.
        #[prost(enumeration = "super::instance::InstanceType", tag = "3")]
        pub instance_type: i32,
    }
    ...
    pub struct ClusterUpgradeDetails {
        ...
        #[prost(enumeration = "super::cluster::ClusterType", tag = "3")]
        pub cluster_type: i32,
        ...
        #[prost(enumeration = "super::DatabaseVersion", tag = "4")]
        pub database_version: i32,
        /// Array containing stage info associated with this cluster.
        #[prost(message, repeated, tag = "5")]
        pub stage_info: ::prost::alloc::vec::Vec<StageInfo>,
        /// Upgrade details of the instances directly associated with this cluster.
        #[prost(message, repeated, tag = "6")]
        pub instance_upgrade_details: ::prost::alloc::vec::Vec<InstanceUpgradeDetails>,
    }
    /// Status of upgrade operation.
    #[derive(
        Clone,
    ...
    pub enum Stage {
        ...
        PrimaryInstanceUpgrade = 3,
        /// This stage is read pool upgrade.
        ReadPoolInstancesUpgrade = 4,
    ...
    impl Stage {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::AlloydbPrecheck => "ALLOYDB_PRECHECK",
                Self::PgUpgradeCheck => "PG_UPGRADE_CHECK",
                Self::PrepareForUpgrade => "PREPARE_FOR_UPGRADE",
                Self::PrimaryInstanceUpgrade => "PRIMARY_INSTANCE_UPGRADE",
                Self::ReadPoolInstancesUpgrade => "READ_POOL_INSTANCES_UPGRADE",
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "ALLOYDB_PRECHECK" => Some(Self::AlloydbPrecheck),
                "PG_UPGRADE_CHECK" => Some(Self::PgUpgradeCheck),
                "PREPARE_FOR_UPGRADE" => Some(Self::PrepareForUpgrade),
                "PRIMARY_INSTANCE_UPGRADE" => Some(Self::PrimaryInstanceUpgrade),
                "READ_POOL_INSTANCES_UPGRADE" => Some(Self::ReadPoolInstancesUpgrade),
...
pub struct OperationMetadata {
    ...
    #[prost(oneof = "operation_metadata::RequestSpecific", tags = "8, 9, 10")]
...
pub struct PromoteClusterStatus {
    ...
    ///    read.
    /// 1. PROMOTE_CLUSTER_COMPLETED, indicating that a promote operation
    ///    completed successfully. The database is available for both read and write
    ///    requests
    #[prost(enumeration = "promote_cluster_status::State", tag = "1")]
    pub state: i32,
}
/// Nested message and enum types in `PromoteClusterStatus`.
pub mod promote_cluster_status {
    ...
    impl State {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Self::Unspecified => "STATE_UNSPECIFIED",
                Self::PromoteClusterAvailableForRead => {
                    "PROMOTE_CLUSTER_AVAILABLE_FOR_READ"
                }
                Self::PromoteClusterAvailableForWrite => {
                    "PROMOTE_CLUSTER_AVAILABLE_FOR_WRITE"
                }
                Self::PromoteClusterCompleted => "PROMOTE_CLUSTER_COMPLETED",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                "STATE_UNSPECIFIED" => Some(Self::Unspecified),
                "PROMOTE_CLUSTER_AVAILABLE_FOR_READ" => {
                    Some(Self::PromoteClusterAvailableForRead)
                }
                "PROMOTE_CLUSTER_AVAILABLE_FOR_WRITE" => {
                    Some(Self::PromoteClusterAvailableForWrite)
                }
                "PROMOTE_CLUSTER_COMPLETED" => Some(Self::PromoteClusterCompleted),
                _ => None,
            }
        }
    }
...
pub struct UpgradeClusterStatus {
    ...
    #[prost(enumeration = "DatabaseVersion", tag = "3")]
    pub source_version: i32,
    /// Target database major version.
    #[prost(enumeration = "DatabaseVersion", tag = "4")]
    pub target_version: i32,
    /// Status of all upgrade stages.
    #[prost(message, repeated, tag = "5")]
    pub stages: ::prost::alloc::vec::Vec<upgrade_cluster_status::StageStatus>,
}
/// Nested message and enum types in `UpgradeClusterStatus`.
pub mod upgrade_cluster_status {
    /// Status of an upgrade stage.
    #[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
    pub struct StageStatus {
        /// Upgrade stage.
        #[prost(enumeration = "super::upgrade_cluster_response::Stage", tag = "1")]
        pub stage: i32,
        /// State of this stage.
        ...
        pub stage_specific_status: ::core::option::Option<
            stage_status::StageSpecificStatus,
        >,
    }
    ...
    pub mod stage_status {
        ...
        pub enum StageSpecificStatus {
            ...
            #[prost(message, tag = "11")]
            ReadPoolInstancesUpgrade(super::ReadPoolInstancesUpgradeStageStatus),
        }
    }
    ...
    pub struct ReadPoolInstancesUpgradeStageStatus {
        ...
        #[prost(message, optional, tag = "1")]
        pub upgrade_stats: ::core::option::Option<
            read_pool_instances_upgrade_stage_status::Stats,
        >,
    }
    /// Nested message and enum types in `ReadPoolInstancesUpgradeStageStatus`.
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "google.cloud.alloydb.v1beta.AlloyDBCSQLAdmin",
                        "RestoreFromCloudSQL",
                    ),
                );
            self.inner.unary(req, path, codec).await
